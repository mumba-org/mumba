...
public class HtmlTableCellElement : HtmlElement {
    ...
    public init(name: String, document: WebDocument) {
      ...
      super.init(reference: _HTMLTableCellElementCreate(nameStr, document.reference))
    }
...
extension WebElement {
  ...
  public func asHtmlTableCell() -> HtmlTableCellElement? {
    return asHtmlElement(to: HtmlTableCellElement.self)
  }
