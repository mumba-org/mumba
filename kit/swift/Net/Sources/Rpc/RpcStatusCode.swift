...
public enum StatusCode: Int {
  ...
  /// RpcOperation was rejected because the system is not in a state required for
  ...
  /// RpcOperation was attempted past the valid range. E.g., seeking or reading
  /// past end of file.
  ///
  ...
  /// RpcOperation is not implemented or not supported/enabled in this service.
