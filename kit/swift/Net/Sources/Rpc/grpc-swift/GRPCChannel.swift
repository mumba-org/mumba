...
public protocol GRPCChannel {
  ...
  ///
  /// After making the `RpcCall`, users must `invoke` the call with a callback which is invoked
  ...
  func makeCall<Request: GeneratedMessageProtocol, Response: GeneratedMessageProtocol>(
    path: String,
    type: GRPCCallType,
  ...
  func close(_ promise: @escaping GRPCPromiseWithStatus)
}
...
extension GRPCChannel {
  ...
  ///   - callOptions: Options for the RPC.
  ///   - interceptors: A list of interceptors to intercept the request and response stream with.
  public func makeUnaryCall<Request: GeneratedMessageProtocol, Response: GeneratedMessageProtocol>(
    path: String,
    request: Request,
    callOptions: CallOptions,
    interceptors: [ClientInterceptor<Request, Response>] = []
  ...
  ///   - callOptions: Options for the RPC.
  ///   - interceptors: A list of interceptors to intercept the request and response stream with.
  public func makeClientStreamingCall<Request: GeneratedMessageProtocol, Response: GeneratedMessageProtocol>(
    path: String,
    callOptions: CallOptions,
    interceptors: [ClientInterceptor<Request, Response>] = []
  ...
  public func makeServerStreamingCall<Request: GeneratedMessageProtocol, Response: GeneratedMessageProtocol>(
    path: String,
    request: Request,
    callOptions: CallOptions,
    interceptors: [ClientInterceptor<Request, Response>] = [],
  ...
  ///   - interceptors: A list of interceptors to intercept the request and response stream with.
  ///   - handler: Response handler; called for every response received from the server.
  public func makeBidirectionalStreamingCall<Request: GeneratedMessageProtocol, Response: GeneratedMessageProtocol>(
    path: String,
    callOptions: CallOptions,
    interceptors: [ClientInterceptor<Request, Response>] = [],
    handler: @escaping (Response) -> Void
