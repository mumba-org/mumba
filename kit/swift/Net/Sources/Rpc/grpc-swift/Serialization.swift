...
public struct ProtobufSerializer<Message: GeneratedMessageProtocol>: MessageSerializer {
  @inlinable
  public init() {}
  ...
  public func serialize(_ message: Message, allocator: ByteBufferAllocator) throws -> ByteBuffer {
    ...
    let serialized = try message.data()
...
public struct ProtobufDeserializer<Message: GeneratedMessageProtocol>: MessageDeserializer {
  @inlinable
  public init() {}
  ...
  public func deserialize(byteBuffer: ByteBuffer) throws -> Message {
    ...
    return try Message.parseFrom(codedInputStream: CodedInputStream(buffer: data))
  }
}
