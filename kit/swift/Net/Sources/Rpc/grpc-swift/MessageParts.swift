...
public enum GRPCClientResponsePart<Response> {
  ...
  case end(GRPCStatus, RpcMetadata)
}

public enum GRPCServerRequestPart<Request> {
  /// RpcMetadata received from the client at the start of the RPC.
  case metadata(RpcMetadata)
...
/// RpcMetadata associated with a request or response message.
