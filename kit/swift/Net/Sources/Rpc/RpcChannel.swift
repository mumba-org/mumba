...
public class RpcChannel {
  ...
  private var activeCalls = [WeakReference<RpcCall>]()
  ...
  /// Constructs a RpcCall object to make a gRPC API call
  ///
  ...
  /// - Returns: a RpcCall object that can be used to perform the request
  public func makeCall(_ method: String, host: String? = nil, timeout: TimeInterval? = nil) throws -> RpcCall {
    self.mutex.lock()
    ...
    let call = RpcCall(underlyingCall: underlyingCall, owned: true, completionQueue: self.completionQueue)
