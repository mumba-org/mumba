...
CRONET_EXPORT
int Cronet_Engine_StartNetLogToFile(Cronet_EnginePtr self,
...
typedef Cronet_RESULT (*Cronet_Engine_StartWithParamsFunc)(
    Cronet_EnginePtr self,
    Cronet_EngineParamsPtr params);
typedef int (*Cronet_Engine_StartNetLogToFileFunc)(Cronet_EnginePtr self,
                                                    Cronet_String file_name,
                                                    int log_all);
...
CRONET_EXPORT
int Cronet_UrlRequest_IsDone(Cronet_UrlRequestPtr self);
CRONET_EXPORT
...
typedef int (*Cronet_UrlRequest_IsDoneFunc)(Cronet_UrlRequestPtr self);
...
CRONET_EXPORT
int Cronet_Error_immediately_retryable_get(Cronet_ErrorPtr self);
CRONET_EXPORT
...
CRONET_EXPORT
int Cronet_PublicKeyPins_include_subdomains_get(Cronet_PublicKeyPinsPtr self);
CRONET_EXPORT
...
CRONET_EXPORT
int Cronet_EngineParams_enable_check_result_get(Cronet_EngineParamsPtr self);
CRONET_EXPORT
...
CRONET_EXPORT
int Cronet_EngineParams_enable_quic_get(Cronet_EngineParamsPtr self);
CRONET_EXPORT
int Cronet_EngineParams_enable_http2_get(Cronet_EngineParamsPtr self);
CRONET_EXPORT
int Cronet_EngineParams_enable_brotli_get(Cronet_EngineParamsPtr self);
CRONET_EXPORT
...
CRONET_EXPORT
int Cronet_EngineParams_enable_public_key_pinning_bypass_for_local_trust_anchors_get(
    Cronet_EngineParamsPtr self);
CRONET_EXPORT
...
void Cronet_UrlResponseInfo_all_headers_list_clear(
    Cronet_UrlResponseInfoPtr self);
CRONET_EXPORT
int Cronet_UrlResponseInfo_was_cached_get(Cronet_UrlResponseInfoPtr self);
CRONET_EXPORT
...
void Cronet_UrlRequestParams_request_headers_clear(
    Cronet_UrlRequestParamsPtr self);
CRONET_EXPORT
int Cronet_UrlRequestParams_disable_cache_get(Cronet_UrlRequestParamsPtr self);
CRONET_EXPORT
...
Cronet_ExecutorPtr Cronet_UrlRequestParams_upload_data_provider_executor_get(
    Cronet_UrlRequestParamsPtr self);
CRONET_EXPORT
int Cronet_UrlRequestParams_allow_direct_executor_get(
    Cronet_UrlRequestParamsPtr self);
CRONET_EXPORT
