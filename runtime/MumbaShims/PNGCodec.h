...
#ifndef MUMBA_RUNTIME_MUMBA_SHIMS_PNG_CODEC_H_
#define MUMBA_RUNTIME_MUMBA_SHIMS_PNG_CODEC_H_
...
class CODEC_EXPORT PNGCodec {
 public:
  static constexpr int DEFAULT_ZLIB_OMPRESSION = 6;
  ...
  static SkiaImage* DecodeAsImage(const unsigned char* input, size_t input_size);

 private:
  DISALLOW_COPY_AND_ASSIGN(PNGCodec);
};

#endif  // UI_GFX_ODEC_PNG_ODEC_H_
