...
class HostCrashReporterClient : public crash_reporter::CrashReporterClient {
 public:
  HostCrashReporterClient();
  ~HostCrashReporterClient() override;
 ...
 private:
  DISALLOW_COPY_AND_ASSIGN(HostCrashReporterClient);
};
