...
SocketDescriptor TCPClientSocket::GetSocketDescriptor() const {
  return socket_->IsValid() ? socket_->GetSocketDescriptor() : kInvalidSocket;
}

void TCPClientSocket::DetachFromThread() {
