...
URLRequestHttpJob::URLRequestHttpJob(
    ...
    : URLRequestJob(request, network_delegate),
      ...
      weak_factory_(this) {
  //DLOG(INFO) << "URLRequestHttpJob::URLRequestHttpJob";
...
void URLRequestHttpJob::SetPriority(RequestPriority priority) {
  //DLOG(INFO) << "URLRequestHttpJob::SetPriority: " << priority;
  priority_ = priority;
  if (transaction_)
...
void URLRequestHttpJob::Start() {
  //DLOG(INFO) << "URLRequestHttpJob::Start";
...
void URLRequestHttpJob::Kill() {
  //DLOG(INFO) << "URLRequestHttpJob::Kill";
...
void URLRequestHttpJob::GetConnectionAttempts(ConnectionAttempts* out) const {
  //DLOG(INFO) << "URLRequestHttpJob::GetConnectionAttempts";
  if (transaction_)
...
void URLRequestHttpJob::NotifyBeforeSendHeadersCallback(
  ...
  //DLOG(INFO) << "URLRequestHttpJob::NotifyBeforeSendHeadersCallback";    
...
void URLRequestHttpJob::NotifyHeadersComplete() {
  //DLOG(INFO) << "URLRequestHttpJob::NotifyHeadersComplete";    
...
void URLRequestHttpJob::DestroyTransaction() {
  //DLOG(INFO) << "URLRequestHttpJob::DestroyTransaction";
  DCHECK(transaction_.get());
...
void URLRequestHttpJob::StartTransaction() {
  //DLOG(INFO) << "URLRequestHttpJob::StartTransaction";
...
void URLRequestHttpJob::NotifyBeforeStartTransactionCallback(int result) {
  //DLOG(INFO) << "URLRequestHttpJob::NotifyBeforeStartTransactionCallback";
...
void URLRequestHttpJob::MaybeStartTransactionInternal(int result) {
  //DLOG(INFO) << "URLRequestHttpJob::MaybeStartTransactionInternal";
...
void URLRequestHttpJob::StartTransactionInternal() {
  ...
  //DLOG(INFO) << "URLRequestHttpJob::StartTransactionInternal";
...
void URLRequestHttpJob::AddExtraHeaders() {
  //DLOG(INFO) << "URLRequestHttpJob::AddExtraHeaders";
...
void URLRequestHttpJob::AddCookieHeaderAndStart() {
  //DLOG(INFO) << "URLRequestHttpJob::AddCookieHeaderAndStart";
...
void URLRequestHttpJob::SetCookieHeaderAndStart(const CookieList& cookie_list) {
  //DLOG(INFO) << "URLRequestHttpJob::SetCookieHeaderAndStart";
...
void URLRequestHttpJob::SaveCookiesAndNotifyHeadersComplete(int result) {
  //DLOG(INFO) << "URLRequestHttpJob::SaveCookiesAndNotifyHeadersComplete";
...
void URLRequestHttpJob::ProcessStrictTransportSecurityHeader() {
  //DLOG(INFO) << "URLRequestHttpJob::ProcessStrictTransportSecurityHeader";
  DCHECK(response_info_);
...
void URLRequestHttpJob::ProcessPublicKeyPinsHeader() {
  //DLOG(INFO) << "URLRequestHttpJob::ProcessPublicKeyPinsHeader";
...
void URLRequestHttpJob::ProcessExpectCTHeader() {
  DCHECK(response_info_);
  //DLOG(INFO) << "URLRequestHttpJob::ProcessExpectCTHeader";
  TransportSecurityState* security_state =
      request_->context()->transport_security_state();
  const SSLInfo& ssl_info = response_info_->ssl_info;
...
void URLRequestHttpJob::ProcessReportToHeader() {
  //DLOG(INFO) << "URLRequestHttpJob::ProcessReportToHeader";
...
void URLRequestHttpJob::ProcessNetworkErrorLoggingHeader() {
  //DLOG(INFO) << "URLRequestHttpJob::ProcessNetworkErrorLoggingHeader";
...
void URLRequestHttpJob::OnStartCompleted(int result) {
  //DLOG(INFO) << "URLRequestHttpJob::OnStartCompleted";
...
void URLRequestHttpJob::OnHeadersReceivedCallback(int result) {
  //DLOG(INFO) << "URLRequestHttpJob::OnHeadersReceivedCallback";
...
void URLRequestHttpJob::RestartTransactionWithAuth(
  ...
  //DLOG(INFO) << "URLRequestHttpJob::RestartTransactionWithAuth";
...
void URLRequestHttpJob::SetUpload(UploadDataStream* upload) {
  //DLOG(INFO) << "URLRequestHttpJob::SetUpload";
...
void URLRequestHttpJob::SetExtraRequestHeaders(
  ...
  //DLOG(INFO) << "URLRequestHttpJob::SetExtraRequestHeaders";
...
LoadState URLRequestHttpJob::GetLoadState() const {
  //DLOG(INFO) << "URLRequestHttpJob::GetLoadState";
...
bool URLRequestHttpJob::GetMimeType(std::string* mime_type) const {
  //DLOG(INFO) << "URLRequestHttpJob::GetMimeType";
...
bool URLRequestHttpJob::GetCharset(std::string* charset) {
  //DLOG(INFO) << "URLRequestHttpJob::GetCharset";
...
void URLRequestHttpJob::GetResponseInfo(HttpResponseInfo* info) {
  //DLOG(INFO) << "URLRequestHttpJob::GetResponseInfo";
  if (response_info_) {
    DCHECK(transaction_.get());
...
void URLRequestHttpJob::GetLoadTimingInfo(
  ...
  //DLOG(INFO) << "URLRequestHttpJob::GetLoadTimingInfo";
...
bool URLRequestHttpJob::GetRemoteEndpoint(IPEndPoint* endpoint) const {
  //DLOG(INFO) << "URLRequestHttpJob::GetRemoteEndpoint";
...
int URLRequestHttpJob::GetResponseCode() const {
  //DLOG(INFO) << "URLRequestHttpJob::GetResponseCode";
...
void URLRequestHttpJob::PopulateNetErrorDetails(
  ...
  //DLOG(INFO) << "URLRequestHttpJob::PopulateNetErrorDetails";
  if (!transaction_)
    return;
...
std::unique_ptr<SourceStream> URLRequestHttpJob::SetUpSourceStream() {
  //DLOG(INFO) << "URLRequestHttpJob::SetUpSourceStream";
...
bool URLRequestHttpJob::CopyFragmentOnRedirect(const GURL& location) const {
  //DLOG(INFO) << "URLRequestHttpJob::CopyFragmentOnRedirect";
...
bool URLRequestHttpJob::IsSafeRedirect(const GURL& location) {
  //DLOG(INFO) << "URLRequestHttpJob::IsSafeRedirect";
  // HTTP is always safe.
...
bool URLRequestHttpJob::NeedsAuth() {
  //DLOG(INFO) << "URLRequestHttpJob::NeedsAuth";
...
void URLRequestHttpJob::GetAuthChallengeInfo(
  ...
  //DLOG(INFO) << "URLRequestHttpJob::GetAuthChallengeInfo";
...
void URLRequestHttpJob::SetAuth(const AuthCredentials& credentials) {
  //DLOG(INFO) << "URLRequestHttpJob::SetAuth";
...
void URLRequestHttpJob::CancelAuth() {
  //DLOG(INFO) << "URLRequestHttpJob::CancelAuth";
  // Proxy gets set first, then WWW.
  if (proxy_auth_state_ == AUTH_STATE_NEED_AUTH) {
...
void URLRequestHttpJob::ContinueWithCertificate(
  ...
  //DLOG(INFO) << "URLRequestHttpJob::ContinueWithCertificate";
  DCHECK(transaction_);
...
void URLRequestHttpJob::ContinueDespiteLastError() {
  //DLOG(INFO) << "URLRequestHttpJob::ContinueDespiteLastError";
...
bool URLRequestHttpJob::ShouldFixMismatchedContentLength(int rv) const {
  //DLOG(INFO) << "URLRequestHttpJob::ShouldFixMismatchedContentLength";
...
int URLRequestHttpJob::ReadRawData(IOBuffer* buf, int buf_size) {
  //DLOG(INFO) << "URLRequestHttpJob::ReadRawData";
...
void URLRequestHttpJob::StopCaching() {
  //DLOG(INFO) << "URLRequestHttpJob::StopCaching";
  if (transaction_.get())
...
bool URLRequestHttpJob::GetFullRequestHeaders(
  ...
  //DLOG(INFO) << "URLRequestHttpJob::GetFullRequestHeaders";
...
int64_t URLRequestHttpJob::GetTotalReceivedBytes() const {
  //DLOG(INFO) << "URLRequestHttpJob::GetTotalReceivedBytes";
...
int64_t URLRequestHttpJob::GetTotalSentBytes() const {
  //DLOG(INFO) << "URLRequestHttpJob::GetTotalSentBytes";
...
void URLRequestHttpJob::DoneReading() {
  //DLOG(INFO) << "URLRequestHttpJob::DoneReading";
  if (transaction_) {
...
void URLRequestHttpJob::DoneReadingRedirectResponse() {
  //DLOG(INFO) << "URLRequestHttpJob::DoneReadingRedirectResponse";
  if (transaction_) {
...
void URLRequestHttpJob::UpdatePacketReadTimes() {
  //DLOG(INFO) << "URLRequestHttpJob::UpdatePacketReadTimes";
...
void URLRequestHttpJob::DoneWithRequest(CompletionCause reason) {
  //DLOG(INFO) << "URLRequestHttpJob::DoneWithRequest";
...
HttpResponseHeaders* URLRequestHttpJob::GetResponseHeaders() const {
  //DLOG(INFO) << "URLRequestHttpJob::GetResponseHeaders";
  DCHECK(transaction_.get());
...
void URLRequestHttpJob::NotifyURLRequestDestroyed() {
  //DLOG(INFO) << "URLRequestHttpJob::NotifyURLRequestDestroyed";
