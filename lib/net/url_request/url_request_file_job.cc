...
void URLRequestFileJob::Start() {
  DLOG(INFO) << "URLRequestFileJob::Start";
...
void URLRequestFileJob::Kill() {
  DLOG(INFO) << "URLRequestFileJob::Kill";
  stream_.reset();
...
int URLRequestFileJob::ReadRawData(IOBuffer* dest, int dest_size) {
  DLOG(INFO) << "URLRequestFileJob::ReadRawData: " << dest_size;
...
void URLRequestFileJob::SetExtraRequestHeaders(
  ...
  DLOG(INFO) << "URLRequestFileJob::SetExtraRequestHeaders";    
...
void URLRequestFileJob::OnOpenComplete(int result) {
  DLOG(INFO) << "URLRequestFileJob::OnOpenComplete: " << result;
}

void URLRequestFileJob::OnSeekComplete(int64_t result) {
  DLOG(INFO) << "URLRequestFileJob::OnSeekComplete: " << result;
}

void URLRequestFileJob::OnReadComplete(IOBuffer* buf, int result) {
  DLOG(INFO) << "URLRequestFileJob::OnReadComplete: " << result;
}
...
void URLRequestFileJob::DidFetchMetaInfo(const FileMetaInfo* meta_info) {
  DLOG(INFO) << "URLRequestFileJob::DidFetchMetaInfo: file_size = " << meta_info->file_size;
...
void URLRequestFileJob::DidOpen(int result) {
  DLOG(INFO) << "URLRequestFileJob::DidOpen: " << result;
...
void URLRequestFileJob::DidSeek(int64_t result) {
  DLOG(INFO) << "URLRequestFileJob::DidSeek: " << result;
...
void URLRequestFileJob::DidRead(scoped_refptr<IOBuffer> buf, int result) {
  DLOG(INFO) << "URLRequestFileJob::DidRead: " << result;
  if (result >= 0) {
