...
WebMediaPlayerParams::WebMediaPlayerParams(
    ...
    scoped_refptr<SwitchableAudioRendererSink> audio_renderer_sink,
    ...
    PipSurfaceInfoCB pip_surface_info_cb,
    ExitPipCB exit_pip_cb)
    : defer_load_cb_(std::move(defer_load_cb)),
      ...
      pip_surface_info_cb_(std::move(pip_surface_info_cb)),
      exit_pip_cb_(std::move(exit_pip_cb)) {}
