...
void WebMediaPlayerImpl::StartPipeline() {
  DLOG(INFO) << "WebMediaPlayerImpl::StartPipeline";
  DCHECK(main_task_runner_->BelongsToCurrentThread());
  ...
  if (load_type_ != kLoadTypeMediaSource) {
    ...
    DLOG(INFO) << "WebMediaPlayerImpl::StartPipeline: ENABLE_FFMPEG = true -> demuxer_ = FFmpegDemuxer";
...
#else
    DLOG(INFO) << "WebMediaPlayerImpl::StartPipeline: ENABLE_FFMPEG = false -> OnError(PipelineStatus::DEMUXER_ERROR_COULD_NOT_OPEN)";
