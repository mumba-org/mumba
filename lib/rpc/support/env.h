...
/* Gets the environment variable value with the specified name.
   ...
   variable exists). */
GPRAPI char* gpr_getenv(const char* name);

/* Sets the the environment with the specified name to the specified value. */
GPRAPI void gpr_setenv(const char* name, const char* value);
...
GPRAPI const char* gpr_getenv_silent(const char* name, char** dst);
