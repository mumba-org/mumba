...
void GPRAPI gpr_timers_global_init(void);
void GPRAPI gpr_timers_global_destroy(void);

void GPRAPI gpr_timer_add_mark(const char* tagstr, int important, const char* file,
                        int line);
void GPRAPI gpr_timer_begin(const char* tagstr, int important, const char* file,
                     int line);
void GPRAPI gpr_timer_end(const char* tagstr, int important, const char* file,
                   int line);

void GPRAPI gpr_timers_set_log_filename(const char* filename);

void GPRAPI gpr_timer_set_enabled(int enabled);
