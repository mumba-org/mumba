...
GRPCAPI void grpc_socket_mutator_init(grpc_socket_mutator* mutator,
                              const grpc_socket_mutator_vtable* vtable);

/** Wrap \a mutator as a grpc_arg */
GRPCAPI grpc_arg grpc_socket_mutator_to_arg(grpc_socket_mutator* mutator);

/** Perform the file descriptor mutation operation of \a mutator on \a fd */
GRPCAPI bool grpc_socket_mutator_mutate_fd(grpc_socket_mutator* mutator, int fd);

/** Compare if \a a and \a b are the same mutator or have same settings */
GRPCAPI int grpc_socket_mutator_compare(grpc_socket_mutator* a, grpc_socket_mutator* b);

GRPCAPI grpc_socket_mutator* grpc_socket_mutator_ref(grpc_socket_mutator* mutator);
GRPCAPI void grpc_socket_mutator_unref(grpc_socket_mutator* mutator);
