...
#include "rpc/iomgr/tcp_client_posix.h"
...
static void tcp_client_connect_impl(grpc_exec_ctx* exec_ctx,
  ...
  *ep = nullptr;
  ...
  getsockname(fd, (struct sockaddr *)addr->addr, (socklen_t *)&addr->len);
  inet_ntop(AF_INET, &((struct sockaddr_in *)addr)->sin_addr, mip, sizeof(mip));
  mport = ntohs(((struct sockaddr_in *)addr)->sin_port);
