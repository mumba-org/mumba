...
#include <rpc/impl/codegen/sync_generic.h>

#if defined(GPR_POSIX_SYNC)
#include <rpc/impl/codegen/sync_posix.h>
#elif defined(GPR_WINDOWS)
#include <rpc/impl/codegen/sync_windows.h>
#elif defined(GPR_CUSTOM_SYNC)
#include <rpc/impl/codegen/sync_custom.h>
#else
