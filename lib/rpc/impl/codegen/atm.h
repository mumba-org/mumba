...
#include <rpc/impl/codegen/atm_gcc_atomic.h>
#elif defined(GPR_GCC_SYNC)
#include <rpc/impl/codegen/atm_gcc_sync.h>
#elif defined(GPR_WINDOWS_ATOMIC)
#include <rpc/impl/codegen/atm_windows.h>
#else
...
gpr_atm GPRAPI gpr_atm_no_barrier_clamped_add(gpr_atm* value, gpr_atm delta,
