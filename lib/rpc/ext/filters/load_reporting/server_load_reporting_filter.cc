...
#include <rpc/load_reporting.h>
#include <rpc/support/alloc.h>
#include <rpc/support/log.h>
#include <rpc/support/string_util.h>
#include <rpc/support/sync.h>

#include "rpc/ext/filters/load_reporting/server_load_reporting_filter.h"
#include "rpc/ext/filters/load_reporting/server_load_reporting_plugin.h"
...
static grpc_error* init_call_elem(grpc_exec_ctx* exec_ctx,
  ...
  filter_channel_data *chand = elem->filter_channel_data;
