...
#include "rpc/ext/filters/max_age/max_age_filter.h"
...
static void increase_call_count(grpc_exec_ctx* exec_ctx, filter_channel_data* chand) {
...
static void decrease_call_count(grpc_exec_ctx* exec_ctx, filter_channel_data* chand) {
