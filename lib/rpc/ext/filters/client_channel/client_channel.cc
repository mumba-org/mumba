...
#include "rpc/ext/filters/client_channel/http_connect_handshaker.h"
#include "rpc/ext/filters/client_channel/lb_policy_registry.h"
#include "rpc/ext/filters/client_channel/proxy_mapper_registry.h"
#include "rpc/ext/filters/client_channel/resolver_registry.h"
#include "rpc/ext/filters/client_channel/retry_throttle.h"
...
static void watch_lb_policy_locked(grpc_exec_ctx* exec_ctx, filter_channel_data* chand,
                                   grpc_lb_policy* lb_policy,
...
static void request_reresolution_locked(grpc_exec_ctx* exec_ctx, void* arg,
  ...
  filter_channel_data* chand = args->chand;
...
static void on_resolver_result_changed_locked(grpc_exec_ctx* exec_ctx,
                                              void* arg, grpc_error* error) {
  filter_channel_data* chand = (filter_channel_data*)arg;
  if (grpc_client_channel_trace.enabled()) {
...
/* Destructor for filter_channel_data */
...
static void waiting_for_pick_batches_add(
    filter_call_data* calld, grpc_transport_stream_op_batch* batch) {
...
static void start_pick_locked(grpc_exec_ctx* exec_ctx, void* arg,
  ...
  // from the LB policy.  Add the polling entity from filter_call_data to the
  // filter_channel_data's interested_parties, so that the I/O of the LB policy
...
static external_connectivity_watcher* lookup_external_connectivity_watcher(
    filter_channel_data* chand, grpc_closure* on_complete) {
  gpr_mu_lock(&chand->external_connectivity_watcher_list_mu);
...
static void external_connectivity_watcher_list_append(
    filter_channel_data* chand, external_connectivity_watcher* w) {
...
static void external_connectivity_watcher_list_remove(
    filter_channel_data* chand, external_connectivity_watcher* too_remove) {
  GPR_ASSERT(
