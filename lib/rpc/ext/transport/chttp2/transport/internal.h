...
#include "rpc/ext/transport/chttp2/transport/flow_control.h"
#include "rpc/ext/transport/chttp2/transport/frame.h"
#include "rpc/ext/transport/chttp2/transport/frame_data.h"
#include "rpc/ext/transport/chttp2/transport/frame_goaway.h"
#include "rpc/ext/transport/chttp2/transport/frame_ping.h"
#include "rpc/ext/transport/chttp2/transport/frame_rst_stream.h"
#include "rpc/ext/transport/chttp2/transport/frame_settings.h"
#include "rpc/ext/transport/chttp2/transport/frame_window_update.h"
#include "rpc/ext/transport/chttp2/transport/hpack_encoder.h"
#include "rpc/ext/transport/chttp2/transport/hpack_parser.h"
#include "rpc/ext/transport/chttp2/transport/incoming_metadata.h"
#include "rpc/ext/transport/chttp2/transport/stream_map.h"
#include "rpc/compression/stream_compression.h"
...
inline grpc_chttp2_transport::grpc_chttp2_transport() {}
...
inline grpc_chttp2_stream::grpc_chttp2_stream(){}
...
void GRPCAPI grpc_chttp2_fake_status(grpc_exec_ctx* exec_ctx, grpc_chttp2_transport* t,
                             grpc_chttp2_stream* stream, grpc_error* error);
void GRPCAPI grpc_chttp2_mark_stream_closed(grpc_exec_ctx* exec_ctx,
                                    grpc_chttp2_transport* t,
                                    grpc_chttp2_stream* s, int close_reads,
                                    int close_writes, grpc_error* error);
void GRPCAPI grpc_chttp2_start_writing(grpc_exec_ctx* exec_ctx,
                               grpc_chttp2_transport* t);
...
void GRPCAPI grpc_chttp2_stream_ref(grpc_chttp2_stream* s, const char* reason);
void GRPCAPI grpc_chttp2_stream_unref(grpc_exec_ctx* exec_ctx, grpc_chttp2_stream* s,
                              const char* reason);
#else
#define GRPC_CHTTP2_STREAM_REF(stream, reason) grpc_chttp2_stream_ref(stream)
#define GRPC_CHTTP2_STREAM_UNREF(exec_ctx, stream, reason) \
  grpc_chttp2_stream_unref(exec_ctx, stream)
void GRPCAPI grpc_chttp2_stream_ref(grpc_chttp2_stream* s);
void GRPCAPI grpc_chttp2_stream_unref(grpc_exec_ctx* exec_ctx, grpc_chttp2_stream* s);
#endif
...
// void GRPCAPI grpc_chttp2_unref_transport(grpc_exec_ctx* exec_ctx,
//                                  grpc_chttp2_transport* t, const char* reason,
//                                  const char* file, int line);
// void GRPCAPI grpc_chttp2_ref_transport(grpc_chttp2_transport* t, const char* reason,
//                                const char* file, int line);
//#else
...
void GRPCAPI grpc_chttp2_unref_transport(grpc_exec_ctx* exec_ctx,
                                 grpc_chttp2_transport* t);
void GRPCAPI grpc_chttp2_ref_transport(grpc_chttp2_transport* t);
//#endif
