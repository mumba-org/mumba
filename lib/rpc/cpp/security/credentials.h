...
#include <rpc/cpp/impl/codegen/grpc_library.h>
#include <rpc/cpp/security/auth_context.h>
#include <rpc/cpp/support/status.h>
#include <rpc/cpp/support/string_ref.h>
...
inline bool MetadataCredentialsPlugin::IsBlocking() const { return true; }
inline const char* MetadataCredentialsPlugin::GetType() const { return ""; }    
