...
#include <rpc/cpp/support/async_stream.h>
#include <rpc/cpp/support/async_unary_call.h>
#include <rpc/cpp/support/byte_buffer.h>
...
inline GenericStub::GenericStub(std::shared_ptr<ChannelInterface> channel)
      : channel_(channel) {}
inline GenericStub::~GenericStub(){}
