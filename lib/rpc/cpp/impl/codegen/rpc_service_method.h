...
#include <rpc/cpp/impl/codegen/rpc_method.h>
...
inline RpcServiceMethod::RpcServiceMethod(const char* name, RpcMethod::RpcType type,
                   MethodHandler* handler)
      : RpcMethod(name, type), server_tag_(nullptr), handler_(handler) {}
inline RpcServiceMethod::~RpcServiceMethod(){}
