...
void GRPCAPI grpc_channel_init_init(void);
...
/// types.
void GRPCAPI grpc_channel_init_register_stage(grpc_channel_stack_type type,
                                      int priority,
...
/// allowed.
void GRPCAPI grpc_channel_init_finalize(void);
/// Shutdown the channel init system
void GRPCAPI grpc_channel_init_shutdown(void);
...
bool GRPCAPI grpc_channel_init_create_stack(grpc_exec_ctx* exec_ctx,
                                    grpc_channel_stack_builder* builder,
