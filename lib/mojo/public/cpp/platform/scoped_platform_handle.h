...
#ifndef MOJO_PUBLIC_CPP_PLATFORM_SCOPED_PLATFORM_HANDLE_H_
#define MOJO_PUBLIC_CPP_PLATFORM_SCOPED_PLATFORM_HANDLE_H_
...
class COMPONENT_EXPORT(MOJO_CPP_PLATFORM) ScopedPlatformHandle {
 public:
