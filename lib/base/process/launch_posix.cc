...
//   const char* chroot_directory = nullptr;
//   if (!options.chroot_directory.empty()) {
//     chroot_directory = options.chroot_directory.value().c_str();
//   }
...
//       RAW_CHECK(chroot(chroot_directory) == 0);
//     }
...
//     //RAW_LOG(INFO, "LaunchProcess: executable_path = ");
