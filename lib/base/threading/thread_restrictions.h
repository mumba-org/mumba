...
namespace host {
class HostGpuChannelHostFactory;
class HostGpuMemoryBufferManager;
class HostMainLoop;
class HostProcessSubThread;
//class BrowserShutdownProfileDumper;
class HostSurfaceViewManager;
class HostTestBase;
...
class BASE_EXPORT ScopedAllowBlocking {
 private:
  ...
  friend class host::HostProcessSubThread;
...
class BASE_EXPORT ScopedAllowBaseSyncPrimitives {
 private:
  ...
  friend class host::SessionStorageDatabase;
...
class BASE_EXPORT ScopedAllowBaseSyncPrimitivesOutsideBlockingScope {
 private:
  ...
  friend class host::SynchronousCompositor;
  friend class host::SynchronousCompositorHost;
  friend class host::SynchronousCompositorSyncCallBridge;
...
class BASE_EXPORT ThreadRestrictions {
 ...
 private:
  ...
  friend class host::HostMainLoop;
  friend class host::HostSurfaceViewManager;
  friend class host::HostTestBase;
  friend class host::NestedMessagePumpAndroid;
  friend class host::ScopedAllowWaitForAndroidLayoutTests;
  friend class host::ScopedAllowWaitForDebugURL;
  friend class ::HistogramSynchronizer;
  friend class internal::TaskTracker;
  friend class cc::CompletionEvent;
  friend class cc::SingleThreadTaskGraphRunner;
  friend class host::CategorizedWorkerPool;
  ...
  friend class
      host::HostGpuChannelHostFactory;      // http://crbug.com/125248
  friend class
      host::HostGpuMemoryBufferManager;     // http://crbug.com/420368
  friend class host::TextInputClientMac;       // http://crbug.com/121917
  friend class dbus::Bus;                         // http://crbug.com/125222
  friend class disk_cache::BackendImpl;           // http://crbug.com/74623
  friend class disk_cache::InFlightIO;            // http://crbug.com/74623
  friend class storage::StorageBackend;           
  friend class storage::InFlightIO;            
  friend class gpu::GpuChannelHost;               // http://crbug.com/125264
  friend class net::internal::AddressTrackerLinux;  // http://crbug.com/125097
  friend class net::NetworkChangeNotifierMac;     // http://crbug.com/125097
  //friend class host::HostProcessImpl;              // http://crbug.com/125207
  friend class ::NativeBackendKWallet;            // http://crbug.com/125331
#if !defined(OFFICIAL_BUILD)
  friend class host::SoftwareOutputDeviceMus;  // Interim non-production code
#endif
...
// END USAGE THAT NEEDS TO BE FIXED.
  ...
  class BASE_EXPORT ScopedAllowWait {
   ...
   private:
    friend class application::CategorizedWorkerPool;
#if DCHECK_IS_ON()
    const bool was_allowed_;
#endif
