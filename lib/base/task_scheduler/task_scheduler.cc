...
void TaskScheduler::StartWithDefaultParams() {
  ...
  // The default parameters were too low, and some important IO
  // tasks were blocking forever
  ...
  constexpr int kBackgroundMaxThreads = 2;
  ...
  constexpr TimeDelta kSuggestedReclaimTime = TimeDelta::FromSeconds(18);
