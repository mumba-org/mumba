...
//    to mumba_elf.dll across restarts.
// 2. The APIs exported by mumba_elf.dll to share logs of module load attempts.
...
// Exported API for calling from outside mumba_elf.dll.
