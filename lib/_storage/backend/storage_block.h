...
#ifndef STORAGE_STORAGE_BACKEND_BLOCKFILE_STORAGE_BLOCK_H_
#define STORAGE_STORAGE_BACKEND_BLOCKFILE_STORAGE_BLOCK_H_
...
#endif  // STORAGE_STORAGE_BACKEND_BLOCKFILE_STORAGE_BLOCK_H_
