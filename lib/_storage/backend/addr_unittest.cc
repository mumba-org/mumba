...
TEST_F(StorageCacheTest, StorageAddr_Size) {
  Addr addr1(0);
...
TEST_F(StorageCacheTest, StorageAddr_ValidValues) {
...
TEST_F(StorageCacheTest, StorageAddr_InvalidValues) {
...
TEST_F(StorageCacheTest, StorageAddr_SanityCheck) {
