...
struct MyOverlapped {
  ...
  base::MessagePumpForIO::StorageContext context_;
...
class CompletionHandler : public base::MessagePumpForIO::IOHandler,
 ...
 private:
  ...
  void OnIOCompleted(base::MessagePumpForIO::StorageContext* context,
                     DWORD actual_bytes,
...
void CompletionHandler::OnIOCompleted(
    base::MessagePumpForIO::StorageContext* context,
    DWORD actual_bytes,
    DWORD error) {
