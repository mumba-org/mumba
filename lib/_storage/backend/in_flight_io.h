...
#ifndef STORAGE_STORAGE_BACKEND_BLOCKFILE_IN_FLIGHT_IO_H_
#define STORAGE_STORAGE_BACKEND_BLOCKFILE_IN_FLIGHT_IO_H_
...
class BackgroundIO : public base::RefCountedThreadSafe<BackgroundIO> {
 ...
 protected:
  ...
  int64_t result_;  // Final operation result.
...
#endif  // STORAGE_STORAGE_BACKEND_BLOCKFILE_IN_FLIGHT_IO_H_
