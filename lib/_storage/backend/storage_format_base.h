...
#ifndef STORAGE_STORAGE_BACKEND_BLOCKFILE_STORAGE_FORMAT_BASE_H_
#define STORAGE_STORAGE_BACKEND_BLOCKFILE_STORAGE_FORMAT_BASE_H_

#include <stdint.h>

namespace storage {

typedef uint32_t StorageAddr;
...
const int64_t kBlockHeaderSize = 8192;  // Two pages: almost 64k entries
const int64_t kMaxBlocks = (kBlockHeaderSize - 80) * 8;
const int64_t kNumExtraBlocks = 1024;  // How fast files grow.
...
#endif  // STORAGE_STORAGE_BACKEND_BLOCKFILE_STORAGE_FORMAT_BASE_H_
