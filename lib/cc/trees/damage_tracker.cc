...
//  DLOG(INFO) << "DamageTracker::UpdateDamageTracking";
  //
...
//      DLOG(INFO) << "DamageTracker::UpdateDamageTracking: layer " << layer->id() << " layer->contributes_to_drawn_render_surface() = FALSE. cancelling";
      continue;
    }
