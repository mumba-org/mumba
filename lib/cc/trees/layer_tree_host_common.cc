...
//    DLOG(INFO) << "layer " << layer->id() << " layer->set_contributes_to_drawn_render_surface = false";
...
//    DLOG(INFO) << "skip layer " << layer->id() << " ? " << skip_layer << " is_root = " << is_root << " skip_draw_properties_computation = " << skip_draw_properties_computation << " skip_for_invertibility = " << skip_for_invertibility;
...
//    DLOG(INFO) << "layer " << layer->id() << " layer_should_be_drawn ? " << layer_should_be_drawn << " layer_is_drawn = " << layer_is_drawn;
   ...
   // DLOG(INFO) << "layer " << layer->id() << " graduated! layer->set_contributes_to_drawn_render_surface = true";
