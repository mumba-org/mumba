...
void SingleThreadProxy::SetNeedsAnimate() {
  ...
  DebugScopedSetImplThread impl(task_runner_provider_);
  if (scheduler_on_impl_thread_) {
    //DLOG(INFO) << "SingleThreadProxy::SetNeedsAnimate: scheduler_on_impl_thread_->SetNeedsBeginMainFrame()";
...
void SingleThreadProxy::SetNeedsCommit() {
  ...
  DebugScopedSetImplThread impl(task_runner_provider_);
  if (scheduler_on_impl_thread_) {
//    DLOG(INFO) << "SingleThreadProxy::SetNeedsCommit: scheduler_on_impl_thread_->SetNeedsBeginMainFrame()";
    scheduler_on_impl_thread_->SetNeedsBeginMainFrame();
  }
}
...
void SingleThreadProxy::SetNeedsCommitOnImplThread() {
  single_thread_client_->RequestScheduleComposite();
  if (scheduler_on_impl_thread_) {
//    DLOG(INFO) << "SingleThreadProxy::SetNeedsCommitOnImplThread: scheduler_on_impl_thread_->SetNeedsBeginMainFrame()";
    scheduler_on_impl_thread_->SetNeedsBeginMainFrame();
  }
}
...
//  DLOG(INFO) << "SingleThreadProxy::PostAnimationEventsToMainThreadOnImplThread";
  TRACE_EVENT0(
...
//  DLOG(INFO) << "SingleThreadProxy::DidReceiveCompositorFrameAckOnImplThread";
  if (scheduler_on_impl_thread_) {
  //  DLOG(INFO) << "SingleThreadProxy::DidReceiveCompositorFrameAckOnImplThread: scheduler_on_impl_thread_->DidReceiveCompositorFrameAck()";
  ...
  //DLOG(INFO) << "SingleThreadProxy::DidReceiveCompositorFrameAckOnImplThread: task_runner_provider_->MainThreadTaskRunner()->PostTask SingleThreadProxy::DidReceiveCompositorFrameAck";
