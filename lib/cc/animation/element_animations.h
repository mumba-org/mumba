...
class CC_ANIMATION_EXPORT ElementAnimations
 ...
 public:
  ...
  bool has_element_in_any_list() const {
    //DLOG(INFO) << "ElementAnimations::has_element_in_any_list: has_element_in_active_list_ = " << has_element_in_active_list_ << " has_element_in_pending_list_ = " << has_element_in_pending_list_;
