...
GpuFeatureInfo ComputeGpuFeatureInfo(const GPUInfo& gpu_info,
  ...
  // DLOG(INFO) << "gpu::ComputeGpuFeatureInfo: 0 - Enabled, 1 - Blacklisted, 2 - Disabled, 3 - Software, 4 - Undefined\n" << 
  //  "\n GPU_RASTERIZATION = " << gpu_feature_info.status_values[GPU_FEATURE_TYPE_GPU_RASTERIZATION] << 
  //  "\n ACCELERATED_WEBGL = " << gpu_feature_info.status_values[GPU_FEATURE_TYPE_ACCELERATED_WEBGL] << 
  //  "\n ACCELERATED_WEBGL2 = " << gpu_feature_info.status_values[GPU_FEATURE_TYPE_ACCELERATED_WEBGL2] << 
  //  "\n ACCELERATED_2D_CANVAS = " << gpu_feature_info.status_values[GPU_FEATURE_TYPE_ACCELERATED_2D_CANVAS] << 
  //  "\n ACCELERATED_VIDEO_DECODE = " << gpu_feature_info.status_values[GPU_FEATURE_TYPE_ACCELERATED_VIDEO_DECODE] <<
  //  "\n GPU_COMPOSITING = " << gpu_feature_info.status_values[GPU_FEATURE_TYPE_GPU_COMPOSITING]; 
