...
public:
  ...
  base::StringPiece GetFirstBytes(int index) const;
...
private:
  ...
  base::StringPiece GetFirstBytesInternal(base::MemoryMappedFile* file) const;

  std::unordered_map<base::FilePath::StringType, int> file_path_map_;
