...
public:
  ...
  virtual void CreateDatabase(scoped_refptr<Torrent> torrent, std::vector<std::string> keyspaces, bool in_memory, base::Callback<void(int64_t)> cb) = 0;
  virtual void CreateDatabase(scoped_refptr<Torrent> torrent, const std::vector<std::string>& create_table_stmts, const std::vector<std::string>& insert_table_stmts, bool key_value, bool in_memory, base::Callback<void(int64_t)> cb) = 0;
