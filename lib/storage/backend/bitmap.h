...
#ifndef STORAGE_STORAGE_BACKEND_BLOCKFILE_BITMAP_H_
#define STORAGE_STORAGE_BACKEND_BLOCKFILE_BITMAP_H_
...
class STORAGE_EXPORT_PRIVATE Bitmap {
 public:
...
#endif  // STORAGE_STORAGE_BACKEND_BLOCKFILE_BITMAP_H_
