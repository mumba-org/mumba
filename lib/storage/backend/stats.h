...
#ifndef STORAGE_STORAGE_BACKEND_BLOCKFILE_STATS_H_
#define STORAGE_STORAGE_BACKEND_BLOCKFILE_STATS_H_
...
class STORAGE_EXPORT_PRIVATE Stats {
 public:
...
#endif  // STORAGE_STORAGE_BACKEND_BLOCKFILE_STATS_H_
