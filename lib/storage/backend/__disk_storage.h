...
// See net/disk/disk.h for the public interface of the cache.
...
class StorageBackend {//: public Backend {
 ...
 private:
  ...
  bool CreateBackingStore(storage::File* file);
  ...
  // Creates a new entry object. Returns zero on success, or a disk error
  // on failure.
...
#endif  // STORAGE_STORAGE_BACKEND_STORAGE_BACKEND_H_
