...
#ifndef STORAGE_STORAGE_BACKEND_BLOCKFILE_HISTOGRAM_MACROS_H_
#define STORAGE_STORAGE_BACKEND_BLOCKFILE_HISTOGRAM_MACROS_H_
...
//  UMA_HISTOGRAM_COUNTS_1M("StorageCache.2.MyName", 20);  // "2" is the CacheType.
//  UMA_HISTOGRAM_COUNTS_1M("StorageCache.2.MyExperiment_530", 55);
//
...
#endif  // STORAGE_STORAGE_BACKEND_BLOCKFILE_HISTOGRAM_MACROS_H_
