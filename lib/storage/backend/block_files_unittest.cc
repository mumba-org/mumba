...
TEST_F(StorageCacheTest, BlockFiles_Grow) {
...
TEST_F(StorageCacheTest, BlockFiles_Shrink) {
  ASSERT_TRUE(CleanupCacheDir());
  ASSERT_TRUE(base::CreateDirectory(cache_path_));
...
TEST_F(StorageCacheTest, BlockFiles_Recover) {
  ASSERT_TRUE(CleanupCacheDir());
  ASSERT_TRUE(base::CreateDirectory(cache_path_));
  ...
  StorageAddr entries[kNumEntries];
  ...
  for (int i = 0; i < kNumEntries; i++) {
    ...
    StorageAddr temp = entries[source1];
...
TEST_F(StorageCacheTest, BlockFiles_ZeroSizeFile) {
  ASSERT_TRUE(CleanupCacheDir());
  ASSERT_TRUE(base::CreateDirectory(cache_path_));
...
TEST_F(StorageCacheTest, BlockFiles_TruncatedFile) {
  ASSERT_TRUE(CleanupCacheDir());
  ASSERT_TRUE(base::CreateDirectory(cache_path_));
...
TEST_F(StorageCacheTest, BlockFiles_Counters) {
  ASSERT_TRUE(CleanupCacheDir());
  ASSERT_TRUE(base::CreateDirectory(cache_path_));
...
TEST_F(StorageCacheTest, BlockFiles_InvalidFile) {
  ASSERT_TRUE(CleanupCacheDir());
  ASSERT_TRUE(base::CreateDirectory(cache_path_));
...
TEST_F(StorageCacheTest, BlockFiles_Stats) {
...
TEST_F(StorageCacheTest, AllocationMap) {
  ASSERT_TRUE(CleanupCacheDir());
  ASSERT_TRUE(base::CreateDirectory(cache_path_));
