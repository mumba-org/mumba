...
#ifndef STORAGE_STORAGE_BACKEND_BLOCKFILE_FILE_H_
#define STORAGE_STORAGE_BACKEND_BLOCKFILE_FILE_H_
...
class FileIOCallback {
 public:
  ...
  virtual void OnFileIOComplete(int64_t bytes_copied) = 0;
...
class STORAGE_EXPORT_PRIVATE File : public base::RefCounted<File> {
...
#endif  // STORAGE_STORAGE_BACKEND_BLOCKFILE_FILE_H_
