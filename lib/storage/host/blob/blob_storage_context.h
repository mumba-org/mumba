...
#include "storage/host/blob/blob_entry.h"
#include "storage/host/blob/blob_memory_controller.h"
#include "storage/host/blob/blob_storage_registry.h"
...
class STORAGE_EXPORT BlobStorageContext
 ...
 protected:
  friend class host::BlobDispatcherHost;
  friend class host::BlobDispatcherHostTest;
  friend class host::BlobTransportHostTest;
  friend class host::ChromeBlobStorageContext;
