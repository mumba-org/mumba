...
bool EnumTraits<ui::mojom::LatencyComponentType, ui::LatencyComponentType>::
  ...
  switch (input) {
    ...
    case ui::mojom::LatencyComponentType::
        BROWSER_SNAPSHOT_FRAME_NUMBER_COMPONENT:
      *output = ui::BROWSER_SNAPSHOT_FRAME_NUMBER_COMPONENT;
      return true;
    case ui::mojom::LatencyComponentType::TAB_SHOW_COMPONENT:
      *output = ui::TAB_SHOW_COMPONENT;
      return true;
    case ui::mojom::LatencyComponentType::
        INPUT_EVENT_LATENCY_RENDERER_SWAP_COMPONENT:
    ...
    case ui::mojom::LatencyComponentType::
        INPUT_EVENT_LATENCY_GENERATE_SCROLL_UPDATE_FROM_MOUSE_WHEEL:
      *output = ui::INPUT_EVENT_LATENCY_GENERATE_SCROLL_UPDATE_FROM_MOUSE_WHEEL;
      return true;
    case ui::mojom::LatencyComponentType::
        INPUT_EVENT_LATENCY_TERMINATED_NO_SWAP_COMPONENT:
      *output = ui::INPUT_EVENT_LATENCY_TERMINATED_NO_SWAP_COMPONENT;
      return true;
    case ui::mojom::LatencyComponentType::
        INPUT_EVENT_LATENCY_TERMINATED_FRAME_SWAP_COMPONENT:
      *output = ui::INPUT_EVENT_LATENCY_TERMINATED_FRAME_SWAP_COMPONENT;
      return true;
    case ui::mojom::LatencyComponentType::
        INPUT_EVENT_LATENCY_TERMINATED_COMMIT_FAILED_COMPONENT:
      *output = ui::INPUT_EVENT_LATENCY_TERMINATED_COMMIT_FAILED_COMPONENT;
      return true;
    case ui::mojom::LatencyComponentType::
        INPUT_EVENT_LATENCY_TERMINATED_COMMIT_NO_UPDATE_COMPONENT:
      *output = ui::INPUT_EVENT_LATENCY_TERMINATED_COMMIT_NO_UPDATE_COMPONENT;
      return true;
    case ui::mojom::LatencyComponentType::
        INPUT_EVENT_LATENCY_TERMINATED_SWAP_FAILED_COMPONENT:
      *output = ui::INPUT_EVENT_LATENCY_TERMINATED_SWAP_FAILED_COMPONENT;
      return true;
  }
  NOTREACHED();
  return false;
