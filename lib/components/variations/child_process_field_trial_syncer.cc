...
void ChildProcessFieldTrialSyncer::InitFieldTrialObserving(
  ...
  //DLOG(INFO) << "ChildProcessFieldTrialSyncer::InitFieldTrialObserving";
  // Set up initial set of crash dump data for field trials in this process.
  variations::InitCrashKeys();
  //DLOG(INFO) << "ChildProcessFieldTrialSyncer: variations::InitCrashKeys() END";
  ...
  //DLOG(INFO) << "ChildProcessFieldTrialSyncer: base::FieldTrialList::GetInitiallyActiveFieldTrials END";
  ...
  //DLOG(INFO) << "ChildProcessFieldTrialSyncer: base::FieldTrialList::GetActiveFieldTrialGroups END";
  ...
  //DLOG(INFO) << "ChildProcessFieldTrialSyncer::InitFieldTrialObserving END";
}
