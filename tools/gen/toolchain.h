...
#include "gen/substitution_type.h"
#include "gen/tool.h"
#include "gen/value.h"
...
class Toolchain : public Item {
 public:
  ...
  // Item overrides.
  scoped_refptr<Toolchain> AsToolchain() override;
  ...
  static ToolType GetToolTypeForTargetFinalOutput(scoped_refptr<Target> target);
  const Tool* GetToolForTargetFinalOutput(scoped_refptr<Target> target) const;
