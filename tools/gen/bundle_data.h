...
#include "gen/bundle_file_rule.h"
#include "gen/source_dir.h"
#include "gen/source_file.h"
#include "gen/substitution_list.h"
...
class BundleData {
 public:
  using UniqueTargets = UniqueVector<Target*>;
  ...
  void AddBundleData(scoped_refptr<Target> target);
  ...
  std::vector<Target*> assets_catalog_deps() const {
 ...
 private:
  ...
  std::vector<Target*> assets_catalog_deps_;
