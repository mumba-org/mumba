...
class NinjaTargetWriter {
 public:
  NinjaTargetWriter(scoped_refptr<Target> target, std::ostream& out);
  ...
  static std::string RunAndWriteFile(scoped_refptr<Target> target);
 ...
 protected:
  ...
  scoped_refptr<Target> target_;  // Non-owning.
  std::ostream& out_;
