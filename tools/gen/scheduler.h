...
class Scheduler {
 public:
  ...
  void AddWriteRuntimeDepsTarget(scoped_refptr<Target> entry);
  std::vector<Target*> GetWriteRuntimeDepsTargets() const;
  ...
  void AddUnknownGeneratedInput(scoped_refptr<Target> target, const SourceFile& file);
  std::multimap<SourceFile, Target*> GetUnknownGeneratedInputs() const;
 ...
 private:
  ...
  void DoTargetFileWrite(scoped_refptr<Target> target);
  ...
  std::vector<Target*> write_runtime_deps_targets_;
  std::multimap<SourceFile, Target*> unknown_generated_inputs_;
