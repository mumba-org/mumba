...
void BundleData::OnTargetResolved(Target* owning_target) {
  ...
  UniqueVector<Target*> assets_catalog_deps;
  UniqueVector<SourceFile> assets_catalog_sources;

  for (Target* target : bundle_deps_) {
