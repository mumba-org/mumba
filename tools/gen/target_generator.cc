...
#include "gen/target_generator.h"
...
#include "gen/action_target_generator.h"
#include "gen/binary_target_generator.h"
#include "gen/build_settings.h"
#include "gen/bundle_data_target_generator.h"
#include "gen/config.h"
#include "gen/copy_target_generator.h"
#include "gen/create_bundle_target_generator.h"
#include "gen/err.h"
...
void TargetGenerator::GenerateTarget(Scope* scope,
  ...
  scoped_refptr<Target> target = new Target(
...
bool TargetGenerator::FillSources() {
  ...
  //is_swift_target_ = target_->is_swift_target();
...
bool TargetGenerator::FillOutputs(bool allow_substitutions) {
  ...
  // We need to break this enforcement in swift case
  // because its module system doesnt work if generated
  // source files (like the ones generated by protobuf)
  // are outside the source path.. maybe theres a way
  // around it in swift , but i didnt found any for now

  if (!target_->is_swift_target()) {
