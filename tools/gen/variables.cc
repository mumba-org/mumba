...
const char kCflagsSwift[] = "cflags_swift";
const char kCflagsSwift_HelpShort[] =
    "cflags_swift: [string list] Flags passed to the Swift compiler.";
const char* kCflagsSwift_Help = kCommonCflagsHelp;
