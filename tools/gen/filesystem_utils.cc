...
BuildDirContext::BuildDirContext(scoped_refptr<Target> target)
...
SourceDir GetBuildDirForTargetAsSourceDir(scoped_refptr<Target> target,
                                          BuildDirType type) {
  return GetSubBuildDirAsSourceDir(
      BuildDirContext(target), target->label().dir(), type);
}

OutputFile GetBuildDirForTargetAsOutputFile(scoped_refptr<Target> target,
                                            BuildDirType type) {
