...
class Builder {
 ...
 private:
  ...
  bool ResolveToolchain(scoped_refptr<Target> target, Err* err);
  bool ResolvePools(scoped_refptr<Toolchain> toolchain, Err* err);
