...
class Visibility {
 public:
  ...
  static bool CheckItemVisibility(scoped_refptr<Item> from, scoped_refptr<Item> to, Err* err);

  // Helper function to fill an item's visibility from the "visibility" value
  // in the current scope.
  static bool FillItemVisibility(scoped_refptr<Item> item, Scope* scope, Err* err);
