...
#ifndef CORE_DOMAIN_MOJO_BLINK_INTERFACE_PROVIDER_IMPL_H_
#define CORE_DOMAIN_MOJO_BLINK_INTERFACE_PROVIDER_IMPL_H_
...
#endif  // CORE_DOMAIN_MOJO_BLINK_INTERFACE_PROVIDER_IMPL_H_
