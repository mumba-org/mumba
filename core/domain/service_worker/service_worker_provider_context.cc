...
#include "core/shared/common/thread_safe_sender.h"
...
struct ServiceWorkerProviderContext::ProviderStateForClient {
  ...
  //   the shared worker.
  std::vector<common::mojom::ServiceWorkerWorkerClientPtr> worker_clients;
...
common::mojom::ServiceWorkerContainerHost*
...
ServiceWorkerProviderContext::CreateWorkerClientRequest() {
  DCHECK(main_thread_task_runner_->RunsTasksInCurrentSequence());
  DCHECK(state_for_client_);
  common::mojom::ServiceWorkerWorkerClientPtr client;
  common::mojom::ServiceWorkerWorkerClientRequest request = mojo::MakeRequest(&client);
...
void ServiceWorkerProviderContext::UnregisterWorkerFetchContext(
    common::mojom::ServiceWorkerWorkerClient* client) {
  DCHECK(main_thread_task_runner_->RunsTasksInCurrentSequence());
  DCHECK(state_for_client_);
  base::EraseIf(
      state_for_client_->worker_clients,
      [client](const common::mojom::ServiceWorkerWorkerClientPtr& client_ptr) {
...
bool ServiceWorkerProviderContext::CanCreateSubresourceLoaderFactory() const {
  ...
  // in unit tests.
  return (common::ServiceWorkerUtils::IsServicificationEnabled() &&
