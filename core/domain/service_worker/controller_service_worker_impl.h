...
#ifndef CORE_DOMAIN_SERVICE_WORKER_CONTROLLER_SERVICE_WORKER_IMPL_H_
#define CORE_DOMAIN_SERVICE_WORKER_CONTROLLER_SERVICE_WORKER_IMPL_H_
...
#endif  // CORE_DOMAIN_SERVICE_WORKER_CONTROLLER_SERVICE_WORKER_IMPL_H_
