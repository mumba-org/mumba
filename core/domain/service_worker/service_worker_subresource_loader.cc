...
#include "core/domain/service_worker/service_worker_subresource_loader.h"

#include "base/atomic_sequence_num.h"
#include "base/callback.h"
#include "base/optional.h"
#include "core/shared/common/service_worker/service_worker_loader_helpers.h"
...
class ServiceWorkerSubresourceLoader::StreamWaiter
 ...
 public:
  ...
  // common::mojom::ServiceWorkerStreamCallback implementations:
...
void ServiceWorkerSubresourceLoader::StartRequest(
  ...
  DCHECK(!common::ServiceWorkerUtils::IsMainResourceType(
      static_cast<common::ResourceType>(resource_request.resource_type)));
...
void ServiceWorkerSubresourceLoader::DispatchFetchEvent() {
  ...
  common::mojom::ControllerServiceWorker* controller =
      controller_connector_->GetControllerServiceWorker(
          common::mojom::ControllerServiceWorkerPurpose::FETCH_SUB_RESOURCE);
  ...
  if (resource_request_.request_body) {
    inflight_fetch_request_->request_body =
        common::ServiceWorkerLoaderHelpers::CloneResourceRequestBody(
...
void ServiceWorkerSubresourceLoader::StartResponse(
  ...
  common::ServiceWorkerLoaderHelpers::SaveResponseInfo(response, &response_head_);
  common::ServiceWorkerLoaderHelpers::SaveResponseHeaders(
  ...
  redirect_info_ = common::ServiceWorkerLoaderHelpers::ComputeRedirectInfo(
  ...
  if (body_as_blob) {
    ...
    int error = common::ServiceWorkerLoaderHelpers::ReadBlobResponseBody(
