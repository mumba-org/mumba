...
#ifndef CORE_DOMAIN_SERVICE_WORKER_WORKER_FETCH_CONTEXT_IMPL_H_
#define CORE_DOMAIN_SERVICE_WORKER_WORKER_FETCH_CONTEXT_IMPL_H_
...
class WorkerFetchContextImpl : public blink::WebWorkerFetchContext,
                               public common::mojom::ServiceWorkerWorkerClient {
 public:
  ...
  // common::mojom::ServiceWorkerWorkerClient implementation:
 ...
 private:
  ...
  mojo::Binding<common::mojom::ServiceWorkerWorkerClient> binding_;

  // Bound to |this| on the worker thread.
  common::mojom::ServiceWorkerWorkerClientRequest service_worker_client_request_;
  // Consumed on the worker thread to create |service_worker_container_host_|.
  common::mojom::ServiceWorkerContainerHostPtrInfo service_worker_container_host_info_;
  ...
  int service_worker_provider_id_ = common::kInvalidServiceWorkerProviderId;
  bool is_controlled_by_service_worker_ = false;
  // S13nServiceWorker:
  // Initialized on the worker thread when InitializeOnWorkerThread() is called.
  common::mojom::ServiceWorkerContainerHostPtr service_worker_container_host_;
  ...
  // Updated when common::mojom::ServiceWorkerWorkerClient::SetControllerServiceWorker()
...
#endif  // CORE_DOMAIN_SERVICE_WORKER_WORKER_FETCH_CONTEXT_IMPL_H_
