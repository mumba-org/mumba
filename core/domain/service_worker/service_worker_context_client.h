...
#ifndef CORE_DOMAIN_SERVICE_WORKER_SERVICE_WORKER_CONTEXT_CLIENT_H_
#define CORE_DOMAIN_SERVICE_WORKER_SERVICE_WORKER_CONTEXT_CLIENT_H_
...
namespace common {
class ServiceWorkerContextInstance;    
}
...
class CONTENT_EXPORT ServiceWorkerContextClient
 ...
 private:
  ...
  void DispatchPushEvent(const common::PushEventPayload& payload,
  ...
  common::mojom::ServiceWorkerEventDispatcherRequest pending_dispatcher_request_;
  common::mojom::ControllerServiceWorkerRequest pending_controller_request_;
  blink::mojom::ServiceWorkerHostAssociatedPtrInfo pending_service_worker_host_;

  // This is bound on the main thread.
  scoped_refptr<common::mojom::ThreadSafeEmbeddedWorkerInstanceHostAssociatedPtr>
      instance_host_;
  ...
  common::ServiceWorkerContextInstance* instance_;
...
#endif  // CORE_DOMAIN_SERVICE_WORKER_SERVICE_WORKER_CONTEXT_CLIENT_H_
