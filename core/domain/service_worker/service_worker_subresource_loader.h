...
#ifndef CORE_DOMAIN_SERVICE_WORKER_SERVICE_WORKER_SUBRESOURCE_LOADER_H_
#define CORE_DOMAIN_SERVICE_WORKER_SERVICE_WORKER_SUBRESOURCE_LOADER_H_
...
#include "core/shared/common/service_worker/dispatch_fetch_event_params.mojom.h"
...
class CONTENT_EXPORT ServiceWorkerSubresourceLoader
 ...
 private:
  ...
  // common::mojom::ServiceWorkerFetchResponseCallback overrides:
  ...
  void StartResponse(const common::ServiceWorkerResponse& response,
...
#endif  // CORE_DOMAIN_SERVICE_WORKER_SERVICE_WORKER_SUBRESOURCE_LOADER_H_
