...
#ifndef CORE_DOMAIN_SERVICE_WORKER_SERVICE_WORKER_TIMEOUT_TIMER_H_
#define CORE_DOMAIN_SERVICE_WORKER_SERVICE_WORKER_TIMEOUT_TIMER_H_
...
class CONTENT_EXPORT ServiceWorkerTimeoutTimer {
 public:
  ...
  // this is the opposite of the above, where we reset the the timeout to the delay timer
  void ResetIdleTimerDelay();
  void ResetIdleTimerDelayTo(base::TimeDelta timeout);
...
#endif  // CORE_DOMAIN_SERVICE_WORKER_SERVICE_WORKER_TIMEOUT_TIMER_H_
