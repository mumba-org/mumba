...
#ifndef CORE_DOMAIN_SERVICE_WORKER_SERVICE_WORKER_PROVIDER_CONTEXT_H_
#define CORE_DOMAIN_SERVICE_WORKER_SERVICE_WORKER_PROVIDER_CONTEXT_H_
...
class CONTENT_EXPORT ServiceWorkerProviderContext
    : public base::RefCountedThreadSafe<ServiceWorkerProviderContext,
      ...
      public common::mojom::ServiceWorkerContainer {
 public:
  ...
  ServiceWorkerProviderContext(
      ...
      common::mojom::ServiceWorkerContainerAssociatedRequest request,
  ...
  // ServiceWorkerProviderContext.
  common::mojom::ServiceWorkerWorkerClientRequest CreateWorkerClientRequest();
  ...
  common::mojom::ServiceWorkerContainerHostPtrInfo CloneContainerHostPtrInfo();
  ...
  // Gets the common::mojom::ServiceWorkerContainerHost* for sending requests to
  ...
  common::mojom::ServiceWorkerContainerHost* container_host() const;
 ...
 private:
  ...
  void UnregisterWorkerFetchContext(common::mojom::ServiceWorkerWorkerClient*);

  // Implementation of common::mojom::ServiceWorkerContainer.
  void SetController(common::mojom::ControllerServiceWorkerInfoPtr controller_info,
  ...
  // alive.
  mojo::AssociatedBinding<common::mojom::ServiceWorkerContainer> binding_;
  ...
  common::mojom::ServiceWorkerContainerHostAssociatedPtr container_host_;
...
#endif  // CORE_DOMAIN_SERVICE_WORKER_SERVICE_WORKER_PROVIDER_CONTEXT_H_
