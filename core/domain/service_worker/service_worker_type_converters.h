...
#ifndef CORE_DOMAIN_SERVICE_WORKER_SERVICE_WORKER_TYPE_CONVERTERS_H_
#define CORE_DOMAIN_SERVICE_WORKER_SERVICE_WORKER_TYPE_CONVERTERS_H_
...
struct TypeConverter<blink::WebServiceWorkerContextProxy::BackgroundFetchState,
  ...
  static blink::WebServiceWorkerContextProxy::BackgroundFetchState Convert(
      common::mojom::BackgroundFetchState input);
};

}  // namespace

#endif  // CORE_DOMAIN_SERVICE_WORKER_SERVICE_WORKER_TYPE_CONVERTERS_H_
