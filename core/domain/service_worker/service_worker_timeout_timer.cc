...
void ServiceWorkerTimeoutTimer::ResetIdleTimerDelay() {
  idle_time_ = tick_clock_->NowTicks() + kIdleDelay;
}

void ServiceWorkerTimeoutTimer::ResetIdleTimerDelayTo(base::TimeDelta timeout) {
  idle_time_ = tick_clock_->NowTicks() + timeout;
}
