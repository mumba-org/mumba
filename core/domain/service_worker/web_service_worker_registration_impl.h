...
#ifndef CORE_DOMAIN_SERVICE_WORKER_WEB_SERVICE_WORKER_REGISTRATION_IMPL_H_
#define CORE_DOMAIN_SERVICE_WORKER_WEB_SERVICE_WORKER_REGISTRATION_IMPL_H_
...
class CONTENT_EXPORT WebServiceWorkerRegistrationImpl
 ...
 public:
  ...
  blink::mojom::ScriptType ScriptType() const override;
  void Update(
...
#endif  // CORE_DOMAIN_SERVICE_WORKER_WEB_SERVICE_WORKER_REGISTRATION_IMPL_H_
