...
#ifndef CORE_DOMAIN_SERVICE_WORKER_THREAD_SAFE_SCRIPT_CONTAINER_H_
#define CORE_DOMAIN_SERVICE_WORKER_THREAD_SAFE_SCRIPT_CONTAINER_H_
...
#endif  // CORE_DOMAIN_SERVICE_WORKER_THREAD_SAFE_SCRIPT_CONTAINER_H_
