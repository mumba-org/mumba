...
#ifndef CORE_DOMAIN_LOADER_WEB_URL_REQUEST_UTIL_H_
#define CORE_DOMAIN_LOADER_WEB_URL_REQUEST_UTIL_H_
...
CONTENT_EXPORT common::ResourceType WebURLRequestToResourceType(
...
#endif  // CORE_DOMAIN_LOADER_WEB_URL_REQUEST_UTIL_H_
