...
#ifndef MUMBA_DOMAIN_EXECUTION_NATIVE_LIBRARY_FILE_LOADER_H_
#define MUMBA_DOMAIN_EXECUTION_NATIVE_LIBRARY_FILE_LOADER_H_
...
namespace domain {
 ...
 // A native (dll/dso) code loader
class LocalFileLoader : public CodeLoader {
public:
  LocalFileLoader();
...
private:
  ...
  DISALLOW_COPY_AND_ASSIGN(LocalFileLoader); 
};
