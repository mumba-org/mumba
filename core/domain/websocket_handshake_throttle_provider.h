...
#ifndef CORE_DOMAIN_WEBSOCKET_HANDSHAKE_THROTTLE_PROVIDER_H_
#define CORE_DOMAIN_WEBSOCKET_HANDSHAKE_THROTTLE_PROVIDER_H_
...
#endif  // CORE_DOMAIN_WEBSOCKET_HANDSHAKE_THROTTLE_PROVIDER_H_
