...
#ifndef CORE_DOMAIN_LOADER_CHILD_URL_LOADER_FACTORY_BUNDLE_H_
#define CORE_DOMAIN_LOADER_CHILD_URL_LOADER_FACTORY_BUNDLE_H_
...
#endif  // CORE_DOMAIN_LOADER_CHILD_URL_LOADER_FACTORY_BUNDLE_H_
