...
#include "core/domain/fileapi/webfilesystem_impl.h"
...
#include "core/domain/file_info_util.h"
#include "core/domain/fileapi/file_system_dispatcher.h"
#include "core/domain/fileapi/webfilewriter_impl.h"
...
void CallDispatcherOnMainThread(
  ...
  if (!DomainMainThread::current() ||
      !DomainMainThread::current()->file_system_dispatcher())
    return;

  DCHECK(!waitable_results);
  DispatchToMethod(DomainMainThread::current()->file_system_dispatcher(),
                   method, params);
}
