...
#include "core/shared/domain/storage/collections/concept_collection.h"
...
size_t ConceptCollection::count() const {
  return 2;
}

std::shared_ptr<RecordBatch> ConceptCollection::Scan() {
