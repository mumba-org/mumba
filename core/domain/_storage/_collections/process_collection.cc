...
#include "core/shared/domain/storage/collections/process_collection.h"
...
size_t ProcessCollection::count() const {
  return 2;
}

std::shared_ptr<RecordBatch> ProcessCollection::Scan() {
