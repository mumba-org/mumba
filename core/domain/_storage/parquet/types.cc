...
std::string FormatStatValue(ParquetType::type parquet_type, const char* val) {
...
std::string TypeToString(ParquetType::type t) {
  switch (t) {
    case ParquetType::BOOLEAN:
      return "BOOLEAN";
    case ParquetType::INT32:
...
int GetTypeByteSize(ParquetType::type parquet_type) {
  switch (parquet_type) {
    case ParquetType::BOOLEAN:
...
SortOrder::type DefaultSortOrder(ParquetType::type primitive) {
  switch (primitive) {
    case ParquetType::BOOLEAN:
    case ParquetType::INT32:
    case ParquetType::INT64:
...
SortOrder::type GetSortOrder(LogicalType::type converted, ParquetType::type primitive) {
