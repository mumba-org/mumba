...
#include "data/util/key_value_metadata.h"
...
using KeyValueMetadata = ::KeyValueMetadata;
...
class ApplicationVersion {
 public:
  ...
  // Executable that wrote the file. e.g. "IMPALA"
...
class ColumnChunkMetaData {
 public:
  ...
  // parameter is only used when a namespace is spread across multiple files
...
class ColumnChunkMetaDataBuilder {
 public:
  ...
  // column chunk
  // Used when a namespace is spread across multiple files
