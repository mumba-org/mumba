...
#include "core/shared/domain/storage/parquet/api/io.h"
#include "core/shared/domain/storage/parquet/api/reader.h"
#include "core/shared/domain/storage/parquet/api/schema.h"
#include "core/shared/domain/storage/parquet/api/writer.h"
...
PARQUET_NORETURN void ThrowsParquetException() {
  throw parquetParquetException("This function throws");
}

TEST(TestPublicAPI, CanThrowParquetException) {
  ASSERT_THROW(ThrowsParquetException(), parquetParquetException);
}
