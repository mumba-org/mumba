...
template <ParquetType::type TYPE>
struct type_traits {};

template <>
struct type_traits<ParquetType::BOOLEAN> {
...
template <>
struct type_traits<ParquetType::INT32> {
...
template <>
struct type_traits<ParquetType::INT64> {
...
template <>
struct type_traits<ParquetType::INT96> {
...
template <>
struct type_traits<ParquetType::FLOAT> {
...
template <>
struct type_traits<ParquetType::DOUBLE> {
...
template <>
struct type_traits<ParquetType::BYTE_ARRAY> {
...
template <>
struct type_traits<ParquetType::FIXED_LEN_BYTE_ARRAY> {
...
template <ParquetType::type TYPE>
struct ParquetDataType {
  using c_type = typename type_traits<TYPE>::value_type;
  static constexpr ParquetType::type type_num = TYPE;
};

using ParquetBooleanType = ParquetDataType<ParquetType::BOOLEAN>;
using ParquetInt32Type = ParquetDataType<ParquetType::INT32>;
using ParquetInt64Type = ParquetDataType<ParquetType::INT64>;
using ParquetInt96Type = ParquetDataType<ParquetType::INT96>;
using ParquetFloatType = ParquetDataType<ParquetType::FLOAT>;
using ParquetDoubleType = ParquetDataType<ParquetType::DOUBLE>;
using ParquetByteArrayType = ParquetDataType<ParquetType::BYTE_ARRAY>;
using ParquetFLBAType = ParquetDataType<ParquetType::FIXED_LEN_BYTE_ARRAY>;
...
PARQUET_EXPORT std::string TypeToString(ParquetType::type t);

PARQUET_EXPORT std::string FormatStatValue(ParquetType::type parquet_type, const char* val);

PARQUET_EXPORT int GetTypeByteSize(ParquetType::type t);

PARQUET_EXPORT SortOrder::type DefaultSortOrder(ParquetType::type primitive);

PARQUET_EXPORT SortOrder::type GetSortOrder(LogicalType::type converted,
                                            ParquetType::type primitive);
