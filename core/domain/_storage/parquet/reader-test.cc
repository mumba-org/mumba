...
#include "core/shared/domain/storage/parquet/printer.h"
#include "core/shared/domain/storage/parquet/util/memory.h"
#include "core/shared/domain/storage/parquet/util/test-common.h"

using std::string;

namespace domain {

using ReadableFile = io::ReadableFile;
...
class HelperFileClosed : public ArrowInputFile {
 public:
  explicit HelperFileClosed(
      const std::shared_ptr<io::ReadableFileInterface>& file, bool* close_called)
