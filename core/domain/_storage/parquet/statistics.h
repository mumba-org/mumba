...
class RowGroupStatistics
 ...
 public:
  ...
  ParquetType::type physical_type() const { return descr_->physical_type(); }
...
template <>
inline void TypedRowGroupStatistics<ParquetFLBAType>::Copy(const FLBA& src, FLBA* dst,
                                                    PoolBuffer* buffer) {
...
template <>
inline void TypedRowGroupStatistics<ParquetByteArrayType>::Copy(const ByteArray& src,
                                                         ByteArray* dst,
                                                         PoolBuffer* buffer) {
  if (dst->ptr == src.ptr) return;
...
template <>
void TypedRowGroupStatistics<ParquetByteArrayType>::PlainEncode(const T& src, std::string* dst);

template <>
void TypedRowGroupStatistics<ParquetByteArrayType>::PlainDecode(const std::string& src, T* dst);

typedef TypedRowGroupStatistics<ParquetBooleanType> BoolStatistics;
typedef TypedRowGroupStatistics<ParquetInt32Type> Int32Statistics;
typedef TypedRowGroupStatistics<ParquetInt64Type> Int64Statistics;
typedef TypedRowGroupStatistics<ParquetInt96Type> Int96Statistics;
typedef TypedRowGroupStatistics<ParquetFloatType> FloatStatistics;
typedef TypedRowGroupStatistics<ParquetDoubleType> DoubleStatistics;
typedef TypedRowGroupStatistics<ParquetByteArrayType> ByteArrayStatistics;
typedef TypedRowGroupStatistics<ParquetFLBAType> FLBAStatistics;
...
PARQUET_EXTERN_TEMPLATE TypedRowGroupStatistics<ParquetBooleanType>;
PARQUET_EXTERN_TEMPLATE TypedRowGroupStatistics<ParquetInt32Type>;
PARQUET_EXTERN_TEMPLATE TypedRowGroupStatistics<ParquetInt64Type>;
PARQUET_EXTERN_TEMPLATE TypedRowGroupStatistics<ParquetInt96Type>;
PARQUET_EXTERN_TEMPLATE TypedRowGroupStatistics<ParquetFloatType>;
PARQUET_EXTERN_TEMPLATE TypedRowGroupStatistics<ParquetDoubleType>;
PARQUET_EXTERN_TEMPLATE TypedRowGroupStatistics<ParquetByteArrayType>;
PARQUET_EXTERN_TEMPLATE TypedRowGroupStatistics<ParquetFLBAType>;
