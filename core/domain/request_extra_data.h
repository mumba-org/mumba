...
//#include "core/domain/loader/navigation_response_override_parameters.h"
//#include "core/domain/application_url_loader.h"
...
class CONTENT_EXPORT RequestExtraData : public blink::WebURLRequest::ExtraData {
 ...
 // }
  ...
  std::vector<std::unique_ptr<common::URLLoaderThrottle>> TakeURLLoaderThrottles() {
 ...
 private:
  ...
  std::vector<std::unique_ptr<common::URLLoaderThrottle>> url_loader_throttles_;
