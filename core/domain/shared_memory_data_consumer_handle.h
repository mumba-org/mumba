...
#ifndef MUMBA_APPLICATION_SHARED_MEMORY_DATA_CONSUMER_HANDLE_H_
#define MUMBA_APPLICATION_SHARED_MEMORY_DATA_CONSUMER_HANDLE_H_
...
#endif  // CORE_DOMAIN_LOADER_SHARED_MEMORY_DATA_CONSUMER_HANDLE_H_
