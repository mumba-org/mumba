...
#ifndef CORE_DOMAIN_LOADER_URL_RESPONSE_BODY_CONSUMER_H_
#define CORE_DOMAIN_LOADER_URL_RESPONSE_BODY_CONSUMER_H_
...
#endif  // CORE_DOMAIN_LOADER_URL_RESPONSE_BODY_CONSUMER_H_
