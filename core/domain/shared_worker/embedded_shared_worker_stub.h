...
#ifndef CORE_DOMAIN_SHARED_WORKER_EMBEDDED_SHARED_WORKER_STUB_H_
#define CORE_DOMAIN_SHARED_WORKER_EMBEDDED_SHARED_WORKER_STUB_H_
...
#include "core/shared/common/shared_worker/shared_worker_info.mojom.h"
#include "core/domain/child_message_filter.h"
...
class EmbeddedSharedWorkerStub : public blink::WebSharedWorkerClient,
                                 public common::mojom::SharedWorker {
 public:
 ...
 private:
  ...
  common::mojom::SharedWorkerHostPtr host_;
...
#endif  // CORE_DOMAIN_SHARED_WORKER_EMBEDDED_SHARED_WORKER_STUB_H_
