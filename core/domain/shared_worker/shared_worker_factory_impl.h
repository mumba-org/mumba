...
#ifndef CORE_DOMAIN_SHARED_WORKER_SHARED_WORKER_FACTORY_IMPL_H_
#define CORE_DOMAIN_SHARED_WORKER_SHARED_WORKER_FACTORY_IMPL_H_
...
#endif  // CORE_DOMAIN_SHARED_WORKER_SHARED_WORKER_FACTORY_IMPL_H_
