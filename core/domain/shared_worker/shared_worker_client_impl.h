...
#ifndef CORE_DOMAIN_SHARED_WORKER_SHARED_WORKER_CLIENT_IMPL_H_
#define CORE_DOMAIN_SHARED_WORKER_SHARED_WORKER_CLIENT_IMPL_H_
...
class SharedWorkerClientImpl : public common::mojom::SharedWorkerClient {
 public:
...
#endif  // CORE_DOMAIN_SHARED_WORKER_SHARED_WORKER_CLIENT_IMPL_H_
