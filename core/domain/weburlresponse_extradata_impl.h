...
#ifndef CORE_DOMAIN_LOADER_WEBURLRESPONSE_EXTRADATA_IMPL_H_
#define CORE_DOMAIN_LOADER_WEBURLRESPONSE_EXTRADATA_IMPL_H_
...
class CONTENT_EXPORT WebURLResponseExtraDataImpl
 ...
 public:
  ...
  common::PreviewsState previews_state() const { return previews_state_; }
  void set_previews_state(common::PreviewsState previews_state) {
 ...
 private:
  ...
  common::PreviewsState previews_state_;
...
#endif  // CORE_DOMAIN_LOADER_WEBURLRESPONSE_EXTRADATA_IMPL_H_
