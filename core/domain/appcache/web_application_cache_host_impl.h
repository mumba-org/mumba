...
#ifndef CORE_DOMAIN_APPCACHE_WEB_APPLICATION_CACHE_HOST_IMPL_H_
#define CORE_DOMAIN_APPCACHE_WEB_APPLICATION_CACHE_HOST_IMPL_H_
...
class WebApplicationCacheHostImpl : public blink::WebApplicationCacheHost {
 public:
  ...
  common::AppCacheBackend* backend() const { return backend_; }
  blink::WebApplicationCacheHostClient* client() const { return client_; }

  virtual void OnCacheSelected(const common::AppCacheInfo& info);
  void OnStatusChanged(common::AppCacheStatus);
  void OnEventRaised(common::AppCacheEventID);
  void OnProgressEventRaised(const GURL& url, int num_total, int num_complete);
  void OnErrorEventRaised(const common::AppCacheErrorDetails& details);
  virtual void OnLogMessage(common::AppCacheLogLevel log_level,
...
#endif  // CORE_DOMAIN_APPCACHE_WEB_APPLICATION_CACHE_HOST_IMPL_H_
