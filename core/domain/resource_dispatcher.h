...
#ifndef MUMBA_APPLICATION_RESOURCE_DISPATCHER_H_
#define MUMBA_APPLICATION_RESOURCE_DISPATCHER_H_
...
class CONTENT_EXPORT ResourceDispatcher {
 ...
 private:
  ...
  struct PendingRequestInfo {
    ...
    std::vector<common::mojom::RedirectInfoPtr> redirect_info_chain;
