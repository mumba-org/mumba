...
URLLoaderThrottleProviderImpl::URLLoaderThrottleProviderImpl(
    URLLoaderThrottleProviderType type)//,
...
URLLoaderThrottleProviderImpl::CreateThrottles(
  ...
  // bool is_frame_resource = false;//content::IsResourceTypeFrame(resource_type);

  // DCHECK(!is_frame_resource ||
  //        type_ == URLLoaderThrottleProviderType::kFrame);
...
//   if (type_ == URLLoaderThrottleProviderType::kFrame &&
//       !is_frame_resource) {
//     content::RenderFrame* render_frame =
//         content::RenderFrame::FromRoutingID(render_frame_id);
