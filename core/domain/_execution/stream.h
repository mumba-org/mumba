...
#ifndef MUMBA_DOMAIN_EXECUTION_STREAM_H_
#define MUMBA_DOMAIN_EXECUTION_STREAM_H_
...
public:
  ...
  ReadIOBuffer* read_buffer() const { return read_buf_.get(); }
  QueuedWriteIOBuffer* write_buffer() const { return write_buf_.get(); }
