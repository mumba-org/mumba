...
//#include "core/domain/loader/ftp_directory_listing_response_delegate.h"
...
#include "core/domain/shared_memory_data_consumer_handle.h"
#include "core/domain/sync_load_response.h"
#include "core/domain/web_url_request_util.h"
#include "core/domain/weburlresponse_extradata_impl.h"
...
class KeepAliveHandleWithChildProcessReference {
 public:
  explicit KeepAliveHandleWithChildProcessReference(
      common::mojom::KeepAliveHandlePtr ptr)
      : keep_alive_handle_(std::move(ptr)) {}
  ~KeepAliveHandleWithChildProcessReference() {}

 private:
  common::mojom::KeepAliveHandlePtr keep_alive_handle_;
  common::ScopedChildProcessReference reference_;
};
...
void WebURLLoaderImpl::Context::Cancel() {
  //DLOG(INFO) << "WebURLLoaderImpl::Context::Cancel";
...
void WebURLLoaderImpl::Context::Start(const WebURLRequest& request,
                                      SyncLoadResponse* sync_load_response) {
  //DLOG(INFO) << "WebURLLoaderImpl::Context::Start";
 ...
 // }
  ...
  if (sync_load_response) {
    ...
    //DLOG(INFO) << "WebURLLoaderImpl::Context::Start: resource_dispatcher_->StartSync()";
  ...
  //DLOG(INFO) << "WebURLLoaderImpl::Context::Start: resource_dispatcher_->StartAsync()";
...
void WebURLLoaderImpl::Context::OnReceivedResponse(
    const network::ResourceResponseInfo& info) {
  //DLOG(INFO) << "WebURLLoaderImpl::Context::OnReceivedResponse";
  if (!client_)
    return;
...
void WebURLLoaderImpl::Context::OnStartLoadingResponseBody(
  ...
  //DLOG(INFO) << "WebURLLoaderImpl::Context::OnStartLoadingResponseBody";    
  if (client_)
...
void WebURLLoaderImpl::Context::OnDownloadedData(int len,
  ...
  //DLOG(INFO) << "WebURLLoaderImpl::Context::OnDownloadedData";    
  if (client_)
...
void WebURLLoaderImpl::Context::OnReceivedData(
  ...
  //DLOG(INFO) << "WebURLLoaderImpl::Context::OnReceivedData";
...
void WebURLLoaderImpl::Context::OnCompletedRequest(
  ...
  //DLOG(INFO) << "WebURLLoaderImpl::Context::OnCompletedRequest";
...
bool WebURLLoaderImpl::Context::CanHandleDataURLRequestLocally(
  ...
  //DLOG(INFO) << "WebURLLoaderImpl::Context::CanHandleDataURLRequestLocally";
...
void WebURLLoaderImpl::PopulateURLResponse(
  ...
  extra_data->set_previews_state(
      static_cast<common::PreviewsState>(info.previews_state));
...
void WebURLLoaderImpl::LoadSynchronously(
  ...
  //DLOG(INFO) << "WebURLLoaderImpl::LoadSynchronously";
...
void WebURLLoaderImpl::LoadAsynchronously(const WebURLRequest& request,
  ...
  //DLOG(INFO) << "WebURLLoaderImpl::LoadAsynchronously";
