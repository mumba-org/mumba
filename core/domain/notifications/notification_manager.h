...
#ifndef CORE_DOMAIN_NOTIFICATIONS_NOTIFICATION_MANAGER_H_
#define CORE_DOMAIN_NOTIFICATIONS_NOTIFICATION_MANAGER_H_
...
#endif  // CORE_DOMAIN_NOTIFICATIONS_NOTIFICATION_MANAGER_H_
