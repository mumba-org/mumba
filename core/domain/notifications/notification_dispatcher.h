...
#ifndef CORE_DOMAIN_NOTIFICATIONS_NOTIFICATION_DISPATCHER_H_
#define CORE_DOMAIN_NOTIFICATIONS_NOTIFICATION_DISPATCHER_H_
...
#endif  // CORE_DOMAIN_NOTIFICATIONS_NOTIFICATION_DISPATCHER_H_
