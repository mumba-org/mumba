...
#ifndef MUMBA_DOMAIN_NOTIFICATION_SERVICE_H_
#define MUMBA_DOMAIN_NOTIFICATION_SERVICE_H_

#include "core/domain/notification_details.h"
#include "core/domain/notification_source.h"
...
class NotificationService {
 public:
  ...
  // a shell before use. But, we want the number of AllSources() calls to
  ...
  static Source<void> AllHostContextsAndSources() {
...
#endif  // MUMBA_MODULES_HOST_NOTIFICATION_SERVICE_H_
