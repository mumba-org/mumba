...
#ifndef CORE_DOMAIN_LOADER_URL_LOADER_CLIENT_IMPL_H_
#define CORE_DOMAIN_LOADER_URL_LOADER_CLIENT_IMPL_H_
...
#endif  // CORE_DOMAIN_LOADER_URL_LOADER_CLIENT_IMPL_H_
