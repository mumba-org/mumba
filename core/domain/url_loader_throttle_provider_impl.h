...
class URLLoaderThrottleProviderImpl
    : public URLLoaderThrottleProvider {
 public:
  ...
  std::vector<std::unique_ptr<common::URLLoaderThrottle>> CreateThrottles(
      int render_frame_id,
      const blink::WebURLRequest& request,
      common::ResourceType resource_type) override;
 ...
 private:
  ...
  URLLoaderThrottleProviderType type_;
