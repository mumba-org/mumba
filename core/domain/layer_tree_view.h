...
class CONTENT_EXPORT LayerTreeView
 ...
 public:
  ...
  void StartPageScaleAnimation(const blink::WebPoint& target_offset,
                               bool use_anchor,
...
//       const gfx::PresentationFeedback& feedback) override;
  ...
  void AddPresentationCallback(
      uint32_t frame_token,
      base::Callback<void (blink::WebLayerTreeView::SwapResult, double)> callback);
 ...
 private:
  ...
  blink::scheduler::WebMainThreadScheduler* const web_main_thread_scheduler_;
  ...
  base::circular_deque<
      std::pair<uint32_t,
                std::vector<base::Callback<void (blink::WebLayerTreeView::SwapResult, double)>>>>
