...
#include "content/public/test/mock_application_thread.h"
#include "core/shared/application/media/pepper/pepper_to_video_track_adapter.h"
#include "core/shared/application/media/stream/media_stream_video_track.h"
#include "core/shared/application/media/stream/mock_media_stream_registry.h"
#include "core/shared/application/media/stream/mock_media_stream_video_sink.h"
#include "core/shared/application/pepper/pepper_plugin_instance_impl.h"
#include "core/shared/application/pepper/ppb_image_data_impl.h"
...
class PepperToVideoTrackAdapterTest : public PpapiUnittest {
 ...
 protected:
  ...
  const MockApplicationThread application_thread_;
