...
#include "core/shared/application/media/audio/mojo_audio_output_ipc.h"
...
void MojoAudioOutputIPC::RequestDeviceAuthorization(
  ...
  //DLOG(INFO) << "MojoAudioOutputIPC::RequestDeviceAuthorization: device_id [" << device_id.size() << "] = " << device_id;
...
void MojoAudioOutputIPC::ProviderClientBindingDisconnected(
  ...
  DCHECK(io_task_runner_->RunsTasksInCurrentSequence());
  DCHECK(delegate_);
  //DLOG(INFO) << "MojoAudioOutputIPC::ProviderClientBindingDisconnected: reason: " << 
  //  disconnect_reason << " description: " << description;
...
void MojoAudioOutputIPC::DoRequestDeviceAuthorization(
  ...
  //DLOG(INFO) << "MojoAudioOutputIPC::DoRequestDeviceAuthorization: device_id [" << device_id.size() << "] = " << device_id;
  DCHECK(io_task_runner_->RunsTasksInCurrentSequence());
  ...
  //DLOG(INFO) << "MojoAudioOutputIPC::DoRequestDeviceAuthorization: calling factory->RequestDeviceAuthorization() ...";
...
void MojoAudioOutputIPC::Created(
  ...
  //                           expected_state_ == kPlaying);
  delegate_->OnStreamCreated(memory_handle, socket_handle, expected_state_ == kPlaying);
