...
#include "core/shared/common/buildflags.h"
#include "core/shared/common/client.h"
#include "core/shared/common/content_features.h"
#include "core/shared/common/switches.h"
#include "core/shared/common/feature_h264_with_openh264_ffmpeg.h"
#include "core/shared/common/renderer_preferences.h"
#include "core/shared/common/webrtc_ip_handling_policy.h"
//#include "core/shared/application/application_client.h"
#include "core/shared/application/media/stream/media_stream_video_source.h"
#include "core/shared/application/media/stream/media_stream_video_track.h"
#include "core/shared/application/media/webrtc/audio_codec_factory.h"
#include "core/shared/application/media/webrtc/rtc_peer_connection_handler.h"
#include "core/shared/application/media/webrtc/rtc_video_decoder_factory.h"
#include "core/shared/application/media/webrtc/rtc_video_encoder_factory.h"
#include "core/shared/application/media/webrtc/stun_field_trial.h"
#include "core/shared/application/media/webrtc/webrtc_audio_device_impl.h"
#include "core/shared/application/media/webrtc/webrtc_uma_histograms.h"
#include "core/shared/application/media/webrtc/webrtc_video_capturer_adapter.h"
#include "core/shared/application/media/webrtc_logging.h"
#include "core/shared/application/p2p/empty_network_manager.h"
#include "core/shared/application/p2p/filtering_network_manager.h"
#include "core/shared/application/p2p/ipc_network_manager.h"
#include "core/shared/application/p2p/ipc_socket_factory.h"
#include "core/shared/application/p2p/port_allocator.h"
...
//   if (preference == common::kWebRTCIPHandlingDefaultPublicAndPrivateInterfaces)
//     return DEFAULT_PUBLIC_AND_PRIVATE_INTERFACES;
//   if (preference == common::kWebRTCIPHandlingDefaultPublicInterfaceOnly)
//     return DEFAULT_PUBLIC_INTERFACE_ONLY;
//   if (preference == common::kWebRTCIPHandlingDisableNonProxiedUdp)
...
//#if BUILDFLAG(RTC_USE_H264) && BUILDFLAG(ENABLE_FFMPEG_VIDEO_DECODERS)
  ...
  if (!base::FeatureList::IsEnabled(common::kWebRtcH264WithOpenH264FFmpeg)) {
...
//#endif  // BUILDFLAG(RTC_USE_H264) && BUILDFLAG(ENABLE_FFMPEG_VIDEO_DECODERS)
  ...
  chrome_signaling_thread_.task_runner()->PostTask(
      ...
      base::BindOnce(
          ...
          ApplicationThread::current()->GetGpuFactories(),
...
void PeerConnectionDependencyFactory::InitializeSignalingThread(
  ...
  factory_options.crypto_options.enable_gcm_crypto_suites = true;
      //cmd_line->HasSwitch(switches::kEnableWebRtcSrtpAesGcm);
  factory_options.crypto_options.enable_encrypted_rtp_header_extensions = true;
...
PeerConnectionDependencyFactory::CreatePeerConnection(
  ...
  //   }
    ...
    //     application::RenderFrameImpl* render_frame =
    //         application::RenderFrameImpl::FromWebFrame(web_frame);
    //     if (render_frame)
  ...
  const GURL& requesting_origin = GURL(web_frame->GetDocument().Url().GetString().Utf8().data()).GetOrigin();

  std::unique_ptr<rtc::NetworkManager> network_manager;
  if (port_config.enable_multiple_routes) {
    FilteringNetworkManager* filtering_network_manager =
        new FilteringNetworkManager(network_manager_, 
                                    requesting_origin,
                                    media_permission);
