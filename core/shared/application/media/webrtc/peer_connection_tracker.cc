...
PeerConnectionTracker::PeerConnectionTracker(
    common::mojom::PeerConnectionTrackerHostAssociatedPtr host)
    : next_local_id_(1),
...
ApplicationThread* PeerConnectionTracker::SendTarget() {
...
void PeerConnectionTracker::OverrideSendTargetForTesting(ApplicationThread* target) {
  send_target_for_test_ = target;
}

const common::mojom::PeerConnectionTrackerHostAssociatedPtr&
