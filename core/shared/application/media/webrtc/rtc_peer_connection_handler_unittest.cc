...
#include "core/shared/application/media/audio/mock_audio_device_factory.h"
...
#include "core/shared/application/media/stream/media_stream_source.h"
...
#include "core/shared/application/media/webrtc/mock_data_channel_impl.h"
#include "core/shared/application/media/webrtc/mock_peer_connection_dependency_factory.h"
#include "core/shared/application/media/webrtc/mock_peer_connection_impl.h"
  ...
  blink::WebMediaStream CreateLocalMediaStream(
    ...
    ProcessedLocalAudioSource* const audio_source =
        new ProcessedLocalAudioSource(
            ...
            common::MediaStreamDevice(MEDIA_DEVICE_AUDIO_CAPTURE, "mock_device_id",
                              "Mock device",
