...
#include "core/shared/application/media/webrtc/webrtc_audio_sink.h"
#include "core/shared/application/media/webrtc/webrtc_media_stream_track_adapter.h"
...
class CONTENT_EXPORT WebRtcMediaStreamTrackAdapter
 ...
 private:
  ...
  // Pointer to a |PeerConnectionDependencyFactory| owned by the |ApplicationThread|.
