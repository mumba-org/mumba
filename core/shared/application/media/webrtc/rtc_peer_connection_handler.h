...
#include "core/shared/application/media/webrtc/media_stream_track_metrics.h"
...
#include "core/shared/application/media/webrtc/webrtc_media_stream_adapter_map.h"
