...
class CONTENT_EXPORT PeerConnectionTracker
    : public ApplicationThreadObserver,
      public base::SupportsWeakPtr<PeerConnectionTracker> {
 public:
  PeerConnectionTracker();
  PeerConnectionTracker(common::mojom::PeerConnectionTrackerHostAssociatedPtr host);
  ...
  // ApplicationThreadObserver implementation.
  ...
  void OverrideSendTargetForTesting(ApplicationThread* target);
 ...
 private:
  ...
  ApplicationThread* send_target_for_test_;
  common::mojom::PeerConnectionTrackerHostAssociatedPtr
