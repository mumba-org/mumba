...
#include "core/shared/application/media/webrtc/rtc_certificate.h"
#include "core/shared/application/media/webrtc/rtc_data_channel_handler.h"
#include "core/shared/application/media/webrtc/rtc_dtmf_sender_handler.h"
#include "core/shared/application/media/webrtc/rtc_event_log_output_sink.h"
#include "core/shared/application/media/webrtc/rtc_event_log_output_sink_proxy.h"
#include "core/shared/application/media/webrtc/rtc_stats.h"
#include "core/shared/application/media/webrtc/webrtc_audio_device_impl.h"
#include "core/shared/application/media/webrtc/webrtc_media_stream_adapter.h"
#include "core/shared/application/media/webrtc/webrtc_set_remote_description_observer.h"
...
bool RTCPeerConnectionHandler::Initialize(
  ...
  peer_connection_tracker_ =
      ApplicationThread::current()->peer_connection_tracker()->AsWeakPtr();
...
void RTCPeerConnectionHandler::OnSignalingChange(
  ...
  if (peer_connection_tracker_)
    peer_connection_tracker_->TrackSignalingStateChange(this, new_state);//state);
  if (!is_closed_)
