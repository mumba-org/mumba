...
#include "core/shared/application/media/renderer_webmediaplayer_delegate.h"
...
void RecordAction(const base::UserMetricsAction& action) {
  application::ApplicationThread::Get()->RecordAction(action);
}
...
RendererWebMediaPlayerDelegate::RendererWebMediaPlayerDelegate(
    ...
    : RenderFrameObserver(render_frame),
      allow_idle_cleanup_(
          application::GetContentClient()->renderer()->AllowIdleMediaSuspend()),
