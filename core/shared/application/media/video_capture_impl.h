...
class CONTENT_EXPORT VideoCaptureImpl
 ...
 public:
  ...
  void GetDeviceSupportedFormats(const common::VideoCaptureDeviceFormatsCB& callback);

  // Get capturing formats currently in use by this device.
  // |callback| will be invoked with the results.
  void GetDeviceFormatsInUse(const common::VideoCaptureDeviceFormatsCB& callback);
