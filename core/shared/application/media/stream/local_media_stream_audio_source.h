...
// Uses application::AudioDeviceFactory to auto-create the AudioInputDevice, using
// the parameters and session ID found in common::MediaStreamDevice, just before the
// first track is connected. Audio data is transported directly to the tracks
// (i.e., there is no audio processing).
class CONTENT_EXPORT LocalMediaStreamAudioSource final
