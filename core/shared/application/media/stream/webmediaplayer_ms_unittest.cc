...
// application::MediaStreamVideoRenderer.
// 2. application::MediaStreamVideoRenderer will start pushing frames into
...
//    application::MediaStreamVideoRenderer::Pause, and then the provider will stop
