...
class CONTENT_EXPORT UserMediaProcessor
 ...
 public:
  ...
  void OnDeviceStopped(const common::MediaStreamDevice& device) override;
 ...
 private:
  ...
  const common::mojom::MediaStreamDispatcherHostPtr& GetMediaStreamDispatcherHost();
  const blink::mojom::MediaDevicesDispatcherHostPtr&
  ...
  // Weak ref to a PeerConnectionDependencyFactory, owned by the ApplicationThread.
  // It's valid for the lifetime of ApplicationThread.
  ...
  common::mojom::MediaStreamDispatcherHostPtr dispatcher_host_;
  ...
  ApplicationWindowDispatcher* const dispatcher_;
