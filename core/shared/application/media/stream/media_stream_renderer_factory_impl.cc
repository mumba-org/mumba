...
#include "core/shared/application/media/stream/media_stream_video_renderer_sink.h"
#include "core/shared/application/media/stream/media_stream_video_track.h"
#include "core/shared/application/media/stream/track_audio_renderer.h"
#include "core/shared/application/media/webrtc/peer_connection_dependency_factory.h"
#include "core/shared/application/media/webrtc/peer_connection_remote_audio_source.h"
#include "core/shared/application/media/webrtc/webrtc_audio_renderer.h"
...
PeerConnectionDependencyFactory* GetPeerConnectionDependencyFactory() {
  return ApplicationThread::current()->GetPeerConnectionDependencyFactory();
}
