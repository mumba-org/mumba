...
#include "core/shared/application/media/stream/secure_display_link_tracker.h"
...
class CONTENT_EXPORT MediaStreamVideoSource : public MediaStreamSource {
 ...
 protected:
  ...
  virtual void StartSourceImpl(
      const common::VideoCaptureDeliverFrameCB& frame_callback) = 0;
  void OnStartDone(common::MediaStreamRequestResult result);
