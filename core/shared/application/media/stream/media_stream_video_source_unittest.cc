...
#include "core/shared/application/media/stream/mock_media_stream_video_sink.h"
...
class MediaStreamVideoSourceTest : public ::testing::Test {
 ...
 protected:
  ...
  application::common::MediaStreamRequestResult error_type() const { return result_; }
 ...
 private:
  ...
  application::common::MediaStreamRequestResult result_;
