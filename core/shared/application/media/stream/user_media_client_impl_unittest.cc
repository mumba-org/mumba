...
#include "core/shared/application/media/stream/media_stream_audio_processor_options.h"
#include "core/shared/application/media/stream/media_stream_audio_source.h"
#include "core/shared/application/media/stream/media_stream_audio_track.h"
...
#include "core/shared/application/media/stream/media_stream_track.h"
#include "core/shared/application/media/stream/mock_constraint_factory.h"
#include "core/shared/application/media/stream/mock_media_stream_video_source.h"
#include "core/shared/application/media/stream/mock_mojo_media_stream_dispatcher_host.h"
...
class MockMediaStreamVideoCapturerSource : public MockMediaStreamVideoSource {
 public:
  MockMediaStreamVideoCapturerSource(const common::MediaStreamDevice& device,
...
class UserMediaProcessorUnderTest : public UserMediaProcessor {
 public:
  ...
  application::common::MediaStreamRequestResult error_reason() const { return result_; }
  ...
  void GetUserMediaRequestFailed(
      application::common::MediaStreamRequestResult result,
 ...
 private:
  ...
  application::common::MediaStreamRequestResult result_ = NUM_MEDIA_REQUEST_RESULTS;
...
class UserMediaClientImplTest : public ::testing::Test {
 public:
  ...
  void SetUp() override {
    ...
    common::mojom::MediaStreamDispatcherHostPtr dispatcher_host =
