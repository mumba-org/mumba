...
#include "core/shared/application/media/stream/apply_constraints_processor.h"
...
void ApplyConstraintsProcessor::ProcessVideoRequest() {
  ...
  const common::MediaStreamDevice& device_info = video_source_->device();
  if (device_info.type == common::MEDIA_DEVICE_VIDEO_CAPTURE) {
