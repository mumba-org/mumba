...
class ApplicationWebMediaPlayerDelegate;
...
class MediaFactory {
 ...
 private:
  ...
  void DeferMediaLoad(blink::WebLocalFrame* frame,
...
//#endif
  ...
  ApplicationThread* application_thread_;
  ...
  // lifetime is tied to the RenderFrame via the RenderFrameObserver interface.
  media::ApplicationWebMediaPlayerDelegate* media_player_delegate_ = nullptr;
