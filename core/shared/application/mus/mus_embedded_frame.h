...
class ApplicationWindowTreeClient;
...
class MusEmbeddedFrame {
 ...
 private:
  friend class ApplicationWindowTreeClient;
  ...
  MusEmbeddedFrame(ApplicationWindowTreeClient* renderer_window_tree_client,
  ...
  ApplicationWindowTreeClient* renderer_window_tree_client_;
