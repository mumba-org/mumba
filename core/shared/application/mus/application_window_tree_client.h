...
// ui.mojom.WindowTreeClient implementation for ApplicationWidget. This lives and
// operates on the renderer's main thread.
class ApplicationWindowTreeClient : public ui::mojom::WindowTreeClient,
                                    public common::mojom::ApplicationWindowTreeClient {
 public:
  // Creates a ApplicationWindowTreeClient instance for the ApplicationWidget instance
  ...
  // Returns the ApplicationWindowTreeClient associated with |routing_id|. Returns
  // nullptr if none exists.
  // TODO(sky): make ApplicationWidget own ApplicationWindowTreeClient.
  static ApplicationWindowTreeClient* Get(int routing_id);
 ...
 private:
  ...
  explicit ApplicationWindowTreeClient(int routing_id);
  ~ApplicationWindowTreeClient() override;
  ...
  // mojom::ApplicationWindowTreeClient:
  ...
  // ApplicationWidget and related classes (e.g. resize, input, ime etc.).
  void OnEmbed(
  ...
  mojo::Binding<common::mojom::ApplicationWindowTreeClient>
      application_window_tree_client_binding_;
  ...
  DISALLOW_COPY_AND_ASSIGN(ApplicationWindowTreeClient);
};
