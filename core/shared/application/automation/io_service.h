...
#ifndef MUMBA_APPLICATION_IO_SERVICE_H_
#define MUMBA_APPLICATION_IO_SERVICE_H_
...
class IOService : public service_manager::Service {
 public:
  IOService(PageInstance* page_instance);
  ~IOService() override;
 ...
 private:
  ...
  void Create(automation::IORequest request);
...
#endif  // MUMBA_APPLICATION_IO_SERVICE_H_
