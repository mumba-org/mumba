...
#ifndef MUMBA_APPLICATION_OVERLAY_SERVICE_H_
#define MUMBA_APPLICATION_OVERLAY_SERVICE_H_
...
class OverlayService : public service_manager::Service {
 public:
  OverlayService(PageInstance* page_instance,
 ...
 private:
  ...
  void Create(automation::OverlayRequest request);
...
#endif  // MUMBA_APPLICATION_OVERLAY_SERVICE_H_
