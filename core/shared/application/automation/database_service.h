...
#ifndef MUMBA_APPLICATION_DATABASE_SERVICE_H_
#define MUMBA_APPLICATION_DATABASE_SERVICE_H_
...
class DatabaseService : public service_manager::Service {
 public:
  DatabaseService(AutomationContext* context, PageInstance* page_instance);
 ...
 private:
  ...
  void Create(automation::DatabaseInterfaceRequest request);
...
#endif  // MUMBA_APPLICATION_DATABASE_SERVICE_H_
