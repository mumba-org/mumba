...
#ifndef MUMBA_APPLICATION_NETWORK_SERVICE_H_
#define MUMBA_APPLICATION_NETWORK_SERVICE_H_
...
class NetworkService : public service_manager::Service {
 public:
  NetworkService(PageInstance* page_instance);
 ...
 private:
  ...
  void Create(automation::NetworkRequest request);
...
#endif  // MUMBA_APPLICATION_NETWORK_SERVICE_H_
