...
#ifndef MUMBA_APPLICATION_STORAGE_SERVICE_H_
#define MUMBA_APPLICATION_STORAGE_SERVICE_H_
...
class StorageService : public service_manager::Service {
 public:
  StorageService(PageInstance* page_instance);
 ...
 private:
  ...
  void Create(automation::StorageRequest request);
...
#endif  // MUMBA_APPLICATION_STORAGE_SERVICE_H_
