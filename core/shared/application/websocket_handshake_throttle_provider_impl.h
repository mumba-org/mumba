...
class CONTENT_EXPORT WebSocketHandshakeThrottleProviderImpl final
    : public WebSocketHandshakeThrottleProvider {
 public:
  ...
  std::unique_ptr<WebSocketHandshakeThrottleProvider> Clone() override;
