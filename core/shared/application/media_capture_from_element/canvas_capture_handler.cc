...
#include "core/shared/application/media_capture_from_element/canvas_capture_handler.h"
...
class VideoCapturerSource : public media::VideoCapturerSource {
 ...
 protected:
  media::VideoCaptureFormats GetPreferredFormats() override {
    ...
    gfx::Size size(size_.width, size_.height);
    formats.push_back(media::VideoCaptureFormat(size, frame_rate_,
