...
#include "core/shared/application/media_capture_from_element/html_video_element_capturer_source.h"
...
HtmlVideoElementCapturerSource::GetPreferredFormats() {
  ...
  const media::VideoCaptureFormat format(
      gfx::Size(web_media_player_->NaturalSize().width, web_media_player_->NaturalSize().height),
