...
#include "core/shared/application/media_recorder/video_track_recorder.h"
...
#include "core/shared/application/media_recorder/vea_encoder.h"
#include "core/shared/application/media_recorder/vpx_encoder.h"
...
#include "core/shared/application/media_recorder/h264_encoder.h"
...
CodecEnumerator::CodecEnumerator() {
  ApplicationThread* const application_thread =
  ...
  media::GpuVideoAcceleratorFactories* const gpu_factories =
      application_thread->GetGpuFactories();
