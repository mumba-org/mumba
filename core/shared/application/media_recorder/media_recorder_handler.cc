...
#include "core/shared/application/media_recorder/media_recorder_handler.h"
...
#include "core/shared/common/scoped_web_callbacks.h"
...
#include "core/shared/application/media_recorder/audio_track_recorder.h"
...
blink::WebString MediaRecorderHandler::ActualMimeType() {
  ...
  blink::WebVector<blink::WebMediaStreamTrack> video_streams;
  blink::WebVector<blink::WebMediaStreamTrack> audio_streams;
  media_stream_.VideoTracks(video_streams);
  media_stream_.AudioTracks(audio_streams);
  const bool has_video_tracks = !video_streams.empty();
  const bool has_audio_tracks = !audio_streams.empty();
