...
common::PlatformNotificationData ToPlatformNotificationData(
    const WebNotificationData& web_data) {
  common::PlatformNotificationData platform_data;
  ...
  switch (web_data.direction) {
    case WebNotificationData::kDirectionLeftToRight:
      platform_data.direction =
          common::PlatformNotificationData::DIRECTION_LEFT_TO_RIGHT;
      break;
    case WebNotificationData::kDirectionRightToLeft:
      platform_data.direction =
          common::PlatformNotificationData::DIRECTION_RIGHT_TO_LEFT;
      break;
    case WebNotificationData::kDirectionAuto:
      platform_data.direction = common::PlatformNotificationData::DIRECTION_AUTO;
      break;
  }
    ...
    switch (web_data.actions[i].type) {
      case blink::WebNotificationAction::kButton:
        platform_data.actions[i].type =
            common::PLATFORM_NOTIFICATION_ACTION_TYPE_BUTTON;
        break;
      case blink::WebNotificationAction::kText:
        platform_data.actions[i].type = common::PLATFORM_NOTIFICATION_ACTION_TYPE_TEXT;
        break;
      default:
...
WebNotificationData ToWebNotificationData(
  ...
  switch (platform_data.direction) {
    case common::PlatformNotificationData::DIRECTION_LEFT_TO_RIGHT:
      web_data.direction = WebNotificationData::kDirectionLeftToRight;
      break;
    case common::PlatformNotificationData::DIRECTION_RIGHT_TO_LEFT:
      web_data.direction = WebNotificationData::kDirectionRightToLeft;
      break;
    case common::PlatformNotificationData::DIRECTION_AUTO:
  ...
  web_data.image = blink::KURL(String::FromUTF8(platform_data.image.possibly_invalid_spec().data()));
  web_data.icon = blink::KURL(String::FromUTF8(platform_data.icon.possibly_invalid_spec().data()));
  web_data.badge = blink::KURL(String::FromUTF8(platform_data.badge.possibly_invalid_spec().data()));
  ...
  for (size_t i = 0; i < platform_data.actions.size(); ++i) {
    switch (platform_data.actions[i].type) {
      case common::PLATFORM_NOTIFICATION_ACTION_TYPE_BUTTON:
        web_data.actions[i].type = blink::WebNotificationAction::kButton;
        break;
      case common::PLATFORM_NOTIFICATION_ACTION_TYPE_TEXT:
    ...
    web_data.actions[i].icon = 
      blink::KURL(String::FromUTF8(platform_data.actions[i].icon.possibly_invalid_spec().data()));
