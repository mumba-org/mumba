...
#include "core/shared/application/url_response_body_consumer.h"
...
class URLLoaderClientImpl::DeferredOnReceiveResponse final
 ...
 public:
  ...
  void HandleMessage(ResourceDispatcher* dispatcher, int request_id) override {
   // //DLOG(INFO) << "URLLoaderClientImpl::OnReceivedResponse";
...
class URLLoaderClientImpl::DeferredOnReceiveRedirect final
 ...
 public:
  ...
  void HandleMessage(ResourceDispatcher* dispatcher, int request_id) override {
 //   //DLOG(INFO) << "URLLoaderClientImpl::OnOnReceiveRedirect";
...
class URLLoaderClientImpl::DeferredOnDataDownloaded final
 ...
 public:
  ...
  void HandleMessage(ResourceDispatcher* dispatcher, int request_id) override {
   // //DLOG(INFO) << "URLLoaderClientImpl::OnDataDownloaded";
...
class URLLoaderClientImpl::DeferredOnUploadProgress final
 ...
 public:
  ...
  void HandleMessage(ResourceDispatcher* dispatcher, int request_id) override {
  //  //DLOG(INFO) << "URLLoaderClientImpl::OnUploadProgress";
...
class URLLoaderClientImpl::DeferredOnReceiveCachedMetadata final
 ...
 public:
  ...
  void HandleMessage(ResourceDispatcher* dispatcher, int request_id) override {
  //  //DLOG(INFO) << "URLLoaderClientImpl::OnReceivedCachedMetadata";
...
class URLLoaderClientImpl::DeferredOnComplete final : public DeferredMessage {
 public:
  ...
  void HandleMessage(ResourceDispatcher* dispatcher, int request_id) override {
  //  //DLOG(INFO) << "URLLoaderClientImpl::OnRequestComplete";
...
URLLoaderClientImpl::~URLLoaderClientImpl() {
  //DLOG(INFO) << "URLLoaderClientImpl::~URLLoaderClientImpl";
  if (body_consumer_)
    body_consumer_->Cancel();
}

void URLLoaderClientImpl::SetDefersLoading() {
  //DLOG(INFO) << "URLLoaderClientImpl::SetDefersLoading";
  is_deferred_ = true;
  if (body_consumer_)
...
void URLLoaderClientImpl::UnsetDefersLoading() {
 // //DLOG(INFO) << "URLLoaderClientImpl::UnsetDefersLoading";
  is_deferred_ = false;
...
void URLLoaderClientImpl::OnReceiveResponse(
 ...
 // //DLOG(INFO) << "URLLoaderClientImpl::OnReceiveResponse";
...
void URLLoaderClientImpl::OnReceiveCachedMetadata(
  ...
  //DLOG(INFO) << "URLLoaderClientImpl::OnReceiveCachedMetadata";
  if (NeedsStoringMessage()) {
...
void URLLoaderClientImpl::OnComplete(
 ...
 // //DLOG(INFO) << "URLLoaderClientImpl::OnComplete";
...
void URLLoaderClientImpl::OnConnectionClosed() {
  //DLOG(INFO) << "URLLoaderClientImpl::OnConnectionClosed";
