...
#include "core/shared/application/service_worker/web_service_worker_installed_scripts_manager_impl.h"
...
void EmbeddedWorkerInstanceClientImpl::StartWorker(
  ...
  common::ServiceWorkerContextInstance* instance = application_thread->GetServiceWorkerContextInstance();
  
  if (!worker_native_client_factory_) {
    worker_native_client_factory_ = application_thread->GetWorkerNativeClientFactory();
  }
...
EmbeddedWorkerInstanceClientImpl::StartWorkerContext(
  ...
  start_data.script_url = blink::KURL(params->script_url.possibly_invalid_spec().data());
