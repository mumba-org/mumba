...
TypeConverter<blink::WebServiceWorkerContextProxy::BackgroundFetchState,
              common::mojom::BackgroundFetchState>::
    Convert(common::mojom::BackgroundFetchState input) {
  switch (input) {
    case common::mojom::BackgroundFetchState::PENDING:
      return blink::WebServiceWorkerContextProxy::BackgroundFetchState::
          kPending;
    case common::mojom::BackgroundFetchState::SUCCEEDED:
      return blink::WebServiceWorkerContextProxy::BackgroundFetchState::
          kSucceeded;
    case common::mojom::BackgroundFetchState::FAILED:
