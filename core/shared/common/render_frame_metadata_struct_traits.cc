...
#include "core/shared/common/render_frame_metadata_struct_traits.h"
...
// static
bool StructTraits<common::mojom::RenderFrameMetadataDataView,
                  cc::RenderFrameMetadata>::
    Read(common::mojom::RenderFrameMetadataDataView data,
