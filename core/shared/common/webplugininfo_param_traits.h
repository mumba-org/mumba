...
#include "core/common/webplugininfo.h"
#include "ipc/ipc_message_macros.h"

#undef IPC_MESSAGE_EXPORT
#define IPC_MESSAGE_EXPORT CONTENT_EXPORT

IPC_STRUCT_TRAITS_BEGIN(common::WebPluginMimeType::Param)
  IPC_STRUCT_TRAITS_MEMBER(name)
  IPC_STRUCT_TRAITS_MEMBER(value)
IPC_STRUCT_TRAITS_END()

IPC_STRUCT_TRAITS_BEGIN(common::WebPluginMimeType)
...
IPC_STRUCT_TRAITS_BEGIN(common::WebPluginInfo)
  IPC_STRUCT_TRAITS_MEMBER(name)
