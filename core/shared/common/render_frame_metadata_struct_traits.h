...
#include "core/shared/common/render_frame_metadata.mojom-shared.h"

namespace mojo {

template <>
struct StructTraits<common::mojom::RenderFrameMetadataDataView,
  ...
  static bool Read(common::mojom::RenderFrameMetadataDataView data,
