...
#include "core/shared/common/load_timing_info_struct_traits.h"
...
// static
bool StructTraits<common::mojom::LoadTimingInfoConnectTimingDataView,
                  net::LoadTimingInfo::ConnectTiming>::
    Read(common::mojom::LoadTimingInfoConnectTimingDataView data,
...
// static
bool StructTraits<common::mojom::LoadTimingInfoDataView, net::LoadTimingInfo>::
    Read(common::mojom::LoadTimingInfoDataView data,
