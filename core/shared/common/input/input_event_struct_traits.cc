...
#include "core/shared/common/input/input_event_struct_traits.h"
...
common::mojom::PointerDataPtr PointerDataFromPointerProperties(
    const blink::WebPointerProperties& pointer,
    common::mojom::MouseDataPtr mouse_data) {
  return common::mojom::PointerData::New(
...
void PointerPropertiesFromPointerData(
    const common::mojom::PointerDataPtr& pointer_data,
...
void TouchPointPropertiesFromPointerData(
    const common::mojom::TouchPointPtr& mojo_touch_point,
...
bool StructTraits<common::mojom::EventDataView, InputEventUniquePtr>::Read(
    common::mojom::EventDataView event,
    InputEventUniquePtr* out) {
  DCHECK(!out->get());

  out->reset(new common::InputEvent());
  ...
  if (blink::WebInputEvent::IsKeyboardEventType(type)) {
    common::mojom::KeyDataPtr key_data;
    if (!event.ReadKeyData<common::mojom::KeyDataPtr>(&key_data))
      return false;
    ...
    common::mojom::GestureDataPtr gesture_data;
    if (!event.ReadGestureData<common::mojom::GestureDataPtr>(&gesture_data))
      return false;
    ...
    common::mojom::TouchDataPtr touch_data;
    if (!event.ReadTouchData<common::mojom::TouchDataPtr>(&touch_data))
      return false;
    ...
    std::vector<common::mojom::TouchPointPtr> touches;
    unsigned i;
    ...
    common::mojom::PointerDataPtr pointer_data;
    if (!event.ReadPointerData<common::mojom::PointerDataPtr>(&pointer_data))
      return false;
    ...
    if (pointer_data->mouse_data) {
      ...
      if (type == blink::WebInputEvent::Type::kMouseWheel &&
        ...
        common::mojom::WheelDataPtr& wheel_data =
            pointer_data->mouse_data->wheel_data;
...
// static
common::mojom::KeyDataPtr
StructTraits<common::mojom::EventDataView, InputEventUniquePtr>::key_data(
  ...
  return common::mojom::KeyData::New(
...
// static
common::mojom::PointerDataPtr
StructTraits<common::mojom::EventDataView, InputEventUniquePtr>::pointer_data(
    const InputEventUniquePtr& event) {
  if (!event->web_event)
    return nullptr;
  bool is_wheel_event =
  ...
  if (is_wheel_event) {
    ...
    wheel_data = common::mojom::WheelData::New(
  ...
  return PointerDataFromPointerProperties(
      *mouse_event, common::mojom::MouseData::New(mouse_event->click_count,
                                                   std::move(wheel_data)));
}

// static
common::mojom::GestureDataPtr
StructTraits<common::mojom::EventDataView, InputEventUniquePtr>::gesture_data(
    const InputEventUniquePtr& event) {
  if (!event->web_event ||
  ...
  auto gesture_data = common::mojom::GestureData::New();
  ...
  switch (gesture_event->GetType()) {
    ...
    case blink::WebInputEvent::Type::kGestureDoubleTap:
      ...
      gesture_data->tap_data =
          common::mojom::TapData::New(gesture_event->data.tap.tap_count);
      break;
    case blink::WebInputEvent::Type::kGestureLongPress:
      gesture_data->contact_size =
    ...
    case blink::WebInputEvent::Type::kGestureTwoFingerTap:
      ...
      break;
    case blink::WebInputEvent::Type::kGestureScrollBegin:
      gesture_data->scroll_data = common::mojom::ScrollData::New(
          gesture_event->data.scroll_begin.delta_x_hint,
          gesture_event->data.scroll_begin.delta_y_hint,
          gesture_event->data.scroll_begin.delta_hint_units,
          gesture_event->data.scroll_begin.target_viewport,
    ...
    case blink::WebInputEvent::Type::kGestureScrollUpdate:
      ...
      break;
    case blink::WebInputEvent::Type::kGestureFlingStart:
      gesture_data->fling_data = common::mojom::FlingData::New(
          gesture_event->data.fling_start.velocity_x,
          gesture_event->data.fling_start.velocity_y,
    ...
    case blink::WebInputEvent::Type::kGesturePinchUpdate:
      gesture_data->pinch_data = common::mojom::PinchData::New(
          gesture_event->data.pinch_update.zoom_disabled,
...
// static
common::mojom::TouchDataPtr
StructTraits<common::mojom::EventDataView, InputEventUniquePtr>::touch_data(
    const InputEventUniquePtr& event) {
  if (!event->web_event ||
  ...
  auto touch_data = common::mojom::TouchData::New(
      ...
      std::vector<common::mojom::TouchPointPtr>());
  for (unsigned i = 0; i < touch_event->touches_length; ++i) {
    common::mojom::PointerDataPtr pointer_data =
        PointerDataFromPointerProperties(touch_event->touches[i], nullptr);
    touch_data->touches.emplace_back(common::mojom::TouchPoint::New(
