...
#include "core/shared/common/ax_content_node_data.h"
...
IPC_ENUM_TRAITS_MAX_VALUE(common::AXContentIntAttribute,
                          common::AX_CONTENT_INT_ATTRIBUTE_LAST)
...
IPC_STRUCT_TRAITS_BEGIN(common::AXContentNodeData)
...
IPC_STRUCT_TRAITS_BEGIN(common::AXContentTreeData)
...
IPC_STRUCT_TRAITS_BEGIN(common::AXContentTreeUpdate)
...
IPC_STRUCT_BEGIN(AccessibilityHostMsg_EventParams)
  // The tree update.
  IPC_STRUCT_MEMBER(common::AXContentTreeUpdate, update)
