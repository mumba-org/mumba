...
using PersistentNotificationInfo =
    std::pair<std::string, common::PlatformNotificationData>;
...
IPC_ENUM_TRAITS_MAX_VALUE(
    ...
    common::PlatformNotificationData::DIRECTION_LAST)

IPC_ENUM_TRAITS_MAX_VALUE(common::PlatformNotificationActionType,
                          common::PLATFORM_NOTIFICATION_ACTION_TYPE_TEXT)

IPC_STRUCT_TRAITS_BEGIN(common::PlatformNotificationAction)
...
IPC_STRUCT_TRAITS_BEGIN(common::PlatformNotificationData)
  IPC_STRUCT_TRAITS_MEMBER(title)
...
IPC_STRUCT_TRAITS_BEGIN(common::NotificationResources)
  IPC_STRUCT_TRAITS_MEMBER(image)
...
IPC_MESSAGE_CONTROL5(
    ...
    GURL /* origin */,
    common::PlatformNotificationData /* notification_data */,
    common::NotificationResources /* notification_resources */)
