...
#include "core/shared/common/values_struct_traits.h"
...
bool StructTraits<automation::ListValueDataView,
                  std::unique_ptr<base::ListValue>>::
    Read(automation::ListValueDataView data,
         std::unique_ptr<base::ListValue>* value_out) {
  mojo::ArrayDataView<automation::ValueDataView> view;
...
bool StructTraits<automation::DictionaryValueDataView,
                  std::unique_ptr<base::DictionaryValue>>::
    Read(automation::DictionaryValueDataView data,
         std::unique_ptr<base::DictionaryValue>* value_out) {
  mojo::MapDataView<mojo::StringDataView, automation::ValueDataView> view;
  data.GetValuesDataView(&view);
...
bool UnionTraits<automation::ValueDataView, std::unique_ptr<base::Value>>::
    Read(automation::ValueDataView data,
         std::unique_ptr<base::Value>* value_out) {
  switch (data.tag()) {
    case automation::ValueDataView::Tag::NULL_VALUE: {
      *value_out = std::make_unique<base::Value>();
      return true;
    }
    case automation::ValueDataView::Tag::BOOL_VALUE: {
      *value_out = std::make_unique<base::Value>(data.bool_value());
      return true;
    }
    case automation::ValueDataView::Tag::INT_VALUE: {
      *value_out = std::make_unique<base::Value>(data.int_value());
      return true;
    }
    case automation::ValueDataView::Tag::DOUBLE_VALUE: {
      *value_out = std::make_unique<base::Value>(data.double_value());
      return true;
    }
    case automation::ValueDataView::Tag::STRING_VALUE: {
    ...
    case automation::ValueDataView::Tag::BINARY_VALUE: {
    ...
    case automation::ValueDataView::Tag::DICTIONARY_VALUE: {
    ...
    case automation::ValueDataView::Tag::LIST_VALUE: {
