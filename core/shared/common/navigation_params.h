...
//#include "core/shared/common/content_security_policy/csp_disposition_enum.h"
//#include "core/shared/common/frame_message_enums.h"
...
struct CONTENT_EXPORT CommonNavigationParams {
  ...
  CommonNavigationParams(
      const GURL& url,
      const common::Referrer& referrer,
