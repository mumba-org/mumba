...
#include "core/shared/common/load_timing_info.mojom.h"
...
template <>
struct StructTraits<common::mojom::LoadTimingInfoConnectTimingDataView,
  ...
  static bool Read(common::mojom::LoadTimingInfoConnectTimingDataView obj,
                   net::LoadTimingInfo::ConnectTiming* output);
};

template <>
struct StructTraits<common::mojom::LoadTimingInfoDataView,
                    net::LoadTimingInfo> {
  ...
  static bool Read(common::mojom::LoadTimingInfoDataView obj,
