...
#ifndef MUMBA_COMMON_COMPOSITOR_DIRECT_OUTPUT_SURFACE_H_
#define MUMBA_COMMON_COMPOSITOR_DIRECT_OUTPUT_SURFACE_H_
...
// GL surface.
class CONTENT_EXPORT DirectOutputSurface : public viz::OutputSurface {
 public:
