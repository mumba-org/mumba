...
CONTENT_EXPORT static const int kDocumentMainThreadId = 0;

// Constants for error messages.
CONTENT_EXPORT extern const char kServiceWorkerRegisterErrorPrefix[];
CONTENT_EXPORT extern const char kServiceWorkerUpdateErrorPrefix[];
CONTENT_EXPORT extern const char kServiceWorkerUnregisterErrorPrefix[];
CONTENT_EXPORT extern const char kServiceWorkerGetRegistrationErrorPrefix[];
CONTENT_EXPORT extern const char kServiceWorkerGetRegistrationsErrorPrefix[];
CONTENT_EXPORT extern const char kServiceWorkerFetchScriptError[];
CONTENT_EXPORT extern const char kServiceWorkerBadHTTPResponseError[];
CONTENT_EXPORT extern const char kServiceWorkerSSLError[];
CONTENT_EXPORT extern const char kServiceWorkerBadMIMEError[];
CONTENT_EXPORT extern const char kServiceWorkerNoMIMEError[];
CONTENT_EXPORT extern const char kServiceWorkerRedirectError[];
CONTENT_EXPORT extern const char kServiceWorkerAllowed[];

// Constants for invalid identifiers.
CONTENT_EXPORT static const int kInvalidEmbeddedWorkerThreadId = -1;
CONTENT_EXPORT static const int kInvalidServiceWorkerProviderId = -1;
CONTENT_EXPORT static const int64_t kInvalidServiceWorkerResourceId = -1;

// The HTTP cache is bypassed for Service Worker scripts if the last network
// fetch occurred over 24 hours ago.
CONTENT_EXPORT static constexpr base::TimeDelta kServiceWorkerScriptMaxCacheAge =
...
class CONTENT_EXPORT ChangedVersionAttributesMask {
 public:
  enum {
