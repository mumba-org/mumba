...
IPC_STRUCT_TRAITS_BEGIN(common::ServiceWorkerFetchRequest)
...
IPC_STRUCT_TRAITS_BEGIN(common::ServiceWorkerResponse)
...
IPC_STRUCT_TRAITS_BEGIN(common::PushEventPayload)
