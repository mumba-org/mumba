...
#include "core/shared/common/input/input_event.h"
#include "core/shared/common/input/input_event_ack.h"
#include "core/shared/common/input/input_event_dispatch_type.h"
#include "core/shared/common/input/input_param_traits.h"
...
#include "core/shared/common/input/synthetic_tap_gesture_params.h"
...
IPC_ENUM_TRAITS_MAX_VALUE(common::InputEventAckSource,
                          common::InputEventAckSource::MAX_FROM_RENDERER)
IPC_ENUM_TRAITS_MAX_VALUE(
    common::SyntheticGestureParams::GestureSourceType,
    common::SyntheticGestureParams::GESTURE_SOURCE_TYPE_MAX)
IPC_ENUM_TRAITS_MAX_VALUE(
    common::SyntheticGestureParams::GestureType,
    common::SyntheticGestureParams::SYNTHETIC_GESTURE_TYPE_MAX)
IPC_ENUM_TRAITS_MAX_VALUE(
    common::SyntheticPointerActionParams::PointerActionType,
    common::SyntheticPointerActionParams::PointerActionType::
        POINTER_ACTION_TYPE_MAX)
IPC_ENUM_TRAITS_MAX_VALUE(
    common::SyntheticPointerActionParams::Button,
    common::SyntheticPointerActionParams::Button::BUTTON_MAX)
IPC_ENUM_TRAITS_MAX_VALUE(common::InputEventDispatchType,
                          common::InputEventDispatchType::DISPATCH_TYPE_MAX)
...
IPC_STRUCT_TRAITS_BEGIN(common::EditCommand)
  IPC_STRUCT_TRAITS_MEMBER(name)
  IPC_STRUCT_TRAITS_MEMBER(value)
IPC_STRUCT_TRAITS_END()

IPC_STRUCT_TRAITS_BEGIN(common::SyntheticGestureParams)
  IPC_STRUCT_TRAITS_MEMBER(gesture_source_type)
IPC_STRUCT_TRAITS_END()

IPC_STRUCT_TRAITS_BEGIN(common::SyntheticSmoothDragGestureParams)
  IPC_STRUCT_TRAITS_PARENT(common::SyntheticGestureParams)
  IPC_STRUCT_TRAITS_MEMBER(start_point)
  IPC_STRUCT_TRAITS_MEMBER(distances)
  IPC_STRUCT_TRAITS_MEMBER(speed_in_pixels_s)
IPC_STRUCT_TRAITS_END()

IPC_STRUCT_TRAITS_BEGIN(common::SyntheticSmoothScrollGestureParams)
  IPC_STRUCT_TRAITS_PARENT(common::SyntheticGestureParams)
...
IPC_STRUCT_TRAITS_BEGIN(common::SyntheticPinchGestureParams)
  IPC_STRUCT_TRAITS_PARENT(common::SyntheticGestureParams)
...
IPC_STRUCT_TRAITS_BEGIN(common::SyntheticTapGestureParams)
  IPC_STRUCT_TRAITS_PARENT(common::SyntheticGestureParams)
  IPC_STRUCT_TRAITS_MEMBER(position)
  IPC_STRUCT_TRAITS_MEMBER(duration_ms)
IPC_STRUCT_TRAITS_END()

IPC_STRUCT_TRAITS_BEGIN(common::SyntheticPointerActionParams)
...
IPC_STRUCT_TRAITS_BEGIN(common::SyntheticPointerActionListParams)
  IPC_STRUCT_TRAITS_PARENT(common::SyntheticGestureParams)
