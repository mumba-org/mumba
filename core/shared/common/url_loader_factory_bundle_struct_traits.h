...
#include "core/shared/common/url_loader_factory_bundle.mojom-shared.h"
#include "mojo/public/cpp/bindings/struct_traits.h"

namespace mojo {

template <>
struct StructTraits<common::mojom::URLLoaderFactoryBundleDataView,
                    std::unique_ptr<common::URLLoaderFactoryBundleInfo>> {
  using BundleInfoType = std::unique_ptr<common::URLLoaderFactoryBundleInfo>;
  ...
  static bool Read(common::mojom::URLLoaderFactoryBundleDataView data,
