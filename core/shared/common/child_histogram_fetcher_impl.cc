...
void ChildHistogramFetcherFactoryImpl::Create(
    common::mojom::ChildHistogramFetcherFactoryRequest request) {
...
void ChildHistogramFetcherFactoryImpl::CreateFetcher(
    ...
    common::mojom::ChildHistogramFetcherRequest request) {
  ...
  common::mojom::ChildHistogramFetcherPtr child_histogram_interface;
