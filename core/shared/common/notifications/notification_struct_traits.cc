...
#include "core/shared/common/notifications/notification_struct_traits.h"
...
bool ValidateActions(
    const std::vector<common::PlatformNotificationAction>& actions) {
...
NotificationDirection EnumTraits<NotificationDirection,
    ...
    ToMojom(common::PlatformNotificationData::Direction input) {
  switch (input) {
...
bool EnumTraits<NotificationDirection,
  ...
  switch (input) {
    case NotificationDirection::LEFT_TO_RIGHT:
      *out = common::PlatformNotificationData::DIRECTION_LEFT_TO_RIGHT;
      return true;
    case NotificationDirection::RIGHT_TO_LEFT:
      *out = common::PlatformNotificationData::DIRECTION_RIGHT_TO_LEFT;
      return true;
    case NotificationDirection::AUTO:
      *out = common::PlatformNotificationData::DIRECTION_AUTO;
      return true;
  }
...
EnumTraits<NotificationActionType, common::PlatformNotificationActionType>::
    ToMojom(common::PlatformNotificationActionType input) {
  switch (input) {
...
bool EnumTraits<NotificationActionType,
  ...
  switch (input) {
    case NotificationActionType::BUTTON:
      *out = common::PLATFORM_NOTIFICATION_ACTION_TYPE_BUTTON;
      return true;
    case NotificationActionType::TEXT:
      *out = common::PLATFORM_NOTIFICATION_ACTION_TYPE_TEXT;
      return true;
  }
...
bool StructTraits<blink::mojom::NotificationActionDataView,
    ...
    Read(blink::mojom::NotificationActionDataView notification_action,
         common::PlatformNotificationAction* out) {
