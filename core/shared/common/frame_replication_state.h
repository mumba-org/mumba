...
//#include "core/shared/common/content_security_policy_header.h"
...
struct CONTENT_EXPORT FrameReplicationState {
  ...
  // Iframe sandbox flags and shell policy currently in effect for the
  // frame. Shell policy may be empty if this is the top-level frame.
