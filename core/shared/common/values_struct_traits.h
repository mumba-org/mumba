...
#ifndef COMMON_VALUES_STRUCT_TRAITS_H_
#define COMMON_VALUES_STRUCT_TRAITS_H_

#include "base/containers/span.h"
#include "base/values.h"
#include "core/shared/common/mojom/values.mojom-shared.h"
...
template <>
struct CONTENT_EXPORT StructTraits<automation::ListValueDataView, base::ListValue> {
...
template <>
struct CONTENT_EXPORT StructTraits<automation::ListValueDataView,
  ...
  static bool Read(automation::ListValueDataView data,
...
template <>
struct CONTENT_EXPORT MapTraits<base::DictionaryValue> {
...
template <>
struct CONTENT_EXPORT StructTraits<automation::DictionaryValueDataView,
...
struct CONTENT_EXPORT StructTraits<automation::DictionaryValueDataView,
  ...
  static bool Read(automation::DictionaryValueDataView data,
                   std::unique_ptr<base::DictionaryValue>* value);
};

template <>
struct CONTENT_EXPORT CloneTraits<std::unique_ptr<base::DictionaryValue>, false> {
  static std::unique_ptr<base::DictionaryValue> Clone(
      const std::unique_ptr<base::DictionaryValue>& input);
};

template <>
struct CONTENT_EXPORT StructTraits<automation::NullValueDataView, void*> {
  static bool IsNull(const void* value) { return true; }
  static void SetToNull(void** value) {}
  static bool Read(automation::NullValueDataView data, void** value) {
    return true;
  }
};

template <>
struct CONTENT_EXPORT UnionTraits<automation::ValueDataView, base::Value> {
  static automation::ValueDataView::Tag GetTag(const base::Value& data) {
    switch (data.type()) {
      case base::Value::Type::NONE:
        return automation::ValueDataView::Tag::NULL_VALUE;
      case base::Value::Type::BOOLEAN:
        return automation::ValueDataView::Tag::BOOL_VALUE;
      case base::Value::Type::INTEGER:
        return automation::ValueDataView::Tag::INT_VALUE;
      case base::Value::Type::DOUBLE:
        return automation::ValueDataView::Tag::DOUBLE_VALUE;
      case base::Value::Type::STRING:
        return automation::ValueDataView::Tag::STRING_VALUE;
      case base::Value::Type::BINARY:
        return automation::ValueDataView::Tag::BINARY_VALUE;
      case base::Value::Type::DICTIONARY:
        return automation::ValueDataView::Tag::DICTIONARY_VALUE;
      case base::Value::Type::LIST:
        return automation::ValueDataView::Tag::LIST_VALUE;
    }
    NOTREACHED();
    return automation::ValueDataView::Tag::NULL_VALUE;
  }
...
template <>
struct CONTENT_EXPORT UnionTraits<automation::ValueDataView, std::unique_ptr<base::Value>> {
  ...
  static automation::ValueDataView::Tag GetTag(
      const std::unique_ptr<base::Value>& value) {
    return UnionTraits<automation::ValueDataView, base::Value>::GetTag(
        *value);
  }

  static void* null_value(const std::unique_ptr<base::Value>& value) {
    return UnionTraits<automation::ValueDataView, base::Value>::null_value(
        *value);
  }
  static bool bool_value(const std::unique_ptr<base::Value>& value) {
    return UnionTraits<automation::ValueDataView, base::Value>::bool_value(
        *value);
  }
  static int32_t int_value(const std::unique_ptr<base::Value>& value) {
    return UnionTraits<automation::ValueDataView, base::Value>::int_value(
        *value);
  }
  static double double_value(const std::unique_ptr<base::Value>& value) {
    return UnionTraits<automation::ValueDataView, base::Value>::double_value(
        *value);
  }
  static base::StringPiece string_value(
      const std::unique_ptr<base::Value>& value) {
    return UnionTraits<automation::ValueDataView, base::Value>::string_value(
        *value);
  }
  static base::span<const uint8_t> binary_value(
      const std::unique_ptr<base::Value>& value) {
    return UnionTraits<automation::ValueDataView, base::Value>::binary_value(
        *value);
  }
  static const base::ListValue& list_value(
      const std::unique_ptr<base::Value>& value) {
    return UnionTraits<automation::ValueDataView, base::Value>::list_value(
        *value);
  }
  static const base::DictionaryValue& dictionary_value(
      const std::unique_ptr<base::Value>& value) {
    return UnionTraits<automation::ValueDataView,
                       base::Value>::dictionary_value(*value);
  }

  static bool Read(automation::ValueDataView data,
