...
#ifndef MUMBA_SHELL_NET_P2P_SOCKET_CLIENT_DELEGATE_H_
#define MUMBA_SHELL_NET_P2P_SOCKET_CLIENT_DELEGATE_H_
...
#endif  // MUMBA_SHELL_NET_P2P_SOCKET_CLIENT_DELEGATE_H_
