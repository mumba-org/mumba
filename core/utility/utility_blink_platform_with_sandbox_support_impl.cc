...
#include "core/common/child_process_sandbox_support_impl_mac.h"
...
#include "core/shared/common/child_process_sandbox_support_impl_linux.h"
...
bool UtilityBlinkPlatformWithSandboxSupportImpl::SandboxSupport::LoadFont(
    ...
    CGFontRef* out,
    uint32_t* font_id) {
  return common::LoadFont(src_font, out, font_id);
}
...
void UtilityBlinkPlatformWithSandboxSupportImpl::SandboxSupport::
  ...
  common::GetFallbackFontForCharacter(character, preferred_locale,
                                       fallback_font);
...
void UtilityBlinkPlatformWithSandboxSupportImpl::SandboxSupport::
  ...
  common::GetRenderStyleForStrike(family, size_and_style, out);
}
