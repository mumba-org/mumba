...
void ChromeContentUtilityClient::UtilityThreadStarted() {
  ...
  common::ServiceManagerConnection* connection =
     common::ChildThread::Get()->GetServiceManagerConnection();
...
// #endif
  ...
  profiling_info.task_runner = common::ChildThread::Get()->GetIOTaskRunner();
  ...
  proxy_resolver_info.task_runner =
      common::ChildThread::Get()->GetIOTaskRunner();
