...
//#include "core/common/thread_profiler.h"
...
class ContentGpuClientImpl : public ContentGpuClient {
 public:
  ContentGpuClientImpl();
  ~ContentGpuClientImpl() override;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(ContentGpuClientImpl);
};
