...
#ifndef MUMBA_HOST_HOST_NOTIFICATION_SERVICE_H_
#define MUMBA_HOST_HOST_NOTIFICATION_SERVICE_H_
...
class NotificationService {
 public:
  ...
  // singletons now will always have multiple instances, one per host
  // context.
  //
