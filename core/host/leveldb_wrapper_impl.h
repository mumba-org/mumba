...
#include "core/shared/common/leveldb_wrapper.mojom.h"
...
class CONTENT_EXPORT LevelDBWrapperImpl : public common::mojom::LevelDBWrapper {
 public:
  ...
  void Bind(common::mojom::LevelDBWrapperRequest request);
  ...
  mojo::InterfacePtrSetElementId AddObserver(
      common::mojom::LevelDBObserverAssociatedPtr observer);
  bool HasObserver(mojo::InterfacePtrSetElementId id);
  common::mojom::LevelDBObserverAssociatedPtr RemoveObserver(
      mojo::InterfacePtrSetElementId id);

  // LevelDBWrapper:
  void AddObserver(common::mojom::LevelDBObserverAssociatedPtrInfo observer) override;
  ...
  void GetAll(
      common::mojom::LevelDBWrapperGetAllCallbackAssociatedPtrInfo complete_callback,
 ...
 private:
  ...
  mojo::BindingSet<common::mojom::LevelDBWrapper> bindings_;
  mojo::AssociatedInterfacePtrSet<common::mojom::LevelDBObserver> observers_;
  Delegate* delegate_;
