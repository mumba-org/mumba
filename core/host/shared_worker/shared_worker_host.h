...
#include "core/shared/common/shared_worker/shared_worker.mojom.h"
...
#include "core/shared/common/shared_worker/shared_worker_host.mojom.h"
...
class CONTENT_EXPORT SharedWorkerHost
    : public common::mojom::SharedWorkerHost,
 ...
 public:
  ...
  void AddClient(common::mojom::SharedWorkerClientPtr client,
                 ServiceWorkerProcessType process_type,
                 int process_id,
                 int frame_id,
 ...
 private:
  ...
  struct ClientInfo {
    ClientInfo(common::mojom::SharedWorkerClientPtr client,
    ...
    const ServiceWorkerProcessType process_type;
  ...
  // common::mojom::SharedWorkerHost methods:
  ...
  mojo::Binding<common::mojom::SharedWorkerHost> binding_;
  ...
  common::mojom::SharedWorkerRequest worker_request_;
  common::mojom::SharedWorkerPtr worker_;
  ...
  // starting or running.
  common::mojom::SharedWorkerFactoryPtr factory_;
