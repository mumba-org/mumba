...
MockSharedWorker::MockSharedWorker(common::mojom::SharedWorkerRequest request)
...
void MockSharedWorkerClient::Bind(common::mojom::SharedWorkerClientRequest request) {
