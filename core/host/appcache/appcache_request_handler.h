...
class CONTENT_EXPORT AppCacheRequestHandler
 ...
 public:
  ...
  base::Optional<common::SubresourceLoaderParams> MaybeCreateSubresourceLoaderParams()
      override;
  ...
  static bool IsMainResourceType(common::ResourceType type) {
    return IsResourceTypeFrame(type) || type == common::RESOURCE_TYPE_SHARED_WORKER;
  }
