...
class AppCacheEntry {
 public:
  ...
  AppCacheEntry()
    : types_(0), response_id_(common::kAppCacheNoResponseId), response_size_(0) {}

  explicit AppCacheEntry(int type)
    : types_(type), response_id_(common::kAppCacheNoResponseId), response_size_(0) {}
  ...
  bool has_response_id() const { return response_id_ != common::kAppCacheNoResponseId; }
