...
class TestAppCacheFrontend : public content::common::AppCacheFrontend {
 public:
  TestAppCacheFrontend()
      : last_host_id_(-1),
        last_cache_id_(-1),
        last_status_(content::common::AppCacheStatus::APPCACHE_STATUS_OBSOLETE) {}

  void OnCacheSelected(int host_id,
                       const content::common::AppCacheInfo& info) override {
  ...
  void OnStatusChanged(const std::vector<int>& host_ids,
                       content::common::AppCacheStatus status) override {}

  void OnEventRaised(const std::vector<int>& host_ids,
                     content::common::AppCacheEventID event_id) override {}

  void OnErrorEventRaised(
      const std::vector<int>& host_ids,
      const content::common::AppCacheErrorDetails& details) override {}
  ...
  void OnLogMessage(int host_id,
                    content::common::AppCacheLogLevel log_level,
  ...
  content::common::AppCacheStatus last_status_;
};
...
class TestAppCacheHost : public AppCacheHost {
 public:
  TestAppCacheHost(int host_id, common::AppCacheFrontend* frontend,
...
TEST_F(AppCacheGroupTest, CleanupUnusedGroup) {
  ...
  EXPECT_EQ(frontend.last_status_, common::AppCacheStatus::APPCACHE_STATUS_IDLE);
  ...
  EXPECT_EQ(frontend.last_status_, common::AppCacheStatus::APPCACHE_STATUS_UNCACHED);
}
