...
#include "core/host/appcache/mock_appcache_policy.h"
...
class AppCacheHostTest : public testing::Test {
 public:
  ...
  class MockFrontend : public common::AppCacheFrontend {
   public:
    MockFrontend()
        : last_host_id_(-222),
          last_cache_id_(-222),
          last_status_(common::AppCacheStatus::APPCACHE_STATUS_OBSOLETE),
          last_status_changed_(common::AppCacheStatus::APPCACHE_STATUS_OBSOLETE),
          last_event_id_(common::AppCacheEventID::APPCACHE_OBSOLETE_EVENT),
    ...
    void OnErrorEventRaised(const std::vector<int>& host_ids,
      ...
      last_event_id_ = common::AppCacheEventID::APPCACHE_ERROR_EVENT;
    }
    ...
    void OnProgressEventRaised(const std::vector<int>& host_ids,
      ...
      last_event_id_ = common::AppCacheEventID::APPCACHE_PROGRESS_EVENT;
    }
    ...
    common::AppCacheStatus last_status_;
    common::AppCacheStatus last_status_changed_;
    common::AppCacheEventID last_event_id_;
  ...
  void GetStatusCallback(common::AppCacheStatus status) {
  ...
  common::AppCacheStatus last_status_result_;
...
TEST_F(AppCacheHostTest, Basic) {
  ...
  last_status_result_ = common::AppCacheStatus::APPCACHE_STATUS_OBSOLETE;
  host.GetStatusWithCallback(std::move(get_status_callback_));
  EXPECT_EQ(common::AppCacheStatus::APPCACHE_STATUS_UNCACHED, last_status_result_);
...
TEST_F(AppCacheHostTest, SelectNoCache) {
  ...
  mock_frontend_.last_status_ = common::AppCacheStatus::APPCACHE_STATUS_OBSOLETE;
  ...
  const url::Origin kOrigin(url::Origin::Create(kDocAndOriginUrl));
  {
    ...
    EXPECT_EQ(common::AppCacheStatus::APPCACHE_STATUS_UNCACHED,
...
TEST_F(AppCacheHostTest, FailedCacheLoad) {
  ...
  last_status_result_ = common::AppCacheStatus::APPCACHE_STATUS_OBSOLETE;
  host.GetStatusWithCallback(std::move(get_status_callback_));
  EXPECT_EQ(common::AppCacheStatus::APPCACHE_STATUS_OBSOLETE, last_status_result_);
...
TEST_F(AppCacheHostTest, SetSwappableCache) {
  ...
  EXPECT_EQ(common::AppCacheStatus::APPCACHE_STATUS_IDLE, host.GetStatus());
  ...
  EXPECT_EQ(common::AppCacheStatus::APPCACHE_STATUS_IDLE, mock_frontend_.last_status_);
...
TEST_F(AppCacheHostTest, SelectCacheAllowed) {
  ...
  mock_frontend_.last_host_id_ = -333;
  mock_frontend_.last_status_ = common::AppCacheStatus::APPCACHE_STATUS_OBSOLETE;
  mock_frontend_.last_event_id_ = common::AppCacheEventID::APPCACHE_OBSOLETE_EVENT;
  ...
  const GURL kManifestUrl(GURL("http://whatever/cache.manifest"));
  {
    ...
    EXPECT_EQ(common::AppCacheStatus::APPCACHE_STATUS_OBSOLETE,
              mock_frontend_.last_status_);
    // No error events either
    EXPECT_EQ(common::AppCacheEventID::APPCACHE_OBSOLETE_EVENT,
...
TEST_F(AppCacheHostTest, SelectCacheBlocked) {
  ...
  const GURL kManifestUrl(GURL("http://whatever/cache.manifest"));
  {
    ...
    EXPECT_EQ(common::AppCacheEventID::APPCACHE_ERROR_EVENT,
              mock_frontend_.last_event_id_);
