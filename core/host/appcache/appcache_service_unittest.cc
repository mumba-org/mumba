...
#include "core/host/appcache/mock_appcache_storage.h"
...
TEST_F(AppCacheServiceImplTest, DeleteAppCachesForOrigin) {
  ...
  common::AppCacheInfo mock_manifest_1;
  common::AppCacheInfo mock_manifest_2;
  common::AppCacheInfo mock_manifest_3;
