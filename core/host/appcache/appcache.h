...
#include "core/host/appcache/appcache_manifest_parser.h"
...
class CONTENT_EXPORT AppCache
 ...
 public:
  ...
  void ToResourceInfoVector(common::AppCacheResourceInfoVector* infos) const;

  static const common::AppCacheNamespace* FindNamespace(
      const common::AppCacheNamespaceVector& namespaces,
      const GURL& url);
 ...
 private:
  ...
  const common::AppCacheNamespace* FindInterceptNamespace(const GURL& url) {
    return FindNamespace(intercept_namespaces_, url);
  }
  const common::AppCacheNamespace* FindFallbackNamespace(const GURL& url) {
  ...
  GURL GetNamespaceEntryUrl(const common::AppCacheNamespaceVector& namespaces,
  ...
  common::AppCacheNamespaceVector intercept_namespaces_;
  common::AppCacheNamespaceVector fallback_namespaces_;
  common::AppCacheNamespaceVector online_whitelist_namespaces_;
