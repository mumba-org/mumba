...
#include "core/host/appcache/appcache_update_job.h"
...
#include "core/host/appcache/appcache_update_url_loader_request.h"
#include "core/host/appcache/mock_appcache_service.h"
...
class MockFrontend : public common::AppCacheFrontend {
 public:
  MockFrontend()
      : ignore_progress_events_(false),
        ...
        start_update_trigger_(common::AppCacheEventID::APPCACHE_CHECKING_EVENT),
        update_(nullptr) {}
  ...
  void OnErrorEventRaised(const std::vector<int>& host_ids,
    ...
    OnEventRaised(host_ids, common::AppCacheEventID::APPCACHE_ERROR_EVENT);
  }
  ...
  void OnProgressEventRaised(const std::vector<int>& host_ids,
    ...
    if (!ignore_progress_events_)
      OnEventRaised(host_ids, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);
  ...
  void AddExpectedEvent(const std::vector<int>& host_ids,
    ...
    DCHECK(!ignore_progress_events_ ||
           event_id != common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);
  ...
  void TriggerAdditionalUpdates(common::AppCacheEventID trigger_event,
  ...
  using RaisedEvent = std::pair<HostIds, common::AppCacheEventID>;
  ...
  common::AppCacheEventID start_update_trigger_;
...
class AppCacheUpdateJobTest : public testing::TestWithParam<RequestHandlerType>,
 ...
 public:
  ...
  void StartCacheAttemptTest() {
    ...
    EXPECT_EQ(common::AppCacheEventID::APPCACHE_CHECKING_EVENT, events[0].second);
  ...
  void UpgradeFetchManifestFailTest() {
    ...
    frontend1->AddExpectedEvent(ids1, common::AppCacheEventID::APPCACHE_CHECKING_EVENT);
    frontend1->AddExpectedEvent(ids1, common::AppCacheEventID::APPCACHE_ERROR_EVENT);
    MockFrontend::HostIds ids2(1, host2->host_id());
    frontend2->AddExpectedEvent(ids2, common::AppCacheEventID::APPCACHE_CHECKING_EVENT);
    frontend2->AddExpectedEvent(ids2, common::AppCacheEventID::APPCACHE_ERROR_EVENT);
  ...
  void ManifestMissingMimeTypeTest() {
    ...
    frontend->AddExpectedEvent(ids, common::AppCacheEventID::APPCACHE_CHECKING_EVENT);
    frontend->AddExpectedEvent(ids,
                               common::AppCacheEventID::APPCACHE_DOWNLOADING_EVENT);
    frontend->AddExpectedEvent(
        ids, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);  // final
    frontend->AddExpectedEvent(ids,
  ...
  void ManifestNotFoundTest() {
    ...
    MockFrontend::HostIds ids1(1, host1->host_id());
    frontend1->AddExpectedEvent(ids1, common::AppCacheEventID::APPCACHE_CHECKING_EVENT);
    frontend1->AddExpectedEvent(ids1, common::AppCacheEventID::APPCACHE_OBSOLETE_EVENT);
    MockFrontend::HostIds ids2(1, host2->host_id());
    frontend2->AddExpectedEvent(ids2, common::AppCacheEventID::APPCACHE_CHECKING_EVENT);
    frontend2->AddExpectedEvent(ids2, common::AppCacheEventID::APPCACHE_OBSOLETE_EVENT);
  ...
  void Bug95101Test() {
    ...
    frontend->AddExpectedEvent(id, common::AppCacheEventID::APPCACHE_CHECKING_EVENT);
    frontend->AddExpectedEvent(id, common::AppCacheEventID::APPCACHE_ERROR_EVENT);
  ...
  void BasicUpgradeSuccessTest() {
    ...
    frontend1->AddExpectedEvent(ids1,
                                common::AppCacheEventID::APPCACHE_DOWNLOADING_EVENT);
    frontend1->AddExpectedEvent(ids1, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);
    frontend1->AddExpectedEvent(ids1, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);
    frontend1->AddExpectedEvent(
        ids1, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);  // final
    frontend1->AddExpectedEvent(ids1,
                                common::AppCacheEventID::APPCACHE_UPDATE_READY_EVENT);
    MockFrontend::HostIds ids2(1, host2->host_id());
    frontend2->AddExpectedEvent(ids2, common::AppCacheEventID::APPCACHE_CHECKING_EVENT);
    frontend2->AddExpectedEvent(ids2,
                                common::AppCacheEventID::APPCACHE_DOWNLOADING_EVENT);
    frontend2->AddExpectedEvent(ids2, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);
    frontend2->AddExpectedEvent(ids2, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);
    frontend2->AddExpectedEvent(
        ids2, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);  // final
    frontend2->AddExpectedEvent(ids2,
                                common::AppCacheEventID::APPCACHE_UPDATE_READY_EVENT);
  ...
  void UpgradeLoadFromNewestCacheTest() {
    ...
    frontend->AddExpectedEvent(ids,
                               common::AppCacheEventID::APPCACHE_DOWNLOADING_EVENT);
    frontend->AddExpectedEvent(ids, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);
    frontend->AddExpectedEvent(ids, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);
    frontend->AddExpectedEvent(
        ids, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);  // final
    frontend->AddExpectedEvent(ids,
  ...
  void UpgradeSuccessMergedTypesTest() {
    ...
    frontend1->AddExpectedEvent(ids1,
                                common::AppCacheEventID::APPCACHE_DOWNLOADING_EVENT);
    frontend1->AddExpectedEvent(
        ids1, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);  // explicit1
    frontend1->AddExpectedEvent(
        ids1, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);  // manifest
    frontend1->AddExpectedEvent(
        ids1, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);  // final
    frontend1->AddExpectedEvent(ids1,
                                common::AppCacheEventID::APPCACHE_UPDATE_READY_EVENT);
  ...
  void UpgradeFailMasterUrlFetchTest() {
    ...
    frontend1->AddExpectedEvent(
        ids1, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);  // explicit1
    frontend1->AddExpectedEvent(
        ids1, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);  // fallback1a
    frontend1->AddExpectedEvent(
        ids1, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);  // notfound
    frontend1->AddExpectedEvent(
        ids1, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);  // explicit2
    frontend1->AddExpectedEvent(
        ids1, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);  // servererror
    frontend1->AddExpectedEvent(
        ids1, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);  // notmodified
    frontend1->AddExpectedEvent(
        ids1, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);  // final
    frontend1->AddExpectedEvent(ids1,
                                common::AppCacheEventID::APPCACHE_UPDATE_READY_EVENT);
    ...
    frontend2->AddExpectedEvent(ids2,
                                common::AppCacheEventID::APPCACHE_DOWNLOADING_EVENT);
    frontend2->AddExpectedEvent(
        ids2, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);  // explicit1
    frontend2->AddExpectedEvent(
        ids2, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);  // fallback1a
    frontend2->AddExpectedEvent(
        ids2, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);  // notfound
    frontend2->AddExpectedEvent(
        ids2, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);  // explicit2
    frontend2->AddExpectedEvent(
        ids2, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);  // servererror
    frontend2->AddExpectedEvent(
        ids2, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);  // notmodified
    frontend2->AddExpectedEvent(
        ids2, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);  // final
    frontend2->AddExpectedEvent(ids2,
                                common::AppCacheEventID::APPCACHE_UPDATE_READY_EVENT);
  ...
  void EmptyFileTest() {
    ...
    frontend->AddExpectedEvent(ids1, common::AppCacheEventID::APPCACHE_CHECKING_EVENT);
    frontend->AddExpectedEvent(ids1,
                               common::AppCacheEventID::APPCACHE_DOWNLOADING_EVENT);
    frontend->AddExpectedEvent(ids1, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);
    frontend->AddExpectedEvent(
        ids1, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);  // final
    frontend->AddExpectedEvent(ids1,
                               common::AppCacheEventID::APPCACHE_UPDATE_READY_EVENT);
  ...
  void MasterEntryFailStoreNewestCacheTest() {
    ...
    MockFrontend::HostIds ids1(1, host->host_id());
    frontend->AddExpectedEvent(ids1, common::AppCacheEventID::APPCACHE_ERROR_EVENT);
    frontend->expected_error_message_ =
  ...
  void UpgradeMasterEntryAllFailTest() {
    ...
    frontend3->AddExpectedEvent(ids3, common::AppCacheEventID::APPCACHE_CHECKING_EVENT);
    frontend3->AddExpectedEvent(ids3,
                                common::AppCacheEventID::APPCACHE_DOWNLOADING_EVENT);
    frontend3->AddExpectedEvent(ids3, common::AppCacheEventID::APPCACHE_ERROR_EVENT);
  ...
  void MasterEntrySomeFailTest() {
    ...
    frontend2->AddExpectedEvent(
        ids2, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);  // final
    frontend2->AddExpectedEvent(ids2, common::AppCacheEventID::APPCACHE_CACHED_EVENT);
  ...
  void UpgradeMasterEntrySomeFailTest() {
    ...
    frontend3->AddExpectedEvent(ids3,
                                common::AppCacheEventID::APPCACHE_DOWNLOADING_EVENT);
    frontend3->AddExpectedEvent(ids3, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);
    frontend3->AddExpectedEvent(ids3, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);
    frontend3->AddExpectedEvent(
        ids3, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);  // final
    frontend3->AddExpectedEvent(ids3,
                                common::AppCacheEventID::APPCACHE_UPDATE_READY_EVENT);
  ...
  void MasterEntryNoUpdateTest() {
    ...
    frontend1->AddExpectedEvent(ids1,
                                common::AppCacheEventID::APPCACHE_NO_UPDATE_EVENT);
    MockFrontend::HostIds ids3(1, host3->host_id());
    frontend2->AddExpectedEvent(ids3, common::AppCacheEventID::APPCACHE_CHECKING_EVENT);
  ...
  void StartUpdateMidCacheAttemptTest() {
    ...
    frontend1->TriggerAdditionalUpdates(
        common::AppCacheEventID::APPCACHE_DOWNLOADING_EVENT, update);
    ...
    frontend1->AddExpectedEvent(
        ids1, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);  // final
    frontend1->AddExpectedEvent(ids1, common::AppCacheEventID::APPCACHE_CACHED_EVENT);
    MockFrontend::HostIds ids2(1, host2->host_id());
    frontend2->AddExpectedEvent(ids2, common::AppCacheEventID::APPCACHE_CHECKING_EVENT);
    frontend2->AddExpectedEvent(ids2,
                                common::AppCacheEventID::APPCACHE_DOWNLOADING_EVENT);
    ...
    frontend3->AddExpectedEvent(
        ids3, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);  // final
    frontend3->AddExpectedEvent(ids3, common::AppCacheEventID::APPCACHE_CACHED_EVENT);
    MockFrontend::HostIds ids4(1, host4->host_id());
    frontend4->AddExpectedEvent(ids4, common::AppCacheEventID::APPCACHE_CHECKING_EVENT);
    frontend4->AddExpectedEvent(ids4,
                                common::AppCacheEventID::APPCACHE_DOWNLOADING_EVENT);
    frontend4->AddExpectedEvent(ids4, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);
    frontend4->AddExpectedEvent(ids4, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);
    frontend4->AddExpectedEvent(
        ids4, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);  // final
    frontend4->AddExpectedEvent(ids4, common::AppCacheEventID::APPCACHE_CACHED_EVENT);

    // Host 5 is not associated with cache so no progress/cached events.
    MockFrontend::HostIds ids5(1, host5->host_id());
    frontend5->AddExpectedEvent(ids5, common::AppCacheEventID::APPCACHE_CHECKING_EVENT);
  ...
  void StartUpdateMidNoUpdateTest() {
    ...
    frontend2->TriggerAdditionalUpdates(common::AppCacheEventID::APPCACHE_ERROR_EVENT,
                                        update);
    ...
    frontend6->AddExpectedEvent(ids6, common::AppCacheEventID::APPCACHE_CHECKING_EVENT);
  ...
  void StartUpdateMidDownloadTest() {
    ...
    frontend1->TriggerAdditionalUpdates(
        common::AppCacheEventID::APPCACHE_PROGRESS_EVENT, update);
    ...
    frontend5->AddExpectedEvent(ids5,
                                common::AppCacheEventID::APPCACHE_DOWNLOADING_EVENT);
    frontend5->AddExpectedEvent(ids5, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);
    frontend5->AddExpectedEvent(
        ids5, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);  // final
    frontend5->AddExpectedEvent(ids5,
                                common::AppCacheEventID::APPCACHE_UPDATE_READY_EVENT);
  ...
  void QueueMasterEntryTest() {
    ...
    frontend->AddExpectedEvent(
        ids1, common::AppCacheEventID::APPCACHE_PROGRESS_EVENT);  // final
    frontend->AddExpectedEvent(ids1, common::AppCacheEventID::APPCACHE_CACHED_EVENT);

    // Group status will be common::AppCacheStatus::APPCACHE_STATUS_IDLE so cannot call
    // WaitForUpdateToFinish.
  ...
  AppCacheHost* MakeHost(int host_id, common::AppCacheFrontend* frontend) {
    hosts_.push_back(
...
TEST_P(AppCacheUpdateJobTest, AlreadyDownloading) {
  ...
  EXPECT_EQ(common::AppCacheEventID::APPCACHE_DOWNLOADING_EVENT, events[1].second);
