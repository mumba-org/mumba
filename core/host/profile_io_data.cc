...
#include "core/host/devtools_network_transaction_factory.h"
...
#include "core/host/android/content_protocol_handler.h"
...
void ProfileIOData::ShutdownOnUIThread(
  ...
  bool posted = HostThread::DeleteSoon(HostThread::IO, FROM_HERE, this);
  if (!posted)
    delete this;
}
