...
#ifndef MUMBA_HOST_WAKE_LOCK_WAKE_LOCK_CONTEXT_HOST_H_
#define MUMBA_HOST_WAKE_LOCK_WAKE_LOCK_CONTEXT_HOST_H_
...
class WakeLockContextHost {
 public:
  explicit WakeLockContextHost(ApplicationContents* application_contents);
  ~WakeLockContextHost();
