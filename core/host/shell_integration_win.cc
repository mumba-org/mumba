...
#include "core/host/win/settings_app_monitor.h"
...
#include "mumba/installer/util/scoped_user_protocol_entry.h"
#include "mumba/installer/util/shell_util.h"
#include "mumba/services/util_win/public/mojom/constants.mojom.h"
#include "mumba/services/util_win/public/mojom/shell_util_win.mojom.h"
...
class IsPinnedToTaskbarHelper {
 ...
 private:
  ...
  mumba::mojom::ShellUtilWinPtr shell_util_win_ptr_;
...
IsPinnedToTaskbarHelper::IsPinnedToTaskbarHelper(
  ...
  connector_->BindInterface(mumba::mojom::kUtilWinServiceName,
                            &shell_util_win_ptr_);
