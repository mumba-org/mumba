...
class CONTENT_EXPORT ServiceWorkerContextWrapper
 ...
 public:
  ...
  explicit ServiceWorkerContextWrapper(Domain* domain);//BrowserContext* browser_context);
  ...
  void DeleteForOrigin(const GURL& origin, int application_process_id, ResultCallback callback) override;
 ...
 private:
  ...
  void DidDeleteAndStartOver(common::ServiceWorkerStatusCode status);
  ...
  void DidCheckHasServiceWorker(CheckHasServiceWorkerCallback callback,
                                ServiceWorkerCapability status);
