...
#include "core/shared/common/url_schemes.h"
...
class ServiceWorkerTestContentBrowserClient : public TestContentBrowserClient {
 public:
  ...
  bool AllowServiceWorker(
      ...
      const base::Callback<ApplicationContents*(void)>& wc_getter) override {
...
class MockServiceWorkerContainer : public common::mojom::ServiceWorkerContainer {
 public:
...
TEST_F(ServiceWorkerProviderHostTest,
...

  {
    std::unique_ptr<ServiceWorkerProviderHost> host =
        ServiceWorkerProviderHost::PreCreateNavigationHost(
            helper_->context()->AsWeakPtr(), true,
            base::RepeatingCallback<ApplicationContents*(void)>());
    ServiceWorkerProviderHostInfo info(
        host->provider_id(), 1 /* route_id */,
        blink::mojom::ServiceWorkerProviderType::kForWindow,
        true /* is_parent_frame_secure */);
