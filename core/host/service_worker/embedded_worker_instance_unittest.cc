...
#include "core/host/service_worker/embedded_worker_test_helper.h"
...
class ProviderHostEndpoints : public common::mojom::ServiceWorkerContainerHost {
 public:
  ProviderHostEndpoints() : binding_(this) {}

  ~ProviderHostEndpoints() override {}

  common::mojom::ServiceWorkerProviderInfoForStartWorkerPtr CreateProviderInfoPtr() {
 ...
 private:
  // Implements common::mojom::ServiceWorkerContainerHost.
  ...
  void EnsureControllerServiceWorker(
      ...
      common::mojom::ControllerServiceWorkerPurpose purpose) override {
    NOTIMPLEMENTED();
  }
  void CloneForWorker(
      common::mojom::ServiceWorkerContainerHostRequest request) override {
    NOTIMPLEMENTED();
  }
  void Ping(PingCallback callback) override { NOTIMPLEMENTED(); }

  common::mojom::ServiceWorkerContainerAssociatedPtr client_;
  mojo::AssociatedBinding<common::mojom::ServiceWorkerContainerHost> binding_;
...
class EmbeddedWorkerInstanceTest : public testing::Test,
 ...
 protected:
  ...
  common::mojom::ServiceWorkerProviderInfoForStartWorkerPtr CreateProviderInfo(
      int /* process_id */,
  ...
  common::mojom::ServiceWorkerEventDispatcherRequest CreateEventDispatcher() {
    dispatchers_.emplace_back();
    return mojo::MakeRequest(&dispatchers_.back());
  }

  common::mojom::ControllerServiceWorkerRequest CreateController() {
  ...
  // Mojo endpoints.
  std::vector<common::mojom::ServiceWorkerEventDispatcherPtr> dispatchers_;
  std::vector<common::mojom::ControllerServiceWorkerPtr> controllers_;
...
class FailEmbeddedWorkerInstanceClientImpl
 ...
 private:
  void StartWorker(common::mojom::EmbeddedWorkerStartParamsPtr) override {
