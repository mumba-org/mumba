...
#include "core/host/service_worker/service_worker_response_info.h"
#include "core/host/service_worker/service_worker_url_job_wrapper.h"
...
ServiceWorkerControlleeRequestHandler::ServiceWorkerControlleeRequestHandler(
    ...
    : ServiceWorkerRequestHandler(context,
      ...
      is_main_resource_load_(
          common::ServiceWorkerUtils::IsMainResourceType(resource_type)),
      is_main_frame_load_(resource_type == common::RESOURCE_TYPE_MAIN_FRAME),
...
net::URLRequestJob* ServiceWorkerControlleeRequestHandler::MaybeCreateJob(
  ...
  // DLOG(INFO) << "ServiceWorkerControlleeRequestHandler::MaybeCreateJob";
  ClearJob();
...
void ServiceWorkerControlleeRequestHandler::MaybeCreateLoader(
  ...
  // DLOG(INFO) << "ServiceWorkerControlleeRequestHandler::MaybeCreateLoader";
...
ServiceWorkerControlleeRequestHandler::MaybeCreateSubresourceLoaderParams() {
  // DLOG(INFO) << "ServiceWorkerControlleeRequestHandler::MaybeCreateSubresourceLoaderParams";
  DCHECK(common::ServiceWorkerUtils::IsServicificationEnabled());

  // We didn't create URLLoader for this request.
  if (!url_job_) {
    // DLOG(ERROR) << "ServiceWorkerControlleeRequestHandler::MaybeCreateSubresourceLoaderParams: url_job_ IS NULL. returning null";
    return base::nullopt;
  }
  ...
  if (!provider_host_ || !provider_host_->controller()) {
    // DLOG(ERROR) << "ServiceWorkerControlleeRequestHandler::MaybeCreateSubresourceLoaderParams: provider_host_ IS NULL. returning null";
    return base::nullopt;
  }
  ...
  common::SubresourceLoaderParams params;
  ...
  return base::Optional<common::SubresourceLoaderParams>(std::move(params));
}

void ServiceWorkerControlleeRequestHandler::PrepareForMainResource(
    const GURL& url,
    const GURL& site_for_cookies) {
  // DLOG(INFO) << "ServiceWorkerControlleeRequestHandler::PrepareForMainResource";
  ...
  context_->storage()->FindRegistrationForDocument(
      stripped_url_, provider_host_->process_type(), provider_host_->process_id(),
      base::BindOnce(&ServiceWorkerControlleeRequestHandler::DidLookupRegistrationForMainResource,
...
void ServiceWorkerControlleeRequestHandler::
  ...
  // DLOG(INFO) << "ServiceWorkerControlleeRequestHandler::DidLookupRegistrationForMainResource";
  // The job may have been canceled before this was invoked.
  if (JobWasCanceled()) {
    // DLOG(INFO) << "ServiceWorkerControlleeRequestHandler::DidLookupRegistrationForMainResource: JobWasCanceled() = true. cancelling";
    return;
  }
  ...
  if (provider_host_ && !need_to_update)
    provider_host_->SetAllowAssociation(true);
  if (status != common::SERVICE_WORKER_OK || !provider_host_ || !context_) {
    //DLOG(INFO) << "ServiceWorkerControlleeRequestHandler::DidLookupRegistrationForMainResource: status != common::SERVICE_WORKER_OK . (should be) cancelling";
    url_job_->FallbackToNetwork();
  ...
  if (!provider_host_->IsContextSecureForServiceWorker()) {
    DLOG(INFO) << "ServiceWorkerControlleeRequestHandler::DidLookupRegistrationForMainResource: provider_host_->IsContextSecureForServiceWorker() = false. (should be) cancelling";
  ...
  if (need_to_update) {
    // DLOG(INFO) << "ServiceWorkerControlleeRequestHandler::DidLookupRegistrationForMainResource: need_to_update = true";
  ...
  if (active_version.get() &&
    ...
    // DLOG(INFO) << "ServiceWorkerControlleeRequestHandler::DidLookupRegistrationForMainResource: active_version->status() == ServiceWorkerVersion::ACTIVATING";
    provider_host_->SetAllowAssociation(false);
  ...
  // DLOG(INFO) << "ServiceWorkerControlleeRequestHandler::DidLookupRegistrationForMainResource: provider_host_->AssociateRegistration()";
  ...
  // FIXME(maybe): keep going instead 

  // if (!active_version.get() ||
  //     active_version->status() != ServiceWorkerVersion::ACTIVATED) {
  //   DLOG(INFO) << "ServiceWorkerControlleeRequestHandler::DidLookupRegistrationForMainResource: active_version->status() != ServiceWorkerVersion::ACTIVATED. cancelling";
  //   url_job_->FallbackToNetwork();
  //   TRACE_EVENT_ASYNC_END2(
  //       "ServiceWorker",
  //       "ServiceWorkerControlleeRequestHandler::PrepareForMainResource",
  ...
  // DLOG(INFO) << "ServiceWorkerControlleeRequestHandler::DidLookupRegistrationForMainResource: MaybeForwardToServiceWorker(). is_forwarded ? " << is_forwarded;
...
void ServiceWorkerControlleeRequestHandler::OnVersionStatusChanged(
  ...
  // DLOG(INFO) << "\nServiceWorkerControleeRequestHandler::OnVersionStatusChanged\n";
  // The job may have been canceled before this was invoked.
  if (JobWasCanceled())
    return;
...
void ServiceWorkerControlleeRequestHandler::DidUpdateRegistration(
  ...
  // DLOG(INFO) << "ServiceWorkerControleeRequestHandler::DidUpdateRegistration";
...
void ServiceWorkerControlleeRequestHandler::OnUpdatedVersionStatusChanged(
  ...
  // DLOG(INFO) << "ServiceWorkerControleeRequestHandler::OnUpdatedVersionStatusChanged";
  // The job may have been canceled before this was invoked.
  if (JobWasCanceled())
    return;
...
void ServiceWorkerControlleeRequestHandler::MainResourceLoadFailed() {
  // DLOG(INFO) << "ServiceWorkerControleeRequestHandler::MainResourceLoadFailed";
  DCHECK(provider_host_);
