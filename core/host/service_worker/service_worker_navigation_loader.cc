...
#include "core/host/service_worker/service_worker_navigation_loader.h"
...
class ServiceWorkerNavigationLoader::StreamWaiter
 ...
 public:
  ...
  // Implements common::mojom::ServiceWorkerStreamCallback.
...
void ServiceWorkerNavigationLoader::StartResponse(
  ...
  base::Optional<net::RedirectInfo> redirect_info =
      common::ServiceWorkerLoaderHelpers::ComputeRedirectInfo(
