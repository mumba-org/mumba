...
class TestServiceImpl : public common::mojom::TestService {
 public:
  static void Create(mojo::InterfaceRequest<common::mojom::TestService> request) {
...
class MessageReceiverDisallowStart : public MessageReceiver {
 ...
 private:
  ...
  std::map<int /* embedded_worker_id */,
           common::mojom::ServiceWorkerEventDispatcherRequest>
      event_dispatcher_request_map_;
  std::map<int /* embedded_worker_id */, common::mojom::ControllerServiceWorkerRequest>
...
TEST_F(ServiceWorkerRequestTimeoutTest, RequestTimeout) {
  ...
  version_->event_dispatcher()->DispatchExtendableMessageEvent(
      common::mojom::ExtendableMessageEvent::New(),
