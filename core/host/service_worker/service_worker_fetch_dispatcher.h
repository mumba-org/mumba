...
class CONTENT_EXPORT ServiceWorkerFetchDispatcher {
 public:
  ...
  using FetchCallback =
      base::OnceCallback<void(common::ServiceWorkerStatusCode,
                              FetchEventResult,
                              const common::ServiceWorkerResponse&,
 ...
 private:
  ...
  void StartWorker();
  void DidStartWorker(common::ServiceWorkerStatusCode status);
  void DispatchFetchEvent();
  void DidFailToDispatch(std::unique_ptr<ResponseCallback> callback,
                         common::ServiceWorkerStatusCode status);
  void DidFail(common::ServiceWorkerStatusCode status);
