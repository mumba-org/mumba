...
class ServiceWorkerUnregisterJob : public ServiceWorkerRegisterJobBase {
 ...
 private:
  ...
  void Complete(int64_t registration_id, common::ServiceWorkerStatusCode status);
  void CompleteInternal(int64_t registration_id,
                        common::ServiceWorkerStatusCode status);
  void ResolvePromise(int64_t registration_id, common::ServiceWorkerStatusCode status);
