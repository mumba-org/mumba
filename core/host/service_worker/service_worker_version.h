...
class CONTENT_EXPORT ServiceWorkerVersion
 ...
 public:
  using StatusCallback = base::OnceCallback<void(common::ServiceWorkerStatusCode)>;
  ...
  const GURL& script_origin() const { return script_origin_; }
  ...
  // common::mojom::EmbeddedWorkerInstanceHost::RequestTermination().
  ...
  // common::mojom::ServiceWorkerEventDispatcher interface instead (see
  ...
  common::mojom::ServiceWorkerEventDispatcher* event_dispatcher() {
  ...
  common::mojom::ControllerServiceWorker* controller() {
  ...
  void ReportError(common::ServiceWorkerStatusCode status,
                   const std::string& status_message);

  void ReportForceUpdateToDevTools();

  // Sets the status code to pass to StartWorker callbacks if start fails.
  void SetStartWorkerStatusCode(common::ServiceWorkerStatusCode status);
 ...
 private:
  ...
  void OnStartSentAndScriptEvaluated(common::ServiceWorkerStatusCode status);
  ...
  // common::mojom::ServiceWorkerEventDispatcher. Use CreateSimpleEventCallback() to
  ...
  // deduce a reason.
  common::ServiceWorkerStatusCode DeduceStartWorkerFailureReason(
  ...
  // callbacks.
  void FinishStartWorker(common::ServiceWorkerStatusCode status);
  ...
  common::mojom::ServiceWorkerEventDispatcherPtr event_dispatcher_;
  ...
  common::mojom::ControllerServiceWorkerPtr controller_ptr_;
  common::mojom::ControllerServiceWorkerRequest controller_request_;
  ...
  common::ServiceWorkerStatusCode start_worker_status_ = common::SERVICE_WORKER_OK;
