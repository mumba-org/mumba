...
void ServiceWorkerJobCoordinator::Register(
  ...
  // DLOG(INFO) << "ServiceWorkerJobCoordinator::Register: process_id = " << process_id;
  std::unique_ptr<ServiceWorkerRegisterJobBase> job(
      new ServiceWorkerRegisterJob(context_, process_type, process_id, script_url, options));
...
void ServiceWorkerJobCoordinator::Unregister(
  ...
  // DLOG(INFO) << "ServiceWorkerJobCoordinator::Unregister";
  std::unique_ptr<ServiceWorkerRegisterJobBase> job(
...
void ServiceWorkerJobCoordinator::Update(
  ...
  // DLOG(INFO) << "ServiceWorkerJobCoordinator::Update: registration->_process_id = " << registration->process_id();
  DCHECK(registration);
...
void ServiceWorkerJobCoordinator::Update(
    ...
    ServiceWorkerRegisterJob::RegistrationCallback callback) {
  // DLOG(INFO) << "ServiceWorkerJobCoordinator::Update: registration->process_id = " << registration->process_id();
  DCHECK(registration);
  ServiceWorkerRegisterJob* queued_job = static_cast<ServiceWorkerRegisterJob*>(
      job_queues_[registration->pattern()].Push(
          base::WrapUnique<ServiceWorkerRegisterJobBase>(
