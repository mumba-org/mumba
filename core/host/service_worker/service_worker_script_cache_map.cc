...
void ServiceWorkerScriptCacheMap::NotifyStartedCaching(const GURL& url,
                                                       int64_t resource_id) {
  // DLOG(INFO) << "ServiceWorkerScriptCacheMap::NotifyStartedCaching";
  DCHECK_EQ(common::kInvalidServiceWorkerResourceId, LookupResourceId(url));
...
void ServiceWorkerScriptCacheMap::NotifyFinishedCaching(
  ...
  DCHECK_NE(common::kInvalidServiceWorkerResourceId, LookupResourceId(url));
...
void ServiceWorkerScriptCacheMap::WriteMetadata(
  ...
  if (found == resource_map_.end() ||
      found->second.resource_id == common::kInvalidServiceWorkerResourceId) {
