...
#include "core/host/loader/resource_request_info_impl.h"
#include "core/host/resource_context_impl.h"
...
#include "core/host/blob_handle.h"
...
#include "storage/host/blob/blob_url_request_job.h"
...
class DelayHelper : public EmbeddedWorkerTestHelper {
 ...
 private:
  ...
  common::mojom::ServiceWorkerEventDispatcherRequest start_worker_request_;
  ...
  common::mojom::EmbeddedWorkerInstanceHostAssociatedPtrInfo
      start_worker_instance_host_;
  common::mojom::ServiceWorkerProviderInfoForStartWorkerPtr provider_info_;
  blink::mojom::ServiceWorkerInstalledScriptsInfoPtr installed_scripts_info_;
  int embedded_worker_id_ = 0;
  common::mojom::ServiceWorkerFetchResponseCallbackPtr response_callback_;
  common::mojom::FetchEventPreloadHandlePtr preload_handle_;
  common::mojom::ServiceWorkerEventDispatcher::DispatchFetchEventCallback
      finish_callback_;
