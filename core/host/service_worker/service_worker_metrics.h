...
#include "core/host/service_worker/service_worker_installed_script_reader.h"
...
class ServiceWorkerMetrics {
 public:
  ...
  static void RecordStartWorkerStatus(common::ServiceWorkerStatusCode status,
                                      EventType purpose,
                                      bool is_installed);
  ...
  static void RecordActivateEventStatus(common::ServiceWorkerStatusCode status,
                                        bool is_shutdown);
  static void RecordInstallEventStatus(common::ServiceWorkerStatusCode status);
