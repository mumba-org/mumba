...
class CONTENT_EXPORT EmbeddedWorkerInstance
    : public common::mojom::EmbeddedWorkerInstanceHost {
 public:
  //class DevToolsProxy;
  ...
  using ProviderInfoGetter =
      base::OnceCallback<common::mojom::ServiceWorkerProviderInfoForStartWorkerPtr(
          int /* process_id */,
 ...
 private:
  ...
  common::ServiceWorkerStatusCode SendStartWorker(
      common::mojom::EmbeddedWorkerStartParamsPtr params,
      network::mojom::URLLoaderFactoryPtr non_network_loader_factory,
  ...
  // Implements common::mojom::EmbeddedWorkerInstanceHost.
  ...
  void OnStarted(common::mojom::EmbeddedWorkerStartTimingPtr start_timing) override;
  ...
  void OnStartFailed(StatusCallback callback, common::ServiceWorkerStatusCode status);
  ...
  common::mojom::EmbeddedWorkerInstanceClientPtr client_;
