...
class CONTENT_EXPORT ServiceWorkerProviderHost
    : public ServiceWorkerRegistration::Listener,
      ...
      public common::mojom::ServiceWorkerContainerHost,
      public service_manager::mojom::InterfaceProvider {
 public:
  using ApplicationContentsGetter = base::Callback<ApplicationContents*(void)>;
  ...
  ServiceWorkerProcessType process_type() const { return process_type_; }
  int process_id() const { return process_id_; }
  int provider_id() const { return info_.provider_id; }
  int frame_id() const;
  int route_id() const { return info_.route_id; }
  const ApplicationContentsGetter& application_contents_getter() const {
    return application_contents_getter_;
  }
  ...
  common::mojom::ControllerServiceWorkerPtr GetControllerServiceWorkerPtr();
 ...
 private:
  ...
  void CloneForWorker(
      common::mojom::ServiceWorkerContainerHostRequest container_host_request) override;
  ...
  common::mojom::ServiceWorkerContainerAssociatedPtr container_;
  ...
  mojo::BindingSet<common::mojom::ServiceWorkerContainerHost>
