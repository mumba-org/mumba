...
#include "core/shared/common/service_worker/service_worker.mojom.h"
...
//
// This class is bound with common::mojom::ServiceWorkerDispatcherHost. All
...
// testing.
//
// TODO(leonhsl): This class no longer needs to be a HostMessageFilter
// because we are already in a pure Mojo world.
class CONTENT_EXPORT ServiceWorkerDispatcherHost
    : public HostMessageFilter,
      public HostAssociatedInterface<common::mojom::ServiceWorkerDispatcherHost>,
      public common::mojom::ServiceWorkerDispatcherHost {
 public:
  ...
  ServiceWorkerProcessType process_type() const {
 ...
 private:
  ...
  // common::mojom::ServiceWorkerDispatcherHost implementation
  void OnProviderCreated(common::ServiceWorkerProviderHostInfo info) override;
