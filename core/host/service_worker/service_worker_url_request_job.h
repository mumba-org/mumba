...
#include "core/host/service_worker/service_worker_response_type.h"
...
class CONTENT_EXPORT ServiceWorkerURLRequestJob : public net::URLRequestJob {
 ...
 private:
  ...
  void SetResponse(const common::ServiceWorkerResponse& response);
  ...
  const common::ResourceType resource_type_;
  common::RequestContextType request_context_type_;
  ...
  common::ServiceWorkerHeaderList cors_exposed_header_names_;
