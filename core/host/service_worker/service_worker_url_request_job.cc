...
#include "core/host/service_worker/service_worker_blob_reader.h"
#include "core/host/service_worker/service_worker_data_pipe_reader.h"
...
#include "core/host/service_worker_context.h"
...
void ServiceWorkerURLRequestJob::CreateResponseHeader(
    ...
    const common::ServiceWorkerHeaderMap& headers) {
...
void ServiceWorkerURLRequestJob::DeliverErrorResponse() {
  ...
  CreateResponseHeader(
      500, "Service Worker Response Error", common::ServiceWorkerHeaderMap());
  CommitResponseHeader();
}
    ...
    case ResponseType::FALLBACK_TO_NETWORK:
      ...
      ServiceWorkerResponseInfo::ForRequest(request_, true)
          ->OnStartCompleted(
              ...
              common::ServiceWorkerHeaderList() /* cors_exposed_header_names */,
              did_navigation_preload_);
      break;
    case ResponseType::FALLBACK_TO_RENDERER:
    case ResponseType::FORWARD_TO_SERVICE_WORKER:
...
bool ServiceWorkerURLRequestJob::IsMainResourceLoad() const {
  return common::ServiceWorkerUtils::IsMainResourceType(resource_type_);
}
