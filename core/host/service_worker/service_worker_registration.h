...
class CONTENT_EXPORT ServiceWorkerRegistration
 ...
 public:
  using StatusCallback =
      base::OnceCallback<void(common::ServiceWorkerStatusCode status)>;
  ...
  void set_script_type(blink::mojom::ScriptType script_type) {
  ...
  void NotifyVersionAttributesChanged(common::ChangedVersionAttributesMask mask);
 ...
 private:
  ...
  void OnDeleteFinished(common::ServiceWorkerStatusCode status);
