...
void EmbeddedWorkerTestHelper::MockEmbeddedWorkerInstanceClient::Bind(
  ...
  common::mojom::EmbeddedWorkerInstanceClientRequest request(std::move(request_handle));
...
class EmbeddedWorkerTestHelper::MockServiceWorkerEventDispatcher
    : public common::mojom::ServiceWorkerEventDispatcher {
 public:
  static void Create(const base::WeakPtr<EmbeddedWorkerTestHelper>& helper,
                     int thread_id,
                     common::mojom::ServiceWorkerEventDispatcherRequest request) {
  ...
  void DispatchCanMakePaymentEvent(
      int payment_request_id,
      payments::common::mojom::CanMakePaymentEventDataPtr event_data,
      payments::common::mojom::PaymentHandlerResponseCallbackPtr response_callback,
  ...
  void DispatchPaymentRequestEvent(
      int payment_request_id,
      payments::common::mojom::PaymentRequestEventDataPtr event_data,
      payments::common::mojom::PaymentHandlerResponseCallbackPtr response_callback,
...
EmbeddedWorkerTestHelper::EmbeddedWorkerTestHelper(
  ...
  render_process_host_->OverrideBinderForTesting(
      common::mojom::EmbeddedWorkerInstanceClient::Name_,
...
void EmbeddedWorkerTestHelper::OnBackgroundFetchedEvent(
    ...
    const std::string& unique_id,
    const std::vector<BackgroundFetchSettledFetch>& fetches,
    common::mojom::ServiceWorkerEventDispatcher::DispatchBackgroundFetchedEventCallback
        callback) {
  std::move(callback).Run(blink::mojom::ServiceWorkerEventStatus::COMPLETED,
                          base::Time::Now());
}
...
void EmbeddedWorkerTestHelper::OnExtendableMessageEvent(
    common::mojom::ExtendableMessageEventPtr event,
    common::mojom::ServiceWorkerEventDispatcher::DispatchExtendableMessageEventCallback
        callback) {
  std::move(callback).Run(blink::mojom::ServiceWorkerEventStatus::COMPLETED,
                          base::Time::Now());
}
...
void EmbeddedWorkerTestHelper::OnNotificationClickEvent(
    ...
    int action_index,
    const base::Optional<base::string16>& reply,
    common::mojom::ServiceWorkerEventDispatcher::DispatchNotificationClickEventCallback
        callback) {
  std::move(callback).Run(blink::mojom::ServiceWorkerEventStatus::COMPLETED,
                          base::Time::Now());
}
...
void EmbeddedWorkerTestHelper::OnNotificationCloseEvent(
    const std::string& notification_id,
    const PlatformNotificationData& notification_data,
    common::mojom::ServiceWorkerEventDispatcher::DispatchNotificationCloseEventCallback
        callback) {
  std::move(callback).Run(blink::mojom::ServiceWorkerEventStatus::COMPLETED,
                          base::Time::Now());
}
...
void EmbeddedWorkerTestHelper::OnPaymentRequestEvent(
  ...
  response_callback->OnResponseForPaymentRequest(
      payments::common::mojom::PaymentHandlerResponse::New(), base::Time::Now());
  std::move(callback).Run(blink::mojom::ServiceWorkerEventStatus::COMPLETED,
                          base::Time::Now());
}
