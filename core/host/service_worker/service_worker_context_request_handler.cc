...
#include "core/host/service_worker/service_worker_read_from_cache_job.h"
...
net::URLRequestJob* ServiceWorkerContextRequestHandler::MaybeCreateJobImpl(
  ...
  if (common::ServiceWorkerUtils::ShouldBypassCacheDueToUpdateViaCache(
      ...
      time_since_last_check > common::kServiceWorkerScriptMaxCacheAge ||
  ...
  int64_t incumbent_resource_id = common::kInvalidServiceWorkerResourceId;
  if (is_main_script) {
  ...
  *out_status = incumbent_resource_id == common::kInvalidServiceWorkerResourceId
