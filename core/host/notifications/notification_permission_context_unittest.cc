...
class TestNotificationPermissionContext : public NotificationPermissionContext {
 public:
  explicit TestNotificationPermissionContext(Domain* domain)
      : NotificationPermissionContext(domain),
  ...
  ContentSetting GetContentSettingFromMap(const GURL& url_a,
                                          const GURL& url_b) {
    return HostContentSettingsMapFactory::GetForProfile(domain())
...
TEST_F(NotificationPermissionContextTest, CrossOriginPermissionChecks) {
  ...
  NotificationPermissionContext context(domain());
...
TEST_F(NotificationPermissionContextTest, SecureOriginRequirement) {
  ...
  NotificationPermissionContext web_notification_context(domain());
