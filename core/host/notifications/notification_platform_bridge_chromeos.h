...
#include "core/host/notifications/domain_notification.h"
...
class NotificationPlatformBridgeChromeOs
 ...
 private:
  WorkspaceNotification* GetWorkspaceNotification(
  ...
  // uniquely identify both the notification and its source domain. The key is
  // the permuted ID.
