...
#include "core/host/chromeos/login/users/fake_chrome_user_manager.h"
#include "core/host/content_settings/host_content_settings_map_factory.h"
#include "core/host/extensions/extension_service.h"
#include "core/host/extensions/test_extension_system.h"
...
TEST_F(ChromeAshMessageCenterClientTest, NotifierSortOrder) {
  TestingProfile* domain = CreateProfile("Domain-1");
  extensions::TestExtensionSystem* test_extension_system =
      static_cast<extensions::TestExtensionSystem*>(
          extensions::ExtensionSystem::Get(domain));
...
TEST_F(ChromeAshMessageCenterClientTest, SetWebPageNotifierEnabled) {
  Domain* domain = CreateProfile("MyProfile");
  CreateClient();
  ...
  PermissionManager* permission_manager = PermissionManager::Get(domain);
