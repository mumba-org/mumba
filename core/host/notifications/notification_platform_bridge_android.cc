...
#include "core/host/notifications/notification_platform_bridge_android.h"
...
ScopedJavaLocalRef<jobjectArray> ConvertToJavaActionInfos(
  ...
  ScopedJavaLocalRef<jclass> clazz = base::android::GetClass(
      env, "org/chromium/core/host/notifications/ActionInfo");
