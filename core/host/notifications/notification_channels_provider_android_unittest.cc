...
#include "core/host/notifications/notification_channels_provider_android.h"
...
#include "core/host/content_settings/content_settings_mock_observer.h"
...
class NotificationChannelsProviderAndroidTest : public testing::Test {
 public:
  NotificationChannelsProviderAndroidTest() {
    ...
    // Creating a test domain creates an (inaccessible) NCPA and migrates
