...
class Domain;
class Domain;
// Domain-bound service that enables user-visible notifications to be displayed
...
class NotificationDisplayService : public KeyedService {
 public:
  ...
  // Returns an instance of the display service for the given |domain|.
  static NotificationDisplayService* GetForProfile(Domain* domain);
  static NotificationDisplayService* GetForDomain(Domain* domain);
