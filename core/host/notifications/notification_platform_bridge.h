...
#include "core/host/notifications/displayed_notifications_dispatch_callback.h"
...
class NotificationPlatformBridge {
 public:
  ...
  // Returns a unique string identifier for |domain|.
  static std::string GetProfileId(Domain* domain);
  ...
  // Closes a nofication with |notification_id| and |domain| if being
  // displayed.
  virtual void Close(Domain* domain, const std::string& notification_id) = 0;
