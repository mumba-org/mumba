...
#include "core/host/notifications/stub_notification_display_service.h"
...
StubNotificationDisplayService::StubNotificationDisplayService(Domain* domain)
    : NotificationDisplayServiceImpl(domain), profile_(domain) {}
