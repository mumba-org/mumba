...
#include "core/host/notifications/notification_permission_context.h"
...
//#include "core/host/permissions/permission_request_id.h"
...
class VisibilityTimerTabHelper
    : public WebContentsObserver,
      public WebContentsUserData<VisibilityTimerTabHelper> {
 public:
 ...
 private:
  friend class WebContentsUserData<VisibilityTimerTabHelper>;
  explicit VisibilityTimerTabHelper(WebContents* contents);
...
DEFINE_APPLICATION_CONTENTS_USER_DATA_KEY(VisibilityTimerTabHelper);

NotificationPermissionContext::NotificationPermissionContext(Domain* domain)
    : PermissionContextBase(domain,
...
void NotificationPermissionContext::ResetPermission(
  ...
  DesktopNotificationProfileUtil::ClearSetting(domain(), requesting_origin);
}
