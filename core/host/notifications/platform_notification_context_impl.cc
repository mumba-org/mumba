...
#include "core/host/notifications/notification_database.h"
...
// Name of the directory in the user's domain directory where the notification
...
void PlatformNotificationContextImpl::CreateServiceOnIO(
  ...
  services_.push_back(std::make_unique<BlinkNotificationServiceImpl>(
      this, domain_, resource_context, service_worker_context_,
...
void PlatformNotificationContextImpl::OpenDatabase(
  ...
  HostThread::PostTask(HostThread::IO, FROM_HERE, failure_closure);
}
