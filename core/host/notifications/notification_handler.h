...
class NotificationHandler {
 public:
  ...
  virtual void OnShow(Domain* domain, const std::string& notification_id);
  ...
  virtual void OnClose(Domain* domain,
                       const GURL& origin,
  ...
  virtual void OnClick(Domain* domain,
                       const GURL& origin,
                       const std::string& notification_id,
  ...
  virtual void DisableNotifications(Domain* domain, const GURL& origin);

  // Called when the settings page for the given origin has to be opened.
  virtual void OpenSettings(Domain* domain, const GURL& origin);
};
