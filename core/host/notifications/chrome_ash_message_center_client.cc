...
#include "core/host/chromeos/arc/arc_session_manager.h"
...
#include "core/host/ui/app_list/arc/arc_app_list_prefs.h"
...
// domain, so this just returns the active domain.
Domain* GetProfileForNotifiers() {
...
void ChromeAshMessageCenterClient::GetArcAppIdByPackageName(
  ...
  std::move(callback).Run(
      ArcAppListPrefs::Get(arc::ArcSessionManager::Get()->domain())
