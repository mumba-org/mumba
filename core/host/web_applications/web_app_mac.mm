...
class Latch : public base::RefCountedThreadSafe<
                  Latch,
                  content::HostThread::DeleteOnUIThread> {
 public:
 ...
 private:
  ...
  friend struct content::HostThread::DeleteOnThread<
      content::HostThread::UI>;
...
bool UpdateAppShortcutsSubdirLocalizedName(
  ...
  content::HostThread::PostTask(
      content::HostThread::UI, FROM_HERE,
      base::BindOnce(
