...
#ifndef MUMBA_HOST_WORKSPACE_BIN_STORAGE_H_
#define MUMBA_HOST_WORKSPACE_BIN_STORAGE_H_
...
class BinStorage : public StorageLayer {
public:
  BinStorage(const base::FilePath& path);
  ~BinStorage() override;
...
private:
  ...
  DISALLOW_COPY_AND_ASSIGN(BinStorage);
};
