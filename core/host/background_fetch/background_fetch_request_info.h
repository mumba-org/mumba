...
class CONTENT_EXPORT BackgroundFetchRequestInfo
 ...
 public:
  BackgroundFetchRequestInfo(int request_index,
                             const common::ServiceWorkerFetchRequest& fetch_request);
  ...
  const common::ServiceWorkerFetchRequest& fetch_request() const {
 ...
 private:
  ...
  common::ServiceWorkerFetchRequest fetch_request_;
