...
class BackgroundFetchEmbeddedWorkerTestHelper
 ...
 public:
  ...
  const base::Optional<std::vector<common::BackgroundFetchSettledFetch>> last_fetches()
      const {
 ...
 private:
  ...
  base::Optional<std::vector<common::BackgroundFetchSettledFetch>> last_fetches_;
