...
//#include "core/host/offline_items_collection/offline_content_aggregator_factory.h"
//#include "components/download/public/background_service/download_params.h"
//#include "components/download/public/background_service/download_service.h"
//#include "components/offline_items_collection/core/offline_content_aggregator.h"
//#include "components/offline_items_collection/core/offline_item.h"
#include "core/host/background_fetch_response.h"
...
BackgroundFetchDelegateImpl::BackgroundFetchDelegateImpl(Domain* domain)
    : //domain_(domain),
      //download_service_(
...
void BackgroundFetchDelegateImpl::DownloadUrl(
  ...
  DCHECK_CURRENTLY_ON(HostThread::UI);
  DLOG(INFO) << "BackgroundFetchDelegateImpl::DownloadUrl: NOT IMPLEMENTED";
...
void BackgroundFetchDelegateImpl::Abort(const std::string& job_unique_id) {
  DCHECK_CURRENTLY_ON(HostThread::UI);
  DLOG(INFO) << "BackgroundFetchDelegateImpl::Abort: NOT IMPLEMENTED";
...
void BackgroundFetchDelegateImpl::OnDownloadFailed(
  ...
  using FailureReason = BackgroundFetchResult::FailureReason;
...
void BackgroundFetchDelegateImpl::CancelDownload(
    const offline_items_collection::ContentId& id) {
  DLOG(INFO) << "BackgroundFetchDelegateImpl::CancelDownload: NOT IMPLEMENTED";    
...
void BackgroundFetchDelegateImpl::PauseDownload(
    const offline_items_collection::ContentId& id) {
  DLOG(INFO) << "BackgroundFetchDelegateImpl::PauseDownload: NOT IMPLEMENTED";        
  auto job_details_iter = job_details_map_.find(id.id);
  if (job_details_iter == job_details_map_.end())
    return;
...
void BackgroundFetchDelegateImpl::ResumeDownload(
  ...
  DLOG(INFO) << "BackgroundFetchDelegateImpl::ResumeDownload: NOT IMPLEMENTED";
  auto job_details_iter = job_details_map_.find(id.id);
  if (job_details_iter == job_details_map_.end())
    return;
