...
#include "core/host/background_fetch/background_fetch_event_dispatcher.h"
...
#include "core/host/background_fetch/background_fetch_embedded_worker_test_helper.h"
#include "core/host/background_fetch/background_fetch_registration_id.h"
#include "core/host/background_fetch/background_fetch_test_base.h"
...
TEST_F(BackgroundFetchEventDispatcherTest, DispatchFailEvent) {
  ...
  std::vector<common::BackgroundFetchSettledFetch> fetches;
  fetches.push_back(common::BackgroundFetchSettledFetch());
