...
#include "core/host/cache_storage_usage_info.h"
...
class CacheStorageManagerTest : public testing::Test {
 public:
  ...
  bool StorageMatch(const url::Origin& origin,
    ...
    common::ServiceWorkerFetchRequest request;
    request.url = url;
  ...
  bool StorageMatchWithRequest(
      ...
      const common::CacheStorageCacheQueryParams& match_params =
          common::CacheStorageCacheQueryParams()) {
    std::unique_ptr<common::ServiceWorkerFetchRequest> unique_request =
        std::make_unique<common::ServiceWorkerFetchRequest>(request);
  ...
  bool CacheMatch(CacheStorageCache* cache, const GURL& url) {
    ...
    base::RunLoop loop;
    cache->Match(
        std::move(request), common::CacheStorageCacheQueryParams(),
        base::BindOnce(&CacheStorageManagerTest::CacheMatchCallback,
                       base::Unretained(this), base::Unretained(&loop)));
    loop.Run();
 ...
 protected:
  ...
  std::unique_ptr<common::ServiceWorkerResponse> callback_cache_handle_response_;
...
TEST_F(CacheStorageManagerTest, TestsRunOnIOThread) {
  EXPECT_TRUE(HostThread::CurrentlyOn(HostThread::IO));
}
...
TEST_P(CacheStorageManagerTestP, StorageMatch_IgnoreMethod) {
  ...
  common::ServiceWorkerFetchRequest post_request;
