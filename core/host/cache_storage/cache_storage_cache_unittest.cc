...
#include "storage/host/blob/blob_data_snapshot.h"
...
#include "storage/host/test/mock_quota_manager_proxy.h"
...
bool ResponseMetadataEqual(const common::ServiceWorkerResponse& expected,
                           const common::ServiceWorkerResponse& actual) {
...
common::ServiceWorkerResponse SetCacheName(const common::ServiceWorkerResponse& original) {
  common::ServiceWorkerResponse result(original);
...
class CacheStorageCacheTest : public testing::Test {
 public:
  CacheStorageCacheTest()
      : browser_thread_bundle_(TestHostThreadBundle::IO_MAINLOOP) {}
  ...
  void CreateRequests(ChromeBlobStorageContext* blob_storage_context) {
    ...
    body_request_ =
        common::ServiceWorkerFetchRequest(GURL("http://example.com/body.html"), "GET",
                                  headers, Referrer(), false);
    body_request_with_query_ = common::ServiceWorkerFetchRequest(
        GURL("http://example.com/body.html?query=test"), "GET", headers,
        Referrer(), false);
    no_body_request_ =
        common::ServiceWorkerFetchRequest(GURL("http://example.com/no_body.html"),
                                  "GET", headers, Referrer(), false);
    body_head_request_ =
        common::ServiceWorkerFetchRequest(GURL("http://example.com/body.html"), "HEAD",
                                  headers, Referrer(), false);
  ...
  static common::ServiceWorkerResponse CreateResponse(
    ...
    return common::ServiceWorkerResponse(
        ...
        blink::mojom::common::ServiceWorkerResponseError::kUnknown, base::Time::Now(),
  ...
  std::unique_ptr<common::ServiceWorkerFetchRequest> CopyFetchRequest(
      const common::ServiceWorkerFetchRequest& request) {
    return std::make_unique<common::ServiceWorkerFetchRequest>(
  ...
  bool Put(const common::ServiceWorkerFetchRequest& request,
           const common::ServiceWorkerResponse& response) {
    common::CacheStorageBatchOperation operation;
    operation.operation_type = CACHE_STORAGE_CACHE_OPERATION_TYPE_PUT;
    operation.request = request;
    operation.response = response;

    CacheStorageError error =
        BatchOperation(std::vector<common::CacheStorageBatchOperation>(1, operation));
    return error == CacheStorageError::kSuccess;
  }

  bool Match(const common::ServiceWorkerFetchRequest& request,
  ...
  bool MatchAll(const common::ServiceWorkerFetchRequest& request,
                const common::CacheStorageCacheQueryParams& match_params,
                std::vector<common::ServiceWorkerResponse>* responses) {
    base::RunLoop loop;
    cache_->MatchAll(
        CopyFetchRequest(request), match_params,
  ...
  bool MatchAll(std::vector<common::ServiceWorkerResponse>* responses) {
    return MatchAll(common::ServiceWorkerFetchRequest(), common::CacheStorageCacheQueryParams(),
                    responses);
  }

  bool Delete(const common::ServiceWorkerFetchRequest& request,
              const common::CacheStorageCacheQueryParams& match_params =
                  common::CacheStorageCacheQueryParams()) {
    common::CacheStorageBatchOperation operation;
  ...
  bool Keys(
      const common::ServiceWorkerFetchRequest& request = common::ServiceWorkerFetchRequest(),
      const common::CacheStorageCacheQueryParams& match_params =
          common::CacheStorageCacheQueryParams()) {
    std::unique_ptr<base::RunLoop> loop(new base::RunLoop());
  ...
  void ResponsesAndErrorCallback(
      ...
      std::vector<common::ServiceWorkerResponse>* responses_out,
      CacheStorageError error,
      std::vector<common::ServiceWorkerResponse> responses) {
    callback_error_ = error;
 ...
 protected:
  ...
  TestHostThreadBundle browser_thread_bundle_;
  ...
  common::ServiceWorkerFetchRequest body_request_;
  common::ServiceWorkerResponse body_response_;
  common::ServiceWorkerFetchRequest body_request_with_query_;
  common::ServiceWorkerResponse body_response_with_query_;
  common::ServiceWorkerFetchRequest no_body_request_;
  common::ServiceWorkerResponse no_body_response_;
  common::ServiceWorkerFetchRequest body_head_request_;
  std::unique_ptr<storage::BlobDataHandle> blob_handle_;
  std::string expected_blob_data_;

  CacheStorageError callback_error_ = CacheStorageError::kSuccess;
  std::unique_ptr<common::ServiceWorkerResponse> callback_response_;
...
TEST_P(CacheStorageCacheTestP, PutBody_Multiple) {
  common::CacheStorageBatchOperation operation1;
  ...
  common::CacheStorageBatchOperation operation2;
  ...
  common::CacheStorageBatchOperation operation3;
  ...
  std::vector<common::CacheStorageBatchOperation> operations;
...
TEST_P(CacheStorageCacheTestP, MatchAllLimit) {
  ...
  std::vector<common::ServiceWorkerResponse> responses;
  common::CacheStorageCacheQueryParams match_params;
...
TEST_P(CacheStorageCacheTestP, PutBodyDropBlobRef) {
  ...
  std::unique_ptr<base::RunLoop> loop(new base::RunLoop());
  cache_->BatchOperation(
      std::vector<common::CacheStorageBatchOperation>(1, operation),
...
TEST_P(CacheStorageCacheTestP, PutBadMessage) {
  ...
  std::vector<common::CacheStorageBatchOperation> operations =
      std::vector<common::CacheStorageBatchOperation>(2, operation);
...
TEST_P(CacheStorageCacheTestP, Match_IgnoreMethod) {
  ...
  common::ServiceWorkerFetchRequest post_request = body_request_;
...
TEST_P(CacheStorageCacheTestP, MatchAll_IgnoreSearch) {
  ...
  for (const common::ServiceWorkerResponse& response : responses) {
...
TEST_P(CacheStorageCacheTestP, KeysWithIgnoreSearchFalse) {
  ...
  EXPECT_EQ(match_params.ignore_search,
            common::CacheStorageCacheQueryParams().ignore_search);
...
TEST_P(CacheStorageCacheTestP, PutWithSideData) {
  common::ServiceWorkerResponse response(body_response_);
...
TEST_F(CacheStorageCacheTest, Caselesscommon::ServiceWorkerResponseHeaders) {
  // CacheStorageCache depends on common::ServiceWorkerResponse having caseless
  ...
  common::ServiceWorkerResponse response(
      ...
      blink::mojom::common::ServiceWorkerResponseError::kUnknown, base::Time(),
      false /* is_in_cache_storage */,
      std::string() /* cache_storage_cache_name */,
      std::make_unique<
          ServiceWorkerHeaderList>() /* cors_exposed_header_names */);
...
TEST_F(CacheStorageCacheTest, Caselesscommon::ServiceWorkerFetchRequestHeaders) {
  // CacheStorageCache depends on common::ServiceWorkerFetchRequest having caseless
  // headers so that it can quickly lookup vary headers.
  common::ServiceWorkerFetchRequest request(GURL("http://www.example.com"), "GET",
...
TEST_F(CacheStorageCacheTest, VerifyOpaqueSizePadding) {
  ...
  common::ServiceWorkerFetchRequest non_opaque_request(body_request_);
  non_opaque_request.url = GURL("http://example.com/no-pad.html");
  common::ServiceWorkerResponse non_opaque_response(body_response_);
  ...
  common::ServiceWorkerFetchRequest opaque_request(non_opaque_request);
  ...
  common::ServiceWorkerResponse opaque_response(non_opaque_response);
...
TEST_F(CacheStorageCacheTest, TestDifferentOpaqueSideDataSizes) {
  common::ServiceWorkerFetchRequest request(body_request_);
...
TEST_F(CacheStorageCacheTest, TestDoubleOpaquePut) {
  ...
  common::ServiceWorkerFetchRequest request2(body_request_);
  common::ServiceWorkerResponse response2(body_response_);
...
TEST_P(CacheStorageCacheTestP, VerifySerialScheduling) {
  ...
  cache_->BatchOperation(
      std::vector<common::CacheStorageBatchOperation>(1, operation1),
  ...
  cache_->BatchOperation(
      std::vector<common::CacheStorageBatchOperation>(1, operation2),
      base::BindOnce(&CacheStorageCacheTest::SequenceCallback,
