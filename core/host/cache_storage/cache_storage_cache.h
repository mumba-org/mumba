...
class CONTENT_EXPORT CacheStorageCache {
 public:
  ...
  using ResponseCallback =
      base::OnceCallback<void(blink::mojom::CacheStorageError,
                              std::unique_ptr<common::ServiceWorkerResponse>)>;
  using ResponsesCallback =
      base::OnceCallback<void(blink::mojom::CacheStorageError,
                              std::vector<common::ServiceWorkerResponse>)>;
  using Requests = std::vector<common::ServiceWorkerFetchRequest>;
  ...
  void Match(std::unique_ptr<common::ServiceWorkerFetchRequest> request,
  ...
  void MatchAll(std::unique_ptr<common::ServiceWorkerFetchRequest> request,
                const common::CacheStorageCacheQueryParams& match_params,
  ...
  void BatchOperation(const std::vector<common::CacheStorageBatchOperation>& operations,
  ...
  void Keys(std::unique_ptr<common::ServiceWorkerFetchRequest> request,
 ...
 private:
  ...
  void QueryCache(std::unique_ptr<common::ServiceWorkerFetchRequest> request,
                  const common::CacheStorageCacheQueryParams& options,
  ...
  // Match callbacks
  void MatchImpl(std::unique_ptr<common::ServiceWorkerFetchRequest> request,
                 const common::CacheStorageCacheQueryParams& match_params,
                 ResponseCallback callback);
  ...
  // MatchAll callbacks
  void MatchAllImpl(std::unique_ptr<common::ServiceWorkerFetchRequest> request,
                    const common::CacheStorageCacheQueryParams& options,
                    ResponsesCallback callback);
  ...
  // success.
  void Put(const common::CacheStorageBatchOperation& operation, ErrorCallback callback);
  ...
  void Delete(const common::CacheStorageBatchOperation& operation,
              ErrorCallback callback);
  void DeleteImpl(std::unique_ptr<common::ServiceWorkerFetchRequest> request,
                  const common::CacheStorageCacheQueryParams& match_params,
                  ErrorCallback callback);
  ...
  // Keys callbacks.
  void KeysImpl(std::unique_ptr<common::ServiceWorkerFetchRequest> request,
                const common::CacheStorageCacheQueryParams& options,
                RequestsCallback callback);
