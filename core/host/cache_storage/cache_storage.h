...
class CONTENT_EXPORT CacheStorage : public CacheStorageCacheObserver {
 public:
  ...
  void MatchAllCaches(std::unique_ptr<common::ServiceWorkerFetchRequest> request,
                      const common::CacheStorageCacheQueryParams& match_params,
                      CacheStorageCache::ResponseCallback callback);
 ...
 private:
  ...
  void MatchAllCachesImpl(std::unique_ptr<common::ServiceWorkerFetchRequest> request,
                          const common::CacheStorageCacheQueryParams& match_params,
                          CacheStorageCache::ResponseCallback callback);
