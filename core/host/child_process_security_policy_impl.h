...
class CONTENT_EXPORT ChildProcessSecurityPolicyImpl
 ...
 public:
  ...
  // Whenever the host processes commands the child process to request a URL,
  ...
  // Whenever the host process drops a file icon on a tab, it should call
 ...
 private:
  friend class ChildProcessSecurityPolicyInProcessHostTest;
  friend class ChildProcessSecurityPolicyTest;
  FRIEND_TEST_ALL_PREFIXES(ChildProcessSecurityPolicyInProcessHostTest,
                           NoLeak);
