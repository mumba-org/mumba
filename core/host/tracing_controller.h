...
// TracingController is used on the host processes to enable/disable
// tracing status and collect trace data. Only the host UI thread is allowed
...
class TracingController {
 public:
  ...
  // and send trace data back to the host process. That is because it may be
