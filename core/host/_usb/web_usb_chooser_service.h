...
class WebUsbChooserService : public device::mojom::UsbChooserService {
 public:
  explicit WebUsbChooserService(ApplicationWindowHost* application_window_host);
  ...
  ApplicationWindowHost* application_window_host() { return application_window_host_; }
