...
#include "content/public/test/application_contents_tester.h"
...
class UsbChooserControllerTest : public ChromeRenderViewHostTestHarness {
 public:
  ...
  void SetUp() override {
    ...
    ApplicationContentsTester* application_contents_tester =
        ApplicationContentsTester::For(application_contents());
    application_contents_tester->NavigateAndCommit(GURL(kDefaultTestUrl));
