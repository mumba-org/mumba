...
#include "chrome/test/base/testing_workspace.h"
#include "components/content_settings/core/browser/host_content_settings_map.h"
#include "content/public/test/test_host_thread_bundle.h"
...
TEST_F(UsbChooserContextTest, CheckGrantAndRevokePermission) {
  ...
  UsbChooserContext* store = UsbChooserContextFactory::GetForWorkspace(workspace());
...
TEST_F(UsbChooserContextTest, GrantPermissionInIncognito) {
  GURL origin("https://www.google.com");
  UsbChooserContext* store = UsbChooserContextFactory::GetForWorkspace(workspace());
  UsbChooserContext* incognito_store = UsbChooserContextFactory::GetForWorkspace(
      workspace()->GetOffTheRecordWorkspace());
...
TEST_F(UsbChooserContextTest, UsbGuardPermission) {
  ...
  auto* map = HostContentSettingsMapFactory::GetForWorkspace(workspace());
  map->SetContentSettingDefaultScope(kFooOrigin, kFooOrigin,
                                     CONTENT_SETTINGS_TYPE_USB_GUARD,
                                     std::string(), CONTENT_SETTING_BLOCK);

  auto* store = UsbChooserContextFactory::GetForWorkspace(workspace());
