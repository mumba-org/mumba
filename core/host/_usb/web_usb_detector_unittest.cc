...
#include "core/host/chromeos/workspaces/workspace_helper.h"
...
#include "core/host/ui/browser_list.h"
#include "core/host/ui/tabs/tab_strip_model.h"
#include "core/host/usb/web_usb_detector.h"
#include "chrome/test/base/browser_with_test_window_test.h"
#include "chrome/test/base/testing_browser_process.h"
#include "chrome/test/base/testing_workspace_manager.h"
...
const char* kWorkspaceName = "test@example.com";
...
class WebUsbDetectorTest : public BrowserWithTestWindowTest {
 public:
  ...
  TestingWorkspace* CreateWorkspace() override {
    return workspace_manager()->CreateTestingWorkspace(kWorkspaceName);
  }

  void SetUp() override {
    BrowserWithTestWindowTest::SetUp();
#if defined(OS_CHROMEOS)
    workspace_manager()->SetLoggedIn(true);
    chromeos::WorkspaceHelper::Get()->SetActiveUserIdForTesting(kWorkspaceName);
#endif
    BrowserList::SetLastActive(browser());
    display_service_ = std::make_unique<NotificationDisplayServiceTester>(
        SystemNotificationHelper::GetWorkspaceForTesting());
...
TEST_F(WebUsbDetectorTest,
  ...
  ApplicationContents* application_contents =
      tab_strip_model->GetApplicationContentsAt(tab_strip_model->active_index());
  EXPECT_EQ(landing_page_1, application_contents->GetURL());
  EXPECT_FALSE(display_service_->GetNotification(guid_1));
