...
// has ever been commanded to load file:// URLs by the host.
//
...
class ChildProcessSecurityPolicy {
 public:
  ...
  // host process.  The object returned by this method may be accessed on
  // any thread.
  ...
  // host should call this function to grant the child process the capability
  ...
  // host should call this method to determine whether the process has the
  ...
  // The host should check this property before assuming the child process
  ...
  // ContentHostClient::GetOriginsRequiringDedicatedProcess().
  //
