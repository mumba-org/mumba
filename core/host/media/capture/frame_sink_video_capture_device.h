...
#ifndef MUMBA_HOST_MEDIA_CAPTURE_FRAME_SINK_VIDEO_CAPTURE_DEVICE_H_
#define MUMBA_HOST_MEDIA_CAPTURE_FRAME_SINK_VIDEO_CAPTURE_DEVICE_H_
...
// of a ApplicationContents instance, producing a stream of video frames.
//
...
// ApplicationContentsVideoCaptureDevice or AuraWindowCaptureDevice. These subclasses
// provide additional implementation, to update which frame sink is targeted for
// capture, and to notify other components that capture is taking portal.
class CONTENT_EXPORT FrameSinkVideoCaptureDevice
 ...
 private:
  ...
  // client-side interface. This callback will be run on the UI HostThread.
  ...
  const std::unique_ptr<CursorRenderer, HostThread::DeleteOnUIThread>
      cursor_renderer_;
...
#endif  // MUMBA_HOST_MEDIA_CAPTURE_FRAME_SINK_VIDEO_CAPTURE_DEVICE_H_
