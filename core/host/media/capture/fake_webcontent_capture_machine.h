...
#ifndef MUMBA_HOST_MEDIA_CAPTURE_FAKE_WEBCONTENT_CAPTURE_MACHINE_H_
#define MUMBA_HOST_MEDIA_CAPTURE_FAKE_WEBCONTENT_CAPTURE_MACHINE_H_
...
#endif  // MUMBA_HOST_MEDIA_CAPTURE_DESKTOP_FAKE_CAPTURE_DEVICE_H_