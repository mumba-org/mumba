...
#ifndef MUMBA_HOST_MEDIA_CAPTURE_SCREEN_CAPTURE_DEVICE_ANDROID_H_
#define MUMBA_HOST_MEDIA_CAPTURE_SCREEN_CAPTURE_DEVICE_ANDROID_H_
...
#endif  // MUMBA_HOST_MEDIA_CAPTURE_SCREEN_CAPTURE_DEVICE_ANDROID_H_
