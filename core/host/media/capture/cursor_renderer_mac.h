...
#ifndef MUMBA_HOST_MEDIA_CAPTURE_CURSOR_RENDERER_MAC_H_
#define MUMBA_HOST_MEDIA_CAPTURE_CURSOR_RENDERER_MAC_H_
...
#endif  // MUMBA_HOST_MEDIA_CAPTURE_CURSOR_RENDERER_MAC_H_
