...
#ifndef MUMBA_HOST_MEDIA_CAPTURE_CURSOR_RENDERER_H_
#define MUMBA_HOST_MEDIA_CAPTURE_CURSOR_RENDERER_H_
...
//
// All parts of this class are meant to run on the UI HostThread, except for
...
class CONTENT_EXPORT CursorRenderer {
 ...
 private:
  ...
  // on the UI HostThread.
  gfx::Point mouse_move_start_location_;
  base::OneShotTimer mouse_activity_ended_timer_;

  // Updated in the mouse event handlers (on the UI HostThread) and read from
...
#endif  // MUMBA_HOST_MEDIA_CAPTURE_CURSOR_RENDERER_H_
