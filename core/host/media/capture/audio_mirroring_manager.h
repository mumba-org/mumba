...
//   2. A user request to mirror all the audio for a ApplicationContents is made.  A
...
#ifndef MUMBA_HOST_MEDIA_CAPTURE_AUDIO_MIRRORING_MANAGER_H_
#define MUMBA_HOST_MEDIA_CAPTURE_AUDIO_MIRRORING_MANAGER_H_
...
#endif  // MUMBA_HOST_MEDIA_CAPTURE_AUDIO_MIRRORING_MANAGER_H_
