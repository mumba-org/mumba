...
#ifndef MUMBA_HOST_MEDIA_CAPTURE_WINDOW_ACTIVITY_TRACKER_H_
#define MUMBA_HOST_MEDIA_CAPTURE_WINDOW_ACTIVITY_TRACKER_H_
...
#endif  // MUMBA_HOST_MEDIA_CAPTURE_WINDOW_ACTIVITY_TRACKER_H_
