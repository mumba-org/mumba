...
#ifndef MUMBA_HOST_DESKTOP_MEDIA_ID_H_
#define MUMBA_HOST_DESKTOP_MEDIA_ID_H_
...
struct CONTENT_EXPORT DesktopMediaID {
 public:
  ...
  DesktopMediaID(Type type, Id id, ApplicationContentsMediaCaptureId app_contents_id)
      : type(type), id(id), app_contents_id(app_contents_id) {}
  ...
  ApplicationContentsMediaCaptureId app_contents_id;
};
