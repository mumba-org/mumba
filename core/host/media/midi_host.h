...
#ifndef MUMBA_HOST_MEDIA_MIDI_HOST_H_
#define MUMBA_HOST_MEDIA_MIDI_HOST_H_
...
class CONTENT_EXPORT MidiHost : public HostMessageFilter,
...
#endif  // MUMBA_HOST_MEDIA_MIDI_HOST_H_
