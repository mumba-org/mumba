...
#ifndef MUMBA_HOST_MEDIA_MEDIA_DEVICES_PERMISSION_CHECKER_H_
#define MUMBA_HOST_MEDIA_MEDIA_DEVICES_PERMISSION_CHECKER_H_
...
class CONTENT_EXPORT MediaDevicesPermissionChecker {
 public:
  ...
  bool CheckPermissionOnUIThread(common::MediaDeviceType device_type,
  ...
  void CheckPermission(common::MediaDeviceType device_type,
                       int render_process_id,
                       int render_frame_id,
...
#endif  // MUMBA_HOST_MEDIA_MEDIA_DEVICES_PERMISSION_CHECKER_H_
