...
bool MediaSessionControllersManager::RequestPlay(
  ...
  std::unique_ptr<MediaSessionController> controller(
      new MediaSessionController(id, media_application_contents_observer_));
