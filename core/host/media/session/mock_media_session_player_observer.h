...
#ifndef MUMBA_HOST_MEDIA_SESSION_MOCK_MEDIA_SESSION_PLAYER_OBSERVER_H_
#define MUMBA_HOST_MEDIA_SESSION_MOCK_MEDIA_SESSION_PLAYER_OBSERVER_H_
...
#endif  // MUMBA_HOST_MEDIA_SESSION_MOCK_MEDIA_SESSION_PLAYER_OBSERVER_H_
