...
class MockApplicationContentsObserver : public ApplicationContentsObserver {
 public:
  explicit MockApplicationContentsObserver(ApplicationContents* contents,
...
void NavigateToURLAndWaitForFinish(Domain* window, const GURL& url) {
  base::RunLoop run_loop;
  MockApplicationContentsObserver observer(window->web_contents(),
