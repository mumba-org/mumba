...
#ifndef MUMBA_HOST_MEDIA_SESSION_PEPPER_PLAYER_DELEGATE_H_
#define MUMBA_HOST_MEDIA_SESSION_PEPPER_PLAYER_DELEGATE_H_
...
#endif  // MUMBA_HOST_MEDIA_SESSION_PEPPER_PLAYER_DELEGATE_H_
