...
MediaSessionController::MediaSessionController(
    ...
    : id_(id),
      ...
      media_session_(
          MediaSessionImpl::Get(media_application_contents_observer_->application_contents())) {
}
...
ApplicationWindowHost* MediaSessionController::application_window_host() const {
  return id_.first;
}
