...
PepperPlaybackObserver::PepperPlaybackObserver(ApplicationContents* contents)
    : contents_(contents) {}

PepperPlaybackObserver::~PepperPlaybackObserver() {
  // At this point ApplicationContents is being destructed, so it's safe to
  ...
  // ApplicationWindowHost has been destroyed.
