...
#ifndef MUMBA_HOST_MEDIA_SESSION_MEDIA_SESSION_ANDROID_H_
#define MUMBA_HOST_MEDIA_SESSION_MEDIA_SESSION_ANDROID_H_
...
class MediaSessionAndroid final : public MediaSessionObserver {
 ...
 private:
  ApplicationContentsAndroid* GetApplicationContentsAndroid();
...
#endif  // MUMBA_HOST_MEDIA_SESSION_MEDIA_SESSION_ANDROID_H_
