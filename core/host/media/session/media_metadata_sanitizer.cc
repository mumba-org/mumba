...
bool CheckMediaImageSanity(const common::MediaMetadata::MediaImage& image) {
...
common::MediaMetadata::MediaImage SanitizeMediaImage(
    const common::MediaMetadata::MediaImage& image) {
  common::MediaMetadata::MediaImage sanitized_image;
...
bool MediaMetadataSanitizer::CheckSanity(const common::MediaMetadata& metadata) {
...
common::MediaMetadata MediaMetadataSanitizer::Sanitize(const common::MediaMetadata& metadata) {
  common::MediaMetadata sanitized_metadata;
