...
#include "core/host/media/session/mock_media_session_player_observer.h"
...
class AudioFocusDelegateDefaultBrowserTest : public ContentBrowserTest {
 protected:
  ...
  void Run(ApplicationContents* start_contents, ApplicationContents* interrupt_contents) {
...
IN_PROC_BROWSER_TEST_F(AudioFocusDelegateDefaultBrowserTest,
                       ActiveApplicationContentsPauseOthers) {
