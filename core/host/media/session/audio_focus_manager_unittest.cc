...
class AudioFocusManagerTest : public testing::Test {
 public:
  ...
  ApplicationContents* CreateApplicationContents() {
    return TestApplicationContents::Create(browser_context_.get(),
 ...
 private:
  TestHostThreadBundle test_browser_thread_bundle_;
...
TEST_F(AudioFocusManagerTest, RequestAudioFocusGain_ReplaceFocusedEntry) {
  std::unique_ptr<ApplicationContents> application_contents_1(CreateApplicationContents());
  MediaSessionImpl* media_session_1 =
      MediaSessionImpl::Get(application_contents_1.get());

  std::unique_ptr<ApplicationContents> application_contents_2(CreateApplicationContents());
  MediaSessionImpl* media_session_2 =
      MediaSessionImpl::Get(application_contents_2.get());

  std::unique_ptr<ApplicationContents> application_contents_3(CreateApplicationContents());
  MediaSessionImpl* media_session_3 =
      MediaSessionImpl::Get(application_contents_3.get());
...
TEST_F(AudioFocusManagerTest, RequestAudioFocusGain_Duplicate) {
  std::unique_ptr<ApplicationContents> web_contents(CreateApplicationContents());
...
TEST_F(AudioFocusManagerTest, ApplicationContentsDestroyed_ReleasesFocus) {
  std::unique_ptr<ApplicationContents> web_contents(CreateApplicationContents());
  MediaSessionImpl* media_session = MediaSessionImpl::Get(web_contents.get());
...
TEST_F(AudioFocusManagerTest, ApplicationContentsDestroyed_ReleasesTransients) {
  std::unique_ptr<ApplicationContents> web_contents(CreateApplicationContents());
  MediaSessionImpl* media_session = MediaSessionImpl::Get(web_contents.get());
...
TEST_F(AudioFocusManagerTest, ApplicationContentsDestroyed_StopsDucking) {
  std::unique_ptr<ApplicationContents> application_contents_1(CreateApplicationContents());
  MediaSessionImpl* media_session_1 =
      MediaSessionImpl::Get(application_contents_1.get());
