...
class MediaSessionImplVisibilityBrowserTest
 ...
 public:
  ...
  void SetUpOnMainThread() override {
    ...
    application_contents_ = shell()->web_contents();
    media_session_ = MediaSessionImpl::Get(application_contents_);
  ...
  void HideTab() {
    ...
    ClearMediaSessionStateLoopRunners();
    application_contents_->WasHidden();
  }
 ...
 private:
  ...
  void RunScript(const std::string& script) {
    ASSERT_TRUE(ExecuteScript(application_contents_->GetMainFrame(), script));
  }
  ...
  // MediaRouterIntegrationTests. Move it into a general portal.
