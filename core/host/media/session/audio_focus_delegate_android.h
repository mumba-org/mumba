...
#ifndef MUMBA_HOST_MEDIA_SESSION_AUDIO_FOCUS_DELEGATE_ANDROID_H_
#define MUMBA_HOST_MEDIA_SESSION_AUDIO_FOCUS_DELEGATE_ANDROID_H_
...
#endif  // MUMBA_HOST_MEDIA_SESSION_AUDIO_FOCUS_DELEGATE_ANDROID_H_
