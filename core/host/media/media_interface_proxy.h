...
#ifndef MUMBA_HOST_MEDIA_MEDIA_INTERFACE_PROXY_H_
#define MUMBA_HOST_MEDIA_MEDIA_INTERFACE_PROXY_H_
...
class MediaInterfaceProxy final : public media::mojom::InterfaceFactory {
 public:
  ...
  MediaInterfaceProxy(ApplicationWindowHost* app_window_host,
 ...
 private:
  ...
  ApplicationWindowHost* const application_window_host_;
...
#endif  // MUMBA_HOST_MEDIA_MEDIA_INTERFACE_PROXY_H_
