...
static const ApplicationContents* WEB_CONTENTS_0 = reinterpret_cast<ApplicationContents*>(0x00);
static const ApplicationContents* WEB_CONTENTS_1 = reinterpret_cast<ApplicationContents*>(0x01);
static const ApplicationContents* WEB_CONTENTS_2 = reinterpret_cast<ApplicationContents*>(0x10);
static const ApplicationContents* WEB_CONTENTS_3 = reinterpret_cast<ApplicationContents*>(0x11);
...
TEST_F(AudibleMetricsTest, AudibleStart) {
  audible_metrics()->UpdateAudibleApplicationContentsState(WEB_CONTENTS_0, true);
...
TEST_F(AudibleMetricsTest, AudibleStartAndStop) {
  audible_metrics()->UpdateAudibleApplicationContentsState(WEB_CONTENTS_0, true);
  audible_metrics()->UpdateAudibleApplicationContentsState(WEB_CONTENTS_0, false);
...
TEST_F(AudibleMetricsTest, ConcurrentTabsInSessionIsIncremental) {
  audible_metrics()->UpdateAudibleApplicationContentsState(WEB_CONTENTS_0, true);
  audible_metrics()->UpdateAudibleApplicationContentsState(WEB_CONTENTS_1, true);
  audible_metrics()->UpdateAudibleApplicationContentsState(WEB_CONTENTS_2, true);
  audible_metrics()->UpdateAudibleApplicationContentsState(WEB_CONTENTS_3, true);
...
TEST_F(AudibleMetricsTest, ConcurrentTabsInSessionKeepTrackOfRemovedTabs) {
  ...
  audible_metrics()->UpdateAudibleApplicationContentsState(WEB_CONTENTS_1, true);
  audible_metrics()->UpdateAudibleApplicationContentsState(WEB_CONTENTS_2, true);
  audible_metrics()->UpdateAudibleApplicationContentsState(WEB_CONTENTS_1, false);
  audible_metrics()->UpdateAudibleApplicationContentsState(WEB_CONTENTS_2, false);
  audible_metrics()->UpdateAudibleApplicationContentsState(WEB_CONTENTS_3, true);
...
TEST_F(AudibleMetricsTest, ConcurrentTabsInSessionIsNotCountedTwice) {
  ...
  audible_metrics()->UpdateAudibleApplicationContentsState(WEB_CONTENTS_1, false);
  audible_metrics()->UpdateAudibleApplicationContentsState(WEB_CONTENTS_2, false);
  audible_metrics()->UpdateAudibleApplicationContentsState(WEB_CONTENTS_3, false);
