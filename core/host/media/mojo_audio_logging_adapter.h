...
#ifndef MUMBA_HOST_MEDIA_MOJO_AUDIO_LOGGING_ADAPTER_H_
#define MUMBA_HOST_MEDIA_MOJO_AUDIO_LOGGING_ADAPTER_H_
...
#endif  // MUMBA_HOST_MEDIA_MOJO_AUDIO_LOGGING_ADAPTER_H_
