...
#include "core/host/media/media_browsertest.h"
...
// When mojo CDM is enabled, External Clear Key is supported in //content/domain/
...
#define SUPPORTS_EXTERNAL_CLEAR_KEY_IN_CONTENT_DOMAIN
#endif
...
#if defined(SUPPORTS_EXTERNAL_CLEAR_KEY_IN_CONTENT_DOMAIN)
