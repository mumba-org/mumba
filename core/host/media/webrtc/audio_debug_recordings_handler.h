...
class AudioDebugRecordingsHandler
 ...
 public:
  ...
  // of |callback|.
  void StartAudioDebugRecordings(ApplicationProcessHost* host,
  ...
  // of |callback|.
  void StopAudioDebugRecordings(ApplicationProcessHost* host,
                                const RecordingDoneCallback& callback,
                                const RecordingErrorCallback& error_callback);
 ...
 private:
  ...
  void DoStartAudioDebugRecordings(ApplicationProcessHost* host,
                                   base::TimeDelta delay,
                                   const RecordingDoneCallback& callback,
                                   const RecordingErrorCallback& error_callback,
  ...
  void DoStopAudioDebugRecordings(ApplicationProcessHost* host,
                                  bool is_manual_stop,
