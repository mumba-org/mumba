...
#include "core/host/media/webrtc/rtp_dump_type.h"
#include "core/host/media/webrtc/webrtc_text_log_handler.h"
...
class WebRtcLoggingHandlerHost : public content::BrowserMessageFilter {
 ...
 private:
  ...
  ApplicationProcessHost::WebRtcStopRtpDumpCallback stop_rtp_dump_callback_;
