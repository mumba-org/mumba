...
#include "core/host/media/webrtc/webrtc_event_log_manager_common.h"
#include "core/host/media/webrtc/webrtc_event_log_manager_local.h"
#include "core/host/media/webrtc/webrtc_event_log_manager_remote.h"
#include "core/host/render_process_host_observer.h"
...
// execute.
class WebRtcEventLogManager final : public ApplicationProcessHostObserver,
 ...
 public:
  ...
  // posted back to HostThread::UI with the return value provided by
  ...
  // If a reply callback is given, it will be posted back to HostThread::UI
 ...
 private:
  ...
  // ApplicationProcessHostObserver implementation.
  void RenderProcessExited(
      ApplicationProcessHost* host,
      const content::ChildProcessTerminationInfo& info) override;
  void ApplicationProcessHostDestroyed(ApplicationProcessHost* host) override;

  // RenderProcessExited() and ApplicationProcessHostDestroyed() treated similarly
  // by this function.
  void ApplicationProcessHostExitedDestroyed(ApplicationProcessHost* host);
  ...
  // Non-empty replies get posted to HostThread::UI.
  ...
  // The set of ApplicationProcessHosts with which the manager is registered for
  ...
  base::flat_set<ApplicationProcessHost*> observed_render_process_hosts_;
