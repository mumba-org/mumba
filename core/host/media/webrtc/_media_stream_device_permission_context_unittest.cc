...
#include "core/host/media/webrtc/media_stream_device_permission_context.h"
...
#if defined(OS_ANDROID)
    InfoBarService::CreateForApplicationContents(web_contents());
#else
    PermissionRequestManager::CreateForApplicationContents(web_contents());
#endif
  }
