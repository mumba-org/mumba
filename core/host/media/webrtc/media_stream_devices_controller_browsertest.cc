...
class MediaStreamDevicesControllerTest : public WebRtcTestBase {
 ...
 protected:
  ...
  TabSpecificContentSettings* GetContentSettings() {
    return TabSpecificContentSettings::FromApplicationContents(GetApplicationContents());
  }
  ...
  void RequestPermissions(ApplicationContents* web_contents,
  ...
  void SetDevicePolicy(DeviceType device_type, Access access) {
    PrefService* prefs = Profile::FromBrowserContext(
        GetApplicationContents()->GetBrowserContext())->GetPrefs();
  ...
  void SetContentSettings(ContentSetting mic_setting,
    ...
    HostContentSettingsMap* content_settings =
        HostContentSettingsMapFactory::GetForProfile(
            Profile::FromBrowserContext(GetApplicationContents()->GetBrowserContext()));
  ...
  content::MediaStreamRequest CreateRequestWithType(
    ...
    EXPECT_EQ(example_url(),
              GetApplicationContents()->GetMainFrame()->GetLastCommittedURL());
    int render_process_id =
        GetApplicationContents()->GetMainFrame()->GetProcess()->GetID();
    int render_frame_id = GetApplicationContents()->GetMainFrame()->GetRoutingID();
 ...
 private:
  void SetUpOnMainThread() override {
    ...
    PermissionRequestManager* manager =
        PermissionRequestManager::FromApplicationContents(
...
IN_PROC_BROWSER_TEST_F(MediaStreamDevicesControllerTest, RequestAndAllowMic) {
  ...
  RequestPermissions(
      GetApplicationContents(), CreateRequest(example_audio_id(), std::string()),
...
IN_PROC_BROWSER_TEST_F(MediaStreamDevicesControllerTest, RequestAndAllowCam) {
  ...
  prompt_factory()->set_response_type(PermissionRequestManager::ACCEPT_ALL);
  RequestPermissions(
      GetApplicationContents(), CreateRequest(std::string(), example_video_id()),
      base::Bind(&MediaStreamDevicesControllerTest::OnMediaStreamResponse,
                 base::Unretained(this)));
...
IN_PROC_BROWSER_TEST_F(MediaStreamDevicesControllerTest,
  ...
  prompt_factory()->set_response_type(PermissionRequestManager::ACCEPT_ALL);
  RequestPermissions(
      GetApplicationContents(), CreateRequest(example_audio_id(), example_video_id()),
      base::Bind(&MediaStreamDevicesControllerTest::OnMediaStreamResponse,
                 base::Unretained(this)));
...
IN_PROC_BROWSER_TEST_F(MediaStreamDevicesControllerTest,
  ...
  std::unique_ptr<content::MediaStreamUI> video_stream_ui =
      dispatcher->GetMediaStreamCaptureIndicator()->RegisterMediaStream(
          GetApplicationContents(), video_devices);
...
IN_PROC_BROWSER_TEST_F(MediaStreamDevicesControllerTest, ApplicationContentsDestroyed) {
  InitWithUrl(GURL("http://www.example.com"));
...
IN_PROC_BROWSER_TEST_F(MediaStreamDevicesControllerTest,
  ...
  content::NavigateIframeToURL(GetApplicationContents(), "test",
                               GURL(cross_origin_url));
  content::RenderFrameHost* child_frame =
      ChildFrameAt(GetApplicationContents()->GetMainFrame(), 0);
  ...
  RequestPermissions(
      GetApplicationContents(), request,
      base::Bind(&MediaStreamDevicesControllerTest::OnMediaStreamResponse,
                 base::Unretained(this)));
