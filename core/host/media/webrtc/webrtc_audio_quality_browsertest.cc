...
#include "core/host/media/webrtc/webrtc_browsertest_audio.h"
...
class MAYBE_WebRtcAudioQualityBrowserTest : public WebRtcTestBase {
 public:
  ...
  void PlayAudioFileThroughWebAudio(ApplicationContents* tab_contents) {
    EXPECT_EQ("ok-playing", ExecuteJavascript("playAudioFile()", tab_contents));
  }

  ApplicationContents* OpenPageWithoutGetUserMedia(const char* url) {
