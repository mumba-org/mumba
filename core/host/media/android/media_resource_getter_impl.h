...
#ifndef MUMBA_HOST_MEDIA_ANDROID_MEDIA_RESOURCE_GETTER_IMPL_H_
#define MUMBA_HOST_MEDIA_ANDROID_MEDIA_RESOURCE_GETTER_IMPL_H_
...
#endif  // MUMBA_HOST_MEDIA_ANDROID_MEDIA_RESOURCE_GETTER_IMPL_H_
