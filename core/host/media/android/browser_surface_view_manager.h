...
#ifndef MUMBA_HOST_MEDIA_ANDROID_BROWSER_SURFACE_VIEW_MANAGER_H_
#define MUMBA_HOST_MEDIA_ANDROID_BROWSER_SURFACE_VIEW_MANAGER_H_
...
#endif  // MUMBA_HOST_MEDIA_ANDROID_BROWSER_SURFACE_VIEW_MANAGER_H_
