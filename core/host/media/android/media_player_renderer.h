...
#ifndef MUMBA_HOST_MEDIA_ANDROID_MEDIA_PLAYER_RENDERER_H_
#define MUMBA_HOST_MEDIA_ANDROID_MEDIA_PLAYER_RENDERER_H_
...
class CONTENT_EXPORT MediaPlayerRenderer : public media::Renderer,
 ...
 public:
  ...
  void OnApplicationContentsDestroyed();
 ...
 private:
  ...
  bool application_contents_muted_;
  MediaPlayerRendererApplicationContentsObserver* application_contents_observer_;
  float volume_;
...
#endif  // MUMBA_HOST_MEDIA_ANDROID_MEDIA_PLAYER_RENDERER_H_
