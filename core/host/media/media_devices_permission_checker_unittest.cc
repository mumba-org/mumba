...
#include "core/common/media_stream_request.h"
...
class TestApplicationContentsDelegate : public content::ApplicationContentsDelegate {
 public:
  ~TestApplicationContentsDelegate() override {}
...
class MediaDevicesPermissionCheckerTest : public ApplicationWindowHostImplTestHarness {
 public:
 ...
 private:
  ...
  TestApplicationContentsDelegate delegate_;
};
