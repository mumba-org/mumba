...
#include "core/host/background_sync/background_sync.pb.h"
#include "core/host/background_sync/background_sync_registration.h"
#include "core/host/background_sync/background_sync_status.h"
...
#include "core/host/background_sync_parameters.h"
...
class CONTENT_EXPORT BackgroundSyncManager
 ...
 private:
  ...
  common::ServiceWorkerStatusCode CanEmulateSyncEvent(
      scoped_refptr<ServiceWorkerVersion> active_version);
