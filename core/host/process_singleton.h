...
// ProcessSingleton ----------------------------------------------------------
//
// This class allows different host processes to communicate with
...
class ProcessSingleton {
 public:
  ...
  // handled within the current host instance or false if the remote process
...
#endif
#if defined(OS_WIN)
  // Called to query whether to kill a hung host process that has visible
 ...
 private:
  ...
  HWND remote_window_;  // The HWND_MESSAGE of another host.
