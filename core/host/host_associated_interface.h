...
// thread. Subclassess of HostMessageFilter may use this to simplify
// the transition to Mojo interfaces.
//
// In general the correct pattern for using this is as follows:
//
//   class FooMessageFilter : public HostMessageFilter,
//                            public HostAssociatedInterface<mojom::Foo>,
//                            public mojom::Foo {
//    public:
//     FooMessageFilter()
//         : HostMessageFilter(FooMsgStart),
//           HostAssociatedInterface<mojom::Foo>(this, this) {}
//
...
//
// See HostAssociatedInterfaceTest.Basic for a simple working example usage.
template <typename Interface>
class HostAssociatedInterface {
 public:
  // |filter| and |impl| must live at least as long as this object.
  HostAssociatedInterface(HostMessageFilter* filter, Interface* impl)
  ...
  ~HostAssociatedInterface() { internal_state_->ClearBindings(); }
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(HostAssociatedInterface);
};
