...
#include "core/host/ui/status_icons/status_tray_win.h"
...
#include "core/host/ui/status_icons/status_icon_win.h"
#include "core/host/ui/status_icons/status_tray_state_changer_win.h"
...
StatusTrayWin::StatusTrayWin()
  ...
  base::win::InitializeWindowClass(
      constants::kStatusTrayWindowClass,
...
LRESULT CALLBACK StatusTrayWin::WndProc(HWND hwnd,
  ...
  if (message == taskbar_created_message_) {
    ...
    // fashion.
    LOG(INFO) << "status tray -> WM_ENDSESSION. Should be calling chrome::SessionEnding() but its disabled";
