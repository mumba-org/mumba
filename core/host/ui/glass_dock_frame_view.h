...
#include "core/host/ui/windows_10_caption_button.h"
...
class GlassDockFrameView : public DockNonClientFrameView,
 ...
 public:
  ...
  static constexpr char kClassName[] = "GlassDockFrameView";

  static SkColor GetReadableFeatureColor(SkColor background_color);

  // Constructs a non-client view for an DockFrame.
  GlassDockFrameView(DockFrame* frame, DockWindow* browser_view);
  ~GlassDockFrameView() override;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(GlassDockFrameView);
};
