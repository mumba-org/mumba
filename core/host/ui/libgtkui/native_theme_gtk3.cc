...
#include "core/host/ui/libgtkui/native_theme_gtk3.h"

#include <gtk/gtk.h>

#include "core/host/ui/libgtkui/chrome_gtk_frame.h"
#include "core/host/ui/libgtkui/chrome_gtk_menu_subclasses.h"
...
void NativeThemeGtk3::PaintMenuSeparator(
  ...
  DLOG(INFO) << "NativeThemeGtk3::PaintMenuSeparator";
