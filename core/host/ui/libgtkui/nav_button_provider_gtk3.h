...
#include "core/host/ui/libgtkui/libgtkui_export.h"
...
class LIBGTKUI_EXPORT NavButtonProviderGtk3 : public views::NavButtonProvider {
 public:
  ...
  gfx::ImageSkia GetImage(host::FrameButtonDisplayType type,
                          views::Button::ButtonState state) const override;
  gfx::Insets GetNavButtonMargin(
      host::FrameButtonDisplayType type) const override;
 ...
 private:
  std::map<host::FrameButtonDisplayType,
           gfx::ImageSkia[views::Button::STATE_COUNT]>
      button_images_;
  std::map<host::FrameButtonDisplayType, gfx::Insets> button_margins_;
