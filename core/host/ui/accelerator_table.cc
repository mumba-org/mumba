...
#if !defined(OS_MAC)
    //{ui::VKEY_D, ui::EF_NONE, IDC_BOOKMARK_THIS_TAB},
    {ui::VKEY_D, ui::EF_SHIFT_DOWN | ui::EF_NONE,
     IDC_BOOKMARK_ALL_TABS},
    {ui::VKEY_W, ui::EF_NONE, IDC_CLOSE_TAB},
    {ui::VKEY_W, ui::EF_SHIFT_DOWN | ui::EF_NONE,
     IDC_CLOSE_WINDOW},
    {ui::VKEY_F, ui::EF_NONE, IDC_FIND},
    //{ui::VKEY_A, ui::EF_SHIFT_DOWN | ui::EF_NONE,
    // IDC_TAB_SEARCH},
    {ui::VKEY_G, ui::EF_NONE, IDC_FIND_NEXT},
    {ui::VKEY_G, ui::EF_SHIFT_DOWN | ui::EF_NONE,
     IDC_FIND_PREVIOUS},
    {ui::VKEY_L, ui::EF_NONE, IDC_FOCUS_LOCATION},
    {ui::VKEY_O, ui::EF_NONE, IDC_OPEN_FILE},
    {ui::VKEY_P, ui::EF_NONE, IDC_PRINT},
    {ui::VKEY_R, ui::EF_NONE, IDC_RELOAD},
    {ui::VKEY_R, ui::EF_SHIFT_DOWN | ui::EF_NONE,
     IDC_RELOAD_BYPASSING_CACHE},
    {ui::VKEY_S, ui::EF_NONE, IDC_SAVE_PAGE},
    {ui::VKEY_9, ui::EF_NONE, IDC_SELECT_LAST_TAB},
    {ui::VKEY_NUMPAD9, ui::EF_NONE, IDC_SELECT_LAST_TAB},
...
// of lacros-chrome is complete.
    ...
    {ui::VKEY_1, ui::EF_NONE, IDC_SELECT_TAB_0},
    {ui::VKEY_NUMPAD1, ui::EF_NONE, IDC_SELECT_TAB_0},
    {ui::VKEY_2, ui::EF_NONE, IDC_SELECT_TAB_1},
    {ui::VKEY_NUMPAD2, ui::EF_NONE, IDC_SELECT_TAB_1},
    {ui::VKEY_3, ui::EF_NONE, IDC_SELECT_TAB_2},
    {ui::VKEY_NUMPAD3, ui::EF_NONE, IDC_SELECT_TAB_2},
    {ui::VKEY_4, ui::EF_NONE, IDC_SELECT_TAB_3},
    {ui::VKEY_NUMPAD4, ui::EF_NONE, IDC_SELECT_TAB_3},
    {ui::VKEY_5, ui::EF_NONE, IDC_SELECT_TAB_4},
    {ui::VKEY_NUMPAD5, ui::EF_NONE, IDC_SELECT_TAB_4},
    {ui::VKEY_6, ui::EF_NONE, IDC_SELECT_TAB_5},
    {ui::VKEY_NUMPAD6, ui::EF_NONE, IDC_SELECT_TAB_5},
    {ui::VKEY_7, ui::EF_NONE, IDC_SELECT_TAB_6},
    {ui::VKEY_NUMPAD7, ui::EF_NONE, IDC_SELECT_TAB_6},
    {ui::VKEY_8, ui::EF_NONE, IDC_SELECT_TAB_7},
    {ui::VKEY_NUMPAD8, ui::EF_NONE, IDC_SELECT_TAB_7},
// TODO(crbug.com/1052397): Revisit the macro expression once build flag switch
// of lacros-chrome is complete.
#if defined(OS_LINUX)
    ...
    {ui::VKEY_B, ui::EF_SHIFT_DOWN | ui::EF_NONE,
     IDC_SHOW_BOOKMARK_BAR},
    {ui::VKEY_OEM_MINUS, ui::EF_NONE, IDC_ZOOM_MINUS},
    {ui::VKEY_SUBTRACT, ui::EF_NONE, IDC_ZOOM_MINUS},
    {ui::VKEY_0, ui::EF_NONE, IDC_ZOOM_NORMAL},
    {ui::VKEY_NUMPAD0, ui::EF_NONE, IDC_ZOOM_NORMAL},
    {ui::VKEY_OEM_PLUS, ui::EF_NONE, IDC_ZOOM_PLUS},
    {ui::VKEY_ADD, ui::EF_NONE, IDC_ZOOM_PLUS},
    ...
    {ui::VKEY_M, ui::EF_SHIFT_DOWN | ui::EF_NONE,
...
// Platform-specific key maps.
   ...
   // {ui::VKEY_I, ui::EF_SHIFT_DOWN | ui::EF_ALT_DOWN, IDC_FEEDBACK},
    {ui::VKEY_N, ui::EF_SHIFT_DOWN | ui::EF_NONE,
     IDC_NEW_INCOGNITO_WINDOW},
    {ui::VKEY_T, ui::EF_NONE, IDC_NEW_TAB},
    {ui::VKEY_N, ui::EF_NONE, IDC_NEW_WINDOW},
    {ui::VKEY_T, ui::EF_SHIFT_DOWN | ui::EF_NONE,
     IDC_RESTORE_TAB},
...
bool GetStandardAcceleratorForCommandId(int command_id,
  ...
  switch (command_id) {
    case IDC_CUT:
      *accelerator = ui::Accelerator(ui::VKEY_X, ui::EF_NONE);
      return true;
    case IDC_COPY:
      *accelerator = ui::Accelerator(ui::VKEY_C, ui::EF_NONE);
      return true;
    case IDC_PASTE:
      *accelerator = ui::Accelerator(ui::VKEY_V, ui::EF_NONE);
      return true;
  }
  return false;
#endif
