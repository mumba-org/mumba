...
class TabUIHelper : public ApplicationContentsObserver,
                    public ApplicationContentsUserData<TabUIHelper> {
 public:
 ...
 private:
  friend class ApplicationContentsUserData<TabUIHelper>;
  ...
  explicit TabUIHelper(ApplicationContents* contents);
