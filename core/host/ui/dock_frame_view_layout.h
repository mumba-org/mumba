...
#ifndef MUMBA_HOST_UI_WINDOW_HOST_FRAME_VIEW_LAYOUT_H_
#define MUMBA_HOST_UI_WINDOW_HOST_FRAME_VIEW_LAYOUT_H_

#include "base/macros.h"
#include "core/host/ui/frame_button_display_types.h"
...
class DockFrameViewLayout : public views::LayoutManager {
 public:
  ...
  DockFrameViewLayout();
  ~DockFrameViewLayout() override;

  void set_delegate(DockFrameViewLayoutDelegate* delegate) {
    delegate_ = delegate;
  }
  ...
  int GetTablistInsetsTop(bool restored) const;
  ...
  virtual int CaptionButtonY(FrameButtonDisplayType button_id,
                             bool restored) const;
  ...
  FrameButtonDisplayType GetButtonDisplayType(
 ...
 protected:
  ...
  DockFrameViewLayoutDelegate* delegate_;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(DockFrameViewLayout);
};
