...
class ExclusiveAccessContext {
 public:
  ...
  virtual scoped_refptr<Workspace> GetWorkspace() = 0;
...
//  virtual void UpdateFullscreenToolbar();
  ...
  // Returns the currently active ApplicationContents, or nullptr if there is none.
  virtual ApplicationContents* GetActiveApplicationContents() = 0;
