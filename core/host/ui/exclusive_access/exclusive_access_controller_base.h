...
// exclusively.
class ExclusiveAccessControllerBase : public NotificationObserver {
 public:
  ...
  ApplicationContents* exclusive_access_tab() const {
  ...
  virtual void OnTabDeactivated(ApplicationContents* application_contents);
  virtual void OnTabDetachedFromView(ApplicationContents* application_contents);
  virtual void OnTabClosing(ApplicationContents* application_contents);
 ...
 protected:
  void SetTabWithExclusiveAccess(ApplicationContents* tab);
 ...
 private:
  ...
  ApplicationContents* tab_with_exclusive_access_ = nullptr;
