...
class FullscreenWithinTabHelper
    : public ApplicationContentsUserData<FullscreenWithinTabHelper> {
 public:
  ...
  static void RemoveForApplicationContents(ApplicationContents* app_contents);

 private:
  friend class ApplicationContentsUserData<FullscreenWithinTabHelper>;
  explicit FullscreenWithinTabHelper(ApplicationContents* ignored);
