...
//#include "core/common/chrome_switches.h"
...
void ExclusiveAccessManager::OnTabDeactivated(ApplicationContents* application_contents) {
  fullscreen_controller_.OnTabDeactivated(application_contents);
  keyboard_lock_controller_.OnTabDeactivated(application_contents);
  mouse_lock_controller_.OnTabDeactivated(application_contents);
}

void ExclusiveAccessManager::OnTabDetachedFromView(ApplicationContents* application_contents) {
  fullscreen_controller_.OnTabDetachedFromView(application_contents);
  keyboard_lock_controller_.OnTabDetachedFromView(application_contents);
  mouse_lock_controller_.OnTabDetachedFromView(application_contents);
}

void ExclusiveAccessManager::OnTabClosing(ApplicationContents* application_contents) {
  fullscreen_controller_.OnTabClosing(application_contents);
  keyboard_lock_controller_.OnTabClosing(application_contents);
  mouse_lock_controller_.OnTabClosing(application_contents);
}
