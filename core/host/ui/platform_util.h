...
// |workspace| is used to determine the running workspace of file manager app in
// Chrome OS only. |workspace| is not used in platforms other than Chrome OS. Must
