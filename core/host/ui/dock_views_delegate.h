...
#ifndef MUMBA_HOST_UI_WINDOW_VIEWS_DELEGATE_H_
#define MUMBA_HOST_UI_WINDOW_VIEWS_DELEGATE_H_
...
class DockViewsDelegate : public views::ViewsDelegate {
 public:
  DockViewsDelegate();
  ~DockViewsDelegate() override;
 ...
 private:
  ...
  // |DockViewsDelegate| exposes a |RefCounted|-like interface, but //chrome
  ...
  base::WeakPtrFactory<DockViewsDelegate> weak_factory_{this};
#endif

  DISALLOW_COPY_AND_ASSIGN(DockViewsDelegate);
};
