...
CONTENT_EXPORT std::vector<AcceleratorMapping> GetAcceleratorList();
...
// second argument.
CONTENT_EXPORT bool GetAshAcceleratorForCommandId(
    int command_id,
...
CONTENT_EXPORT bool GetStandardAcceleratorForCommandId(
    int command_id,
    ui::Accelerator* accelerator);
...
CONTENT_EXPORT bool IsCommandRepeatable(int command_id);
