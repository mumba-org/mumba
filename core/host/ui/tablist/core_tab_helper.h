...
//#include "core/common/chrome_render_frame.mojom.h"
...
class CoreTabHelper : public ApplicationContentsObserver,
                      public ApplicationContentsUserData<CoreTabHelper> {
 public:
  ...
  // the image resources.
  void SearchByImageInNewTab(ApplicationWindowHost* render_frame_host,
                             const GURL& src_url);
 ...
 private:
  explicit CoreTabHelper(ApplicationContents* app_contents);
  friend class ApplicationContentsUserData<CoreTabHelper>;

  static bool GetStatusTextForApplicationContents(base::string16* status_text,
  ...
  // before we created this ApplicationContents.
  base::TimeTicks new_tab_start_time_;

  // The time that we started to close this ApplicationContents.
