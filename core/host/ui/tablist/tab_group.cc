...
#include "core/host/ui/tablist/tab_group.h"
...
//#include "core/host/ui/tablist/tab_ui_helper.h"
#include "core/host/ui/tablist/tab_group_controller.h"
...
base::string16 TabGroup::GetContentString() const {
  ...
  //     controller_->GetApplicationsContentsAt(tabs_in_group.start()));
