...
#include "core/host/ui/dock_tablist.h"

#include "base/command_line.h"
#include "core/host/profiles/profile.h"
#include "core/host/ui/dock.h"
#include "core/host/ui/dock_navigator.h"
#include "core/host/ui/dock_navigator_params.h"
...
void AddTabAt(Dock* dock, const GURL& url, int idx, bool foreground) {
...
void AddApplicationContents(Dock* dock,
...
void CloseApplicationContents(Dock* dock,
                      ...
                      bool add_to_history) {
  int index = dock->tab_strip_model()->GetIndexOfApplicationContents(contents);
  if (index == TabStripModel::kNoTab) {
    NOTREACHED() << "CloseApplicationContents called for tab not in our strip";
    return;
  }

  dock->tab_strip_model()->CloseApplicationContentsAt(
      index,
