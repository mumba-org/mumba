...
#ifndef MUMBA_HOST_SCREEN_ORIENTATION_SCREEN_ORIENTATION_PROVIDER_H_
#define MUMBA_HOST_SCREEN_ORIENTATION_SCREEN_ORIENTATION_PROVIDER_H_
...
class CONTENT_EXPORT ScreenOrientationProvider
 ...
 public:
  ScreenOrientationProvider(ApplicationContents* app_contents);
 ...
 private:
  ...
  ApplicationContentsWindowBindingSet<device::mojom::ScreenOrientation> bindings_;
