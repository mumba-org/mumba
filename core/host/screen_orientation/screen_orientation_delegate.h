...
class CONTENT_EXPORT ScreenOrientationDelegate {
 public:
  ...
  virtual bool FullScreenRequired(ApplicationContents* app_contents) = 0;

  // Lock display to the given orientation.
  virtual void Lock(ApplicationContents* app_contents,
  ...
  virtual void Unlock(ApplicationContents* app_contents) = 0;
