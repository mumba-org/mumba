...
bool IsTlsClientSocket(common::P2PSocketType type) {
  return (type == common::P2P_SOCKET_STUN_TLS_CLIENT ||
          type == common::P2P_SOCKET_TLS_CLIENT);
}

bool IsPseudoTlsClientSocket(common::P2PSocketType type) {
  return (type == common::P2P_SOCKET_SSLTCP_CLIENT ||
...
bool P2PSocketHostTcpBase::InitAccepted(
  ...
  DLOG(INFO) << "P2PSocketHostTcpBase::InitAccepted";
...
bool P2PSocketHostTcpBase::Init(const common::P2PSocketOptions& options) {
  DCHECK_EQ(state_, STATE_UNINITIALIZED);
  DLOG(INFO) << "P2PSocketHostTcpBase::Init";
...
void P2PSocketHostTcpBase::OnConnected(int result) {
  DLOG(INFO) << "P2PSocketHostTcpBase::OnConnected";
...
void P2PSocketHostTcpBase::DoRead() {
  DLOG(INFO) << "P2PSocketHostTcpBase::DoRead";
  int result;
  do {
    if (!read_buffer_.get()) {
...
void P2PSocketHostTcpBase::OnRead(int result) {
  DLOG(INFO) << "P2PSocketHostTcpBase::OnRead";
...
void P2PSocketHostTcpBase::OnPacket(const std::vector<char>& data) {
  DLOG(INFO) << "P2PSocketHostTcpBase::OnPacket";
  if (!connected_) {
  ...
  DLOG(INFO) << "sending P2PMsg_OnDataReceived..";
...
void P2PSocketHostTcpBase::ReceiveRpcMessage(int call_id, int method_type) {}
void P2PSocketHostTcpBase::SendRpcMessage(int call_id, int method_type, std::vector<char> data) {}
void P2PSocketHostTcpBase::SendRpcMessageNow(int call_id, int method_type, std::vector<char> data) {}
void P2PSocketHostTcpBase::SendRpcStatus(int call_id, int status_code) {}
...
void P2PSocketHostTcpBase::DidCompleteRead(int result) {
  DCHECK_EQ(state_, STATE_OPEN);
  DLOG(INFO) << "P2PSocketHostTcpBase::DidCompleteRead";
...
bool P2PSocketHostTcpBase::SetOption(common::P2PSocketOption option, int value) {
  if (state_ != STATE_OPEN) {
...
P2PSocketHostTcp::P2PSocketHostTcp(
    ...
    net::URLRequestContextGetter* url_context,
    network::ProxyResolvingClientSocketFactory* proxy_resolving_socket_factory)
    : P2PSocketHostTcpBase(delegate, message_sender,
                           socket_id,
                           type,
                           url_context,
                           proxy_resolving_socket_factory) {
  DCHECK(type == common::P2P_SOCKET_TCP_CLIENT ||
...
int P2PSocketHostTcp::ProcessInput(char* input, int input_len) {
  DLOG(INFO) << "P2PSocketHostTcp::ProcessInput";
...
P2PSocketHostStunTcp::P2PSocketHostStunTcp(
    ...
    net::URLRequestContextGetter* url_context,
    network::ProxyResolvingClientSocketFactory* proxy_resolving_socket_factory)
    : P2PSocketHostTcpBase(delegate,
                           std::move(message_sender),
                           socket_id,
                           type,
                           url_context,
                           proxy_resolving_socket_factory) {
  DCHECK(type == common::P2P_SOCKET_STUN_TCP_CLIENT ||
         type == common::P2P_SOCKET_STUN_SSLTCP_CLIENT ||
