...
P2PSocketHost::P2PSocketHost(Delegate* delegate,
...
P2PSocketHost* P2PSocketHost::Create(
  ...
  switch (type) {
    case common::P2P_SOCKET_UDP:
      return new P2PSocketHostUdp(
          delegate,
          std::move(message_sender), socket_id, throttler,
          url_context->GetURLRequestContext()->net_log());
    case common::P2P_SOCKET_TCP_SERVER:
      return new P2PSocketHostTcpServer(
          delegate,
          std::move(message_sender), socket_id, common::P2P_SOCKET_TCP_CLIENT);

    case common::P2P_SOCKET_STUN_TCP_SERVER:
      return new P2PSocketHostTcpServer(
          delegate,
          std::move(message_sender), socket_id, common::P2P_SOCKET_STUN_TCP_CLIENT);

    case common::P2P_SOCKET_TCP_CLIENT:
    case common::P2P_SOCKET_SSLTCP_CLIENT:
    case common::P2P_SOCKET_TLS_CLIENT:
      return new P2PSocketHostTcp(delegate, std::move(message_sender), socket_id, type, url_context,
                                  proxy_resolving_socket_factory);

    case common::P2P_SOCKET_STUN_TCP_CLIENT:
    case common::P2P_SOCKET_STUN_SSLTCP_CLIENT:
    case common::P2P_SOCKET_STUN_TLS_CLIENT:
      return new P2PSocketHostStunTcp(delegate, std::move(message_sender), socket_id, type,
                                      url_context,
                                      proxy_resolving_socket_factory);
    case common::P2P_SOCKET_RPC_CLIENT:
      return new P2PSocketHostRpc(delegate, std::move(message_sender), socket_id,type,
                                  url_context,
                                  proxy_resolving_socket_factory,
                                  task_runner);
    case common::P2P_SOCKET_RPC_SERVER:
      return new P2PSocketHostRpcServer(delegate, std::move(message_sender), socket_id, type);
  }
...
//void P2PSocketHost::set_id(int id) {
//  id_ = id;
//}
