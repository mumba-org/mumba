...
#ifndef MUMBA_HOST_NET_STREAM_CHANNEL_FACTORY_H_
#define MUMBA_HOST_NET_STREAM_CHANNEL_FACTORY_H_
...
class StreamChannelFactory {
 public:
  ...
  // connection fails.
  typedef base::Callback<void(std::unique_ptr<protocol::PeerStreamSocket>)>
