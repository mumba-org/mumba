...
#include "core/host/net/gaia_urls.h"

#include "base/command_line.h"
#include "base/logging.h"
#include "base/strings/stringprintf.h"
//#include "google_apis/gaia/gaia_switches.h"
#include "core/host/net/google_api_keys.h"
...
GaiaUrls::GaiaUrls() {
  google_url_ = GURL(kDefaultGoogleUrl);
  gaia_url_ =  GURL(kDefaultGaiaUrl);
  lso_origin_url_ =  GURL(kDefaultGaiaUrl);
  google_apis_origin_url_ =  GURL(kDefaultGoogleApisBaseUrl);
