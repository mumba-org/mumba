...
#ifndef MUMBA_HOST_NET_LINUX_CERTIFICATE_WATCHER_H_
#define MUMBA_HOST_NET_LINUX_CERTIFICATE_WATCHER_H_
...
class CertificateWatcher : public HostStatusObserver {
 public:
  CertificateWatcher(
