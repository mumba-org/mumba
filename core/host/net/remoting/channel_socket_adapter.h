...
#ifndef MUMBA_HOST_NET_CHANNEL_SOCKET_ADAPTER_H_
#define MUMBA_HOST_NET_CHANNEL_SOCKET_ADAPTER_H_
...
class TransportChannelSocketAdapter : public protocol::PeerDatagramSocket,
