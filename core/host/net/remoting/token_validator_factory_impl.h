...
#ifndef MUMBA_HOST_NET_TOKEN_VALIDATOR_FACTORY_IMPL_H_
#define MUMBA_HOST_NET_TOKEN_VALIDATOR_FACTORY_IMPL_H_
...
#include "core/host/net/token_validator_base.h"
...
// |shared_secret|.
class TokenValidatorFactoryImpl : public TokenValidatorFactory {
 public:
  ...
  std::unique_ptr<TokenValidator> CreateTokenValidator(
