...
#ifndef MUMBA_HOST_NET_ICE_TRANSPORT_CHANNEL_H_
#define MUMBA_HOST_NET_ICE_TRANSPORT_CHANNEL_H_
...
class IceTransportChannel : public sigslot::has_slots<> {
 ...
 private:
  ...
  void OnChannelChange(cricket::IceTransportInternal* ice_transport,
                     const cricket::Candidate& candidate);
