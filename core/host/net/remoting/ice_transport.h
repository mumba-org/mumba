...
#ifndef MUMBA_HOST_NET_ICE_TRANSPORT_H_
#define MUMBA_HOST_NET_ICE_TRANSPORT_H_
...
#include "core/host/net/datagram_channel_factory.h"
#include "core/host/net/ice_transport_channel.h"
#include "core/host/net/jingle_messages.h"
...
class IceTransport : public Transport,
 ...
 public:
  ...
  protocol::MessageChannelFactory* GetChannelFactory();
  protocol::MessageChannelFactory* GetMultiplexedChannelFactory();
 ...
 private:
  ...
  std::unique_ptr<protocol::MessageChannelFactory> message_channel_factory_;

  std::unique_ptr<ChannelMultiplexer> channel_multiplexer_;
  std::unique_ptr<protocol::MessageChannelFactory> mux_channel_factory_;
