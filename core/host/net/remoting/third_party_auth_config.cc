...
bool ThirdPartyAuthConfig::ExtractStrings(
  ...
  ExtractHelper(policy_dict, kRemoteAccessHostTokenUrl,
                &policies_present, token_url);
  ExtractHelper(policy_dict, kRemoteAccessHostTokenValidationUrl,
                &policies_present, token_validation_url);
  ExtractHelper(policy_dict,
                kRemoteAccessHostTokenValidationCertificateIssuer,
