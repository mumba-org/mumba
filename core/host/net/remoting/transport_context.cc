...
#include "core/host/net/url_request.h"
#include "core/host/net/http_ice_config_request.h"
#include "core/host/net/jingle_info_request.h"
...
scoped_refptr<TransportContext> TransportContext::ForTests(TransportRole role) {
  ...
  return new TransportContext(
      nullptr, std::make_unique<ChromiumPortAllocatorFactory>(),
      nullptr,
      NetworkSettings(
