...
#ifndef MUMBA_HOST_NET_PAIRING_REGISTRY_DELEGATE_LINUX_H_
#define MUMBA_HOST_NET_PAIRING_REGISTRY_DELEGATE_LINUX_H_
...
class PairingRegistryDelegateLinux
 ...
 public:
  ...
  PairingRegistry::Pairing Load(
      const std::string& client_id) override;
  bool Save(const PairingRegistry::Pairing& pairing) override;
