...
#include "core/host/net/pseudotcp_adapter.h"
...
#include "core/common/protocol/peer_datagram_socket.h"
...
class PseudoTcpAdapter::Core : public cricket::IPseudoTcpNotify,
 ...
 public:
  explicit Core(std::unique_ptr<protocol::PeerDatagramSocket> socket);
 ...
 private:
  ...
  std::unique_ptr<protocol::PeerDatagramSocket> socket_;
...
PseudoTcpAdapter::Core::Core(std::unique_ptr<protocol::PeerDatagramSocket> socket)
    : pseudo_tcp_(this, 0),
...
PseudoTcpAdapter::PseudoTcpAdapter(std::unique_ptr<protocol::PeerDatagramSocket> socket)
