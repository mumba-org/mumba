...
#ifndef MUMBA_HOST_NET_SSL_HMAC_CHANNEL_AUTHENTICATOR_H_
#define MUMBA_HOST_NET_SSL_HMAC_CHANNEL_AUTHENTICATOR_H_
...
class SslHmacChannelAuthenticator : public ChannelAuthenticator {
 public:
  ...
  void SecureAndAuthenticate(std::unique_ptr<protocol::PeerStreamSocket> socket,
