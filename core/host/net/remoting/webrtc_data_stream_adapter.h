...
#ifndef MUMBA_HOST_NET_WEBRTC_DATA_STREAM_ADAPTER_H_
#define MUMBA_HOST_NET_WEBRTC_DATA_STREAM_ADAPTER_H_
...
class WebrtcDataStreamAdapter : public protocol::MessagePipe,
