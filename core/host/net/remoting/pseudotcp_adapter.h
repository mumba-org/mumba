...
#ifndef MUMBA_HOST_NET_PSEUDOTCP_ADAPTER_H_
#define MUMBA_HOST_NET_PSEUDOTCP_ADAPTER_H_
...
class PseudoTcpAdapter : public protocol::PeerStreamSocket {
 public:
  explicit PseudoTcpAdapter(std::unique_ptr<protocol::PeerDatagramSocket> socket);
