...
#include "core/host/net/negotiating_host_authenticator.h"
#include "core/host/net/rejecting_authenticator.h"
#include "core/host/net/token_validator.h"
#include "core/host/net/jid_util.h"
...
PeerHostAuthenticatorFactory::CreateWithPin(
  ...
  std::unique_ptr<PeerHostAuthenticatorFactory> result(
      new PeerHostAuthenticatorFactory());
...
// static
std::unique_ptr<AuthenticatorFactory>
PeerHostAuthenticatorFactory::CreateWithThirdPartyAuth(
    bool use_service_account,
    const std::string& host_owner,
    const std::string& local_cert,
    scoped_refptr<RsaKeyPair> key_pair,
...
PeerHostAuthenticatorFactory::PeerHostAuthenticatorFactory() = default;

PeerHostAuthenticatorFactory::~PeerHostAuthenticatorFactory() = default;

std::unique_ptr<Authenticator>
PeerHostAuthenticatorFactory::CreateAuthenticator(
