...
#include "core/host/net/jingle_session.h"
...
#include "core/host/net/content_description.h"
#include "core/host/net/jingle_messages.h"
#include "core/host/net/jingle_session_manager.h"
#include "core/host/net/session_config.h"
//#include "core/host/net/session_plugin.h"
...
void JingleSession::Close(ErrorCode error) {
  DCHECK(thread_checker_.CalledOnValidThread());
