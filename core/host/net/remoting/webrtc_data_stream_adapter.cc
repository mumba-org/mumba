...
#include "core/host/net/webrtc_data_stream_adapter.h"
...
void WebrtcDataStreamAdapter::Send(const google::protobuf::MessageLite& message,
...
void WebrtcDataStreamAdapter::OnMessage(const webrtc::DataBuffer& rtc_buffer) {
  ...
  std::unique_ptr<protocol::CompoundBuffer> buffer(new protocol::CompoundBuffer());
