...
#include "core/host/net/server_log_entry_host.h"

#include "base/strings/stringize_macros.h"
#include "core/host/net/host_details.h"
#include "core/host/net/server_log_entry.h"
...
void AddConnectionTypeToLogEntry(ServerLogEntry* entry,
  ...
  entry->Set(kKeyConnectionType, TransportRoute::GetTypeString(type));
}
