...
#ifndef MUMBA_HOST_NET_OAUTH_TOKEN_GETTER_IMPL_H_
#define MUMBA_HOST_NET_OAUTH_TOKEN_GETTER_IMPL_H_
...
#include "core/host/net/gaia_oauth_client.h"
#include "core/host/net/oauth_token_getter.h"
