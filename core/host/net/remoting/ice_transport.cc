...
#include "core/host/net/native_ip_synthesizer.h"
...
protocol::MessageChannelFactory* IceTransport::GetChannelFactory() {
  return message_channel_factory_.get();
}

protocol::MessageChannelFactory* IceTransport::GetMultiplexedChannelFactory() {
