...
#ifndef HEADLESS_PUBLIC_HEADLESS_APPLICATION_CONTENTS_H_
#define HEADLESS_PUBLIC_HEADLESS_APPLICATION_CONTENTS_H_
...
// main thread.
class CONTENT_EXPORT HeadlessApplicationContents {
 public:
  class CONTENT_EXPORT Builder;

  HeadlessApplicationContents(const HeadlessWebContents&) = delete;
  HeadlessApplicationContents& operator=(const HeadlessApplicationContents&) = delete;

  virtual ~HeadlessApplicationContents() {}
  ...
  class CONTENT_EXPORT Observer {
   public:
    ...
    virtual void ApplicationProcessExited(base::TerminationStatus status,
                                          int exit_code) {}

    // Invoked when HeadlessWebContents is being destroyed.
    virtual void HeadlessApplicationContentsDestroyed() {}
 ...
 protected:
  HeadlessApplicationContents() {}
};

class HEADLESS_EXPORT HeadlessApplicationContents::Builder {
 public:
  ...
  HeadlessApplicationContents* Build();

 private:
  friend class HeadlessDock;
  //friend class HeadlessBrowserContextImpl;
  friend class HeadlessApplicationContentsImpl;

  explicit Builder(HeadlessDock* dock);
