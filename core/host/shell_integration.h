...
#ifndef CHROME_BROWSER_DOMAIN_INTEGRATION_H_
#define CHROME_BROWSER_DOMAIN_INTEGRATION_H_
...
// Gets the name of the Chrome Apps menu folder in which to portal app
...
#endif  // CHROME_BROWSER_DOMAIN_INTEGRATION_H_
