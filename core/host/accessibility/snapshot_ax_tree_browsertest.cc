...
IN_PROC_BROWSER_TEST_F(SnapshotAXTreeBrowserTest,
  ...
  application_contents->RequestAXTreeSnapshot(
...
IN_PROC_BROWSER_TEST_F(SnapshotAXTreeBrowserTest,
  ...
  ApplicationContents* application_contents =
      static_cast<ApplicationContents*>(shell()->application_contents());
  FrameTreeNode* root_frame = application_contents->GetFrameTree()->root();
...
IN_PROC_BROWSER_TEST_F(SnapshotAXTreeBrowserTest,
  ...
  ApplicationContents* inner_contents =
      static_cast<ApplicationContents*>(CreateAndAttachInnerContents(
