...
//#include "core/host/accessibility/accessibility_buildflags.h"
...
struct BrowserAccessibilityFindInEntryInfo {
  BrowserAccessibilityFindInEntryInfo();
...
//#if BUILDFLAG(USE_ATK)
  ...
  // Returns true if native focus is anywhere in this ApplicationContents or not.
 ...
 protected:
  ...
  BrowserAccessibilityFindInEntryInfo find_in_page_info_;
