...
std::vector<std::string> DumpAccessibilityEventsTest::Dump() {
  ...
  std::unique_ptr<AccessibilityEventRecorder> event_recorder(
      AccessibilityEventRecorder::Create(
          application_contents->GetRootBrowserAccessibilityManager(), pid));
  ...
  waiter.reset(new AccessibilityNotificationWaiter(
      shell()->application_contents(), ui::kAXModeComplete, ax::mojom::Event::kNone));

  application_contents->GetMainFrame()->ExecuteJavaScriptForTests(
