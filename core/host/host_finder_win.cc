...
#include "core/host/host_finder_win.h"
#include <hostapi.h>
#include <string>
...
NotifyHostResult AttemptToNotifyRunningChrome(HWND remote_window,
 bool fast_start) {
 ...
 /*if (fast_start)
  command_line.AppendMumba(switches::kFastStart);
 */
 ...
 // Allow the current running host window to make itself the foreground
