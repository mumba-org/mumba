...
extern "C" NSString* const kDockThemeDidChangeNotification;
#endif  // __OBJC__
...
class ThemeService : public NotificationObserver {//, public KeyedService {
 public:
  ...
  virtual void Init(scoped_refptr<Workspace> workspace);
  ...
  static const ui::ThemeProvider& GetThemeProviderForWorkspace(scoped_refptr<Workspace> workspace);


  ui::ThemeProvider* GetThemeProvider() {
    return &original_theme_provider_;
  }
 ...
 protected:
  ...
  virtual SkColor GetDefaultColor(int id) const;
 ...
 private:
  ...
  class DockThemeProvider : public ui::ThemeProvider {
   public:
    DockThemeProvider(const ThemeService& theme_service);
    ~DockThemeProvider() override;
   ...
   private:
    ...
    DISALLOW_COPY_AND_ASSIGN(DockThemeProvider);
  };
  friend class DockThemeProvider;
...
//#endif
  ...
  DockThemeProvider original_theme_provider_;
  //DockThemeProvider incognito_theme_provider_;
