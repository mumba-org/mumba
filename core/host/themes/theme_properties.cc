...
constexpr SkColor kDefaultColorNTPBackground = SkColorSetRGB(0x30, 0x30, 0x30);//SK_ColorWHITE;
...
base::Optional<SkColor> MaybeGetDefaultColorForNewerMaterialUi(int id) {
  ...
  switch (id) {
    case ThemeProperties::COLOR_FRAME:
      return kDefaultTouchUiColorActiveFrame;
    case ThemeProperties::COLOR_FRAME_INACTIVE:
      return kDefaultTouchUiColorInactiveFrame;
    case ThemeProperties::COLOR_TOOLBAR:
      return kDefaultTouchUiColorToolbar;
    ...
    case ThemeProperties::COLOR_BACKGROUND_TAB:
      return kDefaultTouchUiColorTabBackgroundInactive;
...
SkColor ThemeProperties::GetDefaultColor(int id) {
  DLOG(INFO) << "ThemeProperties::GetDefaultColor: " << id;
  const base::Optional<SkColor> color =
      MaybeGetDefaultColorForNewerMaterialUi(id);
  if (color)
    return color.value();
  ...
  switch (id) {
    ...
    case COLOR_BOOKMARK_BAR_INSTRUCTIONS_TEXT:
      return kDefaultColorBookmarkInstructionsText;
    ...
    case COLOR_DETACHED_BOOKMARK_BAR_BACKGROUND:
      return kDefaultDetachedBookmarkBarBackground;
    case COLOR_TOOLBAR_BOTTOM_SEPARATOR:
      return kDefaultToolbarBottomSeparator;
    ...
    case COLOR_FRAME_VIBRANCY_OVERLAY:
      return kDefaultColorFrameVibrancyOverlay;
    case COLOR_TOOLBAR_INACTIVE:
      return kDefaultColorToolbarInactive;
    case COLOR_BACKGROUND_TAB_INACTIVE:
      return kDefaultColorTabBackgroundInactive;
