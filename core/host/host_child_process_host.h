...
#include "core/host/child_process_termination_info.h"
...
// This represents child processes of the host process, i.e. plugins. They
// will get terminated at host shutdown.
class CONTENT_EXPORT HostChildProcessHost : public IPC::Sender {
 public:
  ...
  static HostChildProcessHost* Create(
  ...
  static HostChildProcessHost* FromID(int child_process_id);

  ~HostChildProcessHost() override {}
  ...
  virtual common::ChildProcessHost* GetHost() const = 0;
  ...
  // Set the handle of the process. HostChildProcessHost will do this when
