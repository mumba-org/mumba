...
#ifndef MUMBA_HOST_APPLICATION_OVERSCROLL_CONTROLLER_H_
#define MUMBA_HOST_APPLICATION_OVERSCROLL_CONTROLLER_H_
...
class ApplicationWindowHostViewAuraOverscrollTest;
...
class CONTENT_EXPORT OverscrollController {
 public:
  ...
  // ApplicationWindowHostView so that the state of the overscroll gesture can be
 ...
 private:
  ...
  friend class ApplicationWindowHostViewAuraOverscrollTest;
...
#endif  // MUMBA_HOST_APPLICATION_OVERSCROLL_CONTROLLER_H_
