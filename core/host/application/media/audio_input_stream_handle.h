...
#ifndef MUMBA_HOST_APPLICATION_MEDIA_AUDIO_INPUT_STREAM_HANDLE_H_
#define MUMBA_HOST_APPLICATION_MEDIA_AUDIO_INPUT_STREAM_HANDLE_H_
...
class CONTENT_EXPORT AudioInputStreamHandle {
 public:
  ...
  AudioInputStreamHandle(common::mojom::RendererAudioInputStreamFactoryClientPtr client,
 ...
 private:
  ...
  common::mojom::RendererAudioInputStreamFactoryClientPtr client_;
...
#endif  // MUMBA_HOST_APPLICATION_MEDIA_AUDIO_INPUT_STREAM_HANDLE_H_
