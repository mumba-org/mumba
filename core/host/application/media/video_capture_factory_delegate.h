...
#ifndef MUMBA_HOST_APPLICATION_MEDIA_VIDEO_CAPTURE_FACTORY_DELEGATE_H_
#define MUMBA_HOST_APPLICATION_MEDIA_VIDEO_CAPTURE_FACTORY_DELEGATE_H_
...
#endif  // MUMBA_HOST_APPLICATION_MEDIA_VIDEO_CAPTURE_FACTORY_DELEGATE_H_
