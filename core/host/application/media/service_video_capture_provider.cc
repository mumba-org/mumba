...
#include "core/host/application/media/service_video_capture_device_launcher.h"
...
class ServiceConnectorImpl
    : public host::ServiceVideoCaptureProvider::ServiceConnector {
 public:
  ServiceConnectorImpl() {
    DCHECK(host::HostThread::CurrentlyOn(host::HostThread::UI));
