...
#ifndef MUMBA_HOST_APPLICATION_MEDIA_AUDIO_OUTPUT_AUTHORIZATION_HANDLER_H_
#define MUMBA_HOST_APPLICATION_MEDIA_AUDIO_OUTPUT_AUTHORIZATION_HANDLER_H_
...
#endif  // MUMBA_HOST_APPLICATION_MEDIA_AUDIO_OUTPUT_AUTHORIZATION_HANDLER_H_
