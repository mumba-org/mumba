...
#ifndef MUMBA_HOST_APPLICATION_MEDIA_MEDIA_DEVICES_MANAGER_H_
#define MUMBA_HOST_APPLICATION_MEDIA_MEDIA_DEVICES_MANAGER_H_
...
using MediaDeviceEnumeration =
    std::array<common::MediaDeviceInfoArray, common::NUM_MEDIA_DEVICE_TYPES>;
...
class CONTENT_EXPORT MediaDevicesManager
 ...
 public:
  ...
  class BoolDeviceTypes final
      : public std::array<bool, common::NUM_MEDIA_DEVICE_TYPES> {
   public:
  ...
  using EnumerateDevicesCallback =
      base::OnceCallback<void(const std::vector<common::MediaDeviceInfoArray>&,
  ...
  common::MediaDeviceInfoArray GetCachedDeviceInfo(common::MediaDeviceType type);
 ...
 private:
  ...
  void SetCachePolicy(common::MediaDeviceType type, CachePolicy policy);
  ...
  void DoEnumerateDevices(common::MediaDeviceType type);
  ...
  void DevicesEnumerated(common::MediaDeviceType type,
                         const common::MediaDeviceInfoArray& snapshot);
  void UpdateSnapshot(common::MediaDeviceType type,
  ...
  void HandleDevicesChanged(common::MediaDeviceType type);
  void NotifyMediaStreamManager(common::MediaDeviceType type,
                                const common::MediaDeviceInfoArray& new_snapshot);
  void NotifyDeviceChangeSubscribers(common::MediaDeviceType type,
                                     const common::MediaDeviceInfoArray& snapshot);
  ...
  using CachePolicies = std::array<CachePolicy, common::NUM_MEDIA_DEVICE_TYPES>;
...
CONTENT_EXPORT std::string GuessVideoGroupID(
    const common::MediaDeviceInfoArray& audio_infos,
    const common::MediaDeviceInfo& video_info);

}  // namespace host

#endif  // MUMBA_HOST_APPLICATION_MEDIA_MEDIA_DEVICES_MANAGER_H_
