...
#include "core/host/application/media/audio_output_stream_observer_impl.h"
#include "core/host/application/media/renderer_audio_output_stream_factory_context.h"
...
common::mojom::RendererAudioOutputStreamFactoryPtr RenderFrameAudioOutputStreamFactoryHandle::CreateBinding() {
  common::mojom::RendererAudioOutputStreamFactoryPtr factory;
  binding_.Bind(mojo::MakeRequest(&factory));
  return factory;
}
...
void RenderFrameAudioOutputStreamFactory::RequestDeviceAuthorization(
  ...
  //DLOG(INFO) << "RenderFrameAudioOutputStreamFactory::RequestDeviceAuthorization [host process]";
