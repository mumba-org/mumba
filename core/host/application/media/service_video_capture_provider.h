...
#ifndef MUMBA_HOST_APPLICATION_MEDIA_SERVICE_VIDEO_CAPTURE_PROVIDER_H_
#define MUMBA_HOST_APPLICATION_MEDIA_SERVICE_VIDEO_CAPTURE_PROVIDER_H_
...
#endif  // MUMBA_HOST_APPLICATION_MEDIA_SERVICE_VIDEO_CAPTURE_PROVIDER_H_
