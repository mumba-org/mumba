...
#ifndef MUMBA_HOST_APPLICATION_MEDIA_MEDIA_STREAM_UI_PROXY_H_
#define MUMBA_HOST_APPLICATION_MEDIA_MEDIA_STREAM_UI_PROXY_H_
...
class CONTENT_EXPORT MediaStreamUIProxy {
 ...
 private:
  ...
  std::unique_ptr<Core, content::HostThread::DeleteOnUIThread> core_;
...
#endif  // MUMBA_HOST_APPLICATION_MEDIA_MEDIA_STREAM_UI_PROXY_H_
