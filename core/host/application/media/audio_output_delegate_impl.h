...
#ifndef MUMBA_HOST_APPLICATION_MEDIA_AUDIO_OUTPUT_DELEGATE_IMPL_H_
#define MUMBA_HOST_APPLICATION_MEDIA_AUDIO_OUTPUT_DELEGATE_IMPL_H_
...
#endif  // MUMBA_HOST_APPLICATION_MEDIA_AUDIO_OUTPUT_DELEGATE_IMPL_H_
