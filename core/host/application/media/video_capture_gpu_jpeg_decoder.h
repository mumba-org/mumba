...
#ifndef MUMBA_HOST_APPLICATION_MEDIA_VIDEO_CAPTURE_GPU_JPEG_DECODER_H_
#define MUMBA_HOST_APPLICATION_MEDIA_VIDEO_CAPTURE_GPU_JPEG_DECODER_H_
...
#endif  // MUMBA_HOST_APPLICATION_MEDIA_VIDEO_CAPTURE_GPU_JPEG_DECODER_H_
