...
#ifndef MUMBA_HOST_APPLICATION_MEDIA_RENDER_FRAME_AUDIO_OUTPUT_STREAM_FACTORY_H_
#define MUMBA_HOST_APPLICATION_MEDIA_RENDER_FRAME_AUDIO_OUTPUT_STREAM_FACTORY_H_
...
class CONTENT_EXPORT RenderFrameAudioOutputStreamFactory
    : public common::mojom::RendererAudioOutputStreamFactory {
 public:
...
class CONTENT_EXPORT RenderFrameAudioOutputStreamFactoryHandle {
 public:
  ...
  common::mojom::RendererAudioOutputStreamFactoryPtr CreateBinding();
 ...
 private:
  ...
  void Init(common::mojom::RendererAudioOutputStreamFactoryRequest request);

  RenderFrameAudioOutputStreamFactory impl_;
  mojo::Binding<common::mojom::RendererAudioOutputStreamFactory> binding_;
...
#endif  // MUMBA_HOST_APPLICATION_MEDIA_RENDER_FRAME_AUDIO_OUTPUT_STREAM_FACTORY_H_
