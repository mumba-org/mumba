...
#ifndef MUMBA_HOST_APPLICATION_MEDIA_VIDEO_CAPTURE_CONTROLLER_H_
#define MUMBA_HOST_APPLICATION_MEDIA_VIDEO_CAPTURE_CONTROLLER_H_
...
#include "core/shared/common/media/video_capture.h"
...
class CONTENT_EXPORT VideoCaptureController
 ...
 public:
  ...
  common::MediaStreamType stream_type() const { return stream_type_; }
 ...
 private:
  ...
  const common::MediaStreamType stream_type_;
  ...
  common::VideoCaptureState state_;
...
#endif  // MUMBA_HOST_APPLICATION_MEDIA_VIDEO_CAPTURE_CONTROLLER_H_
