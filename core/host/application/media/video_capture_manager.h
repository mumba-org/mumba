...
#ifndef MUMBA_HOST_APPLICATION_MEDIA_VIDEO_CAPTURE_MANAGER_H_
#define MUMBA_HOST_APPLICATION_MEDIA_VIDEO_CAPTURE_MANAGER_H_
...
#include "core/host/application/media/video_capture_controller_event_handler.h"
#include "core/host/application/media/video_capture_device_launch_observer.h"
...
class CONTENT_EXPORT VideoCaptureManager
 ...
 public:
  ...
  //using DoneCB =
  //    base::Callback<void(VideoCaptureController*)>;
  ...
  int Open(const common::MediaStreamDevice& device) override;
  ...
  base::Optional<common::CameraCalibration> GetCameraCalibration(
      const std::string& device_id);

 private:
  class CaptureDeviceStartRequest;

  using SessionMap = std::map<media::VideoCaptureSessionId, common::MediaStreamDevice>;
  ...
  void OnOpened(common::MediaStreamType type,
                media::VideoCaptureSessionId capture_session_id);
  void OnClosed(common::MediaStreamType type,
                media::VideoCaptureSessionId capture_session_id);
...
#endif  // MUMBA_HOST_APPLICATION_MEDIA_VIDEO_CAPTURE_MANAGER_H_
