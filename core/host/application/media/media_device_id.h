...
#ifndef MUMBA_HOST_APPLICATION_MEDIA_MEDIA_DEVICE_ID_H_
#define MUMBA_HOST_APPLICATION_MEDIA_MEDIA_DEVICE_ID_H_
...
CONTENT_EXPORT bool GetMediaDeviceIDForHMAC(common::MediaStreamType stream_type,
                                            const std::string& salt,
                                            const url::Origin& security_origin,
