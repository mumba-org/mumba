...
#ifndef MUMBA_HOST_APPLICATION_MEDIA_VIDEO_CAPTURE_HOST_H_
#define MUMBA_HOST_APPLICATION_MEDIA_VIDEO_CAPTURE_HOST_H_
...
#include "core/host/application/media/video_capture_controller.h"
...
class CONTENT_EXPORT VideoCaptureHost
 ...
 public:
  ...
  class ApplicationProcessHostDelegate;
  VideoCaptureHost(std::unique_ptr<ApplicationProcessHostDelegate> delegate,
                   MediaStreamManager* media_stream_manager);
  ...
  // Interface for notifying ApplicationProcessHost instance about active video
  // capture stream changes.
  class CONTENT_EXPORT ApplicationProcessHostDelegate {
   public:
    virtual ~ApplicationProcessHostDelegate();
 ...
 private:
  ...
  class ApplicationProcessHostDelegateImpl;
  std::unique_ptr<ApplicationProcessHostDelegate> render_process_host_delegate_;
...
#endif  // MUMBA_HOST_APPLICATION_MEDIA_VIDEO_CAPTURE_HOST_H_
