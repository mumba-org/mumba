...
#include "core/host/application/media/in_process_video_capture_device_launcher.h"

#include "base/metrics/histogram_macros.h"
#include "base/strings/stringprintf.h"
#include "build/build_config.h"
#include "core/host/application/media/in_process_launched_video_capture_device.h"
#include "core/host/application/media/video_capture_controller.h"
#include "core/host/application/media/video_capture_gpu_jpeg_decoder.h"
...
#include "core/host/media/capture/screen_capture_device_android.h"
#else
#include "core/host/media/capture/web_contents_video_capture_device.h"
#if defined(USE_AURA)
#include "core/host/media/capture/desktop_capture_device_aura.h"
#endif
#if BUILDFLAG(ENABLE_WEBRTC)
#include "core/host/media/capture/desktop_capture_device.h"
#endif
...
std::unique_ptr<media::VideoCaptureJpegDecoder> CreateGpuJpegDecoder(
  ...
  return std::make_unique<host::VideoCaptureGpuJpegDecoder>(
...
void InProcessVideoCaptureDeviceLauncher::LaunchDeviceAsync(
  ...
  switch (stream_type) {
...
#if defined(ENABLE_SCREEN_CAPTURE)
#if !defined(OS_ANDROID)
    case common::MEDIA_TAB_VIDEO_CAPTURE:
      start_capture_closure = base::BindOnce(
    ...
    case common::MEDIA_DESKTOP_VIDEO_CAPTURE: {
