...
#ifndef MUMBA_HOST_APPLICATION_MEDIA_MEDIA_STREAM_TRACK_METRICS_HOST_H_
#define MUMBA_HOST_APPLICATION_MEDIA_MEDIA_STREAM_TRACK_METRICS_HOST_H_
...
// removed.
class MediaStreamTrackMetricsHost : public common::mojom::MediaStreamTrackMetricsHost {
 public:
  explicit MediaStreamTrackMetricsHost();

  ~MediaStreamTrackMetricsHost() override;
  void BindRequest(common::mojom::MediaStreamTrackMetricsHostRequest request);
 ...
 private:
  ...
  mojo::BindingSet<common::mojom::MediaStreamTrackMetricsHost> bindings_;
};

}  // namespace host

#endif  // MUMBA_HOST_APPLICATION_MEDIA_MEDIA_STREAM_TRACK_METRICS_HOST_H_
