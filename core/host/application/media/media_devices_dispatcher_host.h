...
#ifndef MUMBA_HOST_APPLICATION_MEDIA_MEDIA_DEVICES_DISPATCHER_HOST_H_
#define MUMBA_HOST_APPLICATION_MEDIA_MEDIA_DEVICES_DISPATCHER_HOST_H_
...
class CONTENT_EXPORT MediaDevicesDispatcherHost
 ...
 public:
  MediaDevicesDispatcherHost(int app_process_id,
                             int app_window_id,
                             MediaStreamManager* media_stream_manager);
  ~MediaDevicesDispatcherHost() override;

  static void Create(int app_process_id,
                     int app_window_id,
                     MediaStreamManager* media_stream_manager,
 ...
 private:
  ...
  const int app_process_id_;
  const int app_window_id_;
...
#endif  // MUMBA_HOST_APPLICATION_MEDIA_MEDIA_DEVICES_DISPATCHER_HOST_H_
