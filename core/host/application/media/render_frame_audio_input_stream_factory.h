...
#ifndef MUMBA_HOST_APPLICATION_MEDIA_RENDER_FRAME_AUDIO_INPUT_STREAM_FACTORY_H_
#define MUMBA_HOST_APPLICATION_MEDIA_RENDER_FRAME_AUDIO_INPUT_STREAM_FACTORY_H_
...
#include "core/host/application/media/audio_input_stream_handle.h"
...
class CONTENT_EXPORT RenderFrameAudioInputStreamFactory
    : public common::mojom::RendererAudioInputStreamFactory {
 public:
 ...
 private:
  ...
  void CreateStream(common::mojom::RendererAudioInputStreamFactoryClientPtr client,
                    int32_t session_id,
  ...
  void DoCreateStream(common::mojom::RendererAudioInputStreamFactoryClientPtr client,
                      int session_id,
                      const media::AudioParameters& audio_params,
                      bool automatic_gain_control,
                      uint32_t shared_memory_count,
...
class CONTENT_EXPORT RenderFrameAudioInputStreamFactoryHandle {
 ...
 private:
  ...
  void Init(common::mojom::RendererAudioInputStreamFactoryRequest request);

  RenderFrameAudioInputStreamFactory impl_;
  mojo::Binding<common::mojom::RendererAudioInputStreamFactory> binding_;
...
#endif  // MUMBA_HOST_APPLICATION_MEDIA_RENDER_FRAME_AUDIO_INPUT_STREAM_FACTORY_H_
