...
#include "core/host/application/media/fake_video_capture_provider.h"
...
#include "core/common/media/media_devices.h"
...
class VideoCaptureTest : public testing::Test,
  ...
  void OpenSession() {
    ...
    MediaDeviceInfoArray video_devices;
    {
      ...
      media_stream_manager_->media_devices_manager()->EnumerateDevices(
          ...
          base::Bind(&VideoInputDevicesEnumerated, run_loop.QuitClosure(),
                     application_contents_.GetMediaDeviceIDSalt(), security_origin,
                     &video_devices));
      run_loop.Run();
    }
    ...
    // Open the first device.
    {
      ...
      media_stream_manager_->OpenDevice(
          ...
          application_contents_.GetMediaDeviceIDSalt(), page_request_id,
 ...
 private:
  ...
  const content::TestHostThreadBundle thread_bundle_;
  std::unique_ptr<media::AudioManager> audio_manager_;
  std::unique_ptr<media::AudioSystem> audio_system_;
  content::TestApplicationContents application_contents_;
