...
#ifndef MUMBA_HOST_APPLICATION_MEDIA_VIDEO_CAPTURE_CONTROLLER_EVENT_HANDLER_H_
#define MUMBA_HOST_APPLICATION_MEDIA_VIDEO_CAPTURE_CONTROLLER_EVENT_HANDLER_H_
...
#endif  // MUMBA_HOST_APPLICATION_MEDIA_VIDEO_CAPTURE_CONTROLLER_EVENT_HANDLER_H_
