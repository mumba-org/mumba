...
#ifndef MUMBA_HOST_APPLICATION_OVERSCROLL_CONTROLLER_DELEGATE_H_
#define MUMBA_HOST_APPLICATION_OVERSCROLL_CONTROLLER_DELEGATE_H_
...
#endif  // MUMBA_HOST_APPLICATION_OVERSCROLL_CONTROLLER_DELEGATE_H_
