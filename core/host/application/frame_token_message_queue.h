...
#ifndef MUMBA_HOST_APPLICATION_FRAME_TOKEN_MESSAGE_QUEUE_H_
#define MUMBA_HOST_APPLICATION_FRAME_TOKEN_MESSAGE_QUEUE_H_
...
#endif  // MUMBA_HOST_APPLICATION_FRAME_TOKEN_MESSAGE_QUEUE_H_
