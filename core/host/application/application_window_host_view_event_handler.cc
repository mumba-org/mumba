...
bool NeedsInputGrab(host::ApplicationWindowHostView* view) {
  if (!view)
    return false;
...
ApplicationWindowHostViewEventHandler::Delegate::Delegate()
...
ApplicationWindowHostViewEventHandler::ApplicationWindowHostViewEventHandler(
    ApplicationWindowHost* host,
    ApplicationWindowHostView* host_view,
    Delegate* delegate)
    : accept_return_character_(false),
      disable_input_event_router_for_testing_(false),
      mouse_locked_(false),
      pinch_zoom_enabled_(false),//content::IsPinchToZoomEnabled()),
...
void ApplicationWindowHostViewEventHandler::SetPopupChild(
    ApplicationWindowHostView* popup_child_host_view,
    ui::EventHandler* popup_child_event_handler) {
  popup_child_host_view_ = popup_child_host_view;
  popup_child_event_handler_ = popup_child_event_handler;
}

void ApplicationWindowHostViewEventHandler::TrackHost(
...
#if defined(OS_WIN)
void ApplicationWindowHostViewEventHandler::UpdateMouseLockRegion() {
  RECT window_rect =
...
bool ApplicationWindowHostViewEventHandler::LockMouse() {
...
void ApplicationWindowHostViewEventHandler::UnlockMouse() {
...
bool ApplicationWindowHostViewEventHandler::LockKeyboard(
...
void ApplicationWindowHostViewEventHandler::UnlockKeyboard() {
  scoped_keyboard_hook_.reset();
}

bool ApplicationWindowHostViewEventHandler::IsKeyboardLocked() const {
  return scoped_keyboard_hook_ != nullptr;
}

void ApplicationWindowHostViewEventHandler::OnKeyEvent(ui::KeyEvent* event) {
  TRACE_EVENT0("input", "ApplicationWindowHostView::OnKeyEvent");
...
void ApplicationWindowHostViewEventHandler::OnMouseEvent(ui::MouseEvent* event) {
  TRACE_EVENT0("input", "ApplicationWindowHostView::OnMouseEvent");
  ...
  if (event->type() == ui::ET_MOUSEWHEEL) {
    ...
    if (CanApplicationHandleEvent(event, mouse_locked_, is_selection_popup) &&
...
void ApplicationWindowHostViewEventHandler::OnScrollEvent(ui::ScrollEvent* event) {
  TRACE_EVENT0("input", "ApplicationWindowHostView::OnScrollEvent");
  bool should_route_event = ShouldRouteEvent(event);
...
void ApplicationWindowHostViewEventHandler::OnTouchEvent(ui::TouchEvent* event) {
  TRACE_EVENT0("input", "ApplicationWindowHostView::OnTouchEvent");
...
void ApplicationWindowHostViewEventHandler::OnGestureEvent(ui::GestureEvent* event) {
  TRACE_EVENT0("input", "ApplicationWindowHostView::OnGestureEvent");
...
void ApplicationWindowHostViewEventHandler::GestureEventAck(
    const blink::WebGestureEvent& event,
    common::InputEventAckState ack_result) {
  mouse_wheel_phase_handler_.GestureEventAck(event, ack_result);
}

bool ApplicationWindowHostViewEventHandler::CanApplicationHandleEvent(
...
void ApplicationWindowHostViewEventHandler::FinishImeCompositionSession() {
  // ApplicationWindowHostViewAura keeps track of existing composition texts. The
...
void ApplicationWindowHostViewEventHandler::ForwardMouseEventToParent(
    ui::MouseEvent* event) {
...
void ApplicationWindowHostViewEventHandler::HandleGestureForTouchSelection(
...
void ApplicationWindowHostViewEventHandler::HandleMouseEventWhileLocked(
    ui::MouseEvent* event) {
  aura::client::CursorClient* cursor_client =
...
void ApplicationWindowHostViewEventHandler::ModifyEventMovementAndCoords(
...
void ApplicationWindowHostViewEventHandler::MoveCursorToCenter() {
#if defined(OS_WIN)
...
void ApplicationWindowHostViewEventHandler::SetKeyboardFocus() {
#if defined(OS_WIN)
...
bool ApplicationWindowHostViewEventHandler::ShouldMoveToCenter() {
...
bool ApplicationWindowHostViewEventHandler::ShouldRouteEvent(
  ...
  //    it should be a simple extension to modify ApplicationWindowHostViewChildFrame
  //    in a similar manner to ApplicationWindowHostViewGuest.
...
void ApplicationWindowHostViewEventHandler::ProcessMouseEvent(
    const blink::WebMouseEvent& event,
    const ui::LatencyInfo& latency) {
  host_->ForwardMouseEventWithLatencyInfo(event, latency);
}

void ApplicationWindowHostViewEventHandler::ProcessMouseWheelEvent(
    const blink::WebMouseWheelEvent& event,
    const ui::LatencyInfo& latency) {
  host_->ForwardWheelEventWithLatencyInfo(event, latency);
}

void ApplicationWindowHostViewEventHandler::ProcessTouchEvent(
    const blink::WebTouchEvent& event,
    const ui::LatencyInfo& latency) {
  host_->ForwardTouchEventWithLatencyInfo(event, latency);
}

bool ApplicationWindowHostViewEventHandler::IsKeyLocked(const ui::KeyEvent& event) {
