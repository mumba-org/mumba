...
//#include "core/host/global_request_id.h"
...
class ResourceRequestInfo {
 public:
  ...
  virtual ApplicationContentsGetter GetApplicationContentsGetterForRequest() const = 0;
  ...
  virtual bool GetAssociatedApplicationWindow(int* render_process_id,
  ...
  virtual common::PreviewsState GetPreviewsState() const = 0;
