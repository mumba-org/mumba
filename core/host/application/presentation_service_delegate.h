...
#ifndef MUMBA_HOST_APPLICATION_PRESENTATION_SERVICE_DELEGATE_H_
#define MUMBA_HOST_APPLICATION_PRESENTATION_SERVICE_DELEGATE_H_
...
#include "core/host/media/media_controller.h"
#include "core/shared/common/presentation_connection_message.h"
#include "core/shared/common/presentation_info.h"
...
using PresentationConnectionCallback =
    base::OnceCallback<void(const common::PresentationInfo&)>;
...
using DefaultPresentationConnectionCallback =
    base::RepeatingCallback<void(const common::PresentationInfo&)>;
...
class CONTENT_EXPORT ControllerPresentationServiceDelegate
 ...
 public:
  ...
  virtual void ListenForConnectionStateChange(
      int render_process_id,
      int render_frame_id,
      const common::PresentationInfo& connection,
  ...
  virtual void ConnectToPresentation(
      int render_process_id,
      int render_frame_id,
      const common::PresentationInfo& presentation_info,
...
class CONTENT_EXPORT ReceiverPresentationServiceDelegate
 ...
 public:
  ...
  virtual void RegisterReceiverConnectionAvailableCallback(
      const ReceiverConnectionAvailableCallback&
