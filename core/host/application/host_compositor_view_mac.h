...
#ifndef MUMBA_HOST_APPLICATION_BROWSER_COMPOSITOR_VIEW_MAC_H_
#define MUMBA_HOST_APPLICATION_BROWSER_COMPOSITOR_VIEW_MAC_H_
...
// all met:
// - The ApplicationWindowHost providing frames to the DelegatedFrameHost
//   is visible.
// - The ApplicationWindowHostViewMac that is used to display these frames is
...
class CONTENT_EXPORT BrowserCompositorMac : public DelegatedFrameHostClient {
 public:
  BrowserCompositorMac(
      ...
      bool application_window_host_is_hidden,
  ...
  // ApplicationWindowHost have changed.
  ...
  void SetApplicationWindowHostIsHidden(bool hidden);
 ...
 private:
  ...
  enum State {
    ...
    // Happens when:
    // - The |application_window_host_| is hidden, but |cocoa_view_| is still in the
    ...
    // Happens when:
    // - The |application_window_host_| hidden or gone, and |cocoa_view_| is not
  ...
  bool application_window_host_is_hidden_ = true;
...
#endif  // MUMBA_HOST_APPLICATION_BROWSER_COMPOSITOR_VIEW_MAC_H_
