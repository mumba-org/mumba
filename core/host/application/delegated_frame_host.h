...
#ifndef MUMBA_HOST_APPLICATION_DELEGATED_FRAME_HOST_H_
#define MUMBA_HOST_APPLICATION_DELEGATED_FRAME_HOST_H_
...
// The DelegatedFrameHost is used to host all of the ApplicationWindowHostView state
...
class CONTENT_EXPORT DelegatedFrameHost
 ...
 public:
  ...
  // Public interface exposed to ApplicationWindowHostView.
  ...
  // Given a ApplicationWindowHostView that renders to a Surface that is
 ...
 private:
  ...
  std::unique_ptr<ui::Layer> temp_layer_;
...
#endif  // MUMBA_HOST_APPLICATION_DELEGATED_FRAME_HOST_H_
