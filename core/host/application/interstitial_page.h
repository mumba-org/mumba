...
#ifndef MUMBA_HOST_APPLICATION_INTERSTITIAL_PAGE_H_
#define MUMBA_HOST_APPLICATION_INTERSTITIAL_PAGE_H_
...
class InterstitialPage {
 public:
  ...
  CONTENT_EXPORT static InterstitialPage* FromApplicationWindowHost(
