...
#ifndef MUMBA_HOST_APPLICATION_INTERSTITIAL_PAGE_DELEGATE_H_
#define MUMBA_HOST_APPLICATION_INTERSTITIAL_PAGE_DELEGATE_H_
...
class CONTENT_EXPORT InterstitialPageDelegate {
 public:
  ...
  virtual void OverrideRendererPrefs(common::RendererPreferences* prefs) {}
