...
#include "core/common/ax_content_node_data.h"
#include "core/common/buildflags.h"
#include "core/shared/common/content_export.h"
#include "core/common/content_security_policy/csp_context.h"
#include "core/common/download/mhtml_save_status.h"
#include "core/common/frame.mojom.h"
#include "core/common/frame_message_enums.h"
#include "core/common/frame_replication_state.h"
#include "core/common/image_downloader/image_downloader.mojom.h"
#include "core/common/input/input_handler.mojom.h"
#include "core/common/navigation_params.mojom.h"
#include "core/host/host_thread.h"
#include "core/host/content_browser_client.h"
#include "core/host/render_frame_host.h"
#include "core/common/javascript_dialog_type.h"
#include "core/common/previews_state.h"
#include "core/common/transferrable_url_loader.mojom.h"
...
class CONTENT_EXPORT RenderFrameHostImpl
 ...
 public:
  ...
  ApplicationWindowHostView* GetView() override;
  ...
  RenderViewHostImpl* application_window_host() { return application_window_host_; }
  ...
  // distinguished by owning a ApplicationWindowHost, which manages input events
  // and painting for this frame and its contiguous local subtree in the
  // renderer process.
  bool is_local_root() const { return !!application_window_host_; }

  // Returns the ApplicationWindowHost attached to this frame or the nearest
  ...
  // ApplicationWindowHostView methods used. GetApplicationWindowHost() will not
  ...
  // a ApplicationWindowHost and nor does any of its ancestors. That would
  // typically mean that the frame has been detached from the frame tree.
  virtual ApplicationWindowHost* GetApplicationWindowHost();
  ...
  // NULL.
  BrowserAccessibilityManager* GetOrCreateAccessibilityManager();
  ...
  // addition, its associated ApplicationWindowHost has to be focused.
  bool IsFocused();
  ...
  // ApplicationWindowHostViewChildFrame::Show()/Hide(). Calling this on a pending
 ...
 private:
  ...
  // Returns the ApplicationWindowHostView used for accessibility. For subframes,
  // this function will return the platform view on the main frame; for main
  // frames, it will return the current frame's view.
  ApplicationWindowHostView* GetViewForAccessibility();
  ...
  // tree top-down to visit the  ApplicationWindowHostViews of interest in the most
  ...
  // WebContentsImpl::GetApplicationWindowHostViewsInTree() into a new more
  // appropriate API for dealing with (virtual) ApplicationWindowHost(View) tree.
  ...
  RenderViewHostImpl* const application_window_host_;
  ...
  // for their frame subtrees require ApplicationWindowHosts. This typically
