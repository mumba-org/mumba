...
SyntheticTapGesture::SyntheticTapGesture(
    const common::SyntheticTapGestureParams& params)
    : params_(params),
...
SyntheticGesture::Result SyntheticTapGesture::ForwardInputEvents(
  ...
  if (gesture_source_type_ == common::SyntheticGestureParams::TOUCH_INPUT ||
      gesture_source_type_ == common::SyntheticGestureParams::MOUSE_INPUT)
