...
class QueuedWebMouseWheelEvent : public common::MouseWheelEventWithLatencyInfo {
 public:
  QueuedWebMouseWheelEvent(const common::MouseWheelEventWithLatencyInfo& original_event)
      : common::MouseWheelEventWithLatencyInfo(original_event) {
