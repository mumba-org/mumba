...
#ifndef MUMBA_HOST_APPLICATION_INPUT_TOUCH_SELECTION_CONTROLLER_CLIENT_MANAGER_H_
#define MUMBA_HOST_APPLICATION_INPUT_TOUCH_SELECTION_CONTROLLER_CLIENT_MANAGER_H_
