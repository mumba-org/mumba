...
#ifndef MUMBA_HOST_APPLICATION_INPUT_MOCK_INPUT_ROUTER_CLIENT_H_
#define MUMBA_HOST_APPLICATION_INPUT_MOCK_INPUT_ROUTER_CLIENT_H_
...
#include "core/common/input/input_event.h"
...
class MockInputRouterClient : public InputRouterClient {
 ...
 private:
  ...
  common::InputEventAckState filter_state_;
...
#endif  // MUMBA_HOST_APPLICATION_INPUT_MOCK_INPUT_ROUTER_CLIENT_H_
