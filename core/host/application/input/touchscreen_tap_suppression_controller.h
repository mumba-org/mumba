...
#ifndef MUMBA_HOST_APPLICATION_INPUT_TOUCHSCREEN_TAP_SUPPRESSION_CONTROLLER_H_
#define MUMBA_HOST_APPLICATION_INPUT_TOUCHSCREEN_TAP_SUPPRESSION_CONTROLLER_H_
...
class TouchscreenTapSuppressionController
 ...
 public:
  ...
  bool FilterTapEvent(const common::GestureEventWithLatencyInfo& event);
 ...
 private:
  ...
  typedef std::unique_ptr<common::GestureEventWithLatencyInfo> ScopedGestureEvent;
...
#endif  // MUMBA_HOST_APPLICATION_INPUT_TOUCHSCREEN_TAP_SUPPRESSION_CONTROLLER_H_
