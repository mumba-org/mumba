...
#ifndef MUMBA_HOST_APPLICATION_INPUT_STYLUS_TEXT_SELECTOR_H_
#define MUMBA_HOST_APPLICATION_INPUT_STYLUS_TEXT_SELECTOR_H_
...
#endif  // MUMBA_HOST_APPLICATION_INPUT_STYLUS_TEXT_SELECTOR_H_
