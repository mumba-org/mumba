...
#ifndef MUMBA_HOST_APPLICATION_INPUT_TOUCH_EMULATOR_H_
#define MUMBA_HOST_APPLICATION_INPUT_TOUCH_EMULATOR_H_
...
class CONTENT_EXPORT TouchEmulator : public ui::GestureProviderClient {
 ...
 private:
  ...
  common::WebCursor pointer_cursor_;
  common::WebCursor touch_cursor_;
  common::WebCursor pinch_cursor_;
...
#endif  // MUMBA_HOST_APPLICATION_INPUT_TOUCH_EMULATOR_H_
