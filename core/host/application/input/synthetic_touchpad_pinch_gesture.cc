...
SyntheticGesture::Result SyntheticTouchpadPinchGesture::ForwardInputEvents(
  ...
  if (gesture_source_type_ == common::SyntheticGestureParams::MOUSE_INPUT) {
  ...
  switch (state_) {
    case STARTED:
      ...
      target->DispatchInputEventToPlatform(
          common::SyntheticWebGestureEventBuilder::Build(
    ...
    case IN_PROGRESS: {
      ...
      target->DispatchInputEventToPlatform(
          common::SyntheticWebGestureEventBuilder::BuildPinchUpdate(
