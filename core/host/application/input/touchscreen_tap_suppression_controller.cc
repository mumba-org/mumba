  ...
  switch (event.event.GetType()) {
    case WebInputEvent::kGestureTapDown:
      ...
      if (!controller_.ShouldDeferTapDown())
        return false;
      stashed_tap_down_.reset(new common::GestureEventWithLatencyInfo(event));
      return true;

    case WebInputEvent::kGestureShowPress:
      if (!stashed_tap_down_)
        return false;
      stashed_show_press_.reset(new common::GestureEventWithLatencyInfo(event));
      return true;
    ...
    case WebInputEvent::kGestureLongPress:
      ...
      stashed_long_press_.reset(new common::GestureEventWithLatencyInfo(event));
      return true;
