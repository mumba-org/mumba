...
#ifndef MUMBA_HOST_APPLICATION_INPUT_FLING_CONTROLLER_H_
#define MUMBA_HOST_APPLICATION_INPUT_FLING_CONTROLLER_H_
...
class CONTENT_EXPORT FlingControllerClient {
 public:
  ...
  virtual void SendGeneratedWheelEvent(
      const common::MouseWheelEventWithLatencyInfo& wheel_event) = 0;

  virtual void SendGeneratedGestureScrollEvents(
      const common::GestureEventWithLatencyInfo& gesture_event) = 0;
...
class CONTENT_EXPORT FlingController {
 public:
  ...
  bool FilterGestureEvent(const common::GestureEventWithLatencyInfo& gesture_event);

  void OnGestureEventAck(const common::GestureEventWithLatencyInfo& acked_event,
...
#endif  // MUMBA_HOST_APPLICATION_INPUT_FLING_CONTROLLER_H_
