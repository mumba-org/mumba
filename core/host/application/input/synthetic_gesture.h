...
#ifndef MUMBA_HOST_APPLICATION_INPUT_SYNTHETIC_GESTURE_H_
#define MUMBA_HOST_APPLICATION_INPUT_SYNTHETIC_GESTURE_H_
...
#endif  // MUMBA_HOST_APPLICATION_INPUT_SYNTHETIC_GESTURE_H_
