...
#ifndef MUMBA_HOST_APPLICATION_INPUT_TOUCH_SELECTION_CONTROLLER_CLIENT_AURA_H_
#define MUMBA_HOST_APPLICATION_INPUT_TOUCH_SELECTION_CONTROLLER_CLIENT_AURA_H_
...
#include "core/host/application/input/touch_selection_controller_client_manager.h"
...
class CONTENT_EXPORT TouchSelectionControllerClientAura
 ...
 public:
  explicit TouchSelectionControllerClientAura(ApplicationWindowHostViewAura* rwhva);
  ...
  bool HandleContextMenu(const common::ContextMenuParams& params);
 ...
 private:
  ...
  class InternalClient final : public TouchSelectionControllerClient {
   public:
    InternalClient(ApplicationWindowHostViewAura* rwhva) : rwhva_(rwhva) {}
...
#endif  // MUMBA_HOST_APPLICATION_INPUT_TOUCH_SELECTION_CONTROLLER_CLIENT_AURA_H_
