...
#ifndef MUMBA_HOST_APPLICATION_INPUT_MOTION_EVENT_WEB_H_
#define MUMBA_HOST_APPLICATION_INPUT_MOTION_EVENT_WEB_H_
...
#endif  // MUMBA_HOST_APPLICATION_INPUT_MOTION_EVENT_WEB_H_
