...
void FlingController::OnGestureEventAck(
    const common::GestureEventWithLatencyInfo& acked_event,
    common::InputEventAckState ack_result) {
  bool processed = (common::INPUT_EVENT_ACK_STATE_CONSUMED == ack_result);
...
void FlingController::GenerateAndSendWheelEvents(
  ...
  common::MouseWheelEventWithLatencyInfo synthetic_wheel(
...
void FlingController::GenerateAndSendGestureScrollEvents(
  ...
  common::GestureEventWithLatencyInfo synthetic_gesture(
...
void FlingController::CancelCurrentFling() {
  ...
  if (fling_cancellation_is_deferred &&
    ...
    client_->SendGeneratedGestureScrollEvents(common::GestureEventWithLatencyInfo(
