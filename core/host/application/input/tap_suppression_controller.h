...
#ifndef MUMBA_HOST_APPLICATION_INPUT_TAP_SUPPRESSION_CONTROLLER_H_
#define MUMBA_HOST_APPLICATION_INPUT_TAP_SUPPRESSION_CONTROLLER_H_
...
#endif  // MUMBA_HOST_APPLICATION_INPUT_TAP_SUPPRESSION_CONTROLLER_H_
