...
#ifndef MUMBA_HOST_APPLICATION_INPUT_MOUSE_WHEEL_EVENT_QUEUE_H_
#define MUMBA_HOST_APPLICATION_INPUT_MOUSE_WHEEL_EVENT_QUEUE_H_
...
class CONTENT_EXPORT MouseWheelEventQueueClient {
 public:
  ...
  virtual void SendMouseWheelEventImmediately(
      const common::MouseWheelEventWithLatencyInfo& event) = 0;
  virtual void ForwardGestureEventWithLatencyInfo(
      const blink::WebGestureEvent& event,
      const ui::LatencyInfo& latency_info) = 0;
  virtual void OnMouseWheelEventAck(const common::MouseWheelEventWithLatencyInfo& event,
...
class CONTENT_EXPORT MouseWheelEventQueue {
 public:
  ...
  void QueueEvent(const common::MouseWheelEventWithLatencyInfo& event);

  // Notifies the queue that a mouse wheel event has been processed by the
  // renderer.
  void ProcessMouseWheelAck(common::InputEventAckSource ack_source,
...
#endif  // MUMBA_HOST_APPLICATION_INPUT_MOUSE_WHEEL_EVENT_QUEUE_H_
