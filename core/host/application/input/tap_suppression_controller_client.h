...
#ifndef MUMBA_HOST_APPLICATION_INPUT_TAP_SUPPRESSION_CONTROLLER_CLIENT_H_
#define MUMBA_HOST_APPLICATION_INPUT_TAP_SUPPRESSION_CONTROLLER_CLIENT_H_
...
#endif  // MUMBA_HOST_APPLICATION_INPUT_TAP_SUPPRESSION_CONTROLLER_CLIENT_H_
