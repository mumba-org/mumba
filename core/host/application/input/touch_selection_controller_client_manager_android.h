...
#ifndef MUMBA_HOST_APPLICATION_INPUT_TOUCH_SELECTION_CONTROLLER_CLIENT_MANAGER_ANDROID_H_
#define MUMBA_HOST_APPLICATION_INPUT_TOUCH_SELECTION_CONTROLLER_CLIENT_MANAGER_ANDROID_H_
...
class ApplicationWindowHostViewAndroid;
...
class TouchSelectionControllerClientManagerAndroid
 ...
 public:
  explicit TouchSelectionControllerClientManagerAndroid(
      ApplicationWindowHostViewAndroid* rwhv);
 ...
 private:
  ApplicationWindowHostViewAndroid* rwhv_;
...
#endif  // MUMBA_HOST_APPLICATION_INPUT_TOUCH_SELECTION_CONTROLLER_CLIENT_MANAGER_ANDROID_H_
