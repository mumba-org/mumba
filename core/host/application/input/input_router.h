...
#ifndef MUMBA_HOST_APPLICATION_INPUT_INPUT_ROUTER_H_
#define MUMBA_HOST_APPLICATION_INPUT_INPUT_ROUTER_H_
...
class InputRouter : public IPC::Listener {
 public:
  ...
  virtual void SendMouseEvent(
      const common::MouseEventWithLatencyInfo& mouse_event) = 0;
  ...
  virtual void SendTouchEvent(
      const common::TouchEventWithLatencyInfo& touch_event) = 0;
  ...
  virtual void BindHost(common::mojom::WindowInputHandlerHostRequest request,
...
#endif  // MUMBA_HOST_APPLICATION_INPUT_INPUT_ROUTER_H_
