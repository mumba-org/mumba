...
class MouseWheelEventQueueTest
 ...
 public:
  ...
  void SendMouseWheelEventImmediately(
      const common::MouseWheelEventWithLatencyInfo& event) override {
 ...
 protected:
  ...
  void SendMouseWheelEventAck(common::InputEventAckState ack_result) {
    queue_->ProcessMouseWheelAck(common::InputEventAckSource::COMPOSITOR_THREAD,
  ...
  void SendMouseWheel(float x,
    ...
    queue_->QueueEvent(common::MouseWheelEventWithLatencyInfo(event));
  }
