...
#ifndef MUMBA_HOST_APPLICATION_INPUT_TOUCH_ACTION_FILTER_H_
#define MUMBA_HOST_APPLICATION_INPUT_TOUCH_ACTION_FILTER_H_
...
#endif  // MUMBA_HOST_APPLICATION_INPUT_TOUCH_ACTION_FILTER_H_
