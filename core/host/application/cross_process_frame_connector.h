...
// ApplicationWindowHostViewChildFrame allowing RWHVChildFrame to remain ignorant
// of RenderFrameHost.
//
// The ApplicationWindowHostView of an out-of-process child frame needs to
...
// ApplicationWindowHostViewChildFrame. This ApplicationWindowHostViewChildFrame needs
...
// ApplicationWindowHostViewChildFrame and A2 to allow for this communication.
...
class CONTENT_EXPORT CrossProcessFrameConnector
 ...
 public:
  ...
  explicit CrossProcessFrameConnector(
      ApplicationFrame* frame);//RenderFrameProxyHost* frame_proxy_in_parent_renderer);
  ~CrossProcessFrameConnector() override;

  bool OnMessageReceived(const IPC::Message &msg);

  // |view| corresponds to B2's ApplicationWindowHostViewChildFrame in the example
  // above.
  ApplicationWindowHostViewChildFrame* get_view_for_testing() { return view_; }

  // FrameConnectorDelegate implementation.
  void SetView(ApplicationWindowHostViewChildFrame* view) override;
  ApplicationWindowHostView* GetParentApplicationWindowHostView() override;
  ApplicationWindowHostView* GetRootApplicationWindowHostView() override;
  void ApplicationProcessGone() override;
  ...
  bool TransformPointToCoordSpaceForView(
      ...
      const viz::SurfaceId& local_surface_id,
      gfx::PointF* transformed_point) override;
  void ForwardProcessAckedTouchEvent(const common::TouchEventWithLatencyInfo& touch,
  ...
  // Exposed for tests.
  ApplicationWindowHostView* GetRootApplicationWindowHostViewForTesting() {
    return GetRootApplicationWindowHostView();
  }
 ...
 private:
  ...
  ApplicationFrame* frame_proxy_in_parent_renderer_;
