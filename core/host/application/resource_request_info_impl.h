...
class ResourceRequestInfoImpl : public ResourceRequestInfo,
 ...
 public:
  ...
  ApplicationContentsGetter GetApplicationContentsGetterForRequest() const override;
