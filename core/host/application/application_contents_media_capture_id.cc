...
bool ApplicationContentsMediaCaptureId::operator<(
    const ApplicationContentsMediaCaptureId& other) const {
...
bool ApplicationContentsMediaCaptureId::is_null() const {
  return (render_process_id < 0) || (main_render_frame_id < 0);
}

std::string ApplicationContentsMediaCaptureId::ToString() const {
...
// static
bool ApplicationContentsMediaCaptureId::Parse(const std::string& str,
