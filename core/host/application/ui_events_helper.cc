...
bool MakeUITouchEventsFromWebTouchEvents(
    const common::TouchEventWithLatencyInfo& touch_with_latency,
...
bool InputEventAckStateIsSetNonBlocking(common::InputEventAckState ack_state) {
  switch (ack_state) {
    case common::INPUT_EVENT_ACK_STATE_SET_NON_BLOCKING:
    case common::INPUT_EVENT_ACK_STATE_SET_NON_BLOCKING_DUE_TO_FLING:
      return true;
    default:
      return false;
  }
