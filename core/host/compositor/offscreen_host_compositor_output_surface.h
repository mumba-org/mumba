...
class OffscreenHostCompositorOutputSurface
 ...
 public:
  ...
  ~OffscreenHostCompositorOutputSurface() override;
 ...
 private:
  ...
  uint64_t swap_id_ = 0;
  base::WeakPtrFactory<OffscreenHostCompositorOutputSurface>
      weak_ptr_factory_;

  DISALLOW_COPY_AND_ASSIGN(OffscreenHostCompositorOutputSurface);
};
