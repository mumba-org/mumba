...
typedef ContentHostTest ImageTransportFactoryHostTest;
...
// resources are reset.
IN_PROC_BROWSER_TEST_F(ImageTransportFactoryHostTest,
...
class ImageTransportFactoryTearDownHostTest : public ContentHostTest {
 public:
  ImageTransportFactoryTearDownHostTest() {}
...
// renderer and get a frame before we create a host compositor, necessary for
...
IN_PROC_BROWSER_TEST_F(ImageTransportFactoryTearDownHostTest,
