...
#include "core/host/compositor/test/test_image_transport_factory.h"
...
class TestOutputSurface : public HostCompositorOutputSurface {
 public:
  TestOutputSurface(scoped_refptr<viz::ContextProvider> context_provider)
      : HostCompositorOutputSurface(std::move(context_provider),
