...
class CONTENT_EXPORT SoftwareHostCompositorOutputSurface
 ...
 public:
  ...
  ~SoftwareHostCompositorOutputSurface() override;
 ...
 private:
  ...
  base::WeakPtrFactory<SoftwareHostCompositorOutputSurface> weak_factory_;

  DISALLOW_COPY_AND_ASSIGN(SoftwareHostCompositorOutputSurface);
};
