...
#include "core/host/tracing/file_tracing_provider_impl.h"
#include "core/host/tracing/host_tracing_delegate.h"
//#include "core/host/tracing/tracing_ui.h"
...
#include "core/host/tracing/power_tracing_agent.h"
#endif

#if defined(OS_CHROMEOS)
#include "chromeos/dbus/dbus_thread_manager.h"
#include "chromeos/dbus/debug_daemon_client.h"
#include "core/host/tracing/cros_tracing_agent.h"
#endif

#if defined(CAST_TRACING_AGENT)
#include "core/host/tracing/cast_tracing_agent.h"
#endif

#if defined(OS_WIN)
#include "core/host/tracing/etw_tracing_agent_win.h"
#endif
...
TracingControllerImpl::TracingControllerImpl()
    : delegate_(new HostTracingDelegate()) {
...
TracingControllerImpl::GenerateMetadataDict() const {
  ...
  metadata_dict->SetString("product-version", common::GetClient()->GetProduct());
  metadata_dict->SetString("v8-version", V8_VERSION_STRING);
  metadata_dict->SetString("user-agent", common::GetClient()->GetUserAgent());
