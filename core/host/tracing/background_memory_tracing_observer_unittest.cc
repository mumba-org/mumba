...
#include "core/host/tracing/background_memory_tracing_observer.h"
...
#include "core/host/tracing/background_tracing_config_impl.h"
#include "content/public/test/test_host_thread.h"
...
class BackgroundMemoryTracingObserverTest : public testing::Test {
 public:
  BackgroundMemoryTracingObserverTest()
      : ui_thread_(HostThread::UI, &message_loop_) {}
