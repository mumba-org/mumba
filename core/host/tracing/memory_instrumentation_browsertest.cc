...
class MemoryInstrumentationTest : public ContentHostTest {
 protected:
...
// TODO(hjd): Move this once we have a resource_coordinator folder in host.
IN_PROC_BROWSER_TEST_F(MemoryInstrumentationTest,
  ...
  content::WebContents* web_contents = host()->web_contents();
