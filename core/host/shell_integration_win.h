...
#ifndef CHROME_BROWSER_DOMAIN_INTEGRATION_WIN_H_
#define CHROME_BROWSER_DOMAIN_INTEGRATION_WIN_H_
...
// calling GetAppModelIdForProfile() with DomainUtil::GetAppId() as app_name.
...
#endif  // CHROME_BROWSER_DOMAIN_INTEGRATION_WIN_H_
