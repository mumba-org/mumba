...
#ifndef MUMBA_HOST_RPC_TAB_HANDLER_H_
#define MUMBA_HOST_RPC_TAB_HANDLER_H_
...
class TabActivateHandler : public MumbaServicesUnaryCallHandler {
public:  
...
class TabListHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];
...
class TabCloseHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];
