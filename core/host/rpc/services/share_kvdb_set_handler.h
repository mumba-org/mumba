...
#ifndef MUMBA_HOST_RPC_SHARE_KVDB_SET_HANDLER_H_
#define MUMBA_HOST_RPC_SHARE_KVDB_SET_HANDLER_H_
...
class ShareKvDbHandler : public MumbaServicesUnaryCallHandler {
public:  
