...
#ifndef MUMBA_HOST_RPC_INDEX_HANDLER_H_
#define MUMBA_HOST_RPC_INDEX_HANDLER_H_
...
class IndexAddHandler : public MumbaServicesUnaryCallHandler {
public:  
...
class IndexCreateHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];
...
class IndexDropHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];
...
class IndexQueryHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];
...
class IndexRemoveHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];
