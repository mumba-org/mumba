...
#ifndef MUMBA_HOST_RPC_FETCH_HANDLER_H_
#define MUMBA_HOST_RPC_FETCH_HANDLER_H_
...
class FetchCloseHandler : public MumbaServicesUnaryCallHandler {
public:  
...
class FetchStartHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];
