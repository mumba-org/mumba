...
#ifndef MUMBA_HOST_RPC_MARKET_HANDLER_H_
#define MUMBA_HOST_RPC_MARKET_HANDLER_H_
...
class MarketCreateAccountHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  MarketCreateAccountHandler();
  ~MarketCreateAccountHandler();
