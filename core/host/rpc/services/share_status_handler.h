...
#ifndef MUMBA_HOST_RPC_SHARE_STATUS_HANDLER_H_
#define MUMBA_HOST_RPC_SHARE_STATUS_HANDLER_H_
...
class ShareStatusHandler : public MumbaServicesUnaryCallHandler {
public:  
