...
#ifndef MUMBA_HOST_RPC_WEBSHARE_HANDLER_H_
#define MUMBA_HOST_RPC_WEBSHARE_HANDLER_H_
...
class WebshareShareHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  WebshareShareHandler();
  ~WebshareShareHandler();
