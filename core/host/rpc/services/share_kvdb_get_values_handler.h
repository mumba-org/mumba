...
#ifndef MUMBA_HOST_RPC_BATTERY_INFO_HANDLER_H_
#define MUMBA_HOST_RPC_BATTERY_INFO_HANDLER_H_
...
class ShareKvDbGetValuesHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  ShareKvDbGetValuesHandler();
  ~ShareKvDbGetValuesHandler();
