...
#ifndef MUMBA_HOST_RPC_WINDOW_HANDLER_H_
#define MUMBA_HOST_RPC_WINDOW_HANDLER_H_
...
class WindowActivateHandler : public MumbaServicesUnaryCallHandler {
public:  
...
class WindowListHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];
