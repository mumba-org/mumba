...
#ifndef MUMBA_HOST_RPC_SENSOR_GYROSCOPE_STOP_HANDLER_H_
#define MUMBA_HOST_RPC_SENSOR_GYROSCOPE_STOP_HANDLER_H_
...
class SensorGyroscopeStopHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  SensorGyroscopeStopHandler();
  ~SensorGyroscopeStopHandler();
