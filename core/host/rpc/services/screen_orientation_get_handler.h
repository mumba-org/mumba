...
#ifndef MUMBA_HOST_RPC_SCREEN_ORIENTATION_GET_HANDLER_H_
#define MUMBA_HOST_RPC_SCREEN_ORIENTATION_GET_HANDLER_H_
...
class ScreenOrientationGetHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  ScreenOrientationGetHandler();
  ~ScreenOrientationGetHandler();
