...
#ifndef MUMBA_HOST_RPC_DOM_STORAGE_HANDLER_H_
#define MUMBA_HOST_RPC_DOM_STORAGE_HANDLER_H_
...
class DomStorageGetHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  DomStorageGetHandler();
  ~DomStorageGetHandler();
...
class DomStorageRemoveHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  DomStorageRemoveHandler();
  ~DomStorageRemoveHandler();
...
class DomStorageSetHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  DomStorageSetHandler();
  ~DomStorageSetHandler();
