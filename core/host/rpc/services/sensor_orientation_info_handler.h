...
#ifndef MUMBA_HOST_RPC_SENSOR_ORIENTATION_INFO_HANDLER_H_
#define MUMBA_HOST_RPC_SENSOR_ORIENTATION_INFO_HANDLER_H_
...
class SensorOrientationInfoHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  SensorOrientationInfoHandler();
  ~SensorOrientationInfoHandler();
