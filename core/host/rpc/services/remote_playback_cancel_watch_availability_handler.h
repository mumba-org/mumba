...
#ifndef MUMBA_HOST_RPC_REMOTE_PLAYBACK_CANCEL_WATCH_AVAILABILITY_HANDLER_H_
#define MUMBA_HOST_RPC_REMOTE_PLAYBACK_CANCEL_WATCH_AVAILABILITY_HANDLER_H_
...
class RemotePlaybackCancelWatchAvailabilityHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  RemotePlaybackCancelWatchAvailabilityHandler();
  ~RemotePlaybackCancelWatchAvailabilityHandler();
