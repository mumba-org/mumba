...
#ifndef MUMBA_HOST_RPC_PUSH_MESSAGE_SUBSCRIBE_HANDLER_H_
#define MUMBA_HOST_RPC_PUSH_MESSAGE_SUBSCRIBE_HANDLER_H_
...
class PushMessageSubscribeHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  PushMessageSubscribeHandler();
  ~PushMessageSubscribeHandler();
