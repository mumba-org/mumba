...
#ifndef MUMBA_HOST_RPC_SHARE_REMOVE_HANDLER_H_
#define MUMBA_HOST_RPC_SHARE_REMOVE_HANDLER_H_
...
class ShareRemoveHandler : public MumbaServicesUnaryCallHandler {
public:  
