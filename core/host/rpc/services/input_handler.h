...
#ifndef MUMBA_HOST_RPC_INPUT_HANDLER_H_
#define MUMBA_HOST_RPC_INPUT_HANDLER_H_
...
class InputKeyboardHandler : public MumbaServicesUnaryCallHandler {
public:  
...
class InputMouseHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];
...
class InputTouchHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];
