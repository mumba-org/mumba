...
#ifndef MUMBA_HOST_RPC_SHARE_DHT_GET_HANDLER_H_
#define MUMBA_HOST_RPC_SHARE_DHT_GET_HANDLER_H_
...
class ShareDHTGetHandler : public MumbaServicesUnaryCallHandler {
public:  
