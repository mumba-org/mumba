...
#ifndef MUMBA_HOST_RPC_SCRIPT_MODULE_LIST_HANDLER_H_
#define MUMBA_HOST_RPC_SCRIPT_MODULE_LIST_HANDLER_H_
...
class ScriptModuleListHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  ScriptModuleListHandler();
  ~ScriptModuleListHandler();
