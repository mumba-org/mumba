...
#ifndef MUMBA_HOST_RPC_SENSOR_GYROSCOPE_START_HANDLER_H_
#define MUMBA_HOST_RPC_SENSOR_GYROSCOPE_START_HANDLER_H_
...
class SensorGyroscopeStartHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  SensorGyroscopeStartHandler();
  ~SensorGyroscopeStartHandler();
