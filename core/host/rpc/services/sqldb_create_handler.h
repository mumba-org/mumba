...
#ifndef MUMBA_HOST_RPC_SQLDB_CREATE_HANDLER_H_
#define MUMBA_HOST_RPC_SQLDB_CREATE_HANDLER_H_
...
class SqlDbCreateHandler : public MumbaServicesUnaryCallHandler {
public:  
