...
#ifndef MUMBA_HOST_RPC_USB_DEVICE_HANDLER_H_
#define MUMBA_HOST_RPC_USB_DEVICE_HANDLER_H_
...
class UsbDeviceInfoHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  UsbDeviceInfoHandler();
  ~UsbDeviceInfoHandler();
...
class UsbRequestDeviceHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  UsbRequestDeviceHandler();
  ~UsbRequestDeviceHandler();
...
class UsbGetDevicesHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  UsbGetDevicesHandler();
  ~UsbGetDevicesHandler();
