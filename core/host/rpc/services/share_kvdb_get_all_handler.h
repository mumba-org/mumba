...
#ifndef MUMBA_HOST_RPC_SHARE_KVDB_GET_ALL_HANDLER_H_
#define MUMBA_HOST_RPC_SHARE_KVDB_GET_ALL_HANDLER_H_
...
class ShareKvDbGetAllHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  ShareKvDbGetAllHandler();
  ~ShareKvDbGetAllHandler();
