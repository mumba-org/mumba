...
#ifndef MUMBA_HOST_RPC_KEYBOARD_LOCK_HANDLER_H_
#define MUMBA_HOST_RPC_KEYBOARD_LOCK_HANDLER_H_
...
class KeyboardLockHandler : public MumbaServicesUnaryCallHandler {
public:  
...
class KeyboardUnlockHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  KeyboardUnlockHandler();
  ~KeyboardUnlockHandler();
