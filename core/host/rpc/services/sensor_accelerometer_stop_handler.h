...
#ifndef MUMBA_HOST_RPC_SENSOR_ACCELEROMETER_STOP_HANDLER_H_
#define MUMBA_HOST_RPC_SENSOR_ACCELEROMETER_STOP_HANDLER_H_
...
class SensorAccelerometerStopHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  SensorAccelerometerStopHandler();
  ~SensorAccelerometerStopHandler();
