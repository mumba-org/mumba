...
#ifndef MUMBA_HOST_RPC_SHARE_CREATE_FILESET_HANDLER_H_
#define MUMBA_HOST_RPC_SHARE_CREATE_FILESET_HANDLER_H_
...
class ShareCreateFilesetHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  ShareCreateFilesetHandler();
  ~ShareCreateFilesetHandler();
