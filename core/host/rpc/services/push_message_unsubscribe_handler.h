...
#ifndef MUMBA_HOST_RPC_PUSH_MESSAGE_UNSUBSCRIBE_HANDLER_H_
#define MUMBA_HOST_RPC_PUSH_MESSAGE_UNSUBSCRIBE_HANDLER_H_
...
class PushMessageUnsubscribeHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  PushMessageUnsubscribeHandler();
  ~PushMessageUnsubscribeHandler();
