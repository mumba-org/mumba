...
#ifndef MUMBA_HOST_RPC_ROUTE_GET_ENTRY_HANDLER_H_
#define MUMBA_HOST_RPC_ROUTE_GET_ENTRY_HANDLER_H_
...
class RouteGetEntryHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  RouteGetEntryHandler();
  ~RouteGetEntryHandler();
