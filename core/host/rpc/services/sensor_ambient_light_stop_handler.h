...
#ifndef MUMBA_HOST_RPC_SENSOR_AMBIENT_LIGHT_STOP_HANDLER_H_
#define MUMBA_HOST_RPC_SENSOR_AMBIENT_LIGHT_STOP_HANDLER_H_
...
class SensorAmbientLightStopHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  SensorAmbientLightStopHandler();
  ~SensorAmbientLightStopHandler();
