...
#ifndef MUMBA_HOST_RPC_SENSOR_GYROSCOPE_INFO_HANDLER_H_
#define MUMBA_HOST_RPC_SENSOR_GYROSCOPE_INFO_HANDLER_H_
...
class SensorGyroscopeInfoHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  SensorGyroscopeInfoHandler();
  ~SensorGyroscopeInfoHandler();
