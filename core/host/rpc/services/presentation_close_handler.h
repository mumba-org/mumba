...
#ifndef MUMBA_HOST_RPC_PRESENTATION_CLOSE_HANDLER_H_
#define MUMBA_HOST_RPC_PRESENTATION_CLOSE_HANDLER_H_
...
class PresentationCloseHandler : public MumbaServicesUnaryCallHandler {
public:  
