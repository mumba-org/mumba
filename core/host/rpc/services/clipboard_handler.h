...
#ifndef MUMBA_HOST_RPC_CLIPBOARD_HANDLER_H_
#define MUMBA_HOST_RPC_CLIPBOARD_HANDLER_H_
...
class ClipboardReadHandler : public MumbaServicesUnaryCallHandler {
public:  
...
class ClipboardReadTextHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  ClipboardReadTextHandler();
  ~ClipboardReadTextHandler();
...
class ClipboardWriteHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];
...
class ClipboardWriteTextHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  ClipboardWriteTextHandler();
  ~ClipboardWriteTextHandler();
