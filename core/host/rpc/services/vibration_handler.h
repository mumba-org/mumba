...
#ifndef MUMBA_HOST_RPC_VIBRATION_HANDLER_H_
#define MUMBA_HOST_RPC_VIBRATION_HANDLER_H_
...
class VibrationVibrateHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  VibrationVibrateHandler();
  ~VibrationVibrateHandler();
