...
#ifndef MUMBA_HOST_RPC_MIDI_HANDLER_H_
#define MUMBA_HOST_RPC_MIDI_HANDLER_H_
...
class MidiCloseHandler : public MumbaServicesUnaryCallHandler {
public:  
...
class MidiOpenHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];
...
class MidiSendHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];
