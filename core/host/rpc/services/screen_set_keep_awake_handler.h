...
#ifndef MUMBA_HOST_RPC_SCREEN_SET_KEEP_AWAKE_HANDLER_H_
#define MUMBA_HOST_RPC_SCREEN_SET_KEEP_AWAKE_HANDLER_H_
...
class ScreenSetKeepAwakeHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  ScreenSetKeepAwakeHandler();
  ~ScreenSetKeepAwakeHandler();
