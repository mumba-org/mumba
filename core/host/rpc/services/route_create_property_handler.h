...
#ifndef MUMBA_HOST_RPC_ROUTE_CREATE_PROPERTY_HANDLER_H_
#define MUMBA_HOST_RPC_ROUTE_CREATE_PROPERTY_HANDLER_H_
...
class RouteCreatePropertyHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  RouteCreatePropertyHandler();
  ~RouteCreatePropertyHandler();
