...
#ifndef MUMBA_HOST_RPC_SCHEMA_REMOVE_HANDLER_H_
#define MUMBA_HOST_RPC_SCHEMA_REMOVE_HANDLER_H_
...
class SchemaRemoveHandler : public MumbaServicesUnaryCallHandler {
public:  
