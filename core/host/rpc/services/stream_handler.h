...
#ifndef MUMBA_HOST_RPC_STREAM_HANDLER_H_
#define MUMBA_HOST_RPC_STREAM_HANDLER_H_
...
class StreamListHandler : public MumbaServicesUnaryCallHandler {
public:  
...
class StreamWriteHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];
...
class StreamReadHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];
