...
#ifndef MUMBA_HOST_RPC_GEOLOCATION_CLEAR_WATCH_HANDLER_H_
#define MUMBA_HOST_RPC_GEOLOCATION_CLEAR_WATCH_HANDLER_H_
...
class GeolocationClearWatchHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  GeolocationClearWatchHandler();
  ~GeolocationClearWatchHandler();
...
class GeolocationGetCurrentPositionHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  GeolocationGetCurrentPositionHandler();
  ~GeolocationGetCurrentPositionHandler();
...
class GeolocationWatchPositionHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  GeolocationWatchPositionHandler();
  ~GeolocationWatchPositionHandler();
