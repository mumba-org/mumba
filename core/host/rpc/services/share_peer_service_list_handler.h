...
#ifndef MUMBA_HOST_RPC_SHARE_PEER_SERVICE_LIST_HANDLER_H_
#define MUMBA_HOST_RPC_SHARE_PEER_SERVICE_LIST_HANDLER_H_
...
class SharePeerServiceListHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  SharePeerServiceListHandler();
  ~SharePeerServiceListHandler();
