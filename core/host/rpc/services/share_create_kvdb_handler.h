...
#ifndef MUMBA_HOST_RPC_SHARE_CREATE_KVDB_HANDLER_H_
#define MUMBA_HOST_RPC_SHARE_CREATE_KVDB_HANDLER_H_
...
class ShareCreateKvDbHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  ShareCreateKvDbHandler();
  ~ShareCreateKvDbHandler();
