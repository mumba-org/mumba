...
#ifndef MUMBA_HOST_RPC_PRESENTATION_RECONNECT_HANDLER_H_
#define MUMBA_HOST_RPC_PRESENTATION_RECONNECT_HANDLER_H_
...
class PresentationReconnectHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  PresentationReconnectHandler();
  ~PresentationReconnectHandler();
