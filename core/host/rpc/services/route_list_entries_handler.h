...
#ifndef MUMBA_HOST_RPC_ROUTE_LIST_ENTRIES_HANDLER_H_
#define MUMBA_HOST_RPC_ROUTE_LIST_ENTRIES_HANDLER_H_
...
class RouteListEntriesHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  RouteListEntriesHandler();
  ~RouteListEntriesHandler();
