...
#ifndef MUMBA_HOST_RPC_PUSH_MESSAGE_SEND_HANDLER_H_
#define MUMBA_HOST_RPC_PUSH_MESSAGE_SEND_HANDLER_H_
...
class PushMessageSendHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  PushMessageSendHandler();
  ~PushMessageSendHandler();
