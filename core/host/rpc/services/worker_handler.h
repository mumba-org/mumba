...
#ifndef MUMBA_HOST_RPC_WORKER_HANDLER_H_
#define MUMBA_HOST_RPC_WORKER_HANDLER_H_
...
class WorkerListHandler : public MumbaServicesUnaryCallHandler {
public:  
...
class WorkerTerminateHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  WorkerTerminateHandler();
  ~WorkerTerminateHandler();
