...
#ifndef MUMBA_HOST_RPC_SESSION_HANDLER_H_
#define MUMBA_HOST_RPC_SESSION_HANDLER_H_
...
class SessionInfoHandler : public MumbaServicesUnaryCallHandler {
public:  
...
class SessionListHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];
