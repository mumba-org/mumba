...
#ifndef MUMBA_HOST_RPC_REMOTE_PLAYBACK_WATCH_AVAILABILITY_HANDLER_H_
#define MUMBA_HOST_RPC_REMOTE_PLAYBACK_WATCH_AVAILABILITY_HANDLER_H_
...
class RemotePlaybackWatchAvailabilityHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  RemotePlaybackWatchAvailabilityHandler();
  ~RemotePlaybackWatchAvailabilityHandler();
