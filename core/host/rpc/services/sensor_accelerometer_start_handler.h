...
#ifndef MUMBA_HOST_RPC_SENSOR_ACCELEROMETER_START_HANDLER_H_
#define MUMBA_HOST_RPC_SENSOR_ACCELEROMETER_START_HANDLER_H_
...
class SensorAccelerometerStartHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  SensorAccelerometerStartHandler();
  ~SensorAccelerometerStartHandler();
