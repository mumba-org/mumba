...
#ifndef MUMBA_HOST_RPC_SENSOR_MAGNETOMETER_INFO_HANDLER_H_
#define MUMBA_HOST_RPC_SENSOR_MAGNETOMETER_INFO_HANDLER_H_
...
class SensorMagnetometerInfoHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  SensorMagnetometerInfoHandler();
  ~SensorMagnetometerInfoHandler();
