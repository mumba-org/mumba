...
#ifndef MUMBA_HOST_RPC_ROUTE_CREATE_COLLECTION_HANDLER_H_
#define MUMBA_HOST_RPC_ROUTE_CREATE_COLLECTION_HANDLER_H_
...
class RouteCreateCollectionHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  RouteCreateCollectionHandler();
  ~RouteCreateCollectionHandler();
