...
#ifndef MUMBA_HOST_RPC_ROUTE_LIST_PROPERTIES_HANDLER_H_
#define MUMBA_HOST_RPC_ROUTE_LIST_PROPERTIES_HANDLER_H_
...
class RouteListPropertiesHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  RouteListPropertiesHandler();
  ~RouteListPropertiesHandler();
