...
#ifndef MUMBA_HOST_RPC_SHARE_PEER_LIST_HANDLER_H_
#define MUMBA_HOST_RPC_SHARE_PEER_LIST_HANDLER_H_
...
class SharePeerListHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  SharePeerListHandler();
  ~SharePeerListHandler();
