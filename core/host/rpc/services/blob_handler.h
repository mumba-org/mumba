...
#ifndef MUMBA_HOST_RPC_BLOB_HANDLER_H_
#define MUMBA_HOST_RPC_BLOB_HANDLER_H_
...
class BlobListHandler : public MumbaServicesUnaryCallHandler {
public:  
...
class BlobReadHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];
...
class BlobWriteHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];
...
class BlobDeleteHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];
...
class BlobCreateHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];
