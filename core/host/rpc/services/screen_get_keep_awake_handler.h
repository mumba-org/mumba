...
#ifndef MUMBA_HOST_RPC_SCREEN_GET_KEEP_AWAKE_HANDLER_H_
#define MUMBA_HOST_RPC_SCREEN_GET_KEEP_AWAKE_HANDLER_H_
...
class ScreenGetKeepAwakeHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  ScreenGetKeepAwakeHandler();
  ~ScreenGetKeepAwakeHandler();
