...
#ifndef MUMBA_HOST_RPC_WEBSOCKET_HANDLER_H_
#define MUMBA_HOST_RPC_WEBSOCKET_HANDLER_H_
...
class WebsocketCloseHandler : public MumbaServicesUnaryCallHandler {
public:  
...
class WebsocketStartHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];
...
class WebsocketSendHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];
