...
#ifndef MUMBA_HOST_RPC_SHARE_RESUME_HANDLER_H_
#define MUMBA_HOST_RPC_SHARE_RESUME_HANDLER_H_
...
class ShareResumeHandler : public MumbaServicesUnaryCallHandler {
public:  
