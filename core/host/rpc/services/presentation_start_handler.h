...
#ifndef MUMBA_HOST_RPC_PRESENTATION_START_HANDLER_H_
#define MUMBA_HOST_RPC_PRESENTATION_START_HANDLER_H_
...
class PresentationStartHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  PresentationStartHandler();
  ~PresentationStartHandler();
