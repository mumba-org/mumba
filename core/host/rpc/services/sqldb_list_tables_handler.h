...
#ifndef MUMBA_HOST_RPC_SQLDB_LIST_TABLES_HANDLER_H_
#define MUMBA_HOST_RPC_SQLDB_LIST_TABLES_HANDLER_H_
...
class SqlDbListTablesHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  SqlDbListTablesHandler();
  ~SqlDbListTablesHandler();
