...
#ifndef MUMBA_HOST_RPC_COOKIE_HANDLER_H_
#define MUMBA_HOST_RPC_COOKIE_HANDLER_H_
...
class CookieGetAllHandler : public MumbaServicesUnaryCallHandler {
public:  
...
class CookieGetHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];
...
class CookieDeleteHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];
...
class CookieHasHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];
...
class CookieSetHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];
