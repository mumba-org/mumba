...
#ifndef MUMBA_HOST_RPC_ROUTE_RESOLVE_HANDLER_H_
#define MUMBA_HOST_RPC_ROUTE_RESOLVE_HANDLER_H_
...
class RouteResolveHandler : public MumbaServicesUnaryCallHandler {
public:  
