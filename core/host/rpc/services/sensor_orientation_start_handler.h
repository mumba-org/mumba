...
#ifndef MUMBA_HOST_RPC_SENSOR_ORIENTATION_START_HANDLER_H_
#define MUMBA_HOST_RPC_SENSOR_ORIENTATION_START_HANDLER_H_
...
class SensorOrientationStartHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  SensorOrientationStartHandler();
  ~SensorOrientationStartHandler();
