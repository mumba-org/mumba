...
#ifndef MUMBA_HOST_RPC_SHARE_ADD_FILESET_HANDLER_H_
#define MUMBA_HOST_RPC_SHARE_ADD_FILESET_HANDLER_H_
...
class ShareAddFilesetHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  ShareAddFilesetHandler();
  ~ShareAddFilesetHandler();
