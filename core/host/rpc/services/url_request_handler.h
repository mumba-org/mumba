...
#ifndef MUMBA_HOST_RPC_URL_REQUEST_HANDLER_H_
#define MUMBA_HOST_RPC_URL_REQUEST_HANDLER_H_
...
class UrlRequestCloseHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  UrlRequestCloseHandler();
  ~UrlRequestCloseHandler();
...
class UrlRequestStartHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  UrlRequestStartHandler();
  ~UrlRequestStartHandler();
