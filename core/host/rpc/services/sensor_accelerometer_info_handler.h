...
#ifndef MUMBA_HOST_RPC_SENSOR_ACCELEROMETER_INFO_HANDLER_H_
#define MUMBA_HOST_RPC_SENSOR_ACCELEROMETER_INFO_HANDLER_H_
...
class SensorAccelerometerInfoHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  SensorAccelerometerInfoHandler();
  ~SensorAccelerometerInfoHandler();
