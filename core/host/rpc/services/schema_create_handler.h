...
#ifndef MUMBA_HOST_RPC_SCHEMA_CREATE_HANDLER_H_
#define MUMBA_HOST_RPC_SCHEMA_CREATE_HANDLER_H_
...
class SchemaCreateHandler : public MumbaServicesUnaryCallHandler {
public:  
