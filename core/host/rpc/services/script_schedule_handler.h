...
#ifndef MUMBA_HOST_RPC_SCRIPT_SCHEDULE_HANDLER_H_
#define MUMBA_HOST_RPC_SCRIPT_SCHEDULE_HANDLER_H_
...
class ScriptScheduleHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  ScriptScheduleHandler();
  ~ScriptScheduleHandler();
