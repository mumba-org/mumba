...
#ifndef MUMBA_HOST_RPC_SENSOR_AMBIENT_LIGHT_START_HANDLER_H_
#define MUMBA_HOST_RPC_SENSOR_AMBIENT_LIGHT_START_HANDLER_H_
...
class SensorAmbientLightStartHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  SensorAmbientLightStartHandler();
  ~SensorAmbientLightStartHandler();
