...
#ifndef MUMBA_HOST_RPC_SENSOR_MAGNETOMETER_STOP_HANDLER_H_
#define MUMBA_HOST_RPC_SENSOR_MAGNETOMETER_STOP_HANDLER_H_
...
class SensorMagnetometerStopHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  SensorMagnetometerStopHandler();
  ~SensorMagnetometerStopHandler();
