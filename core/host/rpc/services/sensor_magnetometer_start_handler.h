...
#ifndef MUMBA_HOST_RPC_SENSOR_MAGNETOMETER_START_HANDLER_H_
#define MUMBA_HOST_RPC_SENSOR_MAGNETOMETER_START_HANDLER_H_
...
class SensorMagnetometerStartHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  SensorMagnetometerStartHandler();
  ~SensorMagnetometerStartHandler();
