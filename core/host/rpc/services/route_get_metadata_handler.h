...
#ifndef MUMBA_HOST_RPC_ROUTE_GET_METADATA_HANDLER_H_
#define MUMBA_HOST_RPC_ROUTE_GET_METADATA_HANDLER_H_
...
class RouteGetMetadataHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  RouteGetMetadataHandler();
  ~RouteGetMetadataHandler();
