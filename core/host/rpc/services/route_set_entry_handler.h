...
#ifndef MUMBA_HOST_RPC_ROUTE_SET_ENTRY_HANDLER_H_
#define MUMBA_HOST_RPC_ROUTE_SET_ENTRY_HANDLER_H_
...
class RouteSetEntryHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  RouteSetEntryHandler();
  ~RouteSetEntryHandler();
