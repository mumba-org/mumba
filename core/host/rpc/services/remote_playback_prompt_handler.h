...
#ifndef MUMBA_HOST_RPC_REMOTE_PLAYBACK_PROMPT_HANDLER_H_
#define MUMBA_HOST_RPC_REMOTE_PLAYBACK_PROMPT_HANDLER_H_
...
class RemotePlaybackPromptHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  RemotePlaybackPromptHandler();
  ~RemotePlaybackPromptHandler();
