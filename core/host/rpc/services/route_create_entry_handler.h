...
#ifndef MUMBA_HOST_RPC_ROUTE_CREATE_ENTRY_HANDLER_H_
#define MUMBA_HOST_RPC_ROUTE_CREATE_ENTRY_HANDLER_H_
...
class RouteCreateEntryHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  RouteCreateEntryHandler();
  ~RouteCreateEntryHandler();
