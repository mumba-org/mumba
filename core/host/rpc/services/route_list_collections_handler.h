...
#ifndef MUMBA_HOST_RPC_ROUTE_LIST_COLLECTIONS_HANDLER_H_
#define MUMBA_HOST_RPC_ROUTE_LIST_COLLECTIONS_HANDLER_H_
...
class RouteListCollectionsHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  RouteListCollectionsHandler();
  ~RouteListCollectionsHandler();
