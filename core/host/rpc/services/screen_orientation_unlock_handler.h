...
#ifndef MUMBA_HOST_RPC_SCREEN_ORIENTATION_UNLOCK_HANDLER_H_
#define MUMBA_HOST_RPC_SCREEN_ORIENTATION_UNLOCK_HANDLER_H_
...
class ScreenOrientationUnlockHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  ScreenOrientationUnlockHandler();
  ~ScreenOrientationUnlockHandler();
