...
#ifndef MUMBA_HOST_RPC_CHANNEL_HANDLER_H_
#define MUMBA_HOST_RPC_CHANNEL_HANDLER_H_
...
class ChannelCreateHandler : public MumbaServicesUnaryCallHandler {
public:  
...
class ChannelDropHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];
