...
#ifndef MUMBA_HOST_RPC_CSS_HANDLER_H_
#define MUMBA_HOST_RPC_CSS_HANDLER_H_
...
class CSSAddRuleHandler : public MumbaServicesUnaryCallHandler {
public:  
...
class CSSGetStylesheetTextHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  CSSGetStylesheetTextHandler();
  ~CSSGetStylesheetTextHandler();
...
class CSSSetStyleTextsHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  CSSSetStyleTextsHandler();
  ~CSSSetStyleTextsHandler();
...
class CSSSetStylesheetTextHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  CSSSetStylesheetTextHandler();
  ~CSSSetStylesheetTextHandler();
