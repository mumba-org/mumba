...
#ifndef MUMBA_HOST_RPC_SHARE_CREATE_SQLDB_HANDLER_H_
#define MUMBA_HOST_RPC_SHARE_CREATE_SQLDB_HANDLER_H_
...
class ShareCreateSqlDbHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  ShareCreateSqlDbHandler();
  ~ShareCreateSqlDbHandler();
