...
#ifndef MUMBA_HOST_RPC_SCRIPT_REMOVE_HANDLER_H_
#define MUMBA_HOST_RPC_SCRIPT_REMOVE_HANDLER_H_
...
class ScriptRemoveHandler : public MumbaServicesUnaryCallHandler {
public:  
