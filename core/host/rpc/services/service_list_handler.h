...
#ifndef MUMBA_HOST_RPC_SERVICE_LIST_HANDLER_H_
#define MUMBA_HOST_RPC_SERVICE_LIST_HANDLER_H_
...
class ServiceListHandler : public MumbaServicesUnaryCallHandler {
public:
  
  static const char kFullname[];

  ServiceListHandler();
  ~ServiceListHandler() override;
...
private:
  ...
  void Init();
  void ProcessServiceListOnUI(base::Callback<void(int)> cb);
