...
#ifndef MUMBA_HOST_RPC_ROUTE_REMOVE_PROPERTY_HANDLER_H_
#define MUMBA_HOST_RPC_ROUTE_REMOVE_PROPERTY_HANDLER_H_
...
class RouteRemovePropertyHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  RouteRemovePropertyHandler();
  ~RouteRemovePropertyHandler();
