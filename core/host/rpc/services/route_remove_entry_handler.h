...
#ifndef MUMBA_HOST_RPC_ROUTE_REMOVE_ENTRY_HANDLER_H_
#define MUMBA_HOST_RPC_ROUTE_REMOVE_ENTRY_HANDLER_H_
...
class RouteRemoveEntryHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  RouteRemoveEntryHandler();
  ~RouteRemoveEntryHandler();
