...
#ifndef MUMBA_HOST_RPC_SHARE_KVDB_GET_HANDLER_H_
#define MUMBA_HOST_RPC_SHARE_KVDB_GET_HANDLER_H_
...
class ShareKvDbGetHandler : public MumbaServicesUnaryCallHandler {
public:  
