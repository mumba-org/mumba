...
#ifndef MUMBA_HOST_RPC_SCRIPT_WRITE_HANDLER_H_
#define MUMBA_HOST_RPC_SCRIPT_WRITE_HANDLER_H_
...
class ScriptWriteHandler : public MumbaServicesUnaryCallHandler {
public:  
