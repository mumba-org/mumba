...
#ifndef MUMBA_HOST_RPC_SCREEN_ORIENTATION_LOCK_HANDLER_H_
#define MUMBA_HOST_RPC_SCREEN_ORIENTATION_LOCK_HANDLER_H_
...
class ScreenOrientationLockHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  ScreenOrientationLockHandler();
  ~ScreenOrientationLockHandler();
