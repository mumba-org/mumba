...
#ifndef MUMBA_HOST_RPC_MEDIA_HANDLER_H_
#define MUMBA_HOST_RPC_MEDIA_HANDLER_H_
...
class MediaGetAudioConfigurationHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  MediaGetAudioConfigurationHandler();
  ~MediaGetAudioConfigurationHandler();
...
class MediaGetVideoConfigurationHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  MediaGetVideoConfigurationHandler();
  ~MediaGetVideoConfigurationHandler();
