...
#ifndef MUMBA_HOST_RPC_ROUTE_QUERY_HANDLER_HANDLER_H_
#define MUMBA_HOST_RPC_ROUTE_QUERY_HANDLER_HANDLER_H_
...
class RouteQueryHandler : public MumbaServicesUnaryCallHandler {
public:  
