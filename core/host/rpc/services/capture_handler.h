...
#ifndef MUMBA_HOST_RPC_CAPTURE_HANDLER_H_
#define MUMBA_HOST_RPC_CAPTURE_HANDLER_H_
...
class CaptureTakePhotoHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  CaptureTakePhotoHandler();
  ~CaptureTakePhotoHandler();
