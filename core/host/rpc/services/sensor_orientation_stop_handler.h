...
#ifndef MUMBA_HOST_RPC_SENSOR_ORIENTATION_STOP_HANDLER_H_
#define MUMBA_HOST_RPC_SENSOR_ORIENTATION_STOP_HANDLER_H_
...
class SensorOrientationStopHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  SensorOrientationStopHandler();
  ~SensorOrientationStopHandler();
