...
#ifndef MUMBA_HOST_RPC_REPO_INSTALL_HANDLER_H_
#define MUMBA_HOST_RPC_REPO_INSTALL_HANDLER_H_
...
class RepoInstallHandler : public MumbaServicesUnaryCallHandler {
public:  
