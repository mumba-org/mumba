...
#ifndef MUMBA_HOST_RPC_SHARE_PEER_STATUS_HANDLER_H_
#define MUMBA_HOST_RPC_SHARE_PEER_STATUS_HANDLER_H_
...
class SharePeerStatusHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  SharePeerStatusHandler();
  ~SharePeerStatusHandler();
