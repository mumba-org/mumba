...
#ifndef MUMBA_HOST_RPC_SENSOR_AMBIENT_LIGHT_INFO_HANDLER_H_
#define MUMBA_HOST_RPC_SENSOR_AMBIENT_LIGHT_INFO_HANDLER_H_
...
class SensorAmbientLightInfoHandler : public MumbaServicesUnaryCallHandler {
public:  
  static const char kFullname[];

  SensorAmbientLightInfoHandler();
  ~SensorAmbientLightInfoHandler();
