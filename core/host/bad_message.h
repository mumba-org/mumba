...
// The host process often chooses to terminate a renderer if it receives
...
// Called when the host receives a bad IPC message from a renderer process on
...
// Called when a host message filter receives a bad IPC message from a
