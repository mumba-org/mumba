...
class GpuProcessHost : public HostChildProcessHostDelegate,
                       public IPC::Sender,
 ...
 public:
  ...
  // host must submit CompositorFrames over IPC.
 ...
 private:
  ...
  // HostChildProcessHostDelegate implementation.
  ...
  // Whether we are running a GPU thread inside the host process instead
  ...
  std::unique_ptr<HostChildProcessHostImpl> process_;
