...
HostGpuMemoryBufferManager* g_gpu_memory_buffer_manager = nullptr;

}  // namespace

struct HostGpuMemoryBufferManager::CreateGpuMemoryBufferRequest {
...
HostGpuMemoryBufferManager::HostGpuMemoryBufferManager(
  ...
  // HostProcessSubThread::IOThreadPreCleanUp).
  DCHECK(HostThread::GetTaskRunnerForThread(HostThread::IO));
  base::trace_event::MemoryDumpManager::GetInstance()->RegisterDumpProvider(
      this, "HostGpuMemoryBufferManager",
...
// static
HostGpuMemoryBufferManager* HostGpuMemoryBufferManager::current() {
...
void HostGpuMemoryBufferManager::AllocateGpuMemoryBufferForChildProcess(
...
bool HostGpuMemoryBufferManager::OnMemoryDump(
  ...
  for (const auto& client : clients_) {
    ...
    for (const auto& buffer : client.second) {
      ...
      // dump with the same guid, the segment will be accounted to the host.
...
void HostGpuMemoryBufferManager::ChildProcessDeletedGpuMemoryBuffer(
    gfx::GpuMemoryBufferId id,
    int child_client_id,
    const gpu::SyncToken& sync_token) {
  DCHECK_CURRENTLY_ON(HostThread::IO);
...
void HostGpuMemoryBufferManager::ProcessRemoved(
    int client_id) {
  DCHECK_CURRENTLY_ON(HostThread::IO);
...
std::unique_ptr<gfx::GpuMemoryBuffer>
HostGpuMemoryBufferManager::AllocateGpuMemoryBufferForSurface(
    const gfx::Size& size,
    gfx::BufferFormat format,
    gfx::BufferUsage usage,
    gpu::SurfaceHandle surface_handle) {
  ...
  HostThread::PostTask(
      ...
      base::BindOnce(
          &HostGpuMemoryBufferManager::HandleCreateGpuMemoryBufferOnIO,
...
void HostGpuMemoryBufferManager::HandleCreateGpuMemoryBufferOnIO(
  ...
  if (IsNativeGpuMemoryBufferConfiguration(request->format, request->usage)) {
    ...
    CreateGpuMemoryBufferOnIO(
        ...
        base::BindOnce(
            &HostGpuMemoryBufferManager::HandleGpuMemoryBufferCreatedOnIO,
  ...
  request->result = gpu::GpuMemoryBufferImplSharedMemory::Create(
      ...
      base::Bind(
          ...
          HostThread::GetTaskRunnerForThread(HostThread::IO),
          base::Bind(&HostGpuMemoryBufferManager::DestroyGpuMemoryBufferOnIO,
...
void HostGpuMemoryBufferManager::HandleGpuMemoryBufferCreatedOnIO(
    CreateGpuMemoryBufferRequest* request,
  ...
  request->result =
      gpu_memory_buffer_support_->CreateGpuMemoryBufferImplFromHandle(
          ...
          base::Bind(
              ...
              HostThread::GetTaskRunnerForThread(HostThread::IO),
              base::Bind(
                  &HostGpuMemoryBufferManager::DestroyGpuMemoryBufferOnIO,
                  base::Unretained(this), handle.id, request->client_id)));
  request->event.Signal();
}

void HostGpuMemoryBufferManager::CreateGpuMemoryBufferOnIO(
    gfx::GpuMemoryBufferId id,
    const gfx::Size& size,
    gfx::BufferFormat format,
    gfx::BufferUsage usage,
  ...
  host->CreateGpuMemoryBuffer(
      ...
      base::BindOnce(&HostGpuMemoryBufferManager::GpuMemoryBufferCreatedOnIO,
                     base::Unretained(this), id, surface_handle, client_id,
                     host->host_id(), std::move(callback)));
}

void HostGpuMemoryBufferManager::GpuMemoryBufferCreatedOnIO(
    gfx::GpuMemoryBufferId id,
    gpu::SurfaceHandle surface_handle,
    int client_id,
    int gpu_host_id,
...
void HostGpuMemoryBufferManager::DestroyGpuMemoryBufferOnIO(
    gfx::GpuMemoryBufferId id,
    int client_id,
    const gpu::SyncToken& sync_token) {
  DCHECK_CURRENTLY_ON(HostThread::IO);
...
uint64_t HostGpuMemoryBufferManager::ClientIdToTracingProcessId(
    int client_id) const {
  ...
  return common::ChildProcessHostImpl::ChildProcessUniqueIdToTracingProcessId(
      client_id);
}

HostGpuMemoryBufferManager::BufferInfo::BufferInfo(
    const gfx::Size& size,
...
HostGpuMemoryBufferManager::BufferInfo::BufferInfo(const BufferInfo& other) =
    default;
