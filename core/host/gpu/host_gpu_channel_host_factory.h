...
class CONTENT_EXPORT HostGpuChannelHostFactory
    : public gpu::GpuChannelEstablishFactory {
 public:
  static void Initialize(bool establish_gpu_channel);
  static void Terminate();
  static HostGpuChannelHostFactory* instance() { return instance_; }
 ...
 private:
  ...
  HostGpuChannelHostFactory();
  ~HostGpuChannelHostFactory() override;

  void GpuChannelEstablished();
  void RestartTimeout();

  static void InitializeShaderStorageCacheOnIO(int gpu_client_id,
  ...
  static HostGpuChannelHostFactory* instance_;

  DISALLOW_COPY_AND_ASSIGN(HostGpuChannelHostFactory);
};
