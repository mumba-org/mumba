...
#ifndef MUMBA_COMMON_PROTOCOL_COMPOUND_BUFFER_H_
#define MUMBA_COMMON_PROTOCOL_COMPOUND_BUFFER_H_
...
class CONTENT_EXPORT CompoundBuffer {
 public:
  CompoundBuffer();
  ~CompoundBuffer();
...
class CONTENT_EXPORT CompoundBufferInputStream
