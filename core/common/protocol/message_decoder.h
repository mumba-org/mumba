...
#ifndef MUMBA_COMMON_PROTOCOL_MESSAGE_DECODER_H_
#define MUMBA_COMMON_PROTOCOL_MESSAGE_DECODER_H_
...
class CONTENT_EXPORT MessageDecoder {
 public:
  MessageDecoder();
  ...
  // message.
  std::unique_ptr<CompoundBuffer> GetNextMessage();
