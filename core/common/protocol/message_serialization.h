...
#ifndef MUMBA_HOST_COMMON_PROTOCOL_SERIALIZATION_H_
#define MUMBA_HOST_COMMON_PROTOCOL_SERIALIZATION_H_
...
template <class T>
CONTENT_EXPORT std::unique_ptr<T> ParseMessage(CompoundBuffer* buffer) {
...
// decode the message.
CONTENT_EXPORT scoped_refptr<net::IOBufferWithSize> SerializeAndFrameMessage(
    const google::protobuf::MessageLite& msg);

CONTENT_EXPORT bool SerializeAndFrameMessageAsString(
    const google::protobuf::MessageLite& msg, std::string* out);

CONTENT_EXPORT scoped_refptr<net::IOBufferWithSize> SerializeMessage(
    const google::protobuf::MessageLite& msg);
