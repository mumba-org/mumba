...
#ifndef MUMBA_COMMON_PROTOCOL_MESSAGE_CHANNEL_FACTORY_H_
#define MUMBA_COMMON_PROTOCOL_MESSAGE_CHANNEL_FACTORY_H_
...
class CONTENT_EXPORT MessageChannelFactory {
 public:
