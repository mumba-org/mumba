...
#ifndef MUMBA_COMMON_PROTOCOL_MESSAGE_READER_H_
#define MUMBA_COMMON_PROTOCOL_MESSAGE_READER_H_
...
class CONTENT_EXPORT MessageReader {
 public:
  ...
  void StartReading(PeerStreamSocket* socket,
 ...
 private:
  ...
  PeerStreamSocket* socket_ = nullptr;
