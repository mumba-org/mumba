...
#ifndef MUMBA_COMMON_PROTOCOL_PEER_DATAGRAM_SOCKET_H_
#define MUMBA_COMMON_PROTOCOL_PEER_DATAGRAM_SOCKET_H_
...
class CONTENT_EXPORT PeerDatagramSocket {
 public:
  virtual ~PeerDatagramSocket() {};
