...
#ifndef MUMBA_COMMON_PROTOCOL_PEER_STREAM_SOCKET_H_
#define MUMBA_COMMON_PROTOCOL_PEER_STREAM_SOCKET_H_
...
class CONTENT_EXPORT PeerStreamSocket {
 public:
  virtual ~PeerStreamSocket() {};
...
#endif  // MUMBA_HOST_NET_P2P_STREAM_SOCKET_H_
