...
IPC_ENUM_TRAITS_MAX_VALUE(common::GinJavaBridgeError,
                          common::kGinJavaBridgeErrorLast)
...
// a shell to work around immutability of base::Value.
...
IPC_SYNC_MESSAGE_ROUTED3_2(GinJavaBridgeHostMsg_InvokeMethod,
                           ...
                           common::GinJavaBridgeError /* error_code */)
