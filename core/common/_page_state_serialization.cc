...
#include "core/common/page_state.mojom.h"
#include "core/common/unique_name_helper.h"
#include "core/common/referrer_struct_traits.h"
...
namespace mojom = common::history::mojom;
