...
IPC_STRUCT_TRAITS_BEGIN(blink::FramePolicy)
  ...
  IPC_STRUCT_TRAITS_MEMBER(shell_policy)
IPC_STRUCT_TRAITS_END()
...
// Notifies the browser that sandbox flags or shell policy have changed for
// a subframe of this frame.
IPC_MESSAGE_ROUTED2(
    FrameHostMsg_DidChangeFramePolicy,
    int32_t /* subframe_routing_id */,
    blink::FramePolicy /* updated sandbox flags and shell policy */)
