...
#include "core/common/shared_memory_received_data_factory.h"

#include <algorithm>

#include "core/common/resource_messages.h"
...
std::unique_ptr<RequestPeer::ReceivedData> SharedMemoryReceivedDataFactory::Create(
    int offset,
    int length,
    int encoded_length) {
