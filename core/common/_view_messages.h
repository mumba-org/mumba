...
//#include "core/common/date_time_suggestion.h"
//#include "core/common/frame_replication_state.h"
#include "core/common/media/media_param_traits.h"
//#include "core/common/navigation_gesture.h"
#include "core/common/view_message_enums.h"
//#include "core/common/webplugin_geometry.h"
#include "core/common/common_param_traits.h"
//#include "core/common/favicon_url.h"
//#include "core/common/file_chooser_file_info.h"
//#include "core/common/file_chooser_params.h"
//#include "core/common/menu_item.h"
//#include "core/common/message_port_types.h"
//#include "core/common/page_state.h"
//#include "core/common/page_zoom.h"
//#include "core/common/referrer.h"
//#include "core/common/renderer_preferences.h"
//#include "core/common/stop_find_action.h"
//#include "core/common/three_d_api_types.h"
//#include "core/common/window_shell_type.h"
...
//IPC_ENUM_TRAITS_MAX_VALUE(WindowShellType, WINDOW_SHELL_TYPE_MAX_VALUE)
//IPC_ENUM_TRAITS(common::FaviconURL::IconType)
//IPC_ENUM_TRAITS(common::FileChooserParams::Mode)
//IPC_ENUM_TRAITS(common::MenuItem::Type)
...
//IPC_ENUM_TRAITS_MAX_VALUE(common::StopFindAction,
//                          common::STOP_FIND_ACTION_LAST)
...
//IPC_STRUCT_TRAITS_END()
//
//IPC_STRUCT_TRAITS_BEGIN(common::FaviconURL)
//  IPC_STRUCT_TRAITS_MEMBER(icon_url)
//  IPC_STRUCT_TRAITS_MEMBER(icon_type)
//  IPC_STRUCT_TRAITS_MEMBER(icon_sizes)
//IPC_STRUCT_TRAITS_END()
//
//IPC_STRUCT_TRAITS_BEGIN(common::FileChooserFileInfo)
...
//IPC_STRUCT_TRAITS_END()
//
//IPC_STRUCT_TRAITS_BEGIN(common::FileChooserParams)
...
//IPC_STRUCT_TRAITS_END()
//
//IPC_STRUCT_TRAITS_BEGIN(common::WebPluginGeometry)
...
//  IPC_STRUCT_MEMBER(WindowShellType, window_shell_type)
//
...
//  // been specified).
//  IPC_STRUCT_MEMBER(common::Referrer, referrer)
//
...
//  IPC_STRUCT_MEMBER(std::vector<common::DateTimeSuggestion>, suggestions)
//IPC_STRUCT_END()
//
...
//  IPC_STRUCT_MEMBER(std::vector<common::WebPluginGeometry>,
//                    plugin_window_moves)
//
...
//  IPC_STRUCT_MEMBER(common::RendererPreferences, renderer_preferences)
//
//  // Preferences for this view.
//  IPC_STRUCT_MEMBER(common::WebPreferences, web_preferences)
//
...
//  // cases.
//  IPC_STRUCT_MEMBER(common::FrameReplicationState, replicated_frame_state)
//
...
//                    std::vector<common::FileChooserFileInfo>)
//
...
//
//IPC_MESSAGE_ROUTED1(ViewHostMsg_SetCursor, common::WebCursor)
//
//#if defined(OS_WIN)
...
//                    std::vector<common::FaviconURL> /* candidates */)
//
