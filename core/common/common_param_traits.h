...
template <>
struct ParamTraits<base::UUID> {
  typedef base::UUID param_type;
...
template <>
struct ParamTraits<RequestOpcode> {
  typedef RequestOpcode param_type;
  static void Write(base::Pickle* m, const param_type& p);
  static bool Read(const base::Pickle* m, base::PickleIterator* iter, param_type* p);
  static void Log(const param_type& p, std::string* l);
}; 
...
template <>
struct ParamTraits<ResultStatus> {
  typedef ResultStatus param_type;
  static void Write(base::Pickle* m, const param_type& p);
  static bool Read(const base::Pickle* m, base::PickleIterator* iter, param_type* p);
  static void Log(const param_type& p, std::string* l);
}; 
...
template <>
struct ParamTraits<RequestInfo> {
  typedef RequestInfo param_type;
  static void Write(base::Pickle* m, const param_type& p);
  static bool Read(const base::Pickle* m, base::PickleIterator* iter, param_type* p);
  static void Log(const param_type& p, std::string* l);
};
...
template <>
struct ParamTraits<common::DomainInfo> {
  typedef common::DomainInfo param_type;
  static void Write(base::Pickle* m, const param_type& p);
  static bool Read(const base::Pickle* m, base::PickleIterator* iter, param_type* p);
  static void Log(const param_type& p, std::string* l);
};
...
template <>
struct CONTENT_EXPORT ParamTraits<common::ShellManifest> {
  typedef common::ShellManifest param_type;
  static void Write(base::Pickle* m, const param_type& p);
  static bool Read(const base::Pickle* m, base::PickleIterator* iter, param_type* p);
  static void Log(const param_type& p, std::string* l);
};
