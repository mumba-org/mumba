...
#else
  CFURLSessionEasyHandle handle = NULL;
  return handle;
#endif
}
...
#else
    CFURLSessionMultiHandle handle = NULL;
    return handle;
#endif
}
...
CFURLSessionCurlVersion CFURLSessionCurlVersionInfo(void) {
    ...
    return v;
#endif
    CFURLSessionCurlVersion v = {0,0,0};
    return v;
}
