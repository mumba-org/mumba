...
//     while ((basePtr >= basePath)  &&  ((XMLPlatformUtils::isAnySlash(*basePtr) == false)))
//     {
//         basePtr--;
//     }
...
//         if ( 3 <= srcLen )
//         {
//             if ( (XMLPlatformUtils::isAnySlash(*srcPtr))     &&
//                 (chPeriod == *(srcPtr+1)) &&
//                 (XMLPlatformUtils::isAnySlash(*(srcPtr+2)))  )
//             {
//                 // "\.\x" seen
...
//                  (chPeriod == *(srcPtr+1)) &&
//                  (chPeriod == *(srcPtr+2)) &&
//                  (XMLPlatformUtils::isAnySlash(*(srcPtr+3)))  )
//             {
