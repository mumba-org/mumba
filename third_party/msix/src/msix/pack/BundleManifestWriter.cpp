...
namespace MSIX {
    ...
    static const char* packageSizeAttribute = "Size";
    ...
    void BundleManifestWriter::WritePackageElement(PackageInfo packageInfo)
    {
        ...
        if (packageInfo.size > 0)
        {
            ...
            //Mumba: changed here as reading bundle requires it
            m_xmlWriter.AddAttribute(packageSizeAttribute, std::to_string(packageInfo.size));
        }
