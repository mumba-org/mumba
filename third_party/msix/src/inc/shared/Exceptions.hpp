...
#include "third_party/msix/src/inc/public/MsixErrors.hpp"

#ifndef MSIX_TEST
#include "third_party/msix/src/inc/internal/Log.hpp"
#else
namespace MSIX {
    namespace Global {
        namespace Log {
...
namespace MSIX {
    ...
    #endif
    MSIX_API RaiseException(const int line, const char* const file, const char* details, C c)
    {
#ifdef WIN32
#ifndef NDEBUG
    ...
    #endif
    MSIX_API RaiseExceptionIfFailed(HRESULT hr, const int line, const char* const file);
}
