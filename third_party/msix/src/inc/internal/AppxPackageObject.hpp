...
#include "third_party/msix/src/inc/internal/StorageObject.hpp"
#include "third_party/msix/src/inc/internal/ZipObject.hpp"
#include "third_party/msix/src/inc/internal/VerifierObject.hpp"
#include "third_party/msix/src/inc/internal/IXml.hpp"
#include "third_party/msix/src/inc/internal/AppxBlockMapObject.hpp"
#include "third_party/msix/src/inc/internal/AppxSignature.hpp"
#include "third_party/msix/src/inc/internal/AppxFactory.hpp"
#include "third_party/msix/src/inc/internal/AppxPackageInfo.hpp"
#include "third_party/msix/src/inc/internal/AppxManifestObject.hpp"
#include "third_party/msix/src/inc/internal/DirectoryObject.hpp"
...
namespace MSIX {
    ...
    class MSIX_API AppxPackageObject final : public ComClass<AppxPackageObject, IAppxPackageReader, IPackage, IStorageObject, IAppxBundleReader, IAppxPackageReaderUtf8, IAppxBundleReaderUtf8>
    {
    public:
        ...
        HRESULT STDMETHODCALLTYPE QueryInterface(REFIID riid, void** ppvObject) noexcept override
        {
            ...
            *ppvObject = nullptr;
            ...
            if (riid == UuidOfImpl<IAppxBundleReader>::iid)
            {
            ...
            if (riid == UuidOfImpl<IAppxBundleReaderUtf8>::iid)
            {
