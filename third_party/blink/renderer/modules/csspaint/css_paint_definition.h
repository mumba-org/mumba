...
class MODULES_EXPORT CSSPaintDefinition final
 ...
 public:
  ...
  static CSSPaintDefinition* CreateNative(
      ScriptState*,
      void* paint_state,
 ...
 private:
  ...
  // TODO: see if using C styles callbacks here
  // isnt a problematic security issue
  ...
  scoped_refptr<Image> PaintV8(const ImageResourceObserver&,
                               const IntSize& container_size,
                               const CSSStyleValueVector*);    
  
  scoped_refptr<Image> PaintNative(const ImageResourceObserver&,
                                   const IntSize& container_size,
                                   const CSSStyleValueVector*);
  ...
  void* paint_state_;
  void(*paint_callback_)(void*, void*, void*, void*, const void*);
