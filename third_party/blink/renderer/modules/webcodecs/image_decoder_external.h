...
class MODULES_EXPORT ImageDecoderExternal final
 ...
 public:
  ...
  ScriptPromise decode(const ImageDecodeOptions& options);
 ...
 private:
  ...
  void PerformDecode(uint32_t frame_index, bool complete_frames_only);
  void PerformDecodeMetadata();
  ...
  std::unique_ptr<ImageDecoderCore> decoder_;
  ...
  using CompletedProperty =
      ScriptPromiseProperty<Member<ImageDecoderExternal>, ToV8UndefinedGenerator, Member<DOMException>>;
