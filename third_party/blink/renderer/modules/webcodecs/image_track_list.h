...
class MODULES_EXPORT ImageTrackList final : public ScriptWrappable {
 ...
 public:
  ...
  void OnTrackSelectionChanged(size_t index);
 ...
 private:
  ...
  base::Optional<size_t> selected_track_id_;

  using ReadyProperty =
      ScriptPromiseProperty<Member<ImageTrackList>, ToV8UndefinedGenerator, Member<DOMException>>;
