...
class CrossThreadVideoDecoderClient {
 public:
  ...
  virtual void OnInitialize(media::StatusCode status,
                            base::Optional<DecoderDetails> details) = 0;

  virtual void OnDecodeDone(int cb_id, media::DecodeStatus status) = 0;

  virtual void OnDecodeOutput(const scoped_refptr<media::VideoFrame>& frame,
...
class MODULES_EXPORT VideoDecoderBroker : public media::VideoDecoder,
 ...
 public:
  ...
  void Initialize(const media::VideoDecoderConfig& config,
                  ...
                  const WaitingForDecryptionKeyCB& waiting_cb) override;
 ...
 private:
  ...
  void OnInitialize(media::StatusCode status,
