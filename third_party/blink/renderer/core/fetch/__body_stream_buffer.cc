...
void BodyStreamBuffer::Tee(BodyStreamBuffer** branch1,
  ...
  *branch2 = nullptr;
  ...
  if (made_from_readable_stream_) {
    ...
    // //Stream()->Tee(script_state_, &stream1, &stream2, exception_state);
    // Stream().Tee(script_state_, &stream1, &stream2, exception_state);
...
bool BodyStreamBuffer::IsStreamReadable() {
  NonThrowableExceptionState exception_state;
  ScriptState::Scope scope(script_state_.get());
  return *ReadableStreamOperations::IsReadable(script_state_.get(), Stream(), exception_state);
}

bool BodyStreamBuffer::IsStreamClosed() {
  NonThrowableExceptionState exception_state;
  ScriptState::Scope scope(script_state_.get());
  return *ReadableStreamOperations::IsClosed(script_state_.get(), Stream(), exception_state);
}

bool BodyStreamBuffer::IsStreamErrored() {
  NonThrowableExceptionState exception_state;
  ScriptState::Scope scope(script_state_.get());
  return *ReadableStreamOperations::IsErrored(script_state_.get(), Stream(), exception_state);
}

bool BodyStreamBuffer::IsStreamLocked() {
  NonThrowableExceptionState exception_state;
  ScriptState::Scope scope(script_state_.get());
  return *ReadableStreamOperations::IsLocked(script_state_.get(), Stream(), exception_state);
}

bool BodyStreamBuffer::IsStreamDisturbed() {
  NonThrowableExceptionState exception_state;
  ScriptState::Scope scope(script_state_.get());
  return *ReadableStreamOperations::IsDisturbed(script_state_.get(), Stream(), exception_state);
}
