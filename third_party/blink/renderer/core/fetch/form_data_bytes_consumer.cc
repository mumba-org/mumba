...
//         simple_consumer_ = new SimpleFormDataBytesConsumer(
...
//   Member<DataPipeAndDataBytesConsumer> data_pipe_consumer_;
//   //Member<DataPipeBytesConsumer::CompletionNotifier> completion_notifier_;
//   //Member<DataPipeAndDataBytesConsumer::CompletionNotifier> completion_notifier_;
// };
...
BytesConsumer* FormDataBytesConsumer::GetImpl(
  ...
  switch (GetType(form_data.get())) {
    case FormDataType::kSimple:
      return new SimpleFormDataBytesConsumer(
          std::move(form_data));
    ...
    case FormDataType::kDataPipeAndDataOnly:
      return new DataPipeAndDataBytesConsumer(
