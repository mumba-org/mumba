...
ReadableStreamWrapper* ReadableStreamWrapper::Create(
    ...
    ScriptValue strategy,
    ExceptionState& exception_state) {
  auto* stream = new ReadableStreamWrapper();
...
void ReadableStreamWrapper::Tee(ScriptState* script_state,
  ...
  ReadableStreamWrapper* temp_branch1 = new ReadableStreamWrapper();
  ReadableStreamWrapper* temp_branch2 = new ReadableStreamWrapper();
...
ReadableStream::ReadHandle* ReadableStreamWrapper::GetReadHandle(
  ...
  return new ReadHandleImpl(script_state->GetIsolate(),
                            reader.V8Value());
}
