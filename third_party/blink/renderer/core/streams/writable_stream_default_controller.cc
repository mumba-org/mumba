...
void WritableStreamDefaultController::SetUp(
  ...
  StreamThenPromise(
      ...
      new ResolvePromiseFunction(script_state, stream),
      new RejectPromiseFunction(script_state, stream));
}
...
void WritableStreamDefaultController::SetUpFromUnderlyingSink(
  ...
  auto* controller = new WritableStreamDefaultController();
...
void WritableStreamDefaultController::ProcessClose(
  ...
  StreamThenPromise(script_state->GetContext(), sinkClosePromise,
                    new ResolveFunction(script_state, stream),
                    new RejectFunction(script_state, stream));
}
...
void WritableStreamDefaultController::ProcessWrite(
  ...
  StreamThenPromise(
      ...
      new ResolveFunction(script_state, stream, controller),
      new RejectFunction(script_state, stream, controller));
}
