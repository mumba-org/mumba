...
void PackAndPostMessage(ScriptState* script_state,
  ...
  v8::Local<v8::Object> packed = CreateKeyValueObject(
      ...
      value);
  scoped_refptr<SerializedScriptValue> script_value = SerializedScriptValue::Serialize(
      isolate, 
      packed, 
      serialize_options, 
      exception_state);
  port->postMessage(script_state, 
                    script_value,
...
bool UnpackReason(ScriptState* script_state,
  ...
  switch (static_cast<ErrorType>(encoder)) {
    ...
    case ErrorType::kDomException: {
      ...
      *reason = ToV8(DOMException::Create(
          V8StringToWebCoreString<String>(message.As<v8::String>(), kDoNotExternalize),
          V8StringToWebCoreString<String>(name.As<v8::String>(), kDoNotExternalize)),
          script_state);
      return true;
    }
...
class CrossRealmTransformMessageListener final : public NativeEventListener {
 public:
  ...
  void Invoke(ExecutionContext*, Event* event) {
    ...
    v8::Local<v8::Value> data = message->DataAsScriptValue().V8Value();//message->data(script_state).V8Value();
    if (!data->IsObject()) {
  ...
  void handleEvent(ExecutionContext* ctx, Event* ev) override {
    Invoke(ctx, ev);
  }

  bool operator==(const EventListener& other) const override {
    return other.IsNativeEventListener();
  }
...
class CrossRealmTransformErrorListener final : public NativeEventListener {
 public:
  ...
  void Invoke(ExecutionContext*, Event*) {
    ScriptState* script_state = target_->GetScriptState();
    const auto* error =
  ...
  CrossRealmTransformWritable(ScriptState* script_state, MessagePort* port)
      : script_state_(script_state),
        ...
        backpressure_promise_(
            new StreamPromiseResolver(script_state)) {}
 ...
 public:
  ...
  v8::Local<v8::Promise> Run(ScriptState* script_state,
    ...
    return StreamThenPromise(
        ...
        new DoWriteOnResolve(script_state, chunk, this));
  }
  ...
  class DoWriteOnResolve final : public PromiseHandlerWithValue {
   public:
    ...
    ScriptValue Call(ScriptValue) override {
      return ScriptValue::From(GetScriptState(), CallWithLocal(v8::Local<v8::Value>()));
    }
  ...
  v8::Local<v8::Promise> DoWrite(ScriptState* script_state,
    ...
    if (exception_state.HadException()) {
      ...
      PackAndPostMessage(
          ...
          PackReason(writable_->script_state_.get(), exception), exception_state);
      if (exception_state.HadException()) {
 ...
 public:
  ...
  v8::Local<v8::Promise> Run(ScriptState* script_state,
    ...
    PackAndPostMessage(
        ...
        PackReason(writable_->script_state_.get(), reason), exception_state);
    if (exception_state.HadException()) {
...
WritableStreamNative* CrossRealmTransformWritable::CreateWritableStream(
  ...
  message_port_->setOnmessage(
      new CrossRealmTransformMessageListener(this));
  message_port_->setOnmessageerror(
      new CrossRealmTransformErrorListener(this));

  auto* stream = WritableStreamNative::Create(
      script_state_.get(), CreateTrivialStartAlgorithm(),
      new WriteAlgorithm(this),
      new CloseAlgorithm(this),
      new AbortAlgorithm(this), 1,
...
void CrossRealmTransformWritable::HandleMessage(MessageType type,
  ...
  switch (type) {
    case MessageType::kPull:
      ...
      backpressure_promise_->ResolveWithUndefined(script_state_.get());
    ...
    case MessageType::kError: {
      v8::Local<v8::Value> reason;
      if (!UnpackReason(script_state_.get(), value, &reason)) {
        DLOG(WARNING)
            << "Invalid message from peer ignored (unable to unpack value)";
        return;
      }
      WritableStreamDefaultController::ErrorIfNeeded(script_state_.get(), controller_,
                                                     reason);
...
ReadableStreamNative* CrossRealmTransformReadable::CreateReadableStream(
  ...
  auto* stream = ReadableStreamNative::Create(
      script_state_.get(), CreateTrivialStartAlgorithm(),
      new PullAlgorithm(this),
      new CancelAlgorithm(this),
...
void CrossRealmTransformReadable::HandleMessage(MessageType type,
  ...
  switch (type) {
    case MessageType::kChunk: {
      ...
      // 1.0.
      ReadableStreamDefaultController::Enqueue(script_state_.get(), controller_,
                                               value, ASSERT_NO_EXCEPTION);

      backpressure_promise_->ResolveWithUndefined(script_state_.get());
      backpressure_promise_ =
          new StreamPromiseResolver(script_state_.get());
      return;
    }

    case MessageType::kClose:
      finished_ = true;
      ReadableStreamDefaultController::Close(script_state_.get(), controller_);
      message_port_->close();
      return;
    ...
    case MessageType::kError: {
      ...
      ReadableStreamDefaultController::Error(script_state_.get(), controller_,
                                             reason);
      message_port_->close();
      return;
    }
...
void CrossRealmTransformReadable::HandleError(v8::Local<v8::Value> error) {
  ReadableStreamDefaultController::Error(script_state_.get(), controller_, error);
}
...
CORE_EXPORT WritableStreamNative* CreateCrossRealmTransformWritable(
    ...
    MessagePort* port,
    ExceptionState& exception_state) {
  return (new CrossRealmTransformWritable(script_state, port))
...
CORE_EXPORT ReadableStreamNative* CreateCrossRealmTransformReadable(
    ...
    MessagePort* port,
    ExceptionState& exception_state) {
  return (new CrossRealmTransformReadable(script_state, port))
