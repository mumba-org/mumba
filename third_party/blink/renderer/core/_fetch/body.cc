...
ScriptPromise Body::arrayBuffer(ScriptState* script_state, ExceptionState&) {
  return arrayBuffer(script_state);
}
...
ScriptPromise Body::blob(ScriptState* script_state, ExceptionState&) {
  return blob(script_state);
}
...
ScriptPromise Body::formData(ScriptState* script_state, ExceptionState&) {
  return formData(script_state);
}
...
ScriptPromise Body::json(ScriptState* script_state, ExceptionState&) {
  return json(script_state);
}
...
ScriptPromise Body::text(ScriptState* script_state, ExceptionState&) {
  return text(script_state);
}
