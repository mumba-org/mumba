...
Response* Response::Create(ScriptState* script_state,
  ...
  if (body_value.IsUndefined() || body_value.IsNull()) {
    DLOG(INFO) << "Response::Create: body_value.IsUndefined() || body_value.IsNull()"; 
    // Note: The IDL processor cannot handle this situation. See
    // https://crbug.com/335871.
  } else if (V8Blob::hasInstance(body, isolate)) {
    DLOG(INFO) << "Response::Create: V8Blob::hasInstance"; 
    ...
    DLOG(INFO) << "Response::Create: body->IsArrayBuffer";
    ...
    DLOG(INFO) << "Response::Create: body->IsArrayBufferView";
    // Avoid calling into V8 from the following constructor parameters, which
    // is potentially unsafe.
    ...
    DLOG(INFO) << "Response::Create: V8FormData::hasInstance";
    ...
    DLOG(INFO) << "Response::Create: V8URLSearchParams::hasInstance";
    scoped_refptr<EncodedFormData> form_data =
    ...
    content_type = "application/x-www-form-urlencoded;charset=UTF-8";
                                                        ...
                                                        body_value,
                                                        exception_state)) {
    DLOG(INFO) << "Response::Create: ReadableStreamOperations::IsReadableStream";
    UseCounter::Count(execution_context,
                      WebFeature::kFetchResponseConstructionWithStream);
    body_buffer = new BodyStreamBuffer(script_state, body_value);
  } else {
    DLOG(INFO) << "Response::Create: NativeValueTraits<IDLUSVString>::NativeValue";
