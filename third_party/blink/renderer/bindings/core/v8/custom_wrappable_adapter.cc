...
v8::Local<v8::FunctionTemplate> InstallCustomWrappableTemplate(v8::Isolate* isolate,
...
v8::Local<v8::FunctionTemplate> InstallCustomWrappableTemplate(v8::Isolate* isolate,
                                    const DOMWrapperWorld& world) {//,
                                    //v8::Local<v8::Template> v8_template) {
  DLOG(ERROR) << "CustonWrappableAdapter: WARNING running with no function template as a parameter as it suppose to be. it will probably break something";
  v8::Local<v8::FunctionTemplate> v8_template;
  
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(
      isolate, v8_template,//v8_template.As<v8::FunctionTemplate>(),
