...
MODULES_EXPORT bool CanInjectIDBKeyIntoScriptValue(v8::Isolate*,
                                                   const ScriptValue&,
                                                   const IDBKeyPath&);
ScriptValue MODULES_EXPORT DeserializeScriptValue(ScriptState*,
...
template <>
struct MODULES_EXPORT NativeValueTraits<SQLValue> {
...
template <>
struct MODULES_EXPORT NativeValueTraits<std::unique_ptr<IDBKey>> {
...
template <>
struct MODULES_EXPORT NativeValueTraits<IDBKeyRange*> {
