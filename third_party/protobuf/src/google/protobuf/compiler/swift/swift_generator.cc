...
namespace google { namespace protobuf { namespace compiler { namespace swift {
    ...
    bool SwiftGenerator::Generate(const FileDescriptor* file,
        ...
        FileGeneratorExtra file_generator(file);
        RpcFileGenerator rpc_file_generator(file);
        ...
        string filepath = FilePath(file);
        {
            ...
            //std::unique_ptr<io::ZeroCopyOutputStream> output(generator_context->Open(package_name + UnderscoresToCapitalizedCamelCase(UnderscoresToCapitalizedCamelCase(filepath)) + ".proto.swift"));
            std::unique_ptr<io::ZeroCopyOutputStream> output(generator_context->Open(UnderscoresToCapitalizedCamelCase(UnderscoresToCapitalizedCamelCase(filepath)) + ".proto.swift"));
            ...
            printer.Print("import Engine\n");
            printer.Print("import Route\n");
            ...
            rpc_file_generator.GenerateSource(&printer);
        }
