...
static void
fe25519_cmov(fe25519 f, const fe25519 g, unsigned int b) __attribute__((unused));
...
*/
static void
fe25519_cswap(fe25519 f, fe25519 g, unsigned int b) __attribute__((unused));
...
static void
fe25519_mul(fe25519 h, const fe25519 f, const fe25519 g) __attribute__((unused));
...
static void
fe25519_sq(fe25519 h, const fe25519 f) __attribute__((unused));
...
static void
fe25519_sq2(fe25519 h, const fe25519 f) __attribute__((unused));
...
static void
fe25519_scalar_product(fe25519 h, const fe25519 f, uint32_t n) __attribute__((unused));
