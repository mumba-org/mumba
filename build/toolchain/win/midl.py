...
def main(arch, outdir, dynamic_guid, tlb, h, dlldata, iid, proxy, idl, *flags):
  ...
  # CHANGE: append the path from the current environment
  #         this helps when you are using the VsCmd
  #         as cl.exe cannot be found without this 
  env_dict.update(PATH = os.environ['PATH'])
